...
> **审查时间**：2026-07-14（第一轮）, 2026-07-15（第二轮~第十一轮）, 2026-07-15（第十二轮）, 2026-07-15（第十三轮）, 2026-07-15（第十四轮）, 2026-07-15（第十五轮）, 2026-07-15（第十六轮）, 2026-07-15（第十七轮）, 2026-07-15（第十八轮）, 2026-07-15（第十九轮）, 2026-07-16（第二十轮）, 2026-07-16（第二十一轮）, 2026-07-16（第二十二轮）, 2026-07-16（第二十三轮）, 2026-07-16（第二十四轮）, 2026-07-16（第二十五轮）, 2026-07-16（第二十六轮）, 2026-07-16（第二十七轮）, 2026-07-16（第二十八轮）, 2026-07-16（第二十九轮）, 2026-07-16（第三十轮）, 2026-07-16（第三十一轮）
> **审查版本**：main 分支最新提交
...
|------|------|---------|---------|-----------|-----------|-----------|
| VM 虚拟机 | `vm.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 86 | 114 | 97 |
| 编译器 | `compiler.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 56 | 95 | 93 |
| 求值器 | `evaluator.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 74 | 104 | 95 |
| AST 节点 | `ast_nodes.py` | ✅ 已审查 | 2026-07-16(第三十一轮) | 0 | 3 | 7 |
| 类型检查器 | `type_checker.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 89 | 110 | 112 |
| 词法分析器 | `lexer.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 46 | 95 | 89 |
| 语法分析器 | `parser.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 63 | 110 | 93 |
| 错误处理 | `errors.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 56 | 81 | 77 |
| 模块系统 | `modules.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 64 | 81 | 71 |
| 环境 | `environment.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 38 | 57 | 59 |
| C 代码生成 | `c_codegen.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 40 | 66 | 50 |
| Native 后端 | `backend/native_backend.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 75 | 78 | 50 |
| Cranelift 后端 | `backend/cranelift_backend.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 52 | 55 | 37 |
| WASM 后端 | `backend/wasm_backend.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 53 | 52 | 39 |
| x86_64 指令发射 | `backend/x86_64.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 18 | 22 | 21 |
| 编译管道 | `backend/compiler_pipeline.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 24 | 20 | 15 |
| IR 节点 | `ir/ir_nodes.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 2 | 16 | 44 |
| HIR Lowering | `ir/hir_lowering.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 13 | 21 | 34 |
| MIR Lowering | `ir/mir_lowering.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 57 | 62 | 39 |
| LIR Lowering | `ir/lir_lowering.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 58 | 63 | 41 |
| Pass 管理器 | `ir/pass_manager.py` | ✅ 已审查 | 2026-07-16(第三十轮) | 53 | 69 | 56 |
| C 运行时 | `runtime/nova_runtime.c` | ✅ 已审查 | 2026-07-16(第三十轮) | 82 | 101 | 72 |
| 测试套件 | `tests/` | ✅ 已审查 | 2026-07-16(第三十轮) | 24 | 52 | 40 |
| Tree-sitter | `tree-sitter-nova/` | ✅ 已审查 | 2026-07-16(第三十轮) | 27 | 40 | 35 |
...
| 模块 | 文件 | 审查状态 | 上次审查 | 严重问题数 | 中等问题数 | 轻微问题数 |
|------|------|---------|---------|-----------|-----------|-----------|
| VM 虚拟机 | `vm.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 36 | 38 | 25 |
| 编译器 | `compiler.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 22 | 33 | 28 |
| 求值器 | `evaluator.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 23 | 29 | 30 |
| 类型检查器 | `type_checker.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 30 | 32 | 28 |
| 词法分析器 | `lexer.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 13 | 33 | 29 |
| 语法分析器 | `parser.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 21 | 37 | 29 |
| 错误处理 | `errors.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 13 | 18 | 21 |
| 模块系统 | `modules.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 18 | 21 | 20 |
| 环境 | `environment.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 6 | 12 | 15 |
| C 代码生成 | `c_codegen.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 13 | 23 | 20 |
| Native 后端 | `backend/native_backend.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 17 | 19 | 10 |
| Cranelift 后端 | `backend/cranelift_backend.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 16 | 15 | 8 |
| WASM 后端 | `backend/wasm_backend.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 12 | 13 | 9 |
| x86_64 指令发射 | `backend/x86_64.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 6 | 8 | 6 |
| 编译管道 | `backend/compiler_pipeline.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 9 | 7 | 5 |
| IR 节点 | `ir/ir_nodes.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 0 | 7 | 14 |
| HIR Lowering | `ir/hir_lowering.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 7 | 11 | 13 |
| MIR Lowering | `ir/mir_lowering.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 19 | 17 | 12 |
| LIR Lowering | `ir/lir_lowering.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 17 | 16 | 13 |
| Pass 管理器 | `ir/pass_manager.py` | ✅ 已审查 | 2026-07-16(第二十轮) | 11 | 17 | 15 |
| C 运行时 | `runtime/nova_runtime.c` | ✅ 已审查 | 2026-07-16(第二十轮) | 29 | 26 | 17 |
| 测试套件 | `tests/` | ✅ 已审查 | 2026-07-16(第二十轮) | 6 | 19 | 14 |
| Tree-sitter | `tree-sitter-nova/` | ✅ 已审查 | 2026-07-16(第二十轮) | 10 | 14 | 11 |
...
## [2026-07-16] VM 虚拟机 (vm.py) 第二十轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 自研栈式 VM，模式匹配专用指令集、FOR_ITER+LOOP_END 配对、PIPE_CALL 等设计有特色 |
| 可行性 | ⭐⭐⭐⭐ | 核心功能可运行，65 个操作码全覆盖 |
| 正确性 | ⭐⭐⭐ | 核心路径基本正确，但边缘情况和错误路径有多处 bug |
| 安全性 | ⭐⭐ | 内置函数普遍缺乏类型检查、循环状态异常泄漏、栈访问边界检查不全 |
| 一致性 | ⭐⭐ | RETURN 三重语义分裂、双执行循环架构、函数内无法修改全局变量 |
| 完整性 | ⭐⭐⭐⭐⭐ | 65 个操作码全覆盖，模式匹配、闭包、ADT、管道等特性齐全 |
| 工程质量 | ⭐⭐ | 死代码（LOOP）、启发式 hack、hasattr 延迟初始化、Frame.ip 死字段 |
| 性能 | ⭐⭐⭐ | Python 实现的栈 VM 性能上限有限，闭包过度捕获和整体复制栈增加开销 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [vm.py:880] **BREAK for 循环路径中 `self.stack[base_sp + 1]` 无边界检查** → 如果栈因异常路径被修改导致 base_sp+1 越界，将抛出 Python IndexError 而非 Nova RuntimeError_，错误信息泄露 → 添加栈深度断言，统一使用 `_pop` 安全访问
  - 追问：如果是 Haskell GHC 的 STG 机器栈管理有 bug，能被接受吗？→ **不能接受。** 类型安全的虚拟机应保证所有栈访问都是安全的。

- [vm.py:893-912] **CONTINUE/BREAK 在循环外静默失败** → 如果 `_while_loops` 和 `_for_iters` 均为空，CONTINUE 什么都不做继续执行下一条指令；BREAK while 路径盲目跳转不清理栈 → 在 VM 层抛出明确的运行时错误（虽然类型检查器应在编译期阻止，但 VM 也应有防御）
  - 追问：如果任何生产级语言的 continue 是空实现，能被接受吗？→ **绝对不能。** break/continue 在循环外应是明确错误。

- [vm.py:486, 935, 496] **RETURN 三重语义分裂** → 函数内 RETURN 由 `_execute_function` 内联处理（弹出值并 return）；顶层 RETURN 由 `_execute_instruction` 处理（pop+push+return_flag）；函数内 return_flag 路径又是第三种处理方式 → 统一指令分派逻辑，消除双执行循环架构
  - 追问：如果是 OCaml 的字节码 VM，RETURN 语义在三个地方分裂，能被接受吗？→ **绝对不能。** 指令分派逻辑必须唯一且集中。

- [vm.py:921-922] **闭包捕获整个帧而非自由变量** → 每次创建闭包都 dict 浅拷贝所有局部变量，时间 O(n)，阻止 GC 回收不需要的变量；可变共享对象违反不可变性原则 → 编译器分析自由变量，CLOSURE 指令携带自由变量名列表
  - 追问：如果 OCaml 的闭包捕获了整个作用域的 dict 拷贝，性能影响能被接受吗？→ **绝对不能。** 内存使用量可能增加 10-100 倍。

- [vm.py:1123-1124, 1279-1290] **顶层模式匹配绑定泄漏到全局作用域** → 顶层 match 的 MATCH_BIND 直接修改 `self.globals`，MATCH_END 不清理，模式绑定变量永久泄漏 → 顶层也做局部变量快照和清理
  - 追问：如果是 OCaml/Haskell 的编译器，模式匹配的变量泄漏到外层作用域，能被接受吗？→ **不能接受。** 违反词法作用域原则。

- [vm.py:191-227 多处] **内置函数普遍缺乏类型检查** → int_to_str/float_to_str/str_len/list_length/sum/filter/map/head/tail 等几乎所有内置函数都不做参数类型检查，传入错误类型会泄漏 Python TypeError → 为每个内置函数添加参数类型验证
  - 追问：如果 Python 的 builtins 不做类型检查直接抛原生异常，能被接受吗？→ **不能接受。** 内置函数是运行时安全的边界。

- [vm.py:213-224] **数学函数 ValueError 未转换为 RuntimeError_** → sqrt/log/log10 等在非法值时抛出 Python ValueError 而非 Nova 运行时错误 → 捕获 ValueError 并转换为 RuntimeError_
  - 追问：如果是 OCaml 的 Pervasives 抛出 OCaml 原生异常而非语言级错误，能被接受吗？→ **不能接受。** 错误信息应统一。

- [vm.py:1032, 1076] **循环状态字典异常安全缺失** → `_range_index` 和 `_list_index` 在循环体内发生异常时条目永久泄漏；`_for_iters`/`_while_loops` 栈同样不清理 → 使用 try/finally 确保资源释放
  - 追问：如果 Python 的迭代器在异常时不释放资源，能被接受吗？→ **不能接受。** 异常安全是基本要求。

- [vm.py:634-652] **STORE_VAR 在函数中不能修改全局变量** → 函数作用域内，如果变量不在 locals 中，也写入 locals（行 650），不修改全局变量 → 与 evaluator 语义不一致，函数无法修改全局 mut 变量 → 沿作用域链查找并修改
  - 追问：如果是 OCaml 的编译器，两条执行路径对相同代码产生不同结果，能被接受吗？→ **绝对不能接受。** 这是致命的语义不一致。

- [vm.py:134, 455] **Frame.ip 是死字段** → Frame.__init__ 接收 ip 参数，但帧恢复时使用的是 return_ip，frame.ip 从未被读取 → 删除死字段
  - 追问：如果是 JVM 的栈帧有从未使用的字段，能被接受吗？→ **不能接受。** 死代码增加维护负担。

#### 中等问题（影响特定场景）

- [vm.py:1378-1382] LOOP 操作码是死代码，编译器从未生成
- [vm.py:1347-1355] HALT/AUTO_CALL_MAIN 语义分散在外层循环中，指令内为空实现
- [vm.py:1036-1042] for 循环首次迭代检测依赖 IP 比较启发式，极端情况可能误判
- [vm.py:802-806] while 循环 JUMP 回跳检测极其脆弱（依赖下一条指令是 CONST_UNIT）
- [vm.py:868, 881, 904, 911] BREAK/CONTINUE 的 base_sp 无下界校验（应断言 >= 0 且 <= len(stack)）
- [vm.py:544-546] TRY_UNWRAP 顶层语义不明确（提前返回后错误值留在栈上）
- [vm.py:969-979] BUILD_MAP 不处理不可哈希键，直接抛 Python TypeError
- [vm.py:1128-1129] MATCH_START 栈检查不充分（只检查非空，不验证 subject 类型）

#### 轻微问题（代码质量）

- [vm.py:1032, 1076] `_range_index`/`_list_index` 用 hasattr 延迟创建，代码风格差
- [vm.py:268-290] 文件 I/O 无路径沙箱保护
- [vm.py:190] read_line 实现逻辑冗余
- [vm.py:322-340] JSON 转换中对 None/Unit 的处理 evaluator 与 VM 不一致

#### 原创性分析
- **Nova 特色**：模式匹配专用指令集（MATCH_START/MATCH_ARM_START/MATCH_TEST_*/MATCH_CONSTRUCTOR/MATCH_BIND/MATCH_END）、FOR_ITER+LOOP_END 配对循环架构、PIPE_CALL 专用管道调用指令、TRY_UNWRAP 统一错误传播早返回机制、ADT 原生指令支持（MAKE_ADT/REGISTER_CTOR/MATCH_CONSTRUCTOR）
- **参考已有**：基本栈机设计参考 CPython/JVM；函数调用帧栈是经典实现

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 函数修改全局 mut 变量 | 可以（沿作用域链查找） | 不可以（写入局部） | ❌ **严重** |
| Unit 值 bool 语义 | `object()` → True | `UNIT_TYPE.__bool__` = False | ❌ |
| str_to_int 返回 field_names | 无 | 有 | ❌ |
| 闭包捕获方式 | Environment 引用（引用语义） | locals dict 浅拷贝（值语义） | ❌ |
| Map 非可哈希键处理 | 有 try/except 转 RuntimeError_ | 直接抛 Python TypeError | ❌ |
| 递归深度保护 | 无 | MAX_CALL_DEPTH = 1000 | ❌ |
| 基本算术 | 正确 | 正确 | ✅ |
| ADT 构造 | 正确 | 正确 | ✅ |
| 模式匹配 | 正确 | 正确 | ✅ |
| 管道操作 | 正确 | 正确 | ✅ |
| for 循环 continue 语义 | 跳过 append（正确） | 跳过 LOOP_END（正确） | ✅ |


---

## [2026-07-16] 编译器 (compiler.py) 第二十轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配专用指令、FOR_ITER/LOOP_END 架构、PIPE_CALL、TRY_UNWRAP 等设计有新意 |
| 可行性 | ⭐⭐⭐⭐ | 整体架构可行，VM 实现完整，能运行大多数语言特性 |
| 正确性 | ⭐⭐⭐ | while 循环返回值错误、char 类型擦除、闭包过度捕获等问题影响正确性 |
| 安全性 | ⭐⭐⭐ | 模块遮蔽仅警告不报错、CharLiteral 编译为字符串导致类型系统不健全 |
| 一致性 | ⭐⭐⭐ | while 语义与规范不符、break/continue 两种实现策略、char 编译与类型系统不一致 |
| 完整性 | ⭐⭐⭐⭐ | AST 节点全覆盖，语言特性基本完整，模块系统有支持 |
| 工程质量 | ⭐⭐⭐ | 有死代码、命名不一致（JUMP_IF_FALSE vs POP_JUMP_IF_FALSE）、常量池 O(n) 去重 |
| 性能 | ⭐⭐⭐ | 解释执行、常量池低效、闭包过度捕获、无优化 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [compiler.py:1040-1070] **while 循环返回值与语义规范不一致** → ast_nodes.py 明确声明 while 循环"返回体中最后一个表达式的最后一次迭代的值"，但编译器直接 POP 丢弃 body 结果，循环结束后压入 CONST_UNIT → 实现"返回最后一次迭代值"语义，引入结果变量
  - 追问：如果 Rust 的 loop 表达式文档说返回 break 值但实际返回 nil，能被接受吗？→ **不能。** 文档和实现不一致是最危险的 bug。

- [compiler.py:420-421] **CharLiteral 编译为 CONST_STRING，运行时无独立 Char 表示** → 字符字面量与字符串字面量使用相同运行时表示，类型系统认为 Char 和 String 不同但运行时相同 → 类型系统不健全，可绕过类型约束 → 要么在运行时区分 Char 和 String，要么在类型系统中统一
  - 追问：如果 Haskell 的 Char 和 String 在运行时是同一类型，能被接受吗？→ **不能。** 这会导致类型系统不健全。

- [compiler.py:362-368] **模块内联导入的名称冲突检测不完整** → 只检查 functions 和 builtin_names，不检查 let/mut 绑定、ADT 构造器、类型名；且即使检测到冲突也只是 print 警告，仍然继续导入并覆盖 → 全面检测名称冲突，冲突时抛出错误而非警告
  - 追问：如果 Haskell 的 import 把模块内同名绑定静默覆盖，能被接受吗？→ **不能。** 名称遮蔽是模块化语言的严重正确性问题。

- [compiler.py:1072-1133] **列表推导式缺少 _loop_stack 注册，break/continue 语义未定义** → _compile_list_comprehension 内联 for 循环逻辑但未注册到 _loop_stack，推导式内出现 break/continue 会错误操作外层循环 → 在 _compile_list_comprehension 中正确注册循环，或在 parser 层面阻止
  - 追问：如果 Python 的列表推导式中 break 会影响外层循环，能被接受吗？→ **不能。** 控制流作用域必须正确。

- [compiler.py:402, 682] **CLOSURE 捕获全部局部变量而非自由变量** → 编译器完全不做自由变量分析，VM 运行时捕获整个帧的 locals → 内存浪费 + 语义风险 → 实现自由变量分析，CLOSURE 指令携带自由变量名列表
  - 追问：如果 OCaml 的闭包捕获了整个作用域的所有变量，能被接受吗？→ **不能。** 这既是空间优化也是语义正确性问题。

#### 中等问题（影响特定场景）

- [compiler.py:900-964] 死代码：_compile_pattern_test 和 _compile_pattern_bindings（约 65 行），完全未被调用
- [compiler.py:496-506] for 循环 BREAK/CONTINUE 依赖 VM 运行时 _for_iters 栈，与 while 循环使用显式跳转地址的策略不一致
- [compiler.py:547-557] JUMP_IF_TRUE 和 POP_JUMP_IF_FALSE 命名不一致（都是弹出条件并跳转）
- [compiler.py:995, 1074] for 循环 range 迭代检测使用 tuple 结构匹配，绕过类型系统（无 RangeExpr AST 节点）
- [compiler.py:1072-1133] 列表推导式不支持多 for 子句
- [compiler.py:172-174] 常量池去重用 list.index，O(n) 性能
- [compiler.py:75] LOOP 指令定义但未使用
- [compiler.py:48] LOAD_CONST 指令定义但未使用，常量池形同虚设

#### 轻微问题（代码质量）

- [compiler.py:290-291] AliasDef 编译为空操作（pass）
- [compiler.py:268-270] ExportDecl 编译为空操作（直接 return）
- [compiler.py:197-205] patch_match_fail 硬编码 2 操作数和 3 操作数两种情况，缺乏扩展性
- [compiler.py:800-803] MATCH_TEST_FLOAT 使用精确相等比较，浮点数语义危险

#### 原创性分析
- **Nova 特色**：模式匹配专用指令集的编译器支持、FOR_ITER + LOOP_END 配对的高级循环抽象、PIPE_CALL 专用管道调用指令、TRY_UNWRAP 早返回机制在字节码层面的实现、ADT 原生指令（MAKE_ADT/REGISTER_CTOR）、常量值直接内联（无需常量池）
- **参考已有**：基本栈机结构参考 CPython/JVM；跳转回填参考标准编译器教材


---

## [2026-07-16] 求值器 (evaluator.py) 第二十轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 两遍扫描支持相互递归、内置 Option/Result 类型、闭包环境引用语义 |
| 可行性 | ⭐⭐⭐⭐ | 整体架构清晰，核心功能都能工作，两遍扫描支持相互递归是好的设计 |
| 正确性 | ⭐⭐⭐ | 核心逻辑正确，但内置函数类型检查缺失、闭包"未来可见"语义错误、guard 缺少 Bool 检查 |
| 安全性 | ⭐⭐⭐ | 递归深度保护到位，类型检查（if/while/逻辑运算）严格，但错误处理有泄漏 |
| 一致性 | ⭐⭐ | 与 VM 实现存在多处语义不一致（全局变量修改、Map 错误处理、Unit 表示、闭包捕获方式等） |
| 完整性 | ⭐⭐⭐⭐ | AST 覆盖完整，Pattern 类型全覆盖，内置函数丰富，模块系统有基础框架 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，注释充分，但错误信息中缺少源码位置传递，调试体验差 |
| 性能 | ⭐⭐⭐ | 树遍历解释器的正常水平，没有明显的性能陷阱，但 MapExpr 键重复求值是浪费 |
...
- [evaluator.py:799-800] **MapExpr 中非可哈希键导致 Python TypeError 泄露** → 键为列表/字典等非可哈希类型时，Python 直接抛 TypeError 而非 Nova 错误 → 捕获 TypeError 并转换为 Nova RuntimeError_
  - 追问：如果是 OCaml 的 Map 构造函数接收非可哈希键时抛原生异常，能被接受吗？→ **不能。** 应给出语言级错误。

- [evaluator.py 全文] **绝大多数内置函数不做参数类型检查** → str_len/list_length/head/tail/sum/filter/map 等几乎所有内置函数都直接操作参数，不验证类型，传入错误类型会泄漏 Python 原生错误 → 为每个内置函数添加参数类型验证
  - 追问：如果是 OCaml/Python 的标准库函数不做类型检查直接抛原生异常，能被接受吗？→ **不能。** 内置函数是运行时安全的边界。

- [evaluator.py 与 vm.py 对比] **函数内无法修改全局 mut 变量（VM 路径）** → evaluator 中 assign 沿作用域链向上查找可以修改全局变量，但 VM 中 STORE_VAR 只写入 locals → 两条执行路径语义不一致
  - 追问：如果一个语言的两条执行路径对相同代码产生不同结果，能被接受吗？→ **绝对不能。** 这是编译器/解释器的致命缺陷。

- [evaluator.py:804-816] **MapExpr 键求值两次** → 键先被求值用于错误检查，然后再次被求值用于 dict 构造，可能导致重复副作用 → 先求值所有键值对，再统一构造字典
  - 追问：如果是 Haskell 的 Map 字面量对键求值两次，能被接受吗？→ **不能。** 违反了表达式单次求值的基本语义。
...
- [evaluator.py:671-869] 块级作用域不支持局部函数定义（FnDef）
- [evaluator.py:716-727] TryExpr 在顶层代码中使用时 ReturnSignal 未被捕获
- [environment.py:30-32] Environment.define 允许同一作用域内覆盖同名绑定，静默 shadowing
...
#### 原创性分析
- **Nova 特色**：两遍扫描程序求值支持相互递归、TryExpr 通过 ReturnSignal 实现错误传播、for 循环作为表达式返回列表、内置 Option/Result 类型与模式匹配深度集成
- **参考已有**：经典树遍历解释器架构、环境引用捕获模式（Scheme/Python）、异常实现非局部控制流（Ruby/Smalltalk）


---

## [2026-07-16] 类型检查器 (type_checker.py) 第二十轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 自己实现了类型检查器框架，结构清晰，但算法层面是简化版，不是真正的 HM |
| 可行性 | ⭐⭐⭐ | 基本框架可用，对简单程序能工作，但核心算法缺陷严重 |
| 正确性 | ⭐⭐ | TypeVar 按名称相等、没有合一、TypeVar 兼容一切——三大基础错误 |
| 安全性 | ⭐⭐ | 类型检查通过的程序可能在运行时失败（管道、非穷尽 match、json_parse 等） |
| 一致性 | ⭐⭐ | 与 evaluator 存在多处不一致（管道语义、guard 检查等） |
| 完整性 | ⭐⭐⭐ | 覆盖了大部分语法结构，但核心功能缺失（合一、let 多态、穷尽性检查） |
| 工程质量 | ⭐⭐⭐⭐ | 代码结构清晰，命名规范，有错误收集机制，注释充分 |
| 性能 | ⭐⭐⭐⭐ | 没有合一意味着没有复杂的约束求解，性能尚可，但这是以正确性为代价的 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [type_checker.py:167-185] **TypeVar 按名称相等，导致跨作用域类型污染** → 不同作用域中同名的 TypeVar 被视为同一个变量，不同函数的同名类型变量会意外共享 → 按对象身份（默认 __eq__ 和 __hash__）实现 TypeVar 相等性
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 这是类型系统的基础错误。

- [type_checker.py:1251-1271, 1378-1406] **没有真正的合一（unification）算法** → 只有单向的 _collect_type_bindings 和 _types_compatible（只要一方是 TypeVar 就返回 True），没有双向合一、没有 occurs check、没有替换组合 → 实现基于 union-find 的真正合一算法
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 合一算法是 HM 类型推断的基石。

- [type_checker.py:801-811] **没有 let 多态（无泛化/实例化）** → let 绑定直接存储推断类型，不做泛化；查找时也不做实例化 → 引入类型方案（type scheme），let 绑定时泛化，查找时实例化
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能。** let 多态是 HM 类型系统的定义性特征。

- [type_checker.py:777-792] **管道运算符类型检查完全错误** → 同时检查第一个和最后一个参数，不做类型变量绑定，直接返回函数返回类型；非函数类型直接返回右侧类型 → 重新实现管道类型检查，明确语义为 x |> f == f(x)，做完整的类型变量绑定和替换
  - 追问：如果是 OCaml/F# 的编译器，管道运算符类型检查是错误的，能被接受吗？→ **绝对不能。** 管道是函数式语言的核心运算符。

- [type_checker.py:1042-1050] **守卫条件（guard）未被类型检查** → check_match_arm 中完全没有检查 arm.guard，也不验证其返回 Bool 类型 → 在模式匹配成功后添加 guard 类型检查，要求返回 Bool
  - 追问：如果是 Haskell 的 when guard 不被类型检查，能被接受吗？→ **绝对不能。** 守卫条件是模式匹配的核心组成部分。

- [type_checker.py:699-711] **没有模式匹配穷尽性检查** → match 表达式只验证各分支返回类型一致，完全不检查穷尽性；匹配失败在运行时才发现 → 实现穷尽性检查算法
  - 追问：如果是 OCaml/Haskell 的编译器，不做模式匹配穷尽性检查，能被接受吗？→ **绝对不能。** 穷尽性检查是 ML 家族语言的核心安全保证之一。

- [type_checker.py:731-775] **函数调用不做合一，类型变量只单向收集** → 只能从参数类型中的 TypeVar 绑定到实际类型；同一个 TypeVar 在不同参数中被绑定到不同类型时只保留第一个绑定，不检测冲突 → 实现真正的合一算法
  - 追问：如果是 OCaml 的类型推断器，同一个类型变量被绑定到不同类型但不报错，能被接受吗？→ **绝对不能。** 这是类型健全性的基础。

- [type_checker.py:364] **json_parse 返回类型变量，绕过类型检查** → json_parse 返回 TypeVar("json_value")，与任何类型都"兼容"，实际上是 unsafe_cast → 应返回 JSON 值类型（如 ADT），或要求显式类型标注
  - 追问：如果是 Haskell 的 Aeson 库的 decode 函数不做类型检查直接返回任意类型，能被接受吗？→ **不能。** 这是类型安全漏洞。

#### 中等问题（影响特定场景）

- [type_checker.py:267, 273-288] ErrorCollector 存在但错误恢复不完整，ErrorType 与任何类型都兼容，导致级联错误被掩盖
- [type_checker.py:293-307] 内置构造函数类型签名有 bug：None 使用全局 TypeVar，所有 None 共享同一类型变量
- [type_checker.py:981-982] ForExpr 遍历 TupleType 时只取第一个元素类型，元组元素类型可能不同
- [type_checker.py:1001-1005] BreakExpr/ContinueExpr 可以出现在循环外，类型检查器不报错
- [type_checker.py:419-448] 递归 ADT 类型检查不正确——递归引用中类型参数未正确传播（因缺乏合一）
- [type_checker.py:1307-1320] 类型别名展开不完整：只在 _from_ast_type 中展开，类型比较时不展开
- [type_checker.py:387-404] check_program 在 collect_errors 模式下不主动抛出，调用者可能不知道有错误
...
- [type_checker.py:995-999] WhileExpr 返回 body 类型语义存疑
- [type_checker.py:953-965] TryExpr 不检查外围函数返回类型
- [type_checker.py:1168-1172] 二元操作符 % 只支持 Int，与 evaluator 可能不一致
- [type_checker.py:1190-1194] 比较操作符只支持 Int/Float，String/Char 不能比较大小
...
## [2026-07-16] 词法/语法分析器 (lexer.py + parser.py) 第二十轮审查报告

### 总体评分
| 维度 | Lexer | Parser | 说明 |
|------|-------|--------|------|
| Token/AST 覆盖 | ⭐⭐⭐⭐ | ⭐⭐⭐⭐ | 主要语法元素均有覆盖；部分死 token |
| 错误恢复 | ⭐⭐⭐ | ⭐ | Lexer 能跳过非法字符但递归有栈溢出风险；Parser 遇错即停 |
| 位置准确性 | ⭐⭐ | ⭐⭐ | 大多只有起始位置无完整跨度；AST 节点 span 不准确 |
| 运算符优先级 | — | ⭐⭐ | 管道优先级错误、比较/相等性左结合有误 |
| 结合性 | — | ⭐⭐⭐ | 算术/逻辑左结合正确；比较应为无结合 |
| 语法歧义处理 | — | ⭐⭐⭐ | 悬挂 else 已解决；map/block 消歧性能差；空 {} 有歧义 |
| 左递归处理 | — | ⭐⭐⭐⭐⭐ | 递归下降 + 优先级分层正确消除左递归 |
| 与 tree-sitter 一致性 | ⭐⭐ | ⭐⭐ | 优先级、guard 位置、<- token 化等多处不一致 |
...
- [parser.py:672-678] **管道操作符 |> 优先级严重错误** → 管道优先级高于比较运算符，与函数式语言常规相反；`a == b |> f` 会被解析为 `a == (b |> f)` 而非 `(a == b) |> f` → 将 _parse_pipe 移到优先级链最低端（低于比较和相等性）
  - 追问：如果 GCC/Clang 的运算符优先级表与语言规范矛盾，能被接受吗？→ **绝对不能。** 优先级错误是编译器前端最严重的错误类别之一。
...
- [parser.py:660-666] **相等运算符应为无结合性，当前为左结合** → a == b == c 被解析为 (a == b) == c，布尔值与 c 比较 → 同样改为单次 if
...
- [lexer.py:258, 267, 281, 308, 458] **词法错误恢复使用递归调用 _next_token()，存在栈溢出风险** → 连续大量非法字符时递归深度线性增长，Python 默认递归深度约 1000 → 使用循环而非递归
  - 追问：如果 GCC 的词法分析器在遇到大量非法字符时栈溢出，能被接受吗？→ **不能。** 这是 DoS 安全漏洞。

- [parser.py:861-863] **空 {} 被优先解析为空 map，空 block 无法表示** → _is_map_literal 中 {} 返回 True，空块和空 map 语法冲突 → 明确空 {} 的语义，或使用不同语法区分空 map 和空 block
  - 追问：如果 JavaScript 的 {} 既是空对象又是空块但没有消歧规则，能被接受吗？→ **不能。** 语法必须唯一且确定。

- [lexer.py:202-221] **不支持科学计数法** → 1.5e10 会被解析为 1.5 + 标识符 e10 → 添加科学计数法支持
  - 追问：如果 GCC 不支持科学计数法浮点字面量，能被接受吗？→ **不能。** 这是标准语法特性。

#### 中等问题（影响特定场景）

- [lexer.py:202-221] 不支持多进制数字字面量（0x/0o/0b）
- [lexer.py:236-251] 不支持 Unicode 转义 \uXXXX
- [lexer.py:208-209] 不支持数字分隔符 1_000_000
- [lexer.py:186-200] 不支持块注释 /* */
- [parser.py:844-884] map/block 消歧使用 O(n) 前瞻扫描，最坏 O(n²) 复杂度
- [parser.py:416-422] 赋值不是表达式，不支持链式赋值 a = b = 1
- [parser.py:539] MatchArm 没有 span 信息
- [lexer.py:250-251, 297-298] 未知转义序列静默忽略，无警告
- [lexer.py:88] PIPE_VARIANT 是死 Token

#### 轻微问题（代码质量）

- [lexer.py:91, 368] UNIT token 在词法层不生成，仅 parser 使用
- [parser.py:868-877] _is_map_literal 中三种括号共用深度计数器，可能误判
- [parser.py:142-167] _parse_let_binding 和 _parse_mut_binding 代码高度重复
- [lexer.py:168-173] _peek_ahead(1) 等同于 _peek()，方法命名略冗余
- [parser.py 多处] AST 节点 span 不准确，很多只是起始关键字位置
...
## [2026-07-16] 错误处理 + 模块 + 环境 第二十轮审查报告
...
- [modules.py:276-291 + evaluator.py:655-660] **导出名称不验证存在性，导入静默失败** → _collect_exports 在类型检查之前执行，只收集 ExportDecl 名称不验证是否定义；导入方用 try/except 包裹 lookup，找不到就静默 pass → 类型检查完成后验证导出名称存在性；导入失败抛 ImportError
  - 追问：如果 Python 的 from module import undefined_name 静默失败不报错，能被接受吗？→ **绝对不能。** ImportError 是最基本的错误类型。

- [errors.py:167-171] **span.end_column 无 None 校验** → 只检查 end_line is not None 就直接使用 end_column；如果 end_column 为 None，后续计算导致 TypeError，错误格式化自身崩溃 → 同时检查 end_line 和 end_column 不为 None
  - 追问：如果 Rust 编译器遇到不完整的 span 信息时自身崩溃，能被接受吗？→ **绝对不能。** 错误格式化是编译器的"门面"，自身的健壮性比被格式化的错误更重要。

- [errors.py 全文] **ErrorCollector 几乎未被实际使用** → 只有 type_checker 在可选模式下使用，parser/evaluator/modules 全部直接抛异常 → 全面集成 ErrorCollector，所有模块统一使用
  - 追问：如果一个编译器声称有"批量错误收集"但实际上只在一个模块中可选使用，能被接受吗？→ **不能。** 要么实现并全面使用，要么删除。

- [errors.py:405-411] **raise_all 将其余错误格式化为纯文本 note，丢失结构化信息** → 只保留第一个错误的结构化信息，其他错误变成字符串 note，无法被 IDE/工具解析 → 自定义异常类型包装错误列表，保留所有错误的完整结构化信息
  - 追问：如果 Rust 编译器的多个错误中只有第一个有结构化信息，其他都是纯文本，能被接受吗？→ **不能。** 生产级编译器的所有错误都必须是结构化的。

- [modules.py:218] **循环导入错误缺少位置信息** → 错误消息只显示模块路径链，没有文件名、行号、span，用户不知道哪一行的 import 导致循环 → 在 ImportDecl 位置抛出错误，包含完整 span 信息
  - 追问：如果 Python 的循环导入错误不显示具体行号，能被接受吗？→ **不能。** 必须指出具体触发位置。

- [errors.py:186-190] **错误信息完全缺少文件名** → 只有行号和列号，多文件项目中无法定位错误属于哪个文件 → 添加文件名到错误格式，使用标准的 filename:line:col 格式
  - 追问：如果 GCC 的错误信息不显示文件名，能被接受吗？→ **不能。** 这是最基本的诊断信息。
...
- [errors.py:396-398] ErrorCollector.get_all() 丢失时间顺序，所有警告排在所有错误之后
- [modules.py:305-339] 不支持选择性导入，只能整体导入所有导出名称
- [environment.py:30-32] 同一作用域内允许重复定义同名变量，静默覆盖
- [modules.py:293-299] _collect_exported_types 完全忽略 type_checker 参数，返回值从未被使用
- [modules.py:216] loading_stack 使用 list 的 in/remove，应使用 set 提高效率
- [modules.py:366] 全局模块管理器单例可能导致测试之间状态污染
- [environment.py:34] lookup 不返回可变性信息，容易被误用（但有 lookup_binding 替代）
...
**errors.py**（⭐⭐⭐）：Rust 风格错误格式化是对 Rustc 的直接借鉴，实现思路标准但多行高亮和中文本地化有一定工作量。
**modules.py**（⭐⭐）：ModuleResolver + ModuleManager 分离是所有语言模块系统的标准架构，加载栈做循环检测是经典 DFS 方法。
**environment.py**（⭐⭐⭐⭐）：作用域链 + 父指针是经典的词法作用域实现，代码简洁、bug 最少、设计最清晰。三个文件中环境模块质量最高。


---

## [2026-07-16] 所有后端 第二十轮审查报告

### 总体评分
| 后端/组件 | 功能完整度 | 正确性 | 代码质量 | 综合评分 |
|----------|----------|--------|---------|---------|
| Native 后端 | 5/10 | 2/10 | 4/10 | ⭐⭐ |
| Cranelift 后端 | 4/10 | 3/10 | 3/10 | ⭐⭐ |
| Wasm 后端 | 5/10 | 3/10 | 3/10 | ⭐⭐ |
| C 代码生成器 | 7/10 | 5/10 | 5/10 | ⭐⭐⭐ |
| x86_64 编码器 | 6/10 | 5/10 | 4/10 | ⭐⭐⭐ |
| 编译器管道 | 5/10 | 4/10 | 3/10 | ⭐⭐ |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [native_backend.py:1109, 1133, 1152] **Native 后端 List/Tuple/ADT 在栈上分配且不恢复栈指针** → 函数返回后数据损坏，栈帧不平衡 → 在堆上分配或正确恢复栈指针
  - 追问：如果 OCaml 的 native 编译器生成的代码会破坏栈，能被接受吗？→ **绝对不能。** 栈损坏是最严重的内存安全 bug。

- [native_backend.py:485-517] **Native 后端函数调用不保存 caller-saved 寄存器** → System V ABI 规定 RAX、RCX、RDX、RSI、RDI、R8-R11 是 caller-saved，调用前后未保存/恢复 → 按 ABI 保存 caller-saved 寄存器
  - 追问：如果是 OCaml 的 native 编译器不遵守调用约定，能被接受吗？→ **绝对不能。** 这是 ABI 遵从性的核心问题。

- [native_backend.py:730-742] **idiv 指令隐式使用 RDX 但未告知分配器** → 除法/取模需要 RDX:RAX 作为输入，若 RDX 中存有活跃值会被静默破坏 → 在分配器中标记 idiv 会 clobber RDX
  - 追问：如果 GCC 的除法实现破坏了用户的寄存器值，能被接受吗？→ **绝对不能。** 会导致难以调试的随机数据损坏。

- [native_backend.py:1079] **索引操作破坏基址寄存器** → `e.add_reg_reg(base_reg, RCX)` 直接修改基址寄存器的值，后续再次使用会得到错误值 → 使用临时寄存器或正确的 LEA 指令
  - 追问：如果 LLVM 的后端破坏了 SSA 语义，能被接受吗？→ **不能。** 违反了 SSA 基本原则。

- [cranelift_backend.py:234-238] **Cranelift 后端浮点运算走整数操作码路径** → _emit_binop 中 op 总是取 int_op_map，float_op_map 定义了但从未使用 → 正确区分整数和浮点操作
  - 追问：如果 OCaml 的 native 编译器浮点运算全部用整数指令，能被接受吗？→ **绝对不能。** 浮点运算完全错误。

- [cranelift_backend.py:162-168] **Cranelift 后端条件分支目标标签硬编码** → 始终使用 block_true/block_false，不使用实际的标签名 → 使用正确的标签名
  - 追问：如果后端的条件分支总是跳转到同一个固定标签，能被接受吗？→ **不能。** 控制流完全错误。

- [wasm_backend.py:230-232] **Wasm 后端 LIRLabel 只开 block 不关** → 每个 LIRLabel 编译为新的 block，但从不关闭，生成无效 WAT → 重写控制流生成，使用 Wasm 结构化控制流
  - 追问：如果后端生成的代码连基本语法都通不过，能被接受吗？→ **不能。**

- [x86_64.py:375-386] **x86_64 编码器 mov_mem_imm64 只写 32 位立即数** → 函数名声称 imm64 但实际只 emit_uint32，写入内存的立即数少了 4 字节 → 正确实现 64 位立即数存储（先 mov 到寄存器再存内存）
  - 追问：如果汇编器的 mov qword [addr], imm64 实际只写了 32 位，能被接受吗？→ **绝对不能。** 会破坏相邻内存。

- [x86_64.py:137-257] **x86_64 编码器 add/sub/cmp_reg_imm 不支持扩展寄存器** → 硬编码 0x48 作为 REX 前缀，未设置 REX.B 位，R8-R15 编码错误 → 正确计算 REX 前缀
  - 追问：如果汇编器对 R8-R15 寄存器生成错误机器码，能被接受吗？→ **不能。** 扩展寄存器完全不可用。

- [c_codegen.py:214 vs 707/867] **C 代码生成器 ADT 字段名不匹配** → 结构体定义使用 `{variant}_{field}`（单下划线+字段名），但模式匹配访问使用 `{pattern}__field{i}`（双下划线+索引）→ 统一字段命名约定
  - 追问：如果 OCaml 的 C 后端生成的 ADT 字段访问与结构体定义不匹配，能被接受吗？→ **绝对不能。** 所有 ADT 操作都会段错误。

- [c_codegen.py:590-600] **C 代码生成器 TryExpr 字段名/常量名/返回值全错** → variant_tag 应为 tag；NOVA_OPTION_NONE_TAG 应为 NOVA_ADT_Option_None；返回整个 ADT 而非内部值 → 修正所有字段名和常量名，实现正确的早返回语义
  - 追问：如果 Rust 的 ? 操作符在编译器后端实现错误，能被接受吗？→ **绝对不能。** 错误传播是核心语言特性。

- [compiler_pipeline.py:33-35] **编译器管道 BACKEND_NATIVE 映射到 Cranelift 而非自研 Native** → 名为 "native" 的目标实际使用 Cranelift 后端，自研 NativeCodeGen 完全未被使用 → 修正后端映射或统一命名
  - 追问：如果一个编译器的 --native 选项实际调用的是另一个完全不同的后端，能被接受吗？→ **不能。** 命名误导且自研后端未集成。

#### 中等问题（影响特定场景）

- [native_backend.py:225] 寄存器溢出时 fallback 策略可能返回 None 寄存器
- [native_backend.py:716-718] 浮点取模未实现，抛 NotImplementedError
- [native_backend.py:L916-917] 闭包完全不可用（closure 类型常量直接抛 NotImplementedError）
- [cranelift_backend.py:156-157] return 不带返回值
- [cranelift_backend.py:187-188] LIRIndex 硬编码 v0+0
- [wasm_backend.py:260-263] 条件分支目标硬编码
- [wasm_backend.py:284-285] LIRIndex 硬编码默认值
- [x86_64.py:507-565] setcc 系列缺少 REX 前缀支持
- [x86_64.py:567-571] movzx 缺少 REX 前缀支持
- [x86_64.py:289-315] 浮点运算指令缺少 REX 前缀
- [c_codegen.py:954-955] 闭包粗粒度捕获所有可见变量
- [c_codegen.py:908-913] 浮点装箱无释放，内存泄漏
- [c_codegen.py:1266-1270] Option/Result 是指针传递，其他 ADT 是值传递，不一致
- [compiler_pipeline.py:81-84] C 后端绕过 IR 优化，直接从 AST 生成代码

#### 轻微问题（代码质量）

- [x86_64.py:451-473] je_rel32 重复定义
- [cranelift_backend.py:204] iconst 不是 Cranelift 标准操作码（应为 i64.const）
- [cranelift_backend.py:243] ineg 操作码可能不正确
- [wasm_backend.py:161] 字符串转义使用双反斜杠（b"\\x00" 而非 b"\x00"）
- [c_codegen.py:952] 闭包函数命名可能冲突（nova_lambda_{数字}）
- [native_backend.py:1198] _generate_start 中 RDI 设置可能无意义
...
## [2026-07-16] IR 系统 + Pass 管理器 第二十轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 三层 IR 设计思想借鉴 MLIR，结构框架清晰，但各层内部实现缺乏创新点 |
| 可行性 | ⭐⭐ | 架构方向正确（HIR→MIR→LIR），但关键路径（SSA、match 降级、Phi 消除）有阻断性缺陷 |
| 正确性 | ⭐ | 多个严重正确性问题（假 SSA、match 无判定、Phi 只取首源、LICM 位置错误、CSE 语义错） |
| 安全性 | ⭐ | `__class__` 动态修改、静默失败（返回 None/空字符串）、列表推导式变空列表等均为安全隐患 |
| 一致性 | ⭐⭐ | 三层 IR 类型系统共享是优点，但节点设计不一致（MIR 既有 Phi 又有 load/store） |
| 完整性 | ⭐⭐ | 框架搭好了，但内联、match 判定、列表推导式、SSA 构造等核心功能未实现或空壳 |
| 工程质量 | ⭐⭐ | 代码结构清晰、命名规范，但缺乏错误处理、验证、测试基础设施 |
| 性能 | ⭐⭐ | 算法多为 O(n²) 或朴素实现，不动点迭代固定 10 次，无 pass 失效机制 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [mir_lowering.py 全局] **MIR 声称是 SSA 但实际不是** → 无支配树、无 Phi 放置算法、变量通过 load/store 访问（MIRLoad/MIRStore）；Phi 只用于 if/match 结果合并不用于变量多定义 → 实现真正的 SSA 构造算法（支配树 + 支配边界 + Cytron 算法）
  - 追问：如果 LLVM 声称是 SSA 但实际不是，能被接受吗？→ **绝对不能。** SSA 是现代编译器 IR 的核心。

- [mir_lowering.py:351-384] **Match 表达式降级完全没有模式判定逻辑** → 所有 arm block 被无条件顺序跳转（MIRJump），第一个 arm 执行完直接跳到第二个，没有任何模式判定 → 为每个 arm 生成模式匹配判定，使用条件分支选择分支
  - 追问：如果 LLVM 的 switch 指令降级为顺序 goto，能被接受吗？→ **绝对不能。** 这是控制流图的根本性错误。

- [mir_lowering.py:285-289] **列表推导式降级为空列表常量** → HIRListComprehension 直接降级为 MIRConst([])，完全丢弃了推导逻辑 → 正确降级为 for 循环 + 列表追加
  - 追问：如果 GCC 的列表推导式优化把推导式变成空列表，能被接受吗？→ **绝对不能。** 静默的语义丢弃比未实现更危险。

- [lir_lowering.py:204-211] **MIR Phi → LIR 只取第一个 source，其他前驱值全部丢失** → 只取 sources[0]，忽略所有其他前驱的值 → 实现正确的 Phi 消除（在每个前驱末尾插入 copy 指令）
  - 追问：如果 LLVM 的 phi 消除只取第一个前驱的值，能被接受吗？→ **绝对不能。** 除第一个前驱外的所有控制流路径产生错误值。

- [lir_lowering.py:231-241] **MIRSwitch/MIRMatchJump → LIR 全部降级为跳 default** → 直接变成 LIRJump(default_target)，所有 case 被丢弃 → 正确实现 switch/match 跳转
  - 追问：如果 LLVM 的 switch 降级为无条件跳转，能被接受吗？→ **绝对不能。**

- [pass_manager.py:603-607] **LICM LIR 层外提位置错误（仍在循环体内）** → 外提指令被插入到 header 标签之后（header_idx + 1），即仍在循环体内，每次迭代都执行 → 找到循环 pre-header，将外提指令插入到 pre-header 末尾
  - 追问：如果 LLVM 的 opt 工具把循环不变量外提到循环体内部，能被接受吗？→ **绝对不能。** LICM 的核心价值就是将循环不变计算移到循环外。

- [pass_manager.py:628-640] **LICM MIR 层回边识别完全错误** → 任何 MIRJump 到其他块都被视为回边；没有 dominator 检查；向前跳转（if-else merge）也会被误判 → 实现支配树计算；回边定义：边 n→d 是回边当且仅当 d 支配 n
  - 追问：如果 LLVM 的循环识别把 if-else 的前向跳转当作回边，能被接受吗？→ **绝对不能。** 循环识别是所有循环优化的基础。

- [pass_manager.py:474-479] **MIR CSE 用 MIRLoad 替代重复表达式，语义错误** → MIRLoad 的 name 字段是变量名，却被设置为另一个 SSA 名；MIRLoad 的语义是"加载变量"而非"复制 SSA 值" → 添加 MIRCopy/MIRMove 指令用于 SSA 值复制，或直接在使用点替换为原始 SSA 名
  - 追问：如果 LLVM 的 CSE pass 用 load 指令替代公共子表达式，能被接受吗？→ **绝对不能。** 语义完全错误。

- [pass_manager.py:104, 114] **常量折叠用 `__class__` 暴力修改对象类型** → 使用 `expr.__class__ = HIRIntLiteral` 修改类，再删除旧属性，极其脆弱，dataclass 字段布局不同可能导致未定义行为 → 返回新节点并由调用方替换
  - 追问：如果 LLVM 的常量折叠 pass 直接修改 C++ 对象的 vptr，能被接受吗？→ **绝对不能。** 这是极度危险的 hack。

- [mir_lowering.py:406] **For 循环降级直接将 iterable 作为布尔条件** → header_block.terminator = MIRBranch(iter_ssa or "", ...) 直接将 iterable 的 SSA 值作为布尔条件判断 → 调用迭代器的 has_next() 或检查索引边界
  - 追问：如果 GCC 的 for 循环用迭代器对象本身作为循环条件，能被接受吗？→ **不能。** iterable 不是布尔值。

- [mir_lowering.py:396-440] **循环中没有 Phi 节点，循环携带变量值在回边后丢失** → for/while 循环都没有为循环携带变量创建 Phi 节点；循环体内对变量的赋值在回边后丢失 → 在循环 header 处为循环携带变量创建 Phi 节点，合并入口值和回边值
  - 追问：如果 LLVM 的循环中变量值在回边后丢失，能被接受吗？→ **绝对不能。** 这是 SSA 的基本要求。

#### 中等问题（影响特定场景）

- [hir_lowering.py:293-299] HIRLetDecl 混入 HIRBlockExpr.exprs，类型不一致
- [ir_nodes.py:688-700] MIRSwitch 和 MIRMatchJump 从未被生成，是死代码
- [pass_manager.py:345] DCE 副作用列表不完整，LIRBinOp 被误判为有副作用
- [pass_manager.py:320-327] DCE 用前向收集 used 寄存器，无法消除死代码链
- [pass_manager.py:90-120] HIR 常量折叠只递归 HIRBinaryOp，不覆盖所有表达式类型
- [mir_lowering.py:309-349] if 表达式中变量赋值不跨分支合并
- [mir_lowering.py:159-162] HIRIdentifier 找不到时静默返回 None → 空字符串
- [mir_lowering.py:247-250] Lambda 降级是空壳
- [lir_lowering.py:171-176] MIRMapBuild → LIRBuildList，Map 语义丢失
- [lir_lowering.py:141-147] MIRCall 参数未传递到 LIRCall 的 src_locs
- [lir_lowering.py:114-119] MIRStore → LIRStoreGlobal 混淆局部和全局
- [pass_manager.py:704-711] Pass 管理器无依赖管理，纯硬编码顺序

#### 轻微问题（代码质量）

- [ir_nodes.py:38] IRType.PTR 标注"LIR 层新增"但类型系统共享
- [ir_nodes.py:778-786] LIRLoadReg 与 LIRStoreReg 冗余（都是 move 语义）
- [pass_manager.py:713] 不动点迭代 max_iterations 硬编码为 10
- [pass_manager.py 多处] `changed |= ...` 用按位或代替布尔或，可读性差
- [lir_lowering.py:204-211] MIRPhi sources 为空时静默跳过
- [mir_lowering.py:299-305] HIRUnwrapExpr 简化为字段访问，无错误处理
- [lir_lowering.py:68-71] LIR 函数参数名在降级中被丢弃
- [lir_lowering.py:228] MIRReturn 返回值类型硬编码为 UNIT_TYPE

#### 各 Pass 实现状态表
| Pass 名称 | 层级 | 状态 | 主要问题 |
|-----------|------|------|----------|
| ConstantFolding | HIR | ⚠️ 部分可用 | 仅折叠 HIRBinaryOp，不递归深入其他表达式；用 __class__ hack 修改对象 |
| Inlining | HIR | ❌ 空壳 | 直接 return False |
| ConstantFolding | MIR | ✅ 基本可用 | 块内整型/浮点二元运算折叠正确 |
| CommonSubexprElimination | MIR | ❌ 语义错误 | 用 MIRLoad 替代 SSA 复用，语义错误 |
| LoopInvariantCodeMotion | MIR | ❌ 基本无效 | 回边检测错误 + 只从 header 块外提 |
| ConstantFolding | LIR | ✅ 基本可用 | 块内常量折叠正确，支持链式 |
| DeadCodeElimination | LIR | ⚠️ 部分可用 | 无副作用指令列表不全，前向收集无法消除死代码链 |
| CommonSubexprElimination | LIR | ✅ 基本可用 | 块内 CSE 正确 |
| LoopInvariantCodeMotion | LIR | ❌ 外提错误 | 插入到循环体起始位置，仍在循环内 |
...
## [2026-07-16] C 运行时 + 测试 + Tree-sitter 第二十轮审查报告
...
- [nova_runtime.c:363-368] **nova_list_set 不管理引用计数** → 直接覆盖指针，既不 release 旧值，也不 retain 新值 → 内存泄漏 + 悬垂指针风险 → 正确的引用计数管理（release 旧值，retain 新值）
  - 追问：如果 Python 的 list 赋值后旧元素泄漏，能被接受吗？→ **绝对不能。** 容器元素的引用计数管理是最基本的正确性要求。

- [nova_runtime.c:689-692] **nova_adt_set_field 不管理引用计数** → 与 list_set 同样问题：旧值泄漏，新值未 retain → 添加正确的引用计数管理
  - 追问：如果 OCaml 的 record 字段赋值后旧值泄漏，能被接受吗？→ **不能。**

- [nova_runtime.c:597-614] **nova_map_remove 不释放 value，内存泄漏** → 只释放了 key 和 entry 结构体，entry->value 从未被释放 → 释放 entry 前调用 nova_value_release
  - 追问：如果 Python 的 dict.pop 不释放被删除的值，能被接受吗？→ **不能。** 内存泄漏。

- [nova_runtime.c:536-538] **nova_map_put 更新 value 时强制类型转换为 NovaValue*（类型不安全）** → 当 value 不是 NovaValue* 时，会读取错误的内存偏移量（如 NovaString 的 capacity 字段），这是"碰巧不崩溃"的 hack → 统一使用 NovaValue* 接口或正确的类型标签
  - 追问：如果 C 标准库的哈希表实现依赖类型双关 hack，能被接受吗？→ **不能。** 这是未定义行为。

- [nova_runtime.c:479-486, 651-668, 749-756] **容器释放（list/map/adt）不释放元素，且无 tracing GC** → 纯引用计数 + 容器不释放元素 = 大规模内存泄漏 + 循环引用完全无法回收 → 容器释放时递归释放元素；或实现标记-清扫 GC
  - 追问：如果 Python 的 list 被 del 后其元素永远不会被回收，能被接受吗？→ **绝对不能。** 这是内存管理的基本功能。

- [nova_runtime.c:1041, 1044] **JSON 数字解析不检查溢出** → strtoll/strtod 调用时未设置 errno 检查，溢出时静默返回 LLONG_MAX/LLONG_MIN 或 HUGE_VAL → 检查 errno 并处理溢出
  - 追问：如果 Python 的 json.loads 对溢出的数字静默返回 inf，能被接受吗？→ **不能。** 应给出明确错误。

- [nova_runtime.c:1031-1032] **JSON 数字长度 > 63 字节被静默截断** → num_len >= sizeof(num_buf) 时截断为 sizeof(num_buf)-1，产生错误的数值 → 超出长度时报错
  - 追问：如果 JSON 解析器对长数字静默截断，能被接受吗？→ **不能。** 静默产生错误值比报错更危险。

- [nova_runtime.c:1170, 1179, 1187] **JSON true/false/null 不验证字符匹配，直接跳指针** → 如果输入是 "tru" 或 "fals"，会越界访问或错误解析 → 逐字符验证，不匹配则报错
  - 追问：如果 JSON 解析器接受 "tru" 为 true，能被接受吗？→ **不能。** 这是基本的解析正确性。

- [nova_runtime.c:1196-1203, 1101-1111] **JSON 字符串/对象 key 在输入中途结束时不报错** → 输入在字符串中间结束时不会报错，产生无效的解析结果 → 检测 EOF 并报错
  - 追问：如果 JSON 解析器对未闭合字符串静默返回部分结果，能被接受吗？→ **绝对不能。** 解析错误必须被检测。

- [nova_runtime.c:1664-1668, 1726-1729] **HTTP 临时文件使用 PID 命名，存在 /tmp 竞争条件** → /tmp/nova_http_%d.tmp 基于 PID，可被符号链接攻击（TOCTOU）→ 使用 mkstemp 或私有临时目录
  - 追问：如果 curl 的临时文件使用可预测的命名，能被接受吗？→ **不能。** 这是经典的安全漏洞。

**测试套件**：

- [测试套件整体] **无 VM 测试，无 evaluator 与 VM 行为一致性测试** → 所有测试只通过 Evaluator 运行，VM 路径零验证 → 建立 Evaluator-VM 一致性测试框架
  - 追问：如果 GHC 有两条执行路径但只测试一条，能被接受吗？→ **绝对不能。** 多后端语言必须验证所有后端行为一致。

**Tree-sitter 语法**：

- [grammar.js:175 vs parser.py:672-677] **Tree-sitter 与 parser.py 管道优先级颠倒** → parser.py 中 pipe 优先级 > comparison，tree-sitter 中 comparison > pipe → 调整 Tree-sitter 优先级与 parser.py 对齐
  - 追问：如果 GCC 和 Clang 对同一个表达式产生不同的 AST，能接受吗？→ **绝对不能。** 语法必须唯一且确定。

- [grammar.js 全文] **Tree-sitter 缺少 `?`（try）操作符** → Python 解析器有 TryExpr，但 Tree-sitter 语法中完全没有 → 添加后缀 try 操作符

- [grammar.js:88-97] **Tree-sitter 不支持泛型类型参数** → type Option[T] 的语法在 Tree-sitter 中无法解析 → 添加泛型参数列表

#### 中等问题（影响特定场景）

**C 运行时**：
- [nova_runtime.c:349, 556] List/Map 扩容时容量翻倍可能整数溢出
- [nova_runtime.c:1240-1256] JSON \u 转义不支持代理对（surrogate pairs）
- [nova_runtime.c:1242] JSON \u 后面不足 4 个 hex 字符时错误解析
- [nova_runtime.c:370-379] nova_list_concat NULL 参数处理时 ref_count 多 1
- [nova_runtime.c:616-640] nova_map_keys/values 返回的元素不 retain
- [nova_runtime.c 多处] nova_list_push 等操作所有权语义不明确
...
- 缺少边界值测试（大数、空值、极值）
- 负面测试覆盖率不足（运行时错误路径）
- CI lint 检查设为 `|| true`，不强制通过

**Tree-sitter 语法**：
- for/while/if/match 表达式优先级 tree-sitter 不明确
- match_arm 的 guard 位置与 parser.py 可能不一致
- 泛型函数语法支持不完整

#### 轻微问题（代码质量）

**C 运行时**：
- [nova_runtime.c:64-67] nova_alloc OOM 直接 abort，无优雅处理
- [nova_runtime.c:781-785] nova_closure_call 不检查 args 是否为 NULL
- [nova_runtime.c:716, 740] unwrap() 直接 abort 进程（不可捕获）
...
| test_nova.py | ~340 | lexer、parser、typecheck、evaluator、ADT、pipe、builtins、loops、I/O、VM |
| test_type_system.py | ~75 | 泛型 ADT、类型别名、类型推断、类型错误 |
| test_errors.py | ~36 | 错误格式化、错误收集、ANSI 颜色、多行高亮 |
| test_modules.py | ~28 | 模块导入导出、循环依赖、命名空间 |
| test_ir.py | ~93 | HIR/MIR/LIR lowering、pass manager、优化 pass |
| test_c_codegen.py | ~52 | C 代码生成、类型映射、运行时集成 |
| test_backends.py | ~43 | Cranelift、WasmGC、编译器管线 |
...
1. **修复类型检查器合一算法（真正的 HM 推断）** → 类型系统架构级重构，当前类型检查形同虚设
2. **修复 TypeVar 按名称相等的根本性错误** → 类型系统基本失效，跨作用域类型污染
3. **修复 IR SSA 构建 + 支配树** → 整个 IR 后端的正确性基础
4. **修复 Match 表达式 MIR 降级完全错误** → 所有 match 代码生成错误 CFG
5. **修复 MIR CSE 用 MIRLoad 替代的语义错误** → 所有经过 MIR CSE 的代码可能出错
6. **修复 LICM 外提位置错误** → LICM 完全无效
7. **修复 JSON \u 转义堆溢出 / 解析安全问题** → 多个安全漏洞（数字溢出、true/false 不验证、未闭合字符串）
8. **修复模块系统路径遍历安全漏洞** → P0 安全漏洞，可读取系统任意文件
9. **修复 C 运行时容器引用计数完整性** → list_set/map_remove/adt_set_field/list_release/adt_release 大规模内存泄漏
10. **修复闭包词法作用域语义（Evaluator "未来可见" + VM 全量捕获）** → 函数式语言核心语义
...
14. **修复 `?` 操作符不在后缀循环内** → 错误传播操作符核心用法失效
15. **修复导出名称不验证 + 导入静默失败** → 模块系统核心功能缺陷
16. **修复管道运算符类型检查错误** → 类型系统核心功能
17. **修复 Native 后端栈损坏（List/Tuple/ADT 栈分配）** → 原生后端根本正确性
18. **修复 Native 后端 caller-saved 寄存器保存** → 函数调用 ABI 遵从性
19. **修复 C CodeGen ADT 字段名不匹配** → C 后端 ADT 操作全部段错误
20. **修复 C CodeGen TryExpr 字段名/常量名/返回值全错** → ? 操作符完全不可用
21. **修复模式匹配穷尽性检查缺失** → 函数式语言类型安全的重要组成
22. **修复守卫条件类型检查缺失** → 类型安全漏洞
23. **添加 Evaluator-VM 一致性测试框架** → 多后端语言的基本质量要求
24. **修复 Tree-sitter 与 parser.py 语法不一致** → 优先级 + 缺失特性 + guard 位置
25. **修复比较/相等性无结合性** → 语法正确性
26. **修复词法错误恢复递归栈溢出** → DoS 安全漏洞
27. **修复 error span 边界检查（end_column 空指针）** → 错误格式化自身崩溃
28. **修复错误信息缺少文件名** → 多文件项目基本要求

### 🟡 P2 级（中优先级，影响质量/可维护性）

29. **实现 let 多态（泛化 + 实例化）** → 类型系统 HM 核心功能
30. **修复闭包全量捕获（自由变量分析）** → 性能和语义改进
31. **修复 GC 循环引用处理** → 内存管理完整性
32. **重写 IR 降级链，实现真正的 SSA + Phi 消除** → IR 架构级重构
33. **建立模块命名空间系统，摆脱 import * 模式** → 模块系统架构改进
34. **实现 Parser 语法错误恢复** → 开发体验基本要求
35. **实现 Lexer 结构化错误** → 错误报告一致性
36. **统一错误报告路径（ErrorCollector 一致工作）** → 开发体验
37. **添加 fuzz 测试、属性测试、边界值测试** → 测试质量提升
38. **接入 Native 后端到编译管道** → 后端可用性
39. **修复 Cranelift 后端浮点/分支/返回值** → 后端可用性
40. **重写 Wasm 后端控制流翻译** → 后端可用性
41. **修复 `<-` 左箭头 token 化** → 词法分析器基本职责
42. **修复 mut 变量导入丢失可变性** → 语义正确性
43. **修复 VM 中函数无法修改全局 mut 变量** → Evaluator/VM 一致性
44. **修复 HTTP 临时文件 /tmp 竞争条件** → 安全漏洞

### 🟢 长期规划

45. **实现真正的 GC（标记-清除或分代 GC）**
46. **实现 LSP 语言服务器支持**
47. **实现 Tree-sitter 语法与 parser.py 的完全对齐**
48. **添加 C 后端端到端测试**
49. **实现类型检查器错误恢复**
50. **添加端到端集成测试（所有后端）**
51. **实现 JIT 编译（基于 Cranelift）**
52. **实现调试支持（栈回溯、断点、单步执行）**
53. **包管理器：依赖解析、版本管理**
54. **科学计数法、多进制、数字分隔符、Unicode 转义等词法特性完善**
55. **块注释支持**
...
## 第二十一轮审查（2026-07-16）— 全模块深度审查

### 第一轮：核心执行引擎

---

## [2026-07-16] VM 虚拟机 (vm.py) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配栈基指针机制、迭代器状态字典管理有特色 |
| 可行性 | ⭐⭐⭐ | 核心路径可用；跨函数迭代状态、闭包嵌套递归有缺陷 |
| 正确性 | ⭐⭐ | 跨函数FOR_ITER状态碰撞、闭包快照式捕获、顶层match变量泄漏 |
| 安全性 | ⭐⭐ | BUILD_MAP不可哈希键崩溃、for循环return泄漏迭代状态 |
| 一致性 | ⭐⭐ | 闭包语义、构造器部分应用、顶层match作用域与Evaluator不一致 |
| 完整性 | ⭐⭐⭐⭐⭐ | 指令集覆盖完整 |
| 工程质量 | ⭐⭐ | 双路径RETURN、启发式while检测增加维护成本 |
| 性能 | ⭐⭐ | 闭包全量捕获、迭代器字典查找有开销 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[vm.py:1067-1074, 1111-1118] FOR_ITER 的 loop_start 跨函数碰撞** → `loop_start` 只是当前代码块中的整数偏移，不区分是哪个函数的。如果外层函数的 FOR_ITER 位置（数值上）恰好等于内层函数的 FOR_ITER 位置，内层循环会错误复用外层的迭代器 key，导致迭代状态错乱 → 使用 `(code_id, ip)` 元组作为 loop_start 标识，或在函数调用时保存/恢复 _for_iters 栈
  - 追问：如果任何生产级语言的循环状态因函数调用而错乱，能被接受吗？→ **绝对不能。** 这是极其隐蔽的数据竞争级 bug。

- **[vm.py:946-955] 闭包快照式捕获导致嵌套递归函数失效** → CLOSURE 捕获当前帧 locals 的字典拷贝（值语义），函数体内定义的递归函数在创建闭包时自身尚未绑定到 locals，闭包中看不到自己 → 应改为捕获环境引用（引用语义），或编译器确保相互递归的函数在闭包创建前全部注册
  - 追问：如果 OCaml 的闭包不能捕获同一作用域中后续定义的函数，能被接受吗？→ **不能。** 词法作用域 + 闭包是函数式语言的核心语义。

- **[vm.py:1245-1253] 顶层 MATCH_BIND 污染全局命名空间** → 顶层代码中 MATCH_BIND 直接写入 globals，且 MATCH_END 只在有调用帧时清理局部变量，顶层 match 绑定的变量永不清理 → 顶层 match 也应创建临时作用域或在 MATCH_END 中删除 globals 中对应变量
  - 追问：如果 Haskell 的 where 绑定泄漏到顶层作用域，能被接受吗？→ **不能。** 模式匹配的变量作用域必须精确控制。

- **[vm.py:1000-1010] BUILD_MAP 不检查键的可哈希性** → 传入不可哈希键（如 list）时直接抛出 Python TypeError，不转换为 Nova 运行时错误 → 用 try/except 捕获 TypeError 并转换为 RuntimeError_

#### 中等问题（影响特定场景）

- **[vm.py:249-255] _builtin_filter/_builtin_map 参数检查不足** → lst 非可迭代对象时抛 Python TypeError；pred_fn 非可调用时错误消息不清晰 → 添加参数类型验证和更友好的错误消息
- **[vm.py:263-267] _builtin_tail 对非列表类型崩溃** → len(lst) 对非序列类型抛 TypeError，未被捕获转换 → 添加类型检查
- **[vm.py:1025-1046] FIELD_ACCESS 对 tuple 索引越界未处理** → 直接 obj[int(field)]，IndexError 不捕获 → 捕获 IndexError 并转换
- **[vm.py:1012-1023] INDEX 操作 dict 不可哈希键误报"类型错误"** → 不可哈希键抛出的 TypeError 被误报为"索引操作类型错误" → 区分不可哈希键和索引类型错误
- **[vm.py:878-887] for 循环体内 return 导致迭代器状态泄漏** → return 提前退出函数时，_range_index/_list_index 中的迭代状态条目不会被清理 → 在 _call_返回前清理当前帧的迭代状态
- **[vm.py:829-837] JUMP 的 while 循环检测是脆弱启发式** → 依赖"JUMP 后紧跟 CONST_UNIT"模式，且 _while_loops[-1]["loop_start"] 似乎从未被读取 → 使用显式的循环开始指令替代启发式检测
- **[vm.py:392-397] NovaConstructor 不支持部分应用** → 构造器直接检查参数数量，不支持柯里化；而 Evaluator 中构造器用 BuiltinFn 包装，天然支持部分应用 → 为构造器添加部分应用逻辑
- **[vm.py:343-360] _format_value 缺少 NovaPartialBuiltin 处理** → 依赖 __repr__ 默认行为，格式不保证一致 → 显式添加 NovaPartialBuiltin 分支

#### 轻微问题（代码质量）

- **[vm.py:230-233] _to_float 跳过 bool 导致数学函数接受 bool 参数** → 与算术运算禁止 bool 的策略不一致 → 数学函数也拒绝 bool 参数
- **[vm.py:590-608] CONST_INT/CONST_FLOAT 等直接嵌入操作数，两套常量机制并存** → LOAD_CONST + 常量池 与 直接嵌入 两套机制，增加复杂度 → 统一为一种机制或明确文档化
- **[vm.py:717-718] DIV 整数除法使用 //（向下取整），行为应文档化** → 负数行为（-7//3 = -3）可能与用户预期不符 → 在文档中明确说明
- **[vm.py:1214-1225] MATCH_TEST_FLOAT 使用精确相等比较** → 浮点数模式匹配使用精确相等，实践中可能有问题 → 这是设计选择，应在文档中说明
- **[vm.py:163] global_mutable 集合在变量被删除时不清理** → 轻微资源泄漏 → 实现全局变量删除时同步清理
- **[vm.py:多处] isinstance(val, bool) 检查重复，可抽取辅助函数** → 提高可读性和一致性

#### 原创性分析
- **Nova 特色**：模式匹配栈基指针统一恢复机制、_for_iters + _loop_id 迭代器状态字典管理、双路径 RETURN 处理（函数级快速路径 + 顶层 return_flag）
- **参考已有**：基本栈机设计参考 CPython/JVM；TRY_UNWRAP 指令级错误传播参考 Rust ? 运算符

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获 | Environment 引用（引用语义） | locals dict 快照（值语义） | ❌ 根本分歧 |
| 嵌套递归函数 | 支持（env 引用 + 后续 define 可见） | 不支持（快照时未绑定） | ❌ |
| 构造器部分应用 | 支持（BuiltinFn 包装） | 不支持（直接检查参数数量） | ❌ |
| 顶层 match 变量作用域 | arm 级 child_env，自动清理 | 写入 globals，永不清理 | ❌ |
| Map 不可哈希键错误 | 友好错误消息 | Python 原生 TypeError | ❌ |
| 递归深度保护 | 仅函数调用 | 仅函数调用 | ✅ |
| 内置函数集合 | 基本相同 | 基本相同 | ✅ |

---

## [2026-07-16] 编译器 (compiler.py) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | PIPE_CALL 指令、MATCH_START/END 标记、VM 侧栈统一恢复 |
| 可行性 | ⭐⭐⭐ | 基本编译流程可用；嵌套函数、列表推导式有严重 bug |
| 正确性 | ⭐⭐ | 嵌套函数字节码名称碰撞、MATCH_END 成功路径跳过、列表推导式循环栈缺失 |
| 安全性 | ⭐⭐⭐ | 栈布局基本正确 |
| 一致性 | ⭐⭐⭐ | 栈布局与 VM 基本一致，闭包语义不一致 |
| 完整性 | ⭐⭐⭐⭐ | AST 大部分节点有编译处理 |
| 工程质量 | ⭐⭐ | 死代码、重复代码 |
| 性能 | ⭐⭐⭐ | 闭包不做自由变量分析 |
...
- **[compiler.py:394-399] 嵌套函数字节码名称碰撞** → functions 字典以函数名为键，同名嵌套函数覆盖先定义的，闭包通过 func_name 查找字节码时执行错误的函数体 → 使用唯一 ID（递增计数器）作为函数内部标识键，函数名仅用于调试
  - 追问：如果工业级编译器用字符串名称在全局表中查找函数体，能被接受吗？→ **绝对不能。** 这是基础设计缺陷。

- **[compiler.py:777-783] MATCH_END 在匹配成功路径被跳过** → arm 体成功后 JUMP 到 MATCH_END 之后，成功路径不执行 MATCH_END，导致模式绑定变量泄漏到外层作用域，且 match_stack_bases 持续累积 → 将 MATCH_END 移到 end_pos 之前，使两条路径都经过 MATCH_END
  - 追问：如果 Rust/OCaml 的模式匹配变量泄漏到外层作用域，能被接受吗？→ **绝对不能。** 作用域精确性是基本要求。

- **[compiler.py:1072-1133] 列表推导式不注册到 _loop_stack** → 列表推导式内联 for 循环逻辑但不推入循环栈帧，推导式内的 break/continue 会错误跳出外层 while 循环 → 在推导式编译前后推入/弹出 "for" 类型的循环栈帧

#### 中等问题（影响特定场景）

- **[compiler.py:221, 277] _adt_constructors 全局注册表变体名碰撞** → 不同 ADT 的同名变体相互覆盖，零字段构造器识别错误 → 使用 (type_name, variant_name) 元组作为键
- **[compiler.py:362-368] 导入冲突检测覆盖不完整** → 只检查函数名冲突，不检查 let/mut 绑定和 ADT 变体名冲突 → 维护统一的已声明名称集合
- **[compiler.py:607-628] 闭包不做自由变量分析** → CLOSURE 捕获所有局部变量而非仅自由变量，浪费内存且影响语义 → 实现自由变量分析
- **[compiler.py:628-639] 内置 ADT 构造器不是一等函数** → Some/Ok/Err 只能在调用时特殊处理，不能作为值传递（如 map(Some, lst)） → 初始化时用 REGISTER_CTOR 注册内置 ADT 构造器

#### 轻微问题（代码质量）

- **[compiler.py:597-602] _compile_pipe 中内置函数检查是死代码** → 两个分支执行相同操作 → 删除多余的 if/else
- **[compiler.py:535-557] 短路 &&/|| 不强制 Bool 类型** → 短路路径可以返回非 Bool 值，与 AND/OR 操作码的类型检查不一致 → 短路路径也添加类型检查
- **[compiler.py:420-421] CharLiteral 编译为 CONST_STRING 无类型区分** → 字符和字符串运行时无法区分 → 添加 CONST_CHAR 操作码或在类型系统层面处理
- **[compiler.py:1014-1018] _loop_stack 中 for 循环的 continue_target 从未被使用** → 死代码，容易误导 → 删除或文档化
- **[compiler.py:617, 652-653] _compile_fn_call 中 callee_on_stack 判断冗余** → 恒为真 → 简化

#### 原创性分析
- **Nova 特色**：模式匹配 VM 级栈统一恢复（_pattern_fail_cleanup）、FOR_ITER + LOOP_END 抽象统一 for 循环与列表推导、MATCH_START/MATCH_ARM_START 基于快照的作用域管理、TRY_UNWRAP 指令级错误传播
- **参考已有**：基本栈机结构参考 CPython/JVM；跳转回填参考标准编译器教材

---

## [2026-07-16] 求值器 (evaluator.py) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两遍扫描支持相互递归；内置 Option/Result 类型 |
| 可行性 | ⭐⭐⭐ | 核心特性可用；Block 环境泄漏、while 作用域有缺陷 |
| 正确性 | ⭐⭐ | Block 无 try-finally 环境泄漏、闭包语义与 VM 不一致 |
| 安全性 | ⭐⭐ | 表达式递归无深度保护、range 用 tuple 破坏类型安全 |
| 一致性 | ⭐⭐ | 闭包语义、递归深度边界、Unit 实现等多处不一致 |
| 完整性 | ⭐⭐⭐⭐ | 大部分 AST 节点有处理 |
| 工程质量 | ⭐⭐ | eval_decl 重复代码、eval_expr 长 if-elif 链 |
| 性能 | ⭐⭐⭐ | 闭包引用语义效率可接受 |
...
- **[evaluator.py:766-776] Block 求值无 try-finally，异常导致环境泄漏** → 如果 Block 内部抛出 BreakSignal/ContinueSignal/ReturnSignal 等异常，self.env = old_env 永远不执行，后续代码在错误作用域中运行 → 用 try-finally 包裹 Block 体，确保环境始终恢复
  - 追问：如果任何主流语言的解释器在 break 后作用域不恢复，能被接受吗？→ **绝对不能。** 这是 P0 级严重缺陷。

- **[evaluator.py:1015-1030] while 循环无独立作用域，与 for 循环语义不一致** → for 循环每次迭代创建 child_env，while 循环直接在当前环境执行，循环体内定义的变量泄漏到外部 → 为 while 循环体创建 child_env，并用 try-finally 确保环境恢复
  - 追问：两种循环行为不一致，能被接受吗？→ **不能。** 违反最少意外原则。

- **[evaluator.py:49] 闭包引用语义 vs VM 值语义，行为根本分歧** → Evaluator 捕获 Environment 引用（修改外部 mut 变量可见），VM 捕获变量值拷贝（修改不影响外部） → 统一语义。根据函数式语言惯例，应为引用语义
  - 追问：同一段代码在两条执行路径上结果不同，能被接受吗？→ **绝对不能。** 多后端语言必须语义一致。

- **[evaluator.py:676起] 表达式求值递归无深度保护** → eval_expr 是递归的，深度嵌套表达式（如 2000 层 a+b+c+...）会触发 Python RecursionError → 在 eval_expr 入口添加表达式递归深度计数器

- **[evaluator.py:982, 1035] ForExpr/ListComprehension 的 range 用 tuple 表示破坏类型安全** → iterable 字段声明为 Expression，但实际可能是 Python tuple ("range", start, end, step)，绕过 AST 类型系统 → 创建专门的 RangeExpr AST 节点

- **[evaluator.py:724-732] TryExpr 错误消息冗余且误导** → 当 type_name 正确但 variant_name 无效时，错误消息却说"只能在 Option 或 Result 类型上使用" → 修复错误消息为"无效的 Option/Result 值"

#### 中等问题（影响特定场景）

- **[evaluator.py:915-938] 算术运算未捕获 Python TypeError** → "hello" + 42 等抛 Python TypeError 而非 Nova RuntimeError_ → 用 try-except 包裹并转换
- **[evaluator.py:多处] 内置函数未做参数类型检查** → sum/abs/str_len/list_length 等对错误类型参数抛 Python 异常 → 添加参数类型验证
- **[evaluator.py:449] 递归深度边界与 VM 不一致（Evaluator 多允许一层）** → Evaluator 用 >，VM 用 >=，最大深度相差 1 → 统一比较符号
- **[evaluator.py:700-703] 标识符查找异常处理多余且丢失位置信息** → 捕获 RuntimeError_ 后用同样消息重新抛出，完全多余 → 移除多余的 try/except
- **[evaluator.py:804-816] MapExpr 重复键静默覆盖，无任何警告** → 后面的值静默覆盖前面的，用户可能因笔误产生 bug → 检测重复键并报错或警告
- **[evaluator.py:547] 导出声明不验证名称是否存在** → export foo 即使 foo 从未定义也不会报错 → 第二遍求值结束后验证所有导出名称
- **[evaluator.py:1159] _match_pattern 遇到未知模式类型静默返回 False** → 新增 Pattern 类型忘记处理时不会报错，隐藏 bug → 对未知模式类型抛出异常
- **[evaluator.py:943-947] 字符类型与字符串类型运行时无区分** → 'a' == "a" 返回 True，Char 和 String 在类型层面无区分 → 运行时使用包装类型区分 Char 和 String

#### 轻微问题（代码质量）

- **[evaluator.py:384-404] _format_value 未处理 dict 类型** → dict 输出 Python 字典格式而非 Nova Map 格式 → 添加 dict 格式化
- **[evaluator.py:多处] 错误消息格式不一致** → 有的用引号，有的不用；有的有变量名，有的没有 → 统一错误消息风格
- **[evaluator.py:504-551 vs 576-631] _collect_decl 与 eval_decl 代码大量重复** → FnDef/TypeDef/AliasDef/ImportDecl/ExportDecl 处理逻辑几乎相同 → 抽取共享逻辑
- **[evaluator.py:523-526, 603-606] TypeDef 构造器工厂函数两处重复** → make_constructor 在两处完全重复定义 → 抽取为辅助函数
- **[evaluator.py:501] 自动调用 main 时 callable() 检查多余** → NovaClosure 和 BuiltinFn 都没有 __call__，callable() 对它们返回 False → 简化条件
- **[evaluator.py:75-79] ADT 值相等性比较不包含 field_names** → 字段名不同但值相同的 ADT 被认为相等 → 视设计决定是否比较 field_names
- **[evaluator.py:1032-1066] 列表推导式中 break/continue 行为意外** → 推导式内 break/continue 直接传播到外层循环 → 在推导式中捕获 BreakSignal/ContinueSignal 并报错

#### 原创性分析
- **Nova 特色**：管道操作符直接转换为函数调用、TryExpr 用 ReturnSignal 实现错误传播、模式匹配递归正确支持嵌套模式和守卫
- **参考已有**：整体架构是经典的环境传递解释器（SICP/PLAI 标准模式）；用异常实现 break/continue/return 是常见技巧
...
## [2026-07-16] 类型检查器 (type_checker.py) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 混合式简化推断，非标准 HM 实现 |
| 可行性 | ⭐⭐⭐ | 基本类型检查可用；泛型和推断薄弱 |
| 正确性 | ⭐⭐ | TypeVar 过于宽松导致类型系统不健全 |
| 安全性 | ⭐⭐ | 通过类型检查的程序仍可能发生运行时类型错误 |
| 一致性 | ⭐⭐ | 与 Evaluator/VM 基本对应但有漏洞 |
| 完整性 | ⭐⭐⭐⭐ | 覆盖大部分语言特性的类型检查 |
| 工程质量 | ⭐⭐ | 错误路径不一致、死代码、重复代码 |
| 性能 | ⭐⭐⭐ | 单遍检查，效率可接受 |
...
- **[type_checker.py:1386-1387] _types_compatible 对 TypeVar 过于宽松导致类型系统不健全** → 只要一方是 TypeVar 就返回 True 且不产生任何约束，导致无类型标注的函数参数可接受任意类型，通过类型检查的程序仍可能运行时类型错误 → 实现真正的合一（unification）算法，约束 TypeVar 到具体类型
  - 追问：如果 OCaml 的类型推断器对某些表达式直接放过而不约束类型，能被接受吗？→ **绝对不能。** 类型系统不健全（unsound）是最根本的缺陷。

- **[type_checker.py:762-772] 函数调用 TypeVar 错误绕过 _report_error，路径不一致** → 直接写入 error_collector 而非通过 _report_error，非收集模式下错误被静默忽略 → 统一使用 _report_error 报告错误

- **[type_checker.py:813-816] 块内 MutBinding 完全忽略类型标注** → 局部 mut 变量的 type_annotation 被完全忽略，与顶层 MutBinding 和局部 LetBinding 不一致 → 参照 LetBinding 添加类型标注检查
  - 追问：如果任何生产级编译器的类型检查器跳过某些声明的类型标注检查，能被接受吗？→ **不能。** 遗漏检查等同于类型系统漏洞。

- **[type_checker.py:983-984, 1019-1020] ForExpr/ListComprehension 对非 List 迭代对象静默放行** → 迭代对象不是 List/Tuple 时不报错，默默创建 TypeVar 作为元素类型，for x in 42 { x + 1 } 通过类型检查 → 非 List/Tuple 迭代对象应报类型错误

- **[type_checker.py:1255-1275] _collect_type_bindings 方向单一，不是真正的合一** → 只从 expected 收集 TypeVar 绑定到 actual，actual 中的 TypeVar 不被绑定；双向泛型函数调用类型推断失败 → 实现双向合一算法

- **[type_checker.py:1255-1275] 缺少 occurs check，可能构造无限类型** → 将 TypeVar 绑定到类型时不检查 TypeVar 是否出现在被绑定类型中，id(id) 等场景产生病态无限类型 → 添加 occurs check，检测到递归类型时报错
  - 追问：如果 OCaml 的类型检查器允许构造无限类型而不报错，能被接受吗？→ **不能。** occurs check 是 HM 类型推断的基本组成部分。

#### 中等问题（影响特定场景）

- **[type_checker.py:777-792] PipeExpr 类型检查极其粗略，不做类型变量绑定** → 泛型函数的类型参数完全不被管道操作约束，[1,2,3] |> head 的返回类型仍是 Option[TypeVar] → 实现管道操作的类型变量绑定
- **[type_checker.py:1233-1253] _substitute_type_vars 只做单层替换，不处理链式绑定** → bindings 中有链式绑定（T1→T2, T2→Int）时，替换 T1 只得到 T2 而非 Int → 递归替换直到非 TypeVar
- **[type_checker.py:634-635, 652-654] 空列表/空 Map 的元素类型是游离 TypeVar** → TypeVar 不出现在任何函数签名中，不被任何上下文约束，"假通过"类型检查 → 空列表类型需要上下文约束或报错
- **[type_checker.py:1090-1098] ADT 变体查找用线性扫描，效率低且不处理同名冲突** → 每次遇到构造器模式都遍历所有 ADT 的所有变体，O(n) 复杂度，且同名变体只找到第一个 → 维护构造器名到 ADT 的映射表
- **[type_checker.py:1316-1319] 类型别名循环检测不完整** → 别名在定义时就完全展开，_expand_alias 是空操作，循环别名检测实际上不工作 → 实现真正的别名展开和循环检测
- **[type_checker.py:711] MatchExpr 无 arms 时返回 UNIT_T 过于宽松** → 空 match 返回 UNIT_T 而非更精确的类型 → 空 match 应有独立的类型规则
- **[type_checker.py:169-174] TypeVar 计数器是全局的，跨实例不重置** → 类变量在所有 TypeChecker 实例间共享，测试结果可能依赖测试顺序 → 每个 TypeChecker 实例使用独立的变量生成器

#### 轻微问题（代码质量）

- **[type_checker.py:1204-1208] 逻辑运算符错误消息硬编码为 '&&'** → || 操作数类型错误时也说 '&&'，误导 → 动态拼接运算符名称
- **[type_checker.py:1362-1380] _expand_alias 方法是死代码（no-op）** → 只是创建深拷贝，从不实际展开别名 → 删除或实现真正的别名展开
- **[type_checker.py:1056] _check_pattern 中 match_expr 参数未使用** → 冗余参数 → 删除
- **[type_checker.py:293-307] Option/Result 内置 ADT 的 TypeVar 命名不一致** → 变体定义和构造函数签名使用不同的 TypeVar 名称 → 统一命名
- **[type_checker.py:1194-1198] 比较运算符不支持 String 和 Char** → 只支持 Int/Float，缺少字典序比较支持 → 添加 String/Char 比较支持
- **[type_checker.py:748-754] FnCall 参数兼容性检查方向有问题** → _types_compatible(arg_t, substituted) 方向不清晰 → 统一方向（期望 vs 实际）
- **[type_checker.py:840-883] FieldAccess 数字索引和命名字段处理有冗余 try/except** → TupleType 和 ADT 各有一份类似逻辑 → 抽取辅助函数

#### 原创性分析
- **Nova 特色**：所有变体共名字段的 product-like 访问模式、ErrorCollector + ErrorType 的错误恢复模式
- **参考已有**：整体思路接近教学型类型检查器；ADT 和模式匹配参考 ML/Haskell 家族；ErrorCollector 设计参考 Rustc

---

## [2026-07-16] 词法/语法分析器 (lexer.py / parser.py) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | if-then-else 消除悬挂 else、lambda |params| 语法有特色 |
| 可行性 | ⭐⭐⭐ | 核心语法可用；边缘情况有崩溃和歧义 |
| 正确性 | ⭐⭐ | ? 操作符优先级错误、比较运算符左结合、Fn[] 返回类型错误 |
| 安全性 | ⭐⭐ | 字符串/字符末尾反斜杠+EOF 崩溃 |
| 一致性 | ⭐⭐ | 与 Tree-sitter 语法存在系统性差异 |
| 完整性 | ⭐⭐⭐ | 缺少科学计数法、多进制、块注释、Unicode 转义 |
| 工程质量 | ⭐⭐ | 无错误恢复、Span 仅覆盖首 token、词法错误非结构化 |
| 性能 | ⭐⭐⭐⭐ | 递归下降 + 优先级爬升，效率可接受 |
...
- **[lexer.py:237-238] 字符串末尾反斜杠 + EOF 导致词法分析器崩溃** → "hello\ 这种输入在 _read_string 中触发 IndexError → 跳过反斜杠后立即检查 EOF，按未闭合字符串处理
  - 追问：如果 GCC 遇到未闭合字符串就崩溃，能被接受吗？→ **绝对不能。** 任何导致编译器崩溃的输入都是 P0 级 bug。

- **[lexer.py:285-286] 字符字面量末尾反斜杠 + EOF 导致词法分析器崩溃** → 与字符串同理，'\ 这种输入触发 IndexError → 同上修复

- **[parser.py:733-769] ? 操作符优先级错误——应置于后缀循环内** → TryExpr 在后缀 while 循环之外解析，foo?()、foo?.bar、foo?[0] 全部语法错误 → 将 ? 移入后缀循环内部
  - 追问：如果 Rust 的 ? 运算符不能与方法调用/字段访问组合使用，能被接受吗？→ **不能。** ? 是后缀运算符，应与其他后缀操作同优先级。

- **[parser.py:334-345] Fn[A, B] 类型语法返回值恒为 Unit** → 所有类型参数都作为 param_types，return_type 硬编码为 TypeUnit，Fn[Int, Bool] 被解析为 (Int, Bool) -> Unit 而非 (Int) -> Bool → 取最后一个类型参数为返回类型

#### 中等问题（影响特定场景）

- **[parser.py:672-678] 比较运算符为左结合，应是非结合或链式** → a < b < c 被解析为 (a < b) < c，比较布尔值与 c，违反数学直觉 → 改为单次匹配（非结合）或实现链式比较
  - 追问：如果生产级语言的比较运算符是左结合导致 a<b<c 语义错误，能被接受吗？→ **不能。** 这是经典的语言设计陷阱。

- **[parser.py:522] 负数模式不能作为 match 非首分支（无逗号分隔时）** → 分支判断列表缺少 TokenType.MINUS，-1 -> ... 作为非首分支时报语法错误 → 在判断列表中加入 MINUS

- **[parser.py:860-863] 空 {} 永远被解析为空 map，空 block 无法表示** → 用户无法写返回 Unit 的空代码块 → 根据上下文决定或使用专用语法

- **[parser.py:464-466, 968-970] <- 由两个独立 token 拼接，无独立 token 类型** → < 和 - 之间不能有空格，错误消息不友好 → 添加 LEFT_ARROW token 类型

- **[parser.py 全文] 解析器无错误恢复——遇错即停** → 用户每次只能修复一个错误，迭代效率极低 → 实现至少 panic mode 错误恢复

- **[parser.py:386-391] 字段赋值和索引赋值在 block 中不支持** → obj.field = value 和 arr[0] = value 不被识别为赋值 → 实现左值（lvalue）解析

- **[parser.py 各表达式构造处] Span 仅覆盖首 token，不反映完整表达式范围** → 错误高亮只显示关键字/操作符，IDE 支持差 → 用第一个和最后一个 token 计算完整 span
  - 追问：如果 Rustc 的错误位置只指向关键字而非整个表达式，能被接受吗？→ **不能。** Span 准确性是生产级编译器的基本要求。

- **[lexer.py:155-160, 254-256] 词法错误存储为字符串，未使用结构化错误体系** → LexerError 类已定义但从未使用，错误以字符串 print 到 stderr → 改为创建 LexerError 对象，与解析器统一

- **[lexer.py:250-251, 297-298] 未知转义序列静默忽略，无报错** → \q 静默变成 q，用户打错转义序列毫无感知 → 未知转义序列应报词法错误或警告

- **[parser.py:317-323] () -> T（Unit 参数函数类型）无法解析** → 元组类型强制要求至少一个元素，零参数函数类型无法表达 → 在类型元组解析中先检查是否为 ()

- **[lexer.py:202-221] 不支持科学计数法浮点数字面量** → 1e5、1.5e-3 等无法解析 → 添加科学计数法支持

- **[lexer.py:88, 91] PIPE_VARIANT 和 UNIT token 为死代码** → 整个代码库仅在定义处出现一次 → 删除未使用的 token 类型

#### 轻微问题（代码质量）

- 不支持多进制数字字面量（0x/0o/0b）
- 不支持数字分隔符（1_000_000）
- 不支持 Unicode 转义序列（\u{XXXX}）
- 不支持块注释（/* */）和嵌套块注释
- **[lexer.py:182-183] Tab 字符列计数为 1，与编辑器显示不一致** → 错误下划线视觉偏移
- **[parser.py:402-411] Block 中语句可无分号分隔，隐式断句** → { 1 2 } 被解析为两个语句，可能掩盖笔误
- 前导零十进制整数无警告 → 0123 静默解析为 123
- 空 match 表达式语法上合法 → 至少应要求一个分支
- **[parser.py:456, 476] _parse_for_expr 中 tok 变量被覆盖** → 降低可读性
- range 仅在 for/推导式上下文中可用 → 用户可能期望 range 是一等表达式

#### 原创性分析
- **Nova 特色**：if-then-else 使用 then 关键字彻底消除悬挂 else、lambda 使用 |params| 语法、type + alias 并列的类型定义语法、++ 作为单独优先级层级的字符串拼接
- **参考已有**：递归下降 + 优先级爬升是教科书式标准实现；ADT + 模式匹配参考 ML/Haskell 家族；? 运算符直接来自 Rust

---

## [2026-07-16] 错误处理 + 模块 + 环境 (errors.py / modules.py / environment.py) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 错误格式仿 Rust，整体架构标准 |
| 可行性 | ⭐⭐⭐ | 基本功能可用；安全性和完整性有严重缺陷 |
| 正确性 | ⭐⭐ | 路径遍历零防护、导出零验证、多字节字符错位 |
| 安全性 | ⭐ | 路径遍历漏洞、任意文件读取、无文件大小限制 |
| 一致性 | ⭐⭐ | 错误收集器严重程度分类错误、输出顺序不对 |
| 完整性 | ⭐⭐ | 缺少文件名、Unicode 宽度处理、错误码等关键特性 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰但深度不足 |
| 性能 | ⭐⭐⭐⭐ | 基本操作效率可接受 |
...
- **[modules.py:107-157] 路径遍历攻击零防护 — 任意文件读取漏洞** → resolve 方法对 module_path 没有任何规范化和安全检查，../../etc/passwd 可读取系统任意文件 → 用 os.path.realpath() 规范化 + 根目录白名单验证
  - 追问：如果 Python 的 import 系统允许通过路径遍历读取任意系统文件，能被接受吗？→ **绝对不能。** 这是 P0 级安全漏洞。

- **[modules.py:49-57, 276-291] 导出名称完全不验证存在性** → _collect_exports 只收集 name 字符串，不验证名称是否在模块中实际定义；get_exported_bindings 中 lookup 失败静默 pass → 在类型检查阶段验证所有 export 声明的名称确实存在
  - 追问：如果 Rust 中 pub 修饰不存在的项不报错，能被接受吗？→ **不能。** 编译器最基本的语义检查之一。

- **[errors.py:265-283] 下划线计算未处理多字节字符 — 错误高亮完全错位** → 使用 len(line_content) 和字符索引计算位置，中文/日文/emoji 等全角字符显示宽度 ≠ 字符数，错误高亮 ^ 符号错位 → 使用 wcwidth 或 unicodedata.east_asian_width 计算显示宽度
  - 追问：如果 Rust 编译器对中文代码的错误高亮完全错位，能被接受吗？→ **不能。** 自称支持中文错误信息的编译器必须正确处理 Unicode 宽度。

- **[errors.py:157-263] 错误信息缺少文件名 — 无法定位错误来源** → 格式化输出只有行号列号，没有文件名，多文件项目中错误完全不可定位 → NovaError 增加 file_path 字段，位置格式改为 文件路径:行:列
  - 追问：任何生产级编译器的错误信息不含文件名，能被接受吗？→ **绝对不能。** 多文件项目基本要求。

- **[errors.py:358-426] ErrorCollector 严重程度分类错误** → NOTE 和 HELP 级被放入 errors 列表，has_errors() 会因为一个 note 返回 True → 明确区分各严重级别的存储列表

- **[errors.py:405-411] raise_all 格式嵌套灾难** → 把第2到第N个错误的完整 format() 输出作为 note 添加到第一个错误，ANSI 颜色嵌套、缩进混乱，输出完全不可读 → 废弃 raise_all，使用 format_all() 或 ExceptionGroup

- **[modules.py:220-274] 模块加载时执行顶层代码 — 循环导入部分执行状态不一致** → 循环导入检测到异常时，部分执行造成的副作用不会回滚，解释器处于不一致状态 → 两阶段加载：先收集所有声明，再执行；加载失败回滚副作用

#### 中等问题（影响特定场景）

- **[environment.py:34-48, 50-61] 递归实现无深度限制 — 栈溢出风险** → lookup/lookup_binding/assign 都是递归实现，深层嵌套作用域可能触发 Python 递归深度限制 → 改为迭代实现（while 循环）
- **[modules.py:186] 缓存键未规范化 realpath — 符号链接导致重复加载** → 同一模块通过不同符号链接路径导入会被加载多次 → 使用 os.path.realpath() 作为缓存键
- **[errors.py:159] Windows 换行符 \r\n 处理不当** → split('\n') 后每行末尾残留 \r，破坏输出格式 → 使用 splitlines() 或先 replace('\r\n', '\n')
- **[modules.py:245] 死代码：_collect_exported_types 返回值未使用** → 与 _collect_exports 逻辑重复 → 删除冗余方法或实现真正的导出类型验证
- **[modules.py:248-249] 类型检查在导出收集之后 — 无法验证导出** → 顺序错误，类型检查器无法利用导出信息验证 → 调整顺序：先词法+语法分析，再名称解析+类型检查（含导出验证），最后收集导出结果
- **[errors.py:99-104] 多行 span 的 highlight_span 不设置** → 多行错误时 highlight_span 为 None → 正确处理多行情况或完全废弃 highlight_span
- **[environment.py:67-73] all_bindings 是 O(n²) 的低效实现** → 每层递归都创建新字典并 update 父层结果 → 改为单次遍历累加
- **[modules.py:222] 读取文件无大小限制 — 内存耗尽 DoS** → f.read() 一次性读取整个文件，无大小上限 → 设置合理的文件大小上限
- **[errors.py:398] get_all 不按出现顺序排列** → 所有错误在前，所有警告在后，不是按源码顺序 → 维护统一的有序列表

#### 轻微问题（代码质量）

- **[environment.py:14-20] BindingInfo.name 字段冗余** → 字典 key 已经是变量名 → 移除 name 字段
- **[environment.py:34-48] lookup 和 lookup_binding 代码重复** → lookup 可直接调用 lookup_binding(name).value → 复用
- **[errors.py:253-260] 相关 note 的下划线逻辑重复且不完整** → 未复用 _compute_underline → 统一使用 _compute_underline
- **[errors.py:293-317] 各错误类型构造函数参数不一致** → LexerError 的 line/column 是必填，其他是可选 → 统一参数约定
- **[modules.py:98-105] 默认搜索路径包含相对路径 — 依赖 CWD** → 不同目录下运行模块解析行为不一致 → 默认路径基于可执行文件位置或项目根目录
- **[errors.py:48] ANSI 颜色检测基于 stderr，但输出可能到任何地方** → 颜色判断可能错误 → _format 方法接受 use_color 参数
- **[environment.py:30-32] define 允许同作用域重复定义** → 后者静默覆盖前者，无警告 → 增加重复定义检测
- **[modules.py:126-129] 相对路径只搜索第一个 search_path** → 行为不明确 → 文档化或尝试所有搜索路径
- **[errors.py:179] 上下文最后一行显示不完整** → 注释说"前后各1行"但最后一行没有下一行 → 修正注释或实现

#### 原创性分析
- **Nova 特色**：错误系统整体架构参考 Rust rustc_errors 设计思路，Severity 枚举、RelatedNote、ErrorCollector 等概念借鉴自 Rust
- **参考已有**：模块系统（ModuleResolver + ModuleManager + loading_stack 循环检测）是教科书式标准实现；环境系统（parent 指针 + 字典绑定）与 SICP 环境模型一致
...
## [2026-07-16] 所有后端 (backend/* + c_codegen.py) 第21轮审查报告

### 总体评分
| 维度 | Native (x86_64) | Cranelift | WasmGC | C Codegen | 编译管道 |
|------|:---:|:---:|:---:|:---:|:---:|
| 指令覆盖完整性 | ⭐⭐⭐ | ⭐⭐ | ⭐⭐ | ⭐⭐⭐⭐ | — |
| 生成代码正确性 | ⭐ | ⭐ | ⭐ | ⭐⭐ | ⭐⭐ |
| 生产级可行性 | ⭐ | ⭐ | ⭐ | ⭐⭐⭐ | ⭐⭐ |
...
- **[backend/x86_64.py:266-315, 429-434] SSE 浮点指令操作数全部颠倒** → 所有 SSE 寄存器-寄存器指令的 ModR/M 编码中 reg 字段和 r/m 字段被颠倒，结果写入错误的寄存器，浮点运算完全不可用 → 将 _modrm(0b11, src & 7, dst & 7) 改为 _modrm(0b11, dst & 7, src & 7)
  - 追问：如果 GCC 的浮点指令全部编码错误，能被接受吗？→ **绝对不能。** 这是指令编码器级别的根本错误。

- **[backend/native_backend.py:771-787] 浮点比较使用 XMM 寄存器号调用整数指令** → is_float_op 为 true 时 left_reg 是 XMM 编号，但 sete/movzx 是整数指令，由于 GPR 和 XMM 编号重叠，会操作错误的寄存器 → ucomisd 后使用 movmskpd 或专用 GPR 提取比较结果
  - 追问：如果 LLVM 的浮点比较结果写入了错误的寄存器文件，能被接受吗？→ **不能。**

- **[backend/native_backend.py:616-621] 栈对齐违反 System V ABI** → 函数序言中 push 6 个 callee-saved 寄存器（48 字节）后，用 (stack_size + 15) & ~15 对齐，RSP % 16 == 8 而非 0，所有函数调用前栈不对齐，SSE 指令会触发段错误 → 确保栈帧大小满足 (48 + stack_size_adjusted) % 16 == 8
  - 追问：如果 OCaml 的 native 后端栈对齐错误导致所有 SSE 操作崩溃，能被接受吗？→ **绝对不能。** ABI 遵从是最基本的要求。

- **[backend/native_backend.py:1125-1189] List/Tuple/ADT 在栈上分配，返回后变为悬空指针** → _compile_build_list/_compile_build_tuple/_compile_build_adt 全部在栈上分配空间并返回指针，函数返回后栈帧被回收，所有复合数据结构都是 use-after-free → 堆分配 + GC 或正确的生命周期分析
  - 追问：如果任何生产级编译器返回局部数组的指针，能被接受吗？→ **绝对不能。** 这是教科书级别的内存安全漏洞。

- **[backend/native_backend.py:509-541] Caller-saved 寄存器在函数调用后不保存** → 可用 GPR 列表包含 RDI, RSI, RDX, RCX, R8, R9 等 caller-saved 寄存器，函数调用会破坏这些寄存器中的值但代码不保存不恢复 → 函数调用前保存所有活跃的 caller-saved 寄存器，调用后恢复

- **[backend/cranelift_backend.py:162-168, backend/wasm_backend.py:260-263] LIRBranch 使用硬编码标签名** → 完全忽略 instr.true_label 和 instr.false_label，使用硬编码的 block_true/block_false，所有条件分支都跳转到错误标签 → 使用指令中携带的标签名

- **[backend/cranelift_backend.py:156-157, backend/wasm_backend.py:254-255] LIRReturn 不返回值** → 只发射 return（无返回值），完全忽略 src_locs 中的返回值，所有非 void 函数不返回实际值 → 发射返回值

- **[c_codegen.py:851-871] C Codegen ADT 构造器生成无效 C 语法** → 使用 GNU 语句表达式 ({ .tag = ..., .field = value, }) 但没有类型前缀，且字段命名与 struct 定义不一致（单下划线 vs 双下划线+数字） → 使用合法的 C 复合字面量语法并统一字段命名
  - 追问：如果 OCaml 的 native 编译器生成的代码连编译都通不过，能被接受吗？→ **绝对不能。**

- **[c_codegen.py:590-600] C Codegen TryExpr 使用不存在的字段和枚举** → .variant_tag 字段不存在，NOVA_OPTION_NONE_TAG 枚举不存在，变量类型也不对 → 修正为正确的字段名和枚举名

- **[backend/wasm_backend.py:230-232] Wasm 后端标签处理创建未闭合的嵌套 block** → LIRLabel 发射 (block $block_name 打开新 block 但没有对应 ) 闭合，生成的 WAT 语法完全无效 → 正确闭合 block 或使用 br_table 处理跳转

- **[backend/native_backend.py:1064-1111] 索引操作破坏基址寄存器** → _compile_index 中 e.add_reg_reg(base_reg, RCX) 直接修改基址寄存器，多次索引同一数组时基址递增导致后续越界 → 使用临时寄存器计算地址

- **[backend/compiler_pipeline.py:33-35] 编译管道：BACKEND_NATIVE 实际使用 CraneliftBackend** → 用户选择 native 目标时实际走 Cranelift 路径，自研 x86_64 后端完全未集成 → 正确接入 NativeCodeGen

#### 中等问题（影响特定场景）

- **[backend/wasm_backend.py:153-162] Wasm 后端字符串偏移计算错误（多算 3 字节/字符串）** → _scan_strings 用 b"\\x00"（4字节字面量）计算，但实际 null 终止符是 1 字节 → 修正长度计算
- **[backend/native_backend.py:412-447] LinearScanAllocator 溢出路径完全不可用** → 只要有任何溢出就返回 None，退化为按需分配 → 实现真正的溢出/填充逻辑
- **[backend/x86_64.py:375-386] mov_mem_imm64 实际只写 32 位（符号扩展）** → 函数名暗示 64 位立即数，但 opcode 是 MOV r/m64, imm32 → 重命名或使用 mov reg, imm64 + mov mem, reg
- **[backend/native_backend.py:771-786] 浮点比较 NaN 处理错误** → ucomisd + setb/seta/setbe/setae 不检查 PF，NaN 时结果错误 → 检查 PF 标志位
- **[backend/wasm_backend.py:248-249] Wasm 后端 ! 运算符对 i64 使用 i32.eqz** → 类型不匹配 → 使用 i64.eqz
- **[backend/cranelift_backend.py:248-255] Cranelift 后端所有调用参数强制为 i64** → 浮点参数也当作 i64 传递 → 根据参数类型使用正确的 Cranelift 类型
- **[c_codegen.py:655-664] C Codegen match 带守卫时未赋值分支导致未初始化变量** → guard 为 false 时 tmp 不赋值，整个 if-else 链可能全部跳过 → 初始化 tmp 为默认值或确保至少一个分支赋值
- **[backend/native_backend.py:998-1017] _compile_store_global 破坏 RBX（callee-saved）** → 直接覆盖 RBX 而不保存恢复，导致之前放在 RBX 中的虚拟寄存器值丢失 → 使用临时寄存器或保存恢复
- **[backend/x86_64.py:451-453, 467-473] je_rel32 重复定义** → 死代码，第二次覆盖第一次 → 删除重复定义
- **[backend/wasm_backend.py:342-344] Wasm 后端 LIRCall 不传递参数** → 只发射 call 指令，没有将参数压入 Wasm 栈 → 正确传递参数
- **[c_codegen.py:1301-1302] C Codegen Identifier 类型推断默认为 int64_t** → 完全忽略标识符的实际类型，字符串/列表/ADT 都被当作 int64_t → 从环境中查找实际类型

#### 轻微问题（代码质量）

- **[backend/x86_64.py:85] mov_reg_imm64 注释错误（零扩展 vs 符号扩展）** → 注释说零扩展，实际是符号扩展 → 修正注释
- **[backend/cranelift_backend.py:199-200, backend/wasm_backend.py:296-297] LIRStoreReg 在 Cranelift 和 Wasm 后端是空操作** → pass 无任何逻辑 → 添加注释或断言
- **[backend/cranelift_backend.py:257-261] Cranelift 后端数据段语法错误** → 不是有效的 Cranelift IR 数据段语法 → 使用正确的 data 声明语法
- **[backend/native_backend.py:869-876] FLOAT_NEG 实现低效（应为单指令 xor）** → 用 0.0 - x 实现，应使用 xor 符号位 → 使用 xorpd 与符号位掩码
- **[backend/cranelift_backend.py:187-188, backend/wasm_backend.py:284-285] LIRIndex 硬编码 v0** → 完全忽略 src_locs 中的实际操作数 → 使用正确的寄存器
- **[backend/compiler_pipeline.py:81-84] 编译管道中 C 后端使用 AST 而非 LIR** → 跳过全部 lowering 和优化，优化管线对 C 目标完全无效 → C 后端也走 LIR 路径
- **[backend/native_backend.py:1429-1434] SimpleNativeCompiler.compile_source 未实现** → 直接抛 NotImplementedError → 实现或删除类
- **[backend/native_backend.py:1225] _generate_start 中加载 argc 但从未使用** → mov_reg_mem(RDI, RSP, 8) 加载后立即被调用覆盖 → 删除无用加载
- **[backend/x86_64.py:317-322] xorpd_xmm 命名误导：既清零又操作 128 位** → 对 scalar double 操作应注意高位影响 → 添加注释说明

#### 原创性分析
- **Nova 特色**：自研 x86_64 编码器（从零手写机器码，不依赖汇编器）、自研 ELF 生成器（零外部依赖）、线性扫描寄存器分配器框架
- **参考已有**：整体后端架构参考标准编译器后端设计；Cranelift/Wasm 后端是文本生成模式；C 代码生成是常见的 transpiler 模式

---

## [2026-07-16] IR 系统 + Pass 管理器 (ir/*) 第21轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 三层 IR 设计合理性 | ⭐⭐⭐ | HIR/MIR/LIR 三层架构思路正确，但边界模糊 |
| 优化 Pass 实现完整性 | ⭐⭐ | ConstantFolding 较完整，其余有严重缺陷 |
| Pass 管理器健壮性 | ⭐⭐⭐ | 异常传播正确，无依赖管理、无 IR 验证 |
| SSA 形式正确性 | ⭐⭐ | 有 Phi 节点定义但构造不完整，无支配树 |
| Lowering 语义保真性 | ⭐⭐ | HIR→MIR 有 match/for 语义丢失，MIR→LIR 有多处错误 |
| 优化正确性 | ⭐⭐ | 每个 Pass 都有至少一个根本性错误 |
| 工程质量 | ⭐⭐ | __class__ 突变、死代码、设计不一致 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[ir/pass_manager.py:101-108] HIR 常量折叠：比较运算产生 HIRIntLiteral 携带 bool 值** → 1 == 2 的结果是 Python bool，但 __class__ 被设为 HIRIntLiteral，value 是 True/False 而 ir_type 是 BOOL_TYPE，类型不一致 → 比较结果使用 HIRBoolLiteral
  - 追问：如果 LLVM 的常量折叠产生的常量类型与节点类型不匹配，能被接受吗？→ **绝对不能。** 类型一致性是 IR 的基本不变量。

- **[ir/lir_lowering.py:121-138, 141-163, 202-218] LIR Lowering：所有指令的 src_locs 类型一律使用 result_type** → MIRBinOp、MIRUnaryOp、MIRCall 等所有指令的 src_locs 中操作数类型都使用结果类型而非操作数实际类型，后端若根据类型生成代码会生成错误的机器码 → MIR 指令携带操作数类型信息，或 lowering 时通过 SSA 名查找定义
  - 追问：如果 GCC 的 RTL 中操作数类型全部填成结果类型，能被接受吗？→ **不能。** 这是后端代码生成正确性的基础性错误。

- **[ir/pass_manager.py:628-690] MIR LICM：回边检测将前向跳转误判为回边 + 外提方向可能颠倒** → 所有 MIRJump 到其他块都视为回边（包括 if-else 前向跳转），且外提指令被插入到"第一个跳向 header 的前驱"末尾，如果前驱是回边块（循环体最后一个块），外提到循环体末尾而非循环前面 → 实现支配树计算 + pre-header，外提到 pre-header
  - 追问：如果 LLVM 的 LICM 将循环不变量外提到循环体末尾而非 pre-header，能被接受吗？→ **绝对不能。** 这是"外提"概念的方向性错误。

- **[ir/mir_lowering.py:159-162] MIR _lower_expr 对未定义标识符静默返回 None** → HIRIdentifier 不在 env 中时返回 None，调用方用 or "" 转为空字符串，空 SSA 名污染下游，命名函数调用（如 foo()）完全失效 → 区分命名函数引用和局部变量引用

- **[ir/pass_manager.py:186-230] LIR 常量折叠：const_map 跨基本块不失效** → const_map 是函数级别的，遇到标签不清除，若 LIRStoreReg 重定义寄存器，常量折叠使用过期值 → 保证 LIR 严格 SSA 或在 StoreReg 时失效对应寄存器

#### 中等问题（影响特定场景）

- **[ir/pass_manager.py:104-107, 114-117] HIR 常量折叠：__class__ 突变后 dataclass 字段语义不一致** → __dataclass_fields__ 是类属性，突变后对象字段元数据来自新类，但 __dict__ 可能残留旧类字段 → 创建新节点替换旧节点而非原地修改 __class__
- **[ir/pass_manager.py:280-283] DCE Pass：_SIDE_EFFECT_TYPES 常量定义但从未使用** → 两套分类系统并存（白名单 vs 黑名单），_SIDE_EFFECT_TYPES 是死代码 → 删除死代码或统一设计
- **[ir/pass_manager.py:587-588] LICM LIR 层：LIRBranch.cond_reg 检查是死代码** → LIRBranch 不在 side_effect_free 元组中，永远不会到达这行检查 → 删除死代码
- **[ir/mir_lowering.py:368-372] MIR _lower_match_expr：Phi 节点源取自 arm 块最后一条指令而非 arm 结果值** → arm body 最后一条指令是 MIRStore 等非值指令时，Phi 引用错误的值 → 使用 _lower_expr 返回的 arm body 结果构建 Phi 源
- **[ir/pass_manager.py:713-744] Pass 管理器：max_iterations=10 硬编码且无迭代次数告警** → 达到上限时静默退出，不报告未达到不动点 → 达到上限时发出警告，各层独立配置
- **[ir/ir_nodes.py:571-574, pass_manager.py:474-479] MIR MIRLoad 语义模糊** → 是"加载变量"还是"复制 SSA 值"？CSE 用它来"复制" SSA 值，但 LIR lowering 中一律降级为加载全局变量 → 明确 MIRLoad 语义或引入专门的复制指令

#### 轻微问题（代码质量）

- **[ir/ir_nodes.py:48-54] NovaType.__eq__ 和 __hash__ 对递归类型可能无限递归** → 设计债务
- **[ir/ir_nodes.py:755] LIRInstr.src_locs_imm 字段存在但从未使用** → 死字段
- **[ir/mir_lowering.py:59] HIRModule.type_defs 在 MIR lowering 中直接引用赋值，共享可变对象** → 两层共享同一份 type_defs，违反 IR 层独立性 → 深拷贝
- **[ir/mir_lowering.py:417, 440] HIRForExpr/HIRWhileExpr 的 ir_type 默认 TYPE_VAR，但 lowering 返回 None** → 语义不一致（循环是语句还是表达式？） → HIR 中明确为 Unit 类型
- **[ir/pass_manager.py:56-57] ConstantFolding._INT_OPS 中 &&/|| 用 bool() 转换，语义可能与 Nova 不匹配** → 假设 C 风格 0 为假，非0为真 → 与类型系统契约对齐

#### 原创性分析
- **Nova 特色**：三层 IR（HIR/MIR/LIR）架构参考 MLIR Dialect 思想；LIR 中 src_locs 用 (reg, type) 二元组附着类型信息
- **参考已有**：Pass 管理器"分层注册 + 不动点迭代"是标准模式；SSA + Phi 节点是经典设计；整体优化 Pass（常量折叠/DCE/CSE/LICM）是编译器标配

---

## [2026-07-16] C 运行时 + 测试套件 + Tree-sitter 第21轮审查报告
...
- **[runtime/nova_runtime.c:1289-1296] JSON 解析不验证输入完整消费 — 尾随垃圾被静默忽略** → nova_json_parse() 解析第一个值后直接返回，不检查是否到达输入末尾，"42abc"、"{\"a\":1}garbage" 都被"成功"解析 → 解析完成后检查 p->pos == p->len（跳过尾部空白后）
  - 追问：如果 Python 的 json.loads("42abc") 不报错而返回 42，能被接受吗？→ **绝对不能。** JSON 规范要求整个输入是完整的单一值。

- **[tests/test_nova.py 全文] 无 Evaluator 层面的 match guard 测试** → 核心函数式特性零验证，guard 实现若有回归完全无法发现 → 添加 guard 为 true/false、引用绑定变量、多 arm 等测试
  - 追问：如果 Haskell 的 pattern guard 没有任何测试用例，能被接受吗？→ **不能。** Guard 是模式匹配的一等特性。

- **[tree-sitter-nova/grammar.js 全文] 缺少后缀 ?（try）操作符** → 与 parser.py 功能不对齐，所有使用 ? 运算符的代码在 Tree-sitter 中都是语法错误 → 在后缀表达式层级添加 try_expr 规则

#### 中等问题（影响特定场景）

- **[runtime/nova_runtime.c:884-914] nova_list_dir 打开目录失败时返回空列表** → 错误与空目录无法区分 → 失败时返回 NULL 或设置全局错误状态
- **[runtime/nova_runtime.c:874-882] nova_file_exists 无法检测目录存在** → 用 fopen 检测，目录返回 false → 使用 stat()/access() 或重命名函数
- **[runtime/nova_runtime.c:921-924] nova_create_dir 不支持递归创建** → 父目录不存在时静默失败 → 实现递归创建或明确文档化
- **[runtime/nova_runtime.c:916-919] nova_delete_file 可删除空目录** → POSIX remove() 可删空目录，与函数名语义不符 → 使用 unlink() 替代
- **[tests/ 全文] 类型检查器层面零 match exhaustiveness 测试** → 类型安全核心特性未验证 → 添加穷尽性检查测试
- **[runtime/test_runtime.c:415] C 运行时测试无内存泄漏校验** → 所有引用计数 bug 都无法通过测试发现 → 测试结束时检查净分配数是否为 0
- **[tree-sitter-nova/grammar.js:534] negative_pattern 可能与 unary_expr 产生歧义冲突** → match arm 中的 -5 可能被错误解析 → 声明冲突或优先级
- **[tree-sitter-nova/grammar.js:434-439] block_expr 尾表达式语法与 parser.py 不一致** → Tree-sitter 要求尾表达式前有分号，parser.py 不需要 → 对齐语法定义

#### 轻微问题（代码质量）

- **[runtime/nova_runtime.c:206] nova_string_find 对 NULL/空 substr 返回 0** → 返回值歧义（位置 0 vs 错误） → 返回 -1 表示错误
- **[runtime/nova_runtime.c:1015] JSON 数字解析接受前导零** → 非严格 JSON 兼容 → 严格模式下报错
- **[runtime/nova_runtime.c:247-248] nova_string_trim 只处理 ASCII 空白** → 不支持 Unicode 空白字符 → 支持 Unicode 空白或文档化限制
- **[tests/test_nova.py] 无 char 类型求值测试** → 字符字面量运行时行为零验证 → 添加 char 求值和类型测试
- **[runtime/test_runtime.c:138-143] 查找 key 的临时字符串泄漏** → 不好的示范 → 正确 release 临时字符串
- **[tree-sitter-nova/grammar.js:405-426] for_expr 的 range 形式缺少 step 在 in 形式中的支持** → 语法不对称 → 确认设计意图后对齐
- **[tree-sitter-nova/grammar.js 全文] 无错误恢复（error recovery）规则** → IDE 体验差 → 添加 error 规则

#### 原创性分析
- **C 运行时**：引用计数 + FNV-1a 哈希 + 递归下降 JSON 解析的经典组合，标准实现无显著创新，但覆盖面全
- **测试套件**：分层清晰（lexer→parser→typechecker→evaluator→integration），组织合理
- **Tree-sitter 语法**：遵循社区最佳实践，规则命名规范，与 parser.py 系统性差异表明人工独立编写
...
1. **修复 FOR_ITER 跨函数迭代状态碰撞** → VM 隐蔽的数据竞争级 bug
2. **修复 Block 求值无 try-finally 导致的环境泄漏** → Evaluator 中 break/continue/return 后作用域不恢复
3. **修复嵌套函数字节码名称碰撞** → 同名函数覆盖，闭包执行错误代码
4. **修复 MATCH_END 成功路径被跳过导致的作用域泄漏** → 模式匹配变量泄漏到外层
5. **修复 SSE 浮点指令操作数全部颠倒** → Native 后端浮点完全不可用
6. **修复 List/Tuple/ADT 栈上分配返回悬空指针** → Native 后端所有复合类型本质不可用
7. **修复类型检查器 TypeVar 过于宽松导致的不健全** → 类型系统形同虚设
8. **修复模块系统路径遍历安全漏洞** → 可读取系统任意文件
9. **修复闭包语义 Evaluator 引用 vs VM 值的根本分歧** → 函数式语言核心语义
10. **修复 ? 操作符优先级错误（应在后缀循环内）** → 错误传播操作符核心用法失效

### 🟠 P1 级（高优先级，影响功能正确性）

11. **修复 Native 后端栈对齐违反 System V ABI** → SSE 指令段错误
12. **修复 Native 后端 caller-saved 寄存器不保存** → 函数调用后值损坏
13. **修复 Native 后端浮点比较使用 XMM 寄存器号调用整数指令** → 浮点比较结果错误
14. **修复 Cranelift/Wasm 后端 LIRBranch 硬编码标签名** → 控制流完全错乱
15. **修复 Cranelift/Wasm 后端 LIRReturn 不返回值** → 所有非 void 函数无返回值
16. **修复 C Codegen ADT 构造器无效 C 语法** → ADT 操作全部编译失败
17. **修复 LIR Lowering src_locs 类型一律用 result_type** → 后端类型驱动代码生成全部错误
18. **修复 MIR LICM 外提方向错误（循环体末尾而非 pre-header）** → LICM 完全无效
19. **修复列表推导式不注册到 _loop_stack** → 推导式内 break/continue 跳出外层循环
20. **修复 while 循环无独立作用域** → 与 for 循环语义不一致
21. **修复表达式求值递归无深度保护** → 深度嵌套表达式可导致解释器崩溃
22. **修复字符串/字符末尾反斜杠+EOF 崩溃** → 恶意输入可导致词法分析器崩溃
23. **修复错误信息缺少文件名** → 多文件项目基本要求
24. **修复错误高亮多字节字符错位** → 中文代码错误指示完全偏移
25. **修复比较运算符左结合（应为非结合或链式）** → a<b<c 语义错误
26. **修复导出名称零验证** → 模块系统核心功能缺陷
27. **修复 ErrorCollector 严重程度分类错误** → NOTE 被算成 ERROR
28. **修复 JSON 解析不验证输入完整消费** → 尾随垃圾静默忽略
29. **添加 Evaluator-VM 一致性测试框架** → 多后端语言基本质量要求
30. **添加 match guard 源码级测试** → 核心函数式特性零测试

### 🟡 P2 级（中优先级，影响质量/可维护性）

31. **实现真正的 Hindley-Milner 合一算法** → 类型系统架构级重构
32. **实现 let 多态（泛化 + 实例化）** → 类型系统 HM 核心功能
33. **修复闭包全量捕获（自由变量分析）** → 性能和语义改进
34. **修复构造器不支持部分应用（VM）** → 与 Evaluator 一致性
35. **修复顶层 MATCH_BIND 污染全局命名空间** → 作用域精确性
36. **实现解析器语法错误恢复** → 开发体验基本要求
37. **实现词法分析结构化错误** → 错误报告一致性
38. **统一错误报告路径（ErrorCollector 一致工作）** → 开发体验
39. **修复 Native 后端寄存器分配溢出路径** → 复杂函数可用性
40. **修复 Wasm 后端标签未闭合嵌套 block** → Wasm 模块验证失败
41. **修复 C Codegen TryExpr 字段名/枚举名错误** → ? 操作符不可用
42. **修复 Fn[A, B] 类型语法返回值恒为 Unit** → 类型语法核心 bug
43. **修复块内 MutBinding 忽略类型标注** → 类型检查漏洞
44. **修复 ForExpr 非 List 迭代对象静默放行** → 类型检查漏洞
45. **修复 range 用 tuple 表示破坏 AST 类型安全** → 架构清理
46. **修复 BUILD_MAP 不可哈希键崩溃** → 错误处理一致性
47. **修复 for 循环体内 return 导致迭代器状态泄漏** → 资源清理
48. **修复模块缓存键未规范化 realpath** → 符号链接重复加载
49. **添加 fuzz 测试、属性测试、边界值测试** → 测试质量提升
50. **实现 Tree-sitter 与 parser.py 完全对齐** → 语法一致性

### 🟢 长期规划

51. **实现真正的 GC（标记-清除或分代 GC）**
52. **重写 IR 降级链，实现真正的 SSA + Phi 消除**
53. **建立模块命名空间系统，摆脱 import * 模式**
54. **接入 Native 后端到编译管道**
55. **实现 LSP 语言服务器支持**
56. **添加 C 后端端到端测试**
57. **实现类型检查器错误恢复**
58. **添加端到端集成测试（所有后端）**
59. **实现 JIT 编译（基于 Cranelift）**
60. **实现调试支持（栈回溯、断点、单步执行）**
...
## [2026-07-16] VM 虚拟机 (vm.py) 第22轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配栈基指针机制、迭代器状态字典管理有特色 |
| 可行性 | ⭐⭐⭐ | 核心路径可用；TRY_UNWRAP泄漏、闭包可变变量有缺陷 |
| 正确性 | ⭐⭐ | TRY_UNWRAP迭代状态泄漏、闭包可变变量语义、顶层?后继续main |
| 安全性 | ⭐⭐ | BUILD_MAP不可哈希键崩溃、循环状态泄漏 |
| 一致性 | ⭐⭐ | 闭包语义、顶层?、read_line、range步长、顶层match绑定均不一致 |
| 完整性 | ⭐⭐⭐⭐⭐ | 指令集覆盖完整 |
| 工程质量 | ⭐⭐ | 双路径RETURN、启发式while检测增加维护成本 |
| 性能 | ⭐⭐ | 闭包全量捕获、迭代器字典查找有开销 |
...
- **[vm.py:1399-1418] TRY_UNWRAP 提前返回不清理迭代器状态** → 当 `?` 操作触发函数提前返回时，`_for_iters`、`_while_loops`、`_range_index`、`_list_index` 中的循环状态完全不清理，导致内存泄漏和后续循环行为错乱（break/continue 可能命中错误的循环条目） → 在 `_call_closure` 的 finally 块中保存/恢复循环状态栈深度，函数返回时截断到调用前深度
  - 追问：如果任何生产级语言的循环状态因函数提前返回而错乱，能被接受吗？→ **绝对不能。** 这是典型的资源泄漏+状态错乱 bug。

- **[vm.py:946-959] 闭包对可变变量的捕获是值语义而非引用语义** → CLOSURE 通过 `dict(locals)` 浅拷贝捕获，对于 mutable 变量，闭包内的修改不影响外部，外部的修改也不影响闭包内，与 Evaluator 的引用语义根本分歧 → 引入 `MutableCell` 间接层，使闭包和外部共享同一个 cell 对象
  - 追问：如果 OCaml 的闭包不能共享可变变量引用，能被接受吗？→ **不能。** 词法作用域 + 闭包是函数式语言的核心语义。

- **[vm.py:507-511] 顶层 TRY_UNWRAP 失败后仍执行 main()** → 顶层代码中 `?` 失败时 `_run_code` 只是 break 退出循环，然后 `_auto_call_main()` 仍然被调用，而 Evaluator 中 ReturnSignal 会向上传播导致程序终止 → `_run_code` 返回状态标记，`run()` 根据状态决定是否调用 main
  - 追问：如果顶层的错误传播操作符被静默忽略，能被接受吗？→ **绝对不能。** 静默忽略错误是严重的语义错误。

- **[vm.py:926-947] CONTINUE/BREAK 在无对应循环时静默失败** → 既没有 for 循环也没有 while 循环时，CONTINUE 什么都不做继续执行下一条指令，BREAK 进行脆弱的前向扫描，而 Evaluator 中会明确报错 → 在无循环上下文中遇到 break/continue 时抛出 RuntimeError_
  - 追问：如果任何生产级语言的 break 在循环外不报错，能被接受吗？→ **不能。** break/continue 不在循环中是静态错误，动态检查也必须抛出明确错误。

#### 中等问题（影响特定场景）

- **[vm.py:856-875] POP_JUMP_IF_FALSE 的 while 循环检测是地址匹配启发式** → 通过比较跳转目标地址与最近 while 循环的 end_ip 来判断，存在误判风险（if 的 false 分支跳转目标恰好等于外层 while 的 end_ip） → 编译器显式标记哪些跳转是 while 条件跳转
  - 追问：如果工业级编译器用地址猜测来识别循环结构，能被接受吗？→ **不能。** 指令中应携带足够语义信息，VM 不需要猜测。

- **[vm.py:191] read_line 内置函数不捕获 EOFError** → VM 版 `input()` 遇到 EOF 会崩溃，Evaluator 版捕获并返回空字符串 → 统一为捕获 EOFError 并返回空字符串
  - 追问：I/O 操作的错误处理在两条路径上不一致，能被接受吗？→ **不能。** 多后端语言必须语义一致。

- **[vm.py:1153-1165, 1311-1325] 顶层模式匹配绑定泄漏到全局作用域** → 顶层 match 不保存快照，MATCH_END 不清理绑定，变量永久留在 globals 中 → 为顶层 match 也实现快照机制，MATCH_END 时清理新增的 key
  - 追问：如果 Haskell 的 where 绑定泄漏到顶层作用域，能被接受吗？→ **不能。** 模式匹配的变量作用域必须精确控制。

- **[vm.py:1065-1107] range 步长为 0 时语义与 Evaluator 不一致** → Evaluator 报错"步长不能为 0"，VM 静默返回空列表 → 在 FOR_ITER 的 range 分支中添加 step == 0 检查并抛出错误
  - 追问：错误条件在两条路径上行为不同，能被接受吗？→ **不能。** 错误处理必须统一。

- **[vm.py:497-501] _execute_function 中的 return_flag 死代码路径** → return_flag 在执行过程中永远为 False，第497-499行的检查永远不会触发 → 删除死代码或添加防御性注释

#### 轻微问题（代码质量）

- **[vm.py:1004-1014] BUILD_MAP 未处理不可哈希键的错误** → Python TypeError 未包装为 RuntimeError_ → 用 try/except 包裹并抛出友好错误
- **[vm.py:1029-1050] FIELD_ACCESS 错误处理不完整** → tuple 路径的 ValueError/IndexError 未捕获 → 统一捕获并包装
- **[vm.py:1259-1277] MATCH_CONSTRUCTOR 仅检查 variant_name，不检查 type_name** → 两个不同 ADT 的同名 variant 会错误匹配 → 传入 type_name 并检查
- **[vm.py:249-267] 多个内置函数缺少参数类型检查** → filter/map/head/tail/sum 等对错误类型参数可能崩溃 → 添加参数类型验证
- **[vm.py:487-495] TRY_UNWRAP 提前返回时栈上 peek 不 pop，与正常 RETURN 不对称** → 统一为弹出模式或添加注释说明

#### 原创性分析
- **Nova 特色**：模式匹配栈基指针统一恢复机制、_for_iters + _loop_id 迭代器状态字典管理、TRY_UNWRAP 指令级错误传播
- **参考已有**：基本栈机设计参考 CPython/JVM；双路径 RETURN 处理是常见设计

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获可变变量 | Environment 引用（引用语义） | locals dict 快照（值语义） | ❌ 根本分歧 |
| 顶层 ? 操作失败 | ReturnSignal 传播，程序终止 | 静默退出，继续执行 main | ❌ 严重 |
| break/continue 无循环 | 抛出 RuntimeError_ | 静默忽略或启发式扫描 | ❌ |
| read_line 遇 EOF | 返回空字符串 | 抛出 Python EOFError 崩溃 | ❌ |
| 顶层 match 绑定泄漏 | 不泄漏（子环境隔离） | 泄漏到 globals | ❌ |
| range 步长为 0 | 抛出 RuntimeError_ | 静默返回空列表 | ❌ |
| 递归深度保护 | 仅函数调用 | 仅函数调用 | ✅ |
| 内置函数集合 | 基本相同 | 基本相同 | ✅ |

---

## [2026-07-16] 编译器 (compiler.py) 第22轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | PIPE_CALL 指令、MATCH_START/END 标记、VM侧栈统一恢复 |
| 可行性 | ⭐⭐⭐ | 基本编译流程可用；嵌套递归、列表推导式break有bug |
| 正确性 | ⭐⭐ | 嵌套递归函数闭包失效、列表推导式跨循环类型错误 |
| 安全性 | ⭐⭐⭐ | 栈布局基本正确 |
| 一致性 | ⭐⭐⭐ | 栈布局与 VM 基本一致，闭包语义不一致 |
| 完整性 | ⭐⭐⭐⭐ | AST 全覆盖，但 Char 用 string 是妥协 |
| 工程质量 | ⭐⭐ | 死代码、冗余代码 |
| 性能 | ⭐⭐⭐ | 闭包不做自由变量分析 |
...
- **[compiler.py:373-404] 嵌套递归函数闭包捕获时机错误，无法自调用** → 编译函数时先发出 CLOSURE 再 STORE_VAR，闭包创建时函数名尚未存入局部变量表，嵌套递归函数调用自己时 LOAD_VAR 找不到 → 方案A：先 STORE_VAR 再 CLOSURE 再覆盖；方案B：VM 中将函数自身注册到新帧 locals
  - 追问：如果工业级编译器的嵌套递归函数完全不可用，能被接受吗？→ **绝对不能。** 递归是函数式语言的核心特性。

- **[compiler.py:1092-1153] 列表推导式不注册到 _loop_stack，break/continue 逃逸到外层 while** → 列表推导式内联 for 循环逻辑但不推入循环栈帧，推导式内的 break/continue 会错误跳出外层 while 循环 → 在推导式编译前后推入/弹出 "for" 类型的循环栈帧
  - 追问：如果列表推导式内的 break 会跳出外层 while 循环，能被接受吗？→ **不能。** 控制流必须精确。

#### 中等问题（影响特定场景）

- **[compiler.py:362-369] Import 名称冲突检测不完整** → 只检测函数名冲突，不检测 let/mut 绑定、ADT 构造器、不同导入模块之间的冲突 → 维护统一的已定义名称集合，全面检查
  - 追问：如果导入的变量静默覆盖已有变量且无警告，能被接受吗？→ **不能。** 名称遮蔽是常见 bug 来源。

- **[compiler.py:901-965] _compile_pattern_test 和 _compile_pattern_bindings 死代码** → 两个旧的模式编译方法从未被调用，共65行死代码 → 删除或加 DEPRECATED 注释

- **[compiler.py:421-422] CharLiteral 使用 CONST_STRING 而非专用操作码** → 运行时 Char 和 String 无类型区分，类型系统不健全 → 引入 CONST_CHAR 操作码或取消 Char 类型

- **[compiler.py:584-613] 管道操作符参数顺序可能与直觉不符** → 管道值放在参数列表最后（`x |> f(a, b)` = `f(a, b, x)`），而 F#/Elixir/OCaml 等语言通常放在最前 → 修正顺序或明确文档化

- **[compiler.py:75] LOOP 操作码定义但从未使用** → 循环回跳使用 JUMP 而非 LOOP → 删除或统一替换

#### 轻微问题（代码质量）

- **[compiler.py:254-255] AUTO_CALL_MAIN 后紧跟的 HALT 是死代码** → _run_code 遇到 AUTO_CALL_MAIN 直接 break → 删除或重新设计
- **[compiler.py:282-283] REGISTER_CTOR 的 name 操作数在 VM 中未使用** → 浪费操作数槽位 → 删除或实际使用
- **[compiler.py:729] MATCH_START 的 arm_count 操作数在 VM 中未使用** → 预留参数无文档 → 加注释或删除
- **[compiler.py:81] CLOSURE 操作码注释与实际参数数量不符** → 注释写3个操作数，实际2个 → 修正注释
- **[compiler.py:307-308] 顶层表达式结果被 POP 但无 unused expression 警告** → 可能掩盖笔误 → 对纯表达式丢弃发出警告
- **[compiler.py:996, 1094] ListComprehension/ForExpr 的 range 用 tuple 表示，破坏 AST 类型安全** → 用 Python tuple  hack 而非专用 AST 节点 → 定义 RangeExpr 节点

#### 原创性分析
- **Nova 特色**：模式匹配 VM 级栈统一恢复（_pattern_fail_cleanup）、FOR_ITER + LOOP_END 抽象统一 for 循环与列表推导、MATCH_START/MATCH_ARM_START 基于快照的作用域管理
- **参考已有**：基本栈机结构参考 CPython/JVM；跳转回填参考标准编译器教材

---

## [2026-07-16] 求值器 (evaluator.py) 第22轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两遍扫描支持相互递归；内置 Option/Result 类型 |
| 可行性 | ⭐⭐⭐ | 核心特性可用；TryExpr顶层泄漏、块内声明缺失 |
| 正确性 | ⭐⭐ | Block环境泄漏、顶层?泄漏、表达式递归无深度保护 |
| 安全性 | ⭐⭐ | 表达式递归无深度保护、Python异常泄漏 |
| 一致性 | ⭐⭐ | 闭包语义、作用域模型与 VM 有根本差异 |
| 完整性 | ⭐⭐⭐⭐ | 表达式节点全覆盖，但声明类不能在块内使用 |
| 工程质量 | ⭐⭐ | eval_decl 重复代码、eval_expr 长 if-elif 链 |
| 性能 | ⭐⭐⭐ | 闭包引用语义效率可接受 |
...
- **[evaluator.py:766-776] Block 求值缺少 try-finally，异常路径环境泄漏** → BreakSignal/ContinueSignal/ReturnSignal/RuntimeError_ 等异常导致 `self.env = old_env` 不执行，后续代码在错误作用域中运行 → 用 try-finally 包裹 Block 体，确保环境始终恢复
  - 追问：如果任何主流语言解释器在 break 后作用域不恢复，能被接受吗？→ **绝对不能。** 这是 P0 级严重缺陷。

- **[evaluator.py:1015-1030] while 循环体没有独立作用域，与 for 循环不一致** → for 循环每次迭代创建 child_env，while 直接在当前环境执行，循环体内定义的变量泄漏到外部 → 为 while 循环每次迭代创建 child_env，与 for 统一
  - 追问：两种循环行为不一致，能被接受吗？→ **不能。** 违反最少意外原则。

- **[evaluator.py:676-885] 表达式求值无递归深度保护** → eval_expr 是递归的，深度嵌套表达式会触发 Python RecursionError，可被恶意输入利用 → 添加 `_eval_depth` 计数器，超过阈值抛友好错误
  - 追问：如果解释器可被深度嵌套表达式弄崩溃，能被接受吗？→ **不能。** DoS 攻击向量。

- **[evaluator.py:721-732] TryExpr（?操作符）在非函数上下文中异常泄漏** → 顶层或循环体内的 ? 操作抛出 ReturnSignal 但无人捕获，导致 Python 异常崩溃 → 在 eval_program 顶层捕获 ReturnSignal 并报错，或在 TryExpr 求值时检查函数上下文
  - 追问：如果错误传播操作符在错误位置使用时程序崩溃而非给出友好错误，能被接受吗？→ **不能。**

- **[evaluator.py:676-885] 声明类节点（FnDef/TypeDef/AliasDef/ImportDecl）不能在 Block 内使用** → eval_expr 中没有这些节点的处理分支，函数式语言的局部函数定义能力缺失 → 在 eval_expr 中添加 FnDef/TypeDef 等声明的处理
  - 追问：如果现代函数式语言不能在函数内定义局部函数，能被接受吗？→ **不能。** 这是基本能力。

#### 中等问题（影响特定场景）

- **[evaluator.py:915-964] 二元运算缺少完整类型检查，Python 异常直接泄漏** → `"hello" + 42` 等抛 Python TypeError 而非 Nova RuntimeError_ → 用 try-except 包裹并转换
- **[evaluator.py:966-977] 一元运算同样缺少类型检查** → 一元 `-` 应用于非数值类型抛 Python 异常 → 添加类型检查
- **[evaluator.py:804-816] MapExpr 键表达式可能被重复求值** → 错误处理路径重新遍历 pairs 并重新求值键，副作用重复执行 → 用循环逐对求值，先检查再构建
- **[evaluator.py:1120-1121] PatternChar 对单字符 string 和 Char 不区分** → `"a"` 和 `'a'` 运行时无法区分 → 引入独立的 Char 运行时包装类型
- **[evaluator.py:851-865] FieldAccess 对 ADT 先试索引再试名称，纯数字字段名有歧义** → "999" 字段会被当作索引越界报错 → 由 AST 节点类型决定访问方式，不做运行时试探
- **[evaluator.py:982] for 循环 range 用 tuple 判断，类型不安全** → `("range", ...)` 元组约定脆弱 → 创建专用 RangeExpr AST 节点
- **[evaluator.py:220-227] head/tail 的 None 变体 field_names 与构造器创建的不一致** → field_names 长度与 fields 长度不匹配 → 移除 None 变体的 field_names

#### 轻微问题（代码质量）

- **[evaluator.py:104] UNIT_VALUE 的 __bool__ 返回 False，语义不明确** → 可能在内部逻辑中引起混淆 → 考虑移除 __bool__ 或抛异常
- **[evaluator.py:791-797] Assignment 的错误处理冗余 re-raise，丢失元数据** → try/except 捕获后重新包装，丢失 span 等信息 → 直接调用 assign，去掉 try/except
- **[evaluator.py:208] _builtin_filter 用 `is True` 判断谓词结果** → 非 bool 真值会被静默过滤 → 添加类型检查
- **[evaluator.py:1075-1098] 模式匹配守卫与分支体重复创建环境** → 效率略低且守卫中的修改不传播 → 守卫通过后复用同一个 child_env
- **[evaluator.py:1032-1066] 列表推导式中 break/continue 直接传播到外层循环** → 推导式内 break/continue 会跳出外层循环 → 在推导式中捕获并报错
...
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 作用域模型 | 完整词法作用域链，每个 Block 创建子环境 | 扁平作用域（函数内只有 locals + globals 两层） | ❌ 根本差异 |
| 闭包捕获 | 整个环境引用（引用语义） | 当前帧 locals 快照（值语义） | ❌ 根本差异 |
| Block 作用域 | 独立作用域，let 绑定仅 Block 内可见 | 不创建作用域，整个函数内可见 | ❌ 重大差异 |
| for 循环作用域 | 每次迭代新 child_env | 同一帧 locals 中覆盖 | ❌ 重大差异 |
| 顶层 ? 操作 | ReturnSignal 泄漏崩溃 | 静默退出继续执行 main | ❌ 都有问题但表现不同 |
| 表达式递归深度保护 | 无（Python 递归溢出） | 字节码迭代执行，天然安全 | ❌ |
| 函数调用深度保护 | 有（1000层） | 有（1000层） | ✅ |
...
## [2026-07-16] 类型检查器 (type_checker.py) 第22轮审查报告
...
| 原创性 | ⭐⭐⭐ | 混合式简化推断，非标准 HM 实现 |
| 可行性 | ⭐⭐⭐ | 基本类型检查可用；泛型和推断薄弱 |
| 正确性 | ⭐⭐ | TypeVar 过于宽松、递归函数不检查、高阶函数静默放行 |
| 安全性 | ⭐⭐ | 通过类型检查的程序仍可能发生运行时类型错误 |
| 一致性 | ⭐⭐ | 与 Evaluator/VM 基本对应但有漏洞 |
| 完整性 | ⭐⭐⭐⭐ | 覆盖大部分语言特性的类型检查 |
| 工程质量 | ⭐⭐ | 错误路径不一致、死代码、重复代码 |
...
- **[type_checker.py:1405-1406] _types_compatible 对 TypeVar 一律返回 True，类型系统完全不健全** → 只要任意一方是 TypeVar 就直接通过，不做任何约束验证，导致无类型标注的函数参数可接受任意类型 → 实现真正的合一（unification）算法，使用 union-find 结构
  - 追问：如果 OCaml 的类型推断器对某些表达式直接放过而不约束类型，能被接受吗？→ **绝对不能。** 类型系统不健全是最根本的缺陷。

- **[type_checker.py:558-585] 递归函数自调用时类型完全不检查** → 第一遍注册的函数签名中返回类型是 TypeVar，递归调用时查到的返回类型是 TypeVar，由于 TypeVar 兼容一切，递归调用的任何使用都被放行 → 实现真正的 HM 推断，对递归函数使用 fixpoint 式推断

- **[type_checker.py:731-761] 泛型函数调用不生成新鲜 TypeVar，let 多态缺失** → 每次调用复用同一个 TypeVar 对象，bindings 字典局部导致巧合式多态，非真正的参数化多态 → 实现类型方案（type scheme）、let 泛化（generalize）和调用时实例化（instantiate）
  - 追问：如果 OCaml 的 let 多态没有正确实现，能被接受吗？→ **绝对不能。** let 多态是 HM 类型系统的核心。

- **[type_checker.py:762-772] 对 TypeVar 类型的值进行函数调用时直接静默放行** → 高阶函数中函数类型未确定时，直接返回新 TypeVar 作为返回类型，后续完全不检查 → 延迟到更多类型信息可用时再检查，或通过 _report_error 统一报告
  - 追问：如果类型检查器对不确定类型的调用静默放行，能被接受吗？→ **不能。** 错误报告路径必须一致。

- **[type_checker.py:1274-1294] _collect_type_bindings 不检查绑定冲突** → 同一个 TypeVar 出现在多个位置且类型不同时，第一次绑定被保留，后续不同绑定被静默忽略 → 检测冲突并报错

#### 中等问题（影响特定场景）

- **[type_checker.py:699-711] match 表达式无穷尽性检查和冗余模式检查** → 非穷尽 match 可能运行时崩溃，冗余模式无警告 → 实现穷尽性检查算法
- **[type_checker.py:364] json_parse 返回 TypeVar，动态类型逃逸口** → json_parse 的返回值可以赋给任何类型，完全绕过类型检查 → 返回 JsonValue ADT 或 Any 类型
- **[type_checker.py:1000-1001] ForExpr 对 TupleType 的处理错误** → 元组不可迭代但类型检查器允许 → 移除 TupleType 分支或报错
- **[type_checker.py:972-984] TryExpr（?操作符）不检查上下文返回类型** → ? 可以在任何地方使用，不验证函数返回类型是否兼容 → 检查所在函数的返回类型与操作数类型兼容
- **[type_checker.py:1330-1343] TypeIdentifier 对泛型 ADT 不要求类型参数** → `let x: Container = ...` 不会报错（如果 Container 是泛型） → 检查泛型 ADT 必须完整应用
- **[type_checker.py:832-835] 块内 MutBinding 完全忽略类型标注** → 局部 mut 变量的 type_annotation 被忽略，与顶层 MutBinding 不一致 → 添加类型标注检查
- **[type_checker.py:1206-1212] == 和 != 允许所有类型比较** → 函数类型、ADT 等也能比较，运行时可能不支持 → 限制可比较类型

#### 轻微问题（代码质量）

- **[type_checker.py:299-301] None 构造器的 TypeVar 与 Some 不共享对象** → 依赖名字相等的巧合 → 统一使用同一个 TypeVar 对象
- **[type_checker.py:302-307] Ok/Err 构造器的 Result 类型参数不完整** → 一个类型参数确定另一个是自由 TypeVar → 设计上可接受但依赖宽松规则
- **[type_checker.py:1221-1229] 逻辑运算符错误消息硬编码为 '&&'** → || 操作也说 '&&' → 动态拼接运算符名
- **[type_checker.py:1381-1399] _expand_alias 方法是死代码（no-op）** → 只是创建深拷贝，无别名展开逻辑 → 删除或实现真正的展开
- **[type_checker.py:1056] _check_pattern 中 match_expr 参数未使用** → 冗余参数 → 删除
- **[type_checker.py:293-307] Option/Result 内置 ADT 的 TypeVar 命名不一致** → 变体定义和构造函数签名使用不同名称 → 统一命名
- **[type_checker.py:1194-1198] 比较运算符不支持 String 和 Char** → 缺少字典序比较支持 → 添加 String/Char 比较支持
- **[type_checker.py:169-174] TypeVar 计数器是全局的，跨实例不重置** → 类变量在所有 TypeChecker 实例间共享 → 每个实例使用独立生成器

#### 原创性分析
- **Nova 特色**：所有变体共名字段的 product-like 访问模式、ErrorCollector + ErrorType 的错误恢复模式
- **参考已有**：整体思路接近教学型类型检查器；ADT 和模式匹配参考 ML/Haskell 家族

---

## [2026-07-16] 词法/语法分析器 (lexer.py / parser.py) 第22轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | if-then-else消除悬挂else、lambda \|params\| 语法有特色 |
| 可行性 | ⭐⭐⭐ | 核心语法可用；管道优先级错误、链式?不可用 |
| 正确性 | ⭐⭐ | 管道优先级与Tree-sitter相反、guard位置不一致、Fn[]返回类型错 |
| 安全性 | ⭐⭐ | 反斜杠+EOF崩溃 |
| 一致性 | ⭐⭐ | 与 Tree-sitter 语法存在系统性差异 |
| 完整性 | ⭐⭐⭐ | 缺少科学计数法、多进制、块注释等 |
| 工程质量 | ⭐⭐ | 无错误恢复、span不足、词法错误非结构化 |
| 性能 | ⭐⭐⭐⭐ | 递归下降+优先级爬升，效率可接受 |
...
- **[parser.py:432-439, 636-654] 管道操作符 |> 优先级与 Tree-sitter 完全相反** → 解析器中 PIPE 优先级高于 AND/OR，Tree-sitter 中 PIPE 优先级最低（惯例）。`a && b |> f` 两种解析器结果不同 → 调整优先级链，将管道移到最低优先级位置
  - 追问：如果同一语言有两个解析器且优先级定义完全相反，能被接受吗？→ **绝对不能。** 语法定义层面的根本矛盾。

- **[lexer.py:236-238] 字符串末尾反斜杠 + EOF 导致词法分析器崩溃** → `"hello\` 这种输入触发 IndexError，恶意输入可导致崩溃 → 跳过反斜杠后检查 EOF，按未闭合字符串处理
  - 追问：如果 GCC 遇到未闭合字符串就崩溃，能被接受吗？→ **绝对不能。** P0 级崩溃性 bug。

- **[lexer.py:284-286] 字符字面量末尾反斜杠 + EOF 同样崩溃** → 与字符串同理，`'\` 触发 IndexError → 同上修复

- **[parser.py:532-538] match 分支 guard 位置与 Tree-sitter 不一致** → 解析器：`pattern [if guard] -> body`；Tree-sitter：`pattern -> body [if guard]`。两者对同一代码理解完全不同 → 统一守卫位置（建议按 Rust 惯例：守卫在箭头之前）

- **[parser.py:764-768] ? 操作符只能应用一次，无法链式调用** → ? 的解析在 while 循环外面，`expr??`、`foo?()`、`foo?.bar` 全部语法错误 → 将 ? 移入后缀循环内部，与函数调用/字段访问同级
  - 追问：如果 Rust 的 ? 运算符不能链式使用，能被接受吗？→ **不能。** ? 是后缀运算符，应与其他后缀操作同优先级。

- **[parser.py:335-346] Fn[...] 函数类型将所有参数都视为参数类型，返回类型恒为 Unit** → `Fn[Int, Bool]` 被解析为 `(Int, Bool) -> Unit` 而非 `(Int) -> Bool` → 取最后一个类型参数为返回类型
  - 追问：如果类型语法的基本含义解析错误，能被接受吗？→ **绝对不能。** 类型系统层面的基本正确性问题。

#### 中等问题（影响特定场景）

- **[parser.py:660-678] 比较运算符和相等性运算符为左结合，应为非结合** → `a < b < c` 被解析为 `(a < b) < c`，比较布尔值与 c → 改为单次匹配（非结合）或实现链式比较
- **[parser.py:386-422] 赋值操作不是表达式，与 Tree-sitter 不一致** → 无法链式赋值，无法在表达式上下文中使用 → 将赋值纳入表达式优先级链
- **[parser.py: 多处] 几乎所有 AST 节点的 span 只覆盖第一个 token** → 错误报告高亮范围极不准确，IDE 支持差 → 每个复合节点记录起始和结束位置
- **[parser.py:522] match 分支隐式分隔存在歧义** → 负数模式 `-1` 不以 IDENT/UNDERSCORE 等开头，无法被识别为新分支 → 强制逗号分隔或加入所有模式开头 token
- **[parser.py:464-466, 968-970] <- 由两个独立 token 拼接，空白问题** → `<` 和 `-` 之间可以有空格甚至换行 → 在词法分析器中增加 LEFT_ARROW token
- **[lexer.py:155-160] 词法错误以字符串形式存储，_make_error 是死代码** → LexerError 类定义了但从未使用 → 统一使用结构化错误对象
- **[lexer.py:88] PIPE_VARIANT token 类型永远不会产生** → 死代码 → 删除
- **[parser.py:463, 474] for 循环的 iterable 字段类型不一致** → 既可以是 AST 节点也可以是 Python tuple → 创建 RangeExpr 节点
- **[lexer.py:91, parser.py:804-806] UNIT token 类型永远不会产生** → 解析器对应分支是死代码 → 删除

#### 轻微问题（代码质量）

- **[parser.py:57-62] _advance 在 EOF 处静默不推进** → 可能隐藏过度消费的 bug → 防御性编程权衡
- **[parser.py:680-687] _parse_cons_expr 函数名与实际功能不符** → 实际处理 ++ 字符串拼接，命名为 cons 易混淆 → 重命名
- **[parser.py:861-863] _is_map_literal 中空 {} 总是 map** → 空块无法表示 → 语言设计选择问题
- **[lexer.py:186-200] 无块注释（/* */）支持** → 大段注释不方便 → 语言特性选择
- **[lexer.py:202-221] 数字字面量不支持下划线、科学计数法、十六进制** → 现代语言常见功能 → 语言特性选择
- **[parser.py: 全局] 解析器无错误恢复机制** → 遇错即停，用户每次只能修一个错误 → 实现 panic mode 错误恢复
- **[parser.py:91-96] 无 REPL 单表达式解析模式** → REPL 不支持不完整输入检测 → REPL 附加功能

#### 原创性分析
- **Nova 特色**：if-then-else 使用 then 关键字彻底消除悬挂 else、lambda 使用 |params| 语法、type + alias 并列的类型定义语法
- **参考已有**：递归下降 + 优先级爬升是教科书式标准实现；ADT + 模式匹配参考 ML/Haskell 家族

---

## [2026-07-16] 错误处理 + 模块 + 环境 (errors.py / modules.py / environment.py) 第22轮审查报告
...
| 原创性 | ⭐⭐⭐ | 错误格式仿 Rust，整体架构标准 |
| 可行性 | ⭐⭐⭐ | 基本功能可用；安全性和完整性有严重缺陷 |
| 正确性 | ⭐⭐ | raise_all降级错误、符号链接重复加载、循环导入无回滚 |
| 安全性 | ⭐ | 路径遍历漏洞、任意文件读取、递归栈溢出风险 |
| 一致性 | ⭐⭐ | 错误收集器分类错误、输出顺序不对 |
| 完整性 | ⭐⭐ | 缺少文件名、错误码、模块专属错误类型 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰但深度不足 |
| 性能 | ⭐⭐⭐⭐ | 基本操作效率可接受 |
...
- **[errors.py:365-370] ErrorCollector.add() 严重程度分类完全错误** → NOTE 和 HELP 被当作 ERROR 放入 errors 列表，has_errors() 会因为一个 note 返回 True → 明确分类：ERROR 放 errors、WARNING 放 warnings、NOTE/HELP 作为附加信息
  - 追问：如果编译器的错误收集器把注释信息当成错误统计，能被接受吗？→ **绝对不能。** 错误收集器是基础设施核心组件。

- **[modules.py:49-57, 276-291] 导出名称零验证 + 静默失败** → _collect_exports 只收集名称不验证存在，get_exported_bindings 查找失败静默 pass → 模块加载完成后验证所有导出名称确实存在
  - 追问：如果 Rust 中 pub 修饰不存在的项不报错，能被接受吗？→ **不能。** 编译器最基本的语义检查之一。

- **[modules.py:124-130] 路径遍历攻击零防护——任意文件读取漏洞** → 相对导入没有沙箱限制，`../../etc/passwd` 可读任意文件 → 解析后验证路径在允许目录范围内
  - 追问：如果 Python 的 import 系统允许路径遍历读取任意系统文件，能被接受吗？→ **绝对不能。** P0 级安全漏洞。

- **[modules.py:205-213] 符号链接导致模块重复加载** → 缓存键用 abspath 不用 realpath，同一模块通过不同符号链接路径加载多次 → 使用 os.path.realpath() 作为缓存键
  - 追问：如果同一模块被加载多次导致单例失效，能被接受吗？→ **不能。** 模块缓存是模块系统正确性的基石。

- **[errors.py:405-411] raise_all() 将次级错误降级为 NOTE** → 第2到第N个错误作为 note 添加到主错误，严重程度从 ERROR 降为 NOTE → 创建复合错误类型或使用 ExceptionGroup
  - 追问：如果批量错误报告中次级错误的严重程度被降低，能被接受吗？→ **不能。** 错误严重级别降级会误导用户。

- **[environment.py:34-48, 50-61, 67-73] 环境查找递归实现有栈溢出风险** → lookup/lookup_binding/assign/all_bindings 都是递归的，深度嵌套作用域可能触发 RecursionError；all_bindings 还是 O(N²) 的 → 改为迭代实现
  - 追问：如果解释器的作用域查找会栈溢出，能被接受吗？→ **不能。** 崩溃级 bug。

#### 中等问题（影响特定场景）

- **[errors.py:157-263] 错误格式化中无文件名** → 多文件项目中错误完全不可定位 → NovaError 增加 file_path 字段
- **[errors.py 全文] 无错误码系统** → 所有错误只有文本描述，没有 E0001 式的错误码 → 建立错误码枚举
- **[modules.py:228-274] 循环导入无部分回滚机制** → 检测到循环导入时，已执行的副作用不会回滚 → 加载失败时回滚状态
- **[modules.py:328-337] 导入命名空间无冲突检测** → 多模块同名导出静默覆盖 → 导入前检查冲突并报错/警告
- **[modules.py:245, 293-299] _collect_exported_types 是死代码** → 返回值未使用，函数体与 _collect_exports 重复 → 删除或正确实现
- **[errors.py:253-258] RelatedNote 下划线长度边界问题** → end_column == column 时 ^ 数量为0，与 _compute_underline 不一致 → 添加 max(1, ...) 保护
- **[environment.py:30-32] define 允许同作用域重复定义** → 后者静默覆盖前者，无警告 → 增加重复定义检测
- **[modules.py:98-105] 默认搜索路径相对于 CWD 不稳定** → 不同目录运行结果不同 → 相对于入口文件或项目根目录计算

#### 轻微问题（代码质量）

- **[errors.py:47-48] ANSI 颜色检测只检查 stderr，不检查输出目标** → 输出到文件时可能包含 ANSI 转义序列 → format() 接受 use_color 参数
- **[modules.py:47] ModuleInfo.is_loaded 永远为 True** → 死字段 → 删除或实现完整生命周期管理
- **[environment.py:17-20] BindingInfo.name 冗余存储** → 与字典 key 重复 → 删除 name 字段
- **[errors.py:131-137] 错误位置格式不统一** → line/column 有效性校验缺失 → 入口处校验
- **[errors.py:396-398] get_all() 不按时间顺序返回** → 错误都在前、警告都在后，丢失顺序信息 → 维护统一有序列表
- **[errors.py 缺失] 无模块系统专属错误类型** → 模块错误混用 RuntimeError_ → 添加 ModuleError 等子类
- **[environment.py 缺失] 无 is_defined_locally 方法** → 必须直接访问 bindings 字典，破坏封装 → 添加方法

#### 原创性分析
- **Nova 特色**：错误系统整体架构参考 Rust rustc_errors 设计思路，Severity 枚举、RelatedNote、ErrorCollector 等概念借鉴自 Rust
- **参考已有**：模块系统（ModuleResolver + ModuleManager + loading_stack）是教科书式标准实现；环境系统（parent 指针 + 字典绑定）与 SICP 环境模型一致
...
## [2026-07-16] 所有后端 (backend/* + c_codegen.py) 第22轮审查报告

### 总体评分
| 后端 | 正确性 | 完整性 | 可用性 | 安全性 | 工程质量 | 综合评分 |
|------|:------:|:------:|:------:|:------:|:--------:|:--------:|
| native_backend | ⭐⭐ | ⭐⭐⭐ | ⭐⭐ | ⭐⭐ | ⭐⭐⭐ | ⭐⭐ |
| cranelift_backend | ⭐ | ⭐⭐ | ⭐ | ⭐⭐ | ⭐⭐ | ⭐ |
| wasm_backend | ⭐ | ⭐⭐ | ⭐ | ⭐⭐ | ⭐⭐ | ⭐ |
...
- **[native_backend.py:889-890] LIRCall 不处理返回值** → 函数调用后返回值在 RAX/XMM0 中，但没有移动到 dst_loc 指定的目标寄存器，返回值丢失 → 调用后将 RAX/XMM0 移动到目标寄存器
  - 追问：如果 OCaml 的 native 编译器函数调用后不处理返回值，能被接受吗？→ **绝对不能。** 函数调用返回值是最基本的操作。

- **[cranelift_backend.py:162-168] LIRBranch 使用硬编码的块名 block_false/block_true** → 条件分支跳转到不存在的块名，而不是 instr.true_label/false_label → 使用指令中的标签名
  - 追问：如果后端生成的控制流图完全错误，能被接受吗？→ **绝对不能。** 控制流是程序执行的骨架。

- **[cranelift_backend.py:187-188] LIRIndex 硬编码 v0+0** → 索引操作完全忽略操作数，总是从 v0 偏移 0 加载 → 正确使用 src_locs 中的基址和索引

- **[wasm_backend.py:230-232] LIRLabel 只打开 block 从不关闭** → 每个标签打开一个 block 但从不闭合，生成无效的 WAT → 正确闭合 block 嵌套

- **[wasm_backend.py:260-263] LIRBranch 只处理 false 分支** → true_label 完全被忽略，且 $block_false 是硬编码的 → 正确处理两个分支的跳转目标

- **[wasm_backend.py:284-285] LIRIndex 缺少地址操作数** → Wasm 是栈机，load 需要栈顶有地址，但代码只生成 load 指令 → 先将地址压栈再 load

- **[compiler_pipeline.py:33-35] BACKEND_NATIVE 实际使用 CraneliftBackend** → 自研 native_backend 完全没有接入编译管道 → 修正映射，接入 NativeCodeGen

- **[c_codegen.py:704-712] ADT 模式匹配字段名不匹配** → 结构体定义用单下划线（variant_field），模式匹配用双下划线（variant__field），生成的 C 代码编译失败 → 统一命名约定

- **[native_backend.py:1125-1189] LIRBuildList/Tuple/ADT 在栈上分配，指针可能逃逸** → sub rsp 分配空间后将 RSP 作为指针返回，函数返回后栈空间被回收 → 使用堆分配或确保不逃逸时才用栈分配
  - 追问：如果编译器把堆对象分配在栈上导致野指针，能被接受吗？→ **绝对不能。** 严重的内存安全问题。

- **[cranelift_backend.py:141-142] LIRLoadGlobal 无返回值关联，整个后端的 SSA 变量映射断裂** → 每条指令创建新的 vN 临时变量，但 LIR 的 src_locs/dst_loc 使用不同命名体系，操作数和结果完全无关联 → 建立位置名到 Cranelift 变量的映射表

- **[c_codegen.py:1302] Identifier 类型推断总是返回 int64_t** → 任何标识符变量（字符串、列表、函数等）都被推断为 int64_t，类型推断几乎完全失效 → 从环境中查找变量的实际类型

- **[ir/lir_lowering.py:245] MIRReturn 传递错误的类型（硬编码 UNIT_TYPE）** → 返回值类型总是 Unit，影响后端类型驱动的代码生成（如选择 RAX 还是 XMM0） → 使用实际返回类型

- **[cranelift_backend.py:141-214] 整个 Cranelift 后端的 SSA 变量映射断裂** → 所有指令的操作数和结果之间没有关联，生成的 IR 无法编译 → 建立位置名到 Cranelift 变量的完整映射

- **[wasm_backend.py: 多处] 整个 Wasm 后端结构性错误** → block 不闭合、索引无地址、分支不完整、字符串 null 终止符错误 → 需要系统性重构

- **[native_backend.py:522-526 周边] 混合 int/float 参数时栈上参数顺序可能不连续** → System V ABI 要求栈上参数按原始顺序排列，当前按类型分组可能顺序错误 → 按原始参数顺序统一压栈

#### 中等问题（影响特定场景）

- **[native_backend.py:593-605] 栈帧未保证 16 字节对齐（构建列表后调用场景）** → build_list 额外 sub rsp 后调用函数，对齐被破坏 → 动态维护栈对齐状态
- **[native_backend.py:1064-1111] LIRIndex 无数组越界检查** → 可能越界读取 → 添加边界检查
- **[native_backend.py:45-82] 线性扫描分配器不考虑 caller-saved 寄存器** → 跨函数调用的活跃变量可能被破坏 → 调用前保存 caller-saved 寄存器
- **[wasm_backend.py:161] 字符串偏移计算使用字面量 \\x00 而非 null 字节** → b"\\x00" 是 4 个字节不是 1 个 → 改为 b"\x00"
- **[cranelift_backend.py:202-214] 字符串常量生成无对应数据定义** → @str_vN 符号未定义 → 在数据段定义字符串常量
- **[cranelift_backend.py:193-197] LIRLoadReg/LIRStoreReg 处理不当** → StoreReg 直接 pass 什么都不做 → 正确实现寄存器传送
- **[wasm_backend.py:296-297] LIRStoreReg 空实现** → 变量赋值等场景失效 → 正确实现
- **[c_codegen.py:590-600] TryExpr 错误传播类型错误** → 非 ADT 返回类型的函数不能返回指针 → 检查返回类型兼容性
- **[native_backend.py:921-924] LIRPanic 直接调用 exit(1) 无错误消息** → 调试体验差 → 打印错误消息后退出
- **[compiler_pipeline.py:82] C 后端绕开 IR 优化管道** → 直接从 AST 生成代码，无法受益于 IR 优化 → 接入 IR 管道
- **[cranelift_backend.py:247-255] 函数调用参数总是 i64 类型** → 浮点参数也被当作 i64 → 根据实际类型生成
- **[native_backend.py:756-769] 除法/取模破坏 RDX 且不保存** → RDX 可能持有其他活跃变量的值 → 分配器考虑 RDX 被 idiv 占用
- **[x86_64.py:375-386] mov_mem_imm64 只写入32位立即数** → 64位立即数被符号扩展可能错误 → 函数名与行为一致或明确文档化
- **[x86_64.py:266-273] movsd_reg_reg 的 mandatory prefix 在 REX 之前** → x86-64 编码顺序应为 REX 在 mandatory prefix 之后 → 修正前缀顺序

#### 轻微问题（代码质量）

- **[x86_64.py:451-473] je_rel32 函数重复定义** → 第二个定义覆盖第一个 → 删除重复
- **[native_backend.py:714] is_float_op 使用 or 逻辑** → 应该是 and → 修正
- **[native_backend.py:870-876] FLOAT_NEG 用 0.0 - x 而非 xorps 翻转符号位** → 效率低 → 使用 xorps
- **[c_codegen.py:952] Lambda 前向声明重复** → 不必要的前向声明 → 删除
- **[wasm_backend.py:85-110] WasmGC 类型定义了但从未使用** → 名不副实 → 实际使用或重命名
- **[compiler_pipeline.py:88-107] compile_to_ir_text 不做类型检查** → 调试功能，影响有限 → 可选改进

#### 原创性分析
- **Nova 特色**：三层 IR 架构参考 MLIR 思想、自研 x86_64 指令编码器零外部依赖、多后端并行策略
- **参考已有**：栈机 VM 标准设计、C 代码生成 transpiler 常见策略、ADT+模式匹配函数式语言标准特性

---

## [2026-07-16] IR 系统 + Pass 管理器 (ir/*) 第22轮审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 三层 IR 设计合理性 | ⭐⭐⭐⭐⭐ | 分层思路正确，参考 MLIR，每层职责清晰 |
| HIR→MIR 降级正确性 | ⭐⭐ | match/for/list comprehension/unwrap 等核心结构降级错误或缺失 |
| MIR→LIR 降级正确性 | ⭐⭐ | Phi 节点降级错误，switch/match jump 丢失语义，Store/Load 不分全局局部 |
| SSA 形式完整性 | ⭐⭐ | Phi 节点定义了但不完整，可变变量处理完全破坏 SSA |
| Pass 管理器健壮性 | ⭐⭐⭐ | 有不动点循环和分层设计，但没有验证机制，没有错误恢复 |
| 常量折叠正确性 | ⭐⭐⭐ | HIR 层用 __class__ 替换很危险，覆盖范围有限 |
| 优化 Pass 有效性 | ⭐⭐ | LICM 完全错误，DCE 覆盖面不足，CSE 基本正确但只在块内 |
| 代码质量与可维护性 | ⭐⭐⭐ | dataclass 使用清晰，但 __class__ 替换是定时炸弹 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[ir/pass_manager.py:104-107] HIR 常量折叠用 __class__ 替换 + del 属性，极度危险** → 通过修改对象的 __class__ 来"转换"节点类型，dataclass 元数据不会更新，del 属性后访问会抛 AttributeError，持有引用的父节点类型混乱 → 标准 IR 替换模式：在父节点层级用新节点替换旧节点
  - 追问：如果 LLVM 的优化 pass 通过修改 vtable 来转换指令类型，能被接受吗？→ **绝对不能。** 根本性的设计错误。

- **[ir/pass_manager.py:603-607] LIR LICM 外提位置错误——指令仍在循环体内** → 将外提指令插入到 header 标签之后（每次迭代都经过），完全没有达到 LICM 效果 → 插入到 header 标签之前（循环 pre-header）
  - 追问：如果 LLVM 的 LICM 把指令外提到循环体内，能被接受吗？→ **完全不可接受。** LICM 最基础的概念都错了。

- **[ir/lir_lowering.py:221-228] MIR Phi 节点降级到 LIR 时只取第一个 source，破坏 SSA 语义** → Phi 节点的核心是"根据前驱选择值"，但这里直接取 sources[0]，无论控制流从哪来都返回第一个来源的值 → 在每个前驱块末尾将对应值 move 到 Phi 结果的位置
  - 追问：如果 LLVM 的 SelectionDAG 把 Phi 节点当成单源 move，能被接受吗？→ **完全不可接受。** Phi 是 SSA 的基石。

- **[ir/mir_lowering.py:200-204] MIR Lowering 不处理 HIRLetDecl，局部变量完全失效** → HIRBlockExpr 中的 HIRLetDecl 没有降级分支，变量名不会加入 env，后续引用返回 None → 添加 HIRLetDecl 处理分支
  - 追问：如果前端变量作用域在 IR 降级中完全失效，能被接受吗？→ **不可接受。**

- **[ir/mir_lowering.py:351-384] HIR Match 表达式降级为 MIR 时所有 arm 都变成直通** → 每个 arm 被无条件跳转串起来，第一个 arm 总是被执行，其他 arm 不可达，完全没有比较/分派逻辑 → 对字面量模式生成 MIRSwitch，对构造器模式生成 MIRMatchJump
  - 追问：如果 match 表达式总是返回第一个分支的结果，能被接受吗？→ **完全不可接受。**

- **[ir/pass_manager.py:651-655] MIR 层 LICM 的 loop_defined 只收集 header 块** → 注释写着"简化：只看 header 块"，但循环体有多个基本块，只收集 header 会导致外提错误的指令（依赖循环体内定义的值） → 先做循环分析确定循环体边界，收集所有循环内定义的 SSA 名

- **[ir/pass_manager.py:684-690] MIR 层 LICM 外提目标选择错误——可能外提到回边所在块** → 寻找"跳转到 header 的块"并插入外提指令，可能找到的是回边块（循环体内），外提仍然在循环内 → 创建或识别循环的唯一 pre-header

- **[ir/pass_manager.py:90-120] HIR 常量折叠不递归进入非 BinaryOp 表达式** → 只处理 HIRBinaryOp，对于 if/call/block/list 等内部的常量表达式永远不折叠 → 实现完整的表达式访问者模式

#### 中等问题（影响特定场景）

- **[ir/mir_lowering.py:275-283] MIR 赋值直接覆盖 env，不是真正的 SSA 形式** → 同一变量名的多次赋值使用同一个 SSA 名，分支结构中不会插入 Phi 节点 → 实现标准 SSA 构造算法（如 Braun 算法）
- **[ir/lir_lowering.py:107-119] MIRStore/MIRLoad 在 LIR 降级中全部当作全局变量** → 局部变量的加载/存储被错误地当作全局变量 → 区分全局和局部，局部变量映射到栈/寄存器
- **[ir/lir_lowering.py:248-258] LIR Switch 和 MatchJump 降级为无条件跳转** → 所有 case/variant 分支完全丢失，只跳 default → 实现比较链或跳转表
- **[ir/mir_lowering.py:404-406] HIR For 循环条件直接使用 iterable 对象作为布尔值** → for 循环的条件判断应该是迭代器 next() 的结果，不是集合对象本身 → 实现迭代器协议
- **[ir/pass_manager.py:345] LIR DCE 中 LIRBinOp 未列入无副作用指令** → 结果未使用的二元运算不会被删除，DCE 效果打折 → 加入所有纯操作类型
- **[ir/mir_lowering.py:285-289] HIR ListComprehension 降级为空列表常量** → 完全丢失了推导逻辑 → 降级为 for 循环 + append
- **[ir/mir_lowering.py:299-305] HIR UnwrapExpr（?操作符）降级为普通字段访问** → 错误传播和提前返回语义完全丢失 → 降级为分支结构（检查 tag，Err 则 return Err）
- **[ir/pass_manager.py:181-230] LIR 常量折叠不考虑控制流边界** → 线性扫描整个函数体，跨基本块的常量值可能错误 → 基本块边界感知，或使用 SSA + 支配树
- **[ir/pass_manager.py:754-766] Pass 执行顺序不合理** → 内联在常量折叠之后、DCE 在 CSE/LICM 之前 → 调整顺序：Inlining → CF → CSE → LICM → DCE
- **[ir/lir_lowering.py:188-193] MIR MapBuild 降级为 LIRBuildList，Map 语义丢失** → 后端无法区分 List 和 Map → 添加 LIRBuildMap 指令

#### 轻微问题（代码质量）

- **[ir/pass_manager.py:48] 整数除法使用地板除 //，语义可能不符** → 负数行为与 C/Java 等不同 → 根据语言规范确定
- **[ir/hir_lowering.py:97-98] HIR AliasDecl 的 target 类型未设置** → 直接设为 TYPE_VAR，丢失别名目标信息 → 保留原始类型
- **[ir/hir_lowering.py:333] HIR ConstructorPattern 中 type_name 为空** → 不同 ADT 同名 variant 无法区分 → 传入正确的 type_name
- **[ir/lir_lowering.py:245] LIR Return 返回值类型硬编码为 UNIT_TYPE** → 应该是函数的实际返回类型 → 使用实际类型
- **[ir/pass_manager.py:256-261] Inlining Pass 是空壳** → 直接 return False，但加入了默认优化管道 → 实现或移除
- **[ir/ir_nodes.py:696-701] MIRMatchJump 定义了但从未被使用** → 死代码 → 使用或删除
- **[ir/pass_manager.py 全文] Pass 管理器没有验证机制** → 每个 pass 后不检查 IR 有效性 → 添加 verify  pass
- **[ir/hir_lowering.py:302-303] 未知表达式静默返回 UnitLiteral** → 可能隐藏前端 bug → 报错
- **[ir/mir_lowering.py:307] 未知表达式静默返回 None** → 可能导致后续空字符串 SSA 名 → 报错
- **[ir/ir_nodes.py] LIR 层缺失大量必要指令** → 类型转换、移位、按位逻辑、内存加载/存储（局部）、地址计算、比较指令 → 补充必要指令

#### 原创性分析
- **Nova 特色**：三层 IR 放在同一文件用 dataclass 定义、Pass 管理器用简单不动点循环、LIR 用线性指令序列 + 标签表示 CFG
- **参考已有**：三层 IR 分层经典设计（MLIR/LLVM/SIL）、SSA + CFG 标准做法、常量折叠/DCE/CSE/LICM 标准四件套

---

## [2026-07-16] C 运行时 + 测试套件 + Tree-sitter 第22轮审查报告

### 总体评分
| 模块 | 评分 | 说明 |
|------|------|------|
| C 运行时 (nova_runtime.c) | ⭐⭐⭐ | 基础功能可用，但内存泄漏、类型混淆、安全漏洞多 |
| 测试套件 | ⭐⭐⭐ | 数量不少，但覆盖深度和交叉验证不足 |
| Tree-sitter 语法 | ⭐⭐⭐⭐ | 语法基本完整，但与 parser.py 不一致，缺少错误恢复 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[runtime/nova_runtime.c:536-538] Map value 释放时类型混淆——潜在内存损坏/段错误** → nova_map_put 更新已有 key 的 value 时，无条件地将 value 强制转换为 NovaValue* 并调用 nova_value_release，但 NovaMap 的 value 是 void* 泛型，不保证是 NovaValue* → 为 Map 增加类型标签或释放回调，或限制 Map 只存 NovaValue*
  - 追问：如果标准库的哈希表类型混淆导致段错误，能被接受吗？→ **绝对不能。** 类型安全漏洞。

- **[runtime/nova_runtime.c:479-486, 651-668] nova_list_release / nova_map_release 不递归释放元素** → 只释放数组/entry 本身，不释放元素指向的对象，嵌套结构全部内存泄漏 → List/Map 存储元素类型信息，或提供元素释放回调
  - 追问：如果语言的标准容器不负责元素内存管理，能被接受吗？→ **不能。** 对于 GC/引用计数语言，容器必须正确管理元素生命周期。

- **[runtime/nova_runtime.c:979-1296] JSON 解析器无深度限制——栈溢出 DoS** → 递归下降解析无深度检查，深度嵌套 JSON 可耗尽栈空间 → 增加 depth 字段，每次进入数组/对象时递增并检查上限
  - 追问：如果标准库的 JSON 解析器可被恶意输入弄崩溃，能被接受吗？→ **绝对不能。** 典型的 DoS 漏洞。

- **[runtime/nova_runtime.c:1031-1034] JSON 数字解析 64 字节缓冲区截断——静默精度丢失** → 超长数字被静默截断，解析出完全错误的值且无警告 → 超过缓冲区大小时返回解析错误；检查 errno

- **[runtime/nova_runtime.c:1700-1703, 1770-1772] nova_http_get / nova_http_post 状态码硬编码 200** → 使用 curl 但完全不读取 HTTP 状态码，404/500 等都返回 200 → 正确捕获并设置 status_code
  - 追问：如果 HTTP 客户端永远返回 200 OK 即使服务器报错，能被接受吗？→ **绝对不能。** 功能性完全失效。

#### 中等问题（影响特定场景）

- **[runtime/nova_runtime.c:150-166] nova_string_concat NULL+NULL 分支多 retain 一次** → 两个 NULL 时创建的新字符串 ref_count=2，永远不会被释放 → 修正 NULL+NULL 分支
- **[runtime/nova_runtime.c:213-241] nova_string_split 空分隔符行为不一致** → 空分隔符按字符拆分，与主流语言行为不同且无文档 → 明确文档化或报错
- **[runtime/nova_runtime.c:597-613] nova_map_remove 不释放 value** → 删除 entry 时只释放 key 和 entry，不释放 value，内存泄漏 → 释放 value（如果知道类型）
- **[runtime/nova_runtime.c:749-756] nova_adt_release 不释放字段** → 只释放 fields 数组，不释放字段内容，内存泄漏 → 递归释放字段
- **[runtime/nova_runtime.c:1064-1161] JSON 解析器对畸形输入无错误报告** → 遇非法字符直接 break 返回部分结果，不验证输入完整消费 → 严格错误处理
- **[runtime/nova_runtime.c:39-40] 全局状态 g_argc/g_argv/g_alloc_count 无锁** → 非线程安全 → 加锁或明确文档化为单线程
- **[runtime/nova_runtime.c:1614-1632] nova_time_format 缓冲区溢出风险** → 256 字节缓冲区可能不够用户格式字符串 → 动态分配或返回错误
- **[tests/ 全文] 无 Evaluator vs VM 行为一致性测试** → 两条路径各自有测试，但没有同一输入比较输出的测试 → 添加一致性测试框架
- **[tests/ 全文] C 后端端到端测试为零** → 只验证生成的代码包含某些字符串，从不编译运行 → 添加端到端编译运行测试
- **[tests/ 全文] Wasm/Cranelift 后端端到端测试为零** → 只验证文本输出格式 → 添加上实际执行验证
- **[tests/ 全文] 无 fuzz 测试** → JSON/Lexer/Parser 等都没有模糊测试 → 引入 fuzz 测试
- **[tests/test_c_codegen.py:146-171] test_generate_valid_c 测试名不副实** → try-except 吞掉所有错误，测试永远通过 → 正确断言

#### 轻微问题（代码质量）

- **[runtime/nova_runtime.c:959] nova_abs_int INT64_MIN 溢出** → -x 在 x=INT64_MIN 时是未定义行为 → 特殊处理或返回错误
- **[runtime/nova_runtime.c:193-196] nova_string_char_at 返回 '\\0' 无法区分错误和真实字符** → 调用者无法区分越界和字符就是 NUL → 返回错误码或带外通知
- **[runtime/nova_runtime.c:370-388] nova_list_concat NULL 参数处理不对称** → 与 string_concat 类似的引用计数问题 → 统一处理
- **[runtime/nova_runtime.c:492-499] FNV-1a 哈希使用 uint64_t 但 bucket_count 是 int64_t** → 类型转换绕 → 统一类型
- **[runtime/nova_runtime.c:1316-1321] json_buf_grow 可能无限循环（int64溢出）** → buf->cap 溢出变负导致 while 死循环 → 检查溢出
- **[runtime/nova_runtime.c:845-862] nova_read_file 大文件整数溢出** → ftell 返回 long，32 位系统上对 >2GB 文件溢出 → 使用 stat64 或平台无关方式
- **[tree-sitter-nova/grammar.js 全文] 缺少 ? try 操作符** → 与 parser.py 功能不对齐 → 添加 try_expr 规则
- **[tree-sitter-nova/grammar.js 全文] 缺少泛型类型参数 type Foo[T]** → 泛型 ADT 语法无法解析 → 添加类型参数规则
- **[tree-sitter-nova/grammar.js 全文] 列表推导没有 step 子句** → 与 parser.py 不对称 → 对齐
- **[tree-sitter-nova/grammar.js 全文] 无错误恢复（error recovery）规则** → IDE 体验差 → 添加 error 规则
- **[tests/ 全文] 边界值测试不足** → 空字符串、INT64_MIN、空列表等边界覆盖不够 → 补充边界测试
- **[tests/ 全文] 内存泄漏测试为零** → 没有 valgrind/ASAN 测试 → 添加内存正确性测试

#### 原创性分析
- **C 运行时**：引用计数 + FNV-1a 哈希 + 递归下降 JSON 解析的经典组合，标准实现无显著创新，但覆盖面全
- **测试套件**：分层清晰（lexer→parser→typechecker→evaluator→integration），组织合理
- **Tree-sitter 语法**：遵循社区最佳实践，规则命名规范，与 parser.py 系统性差异表明独立编写
...
1. **修复 HIR 常量折叠的 __class__ 替换反模式** → 可能导致运行时崩溃的定时炸弹
2. **修复 MIR Phi 节点降级只取第一个来源的问题** → SSA 基石被破坏，所有分支代码结果可能错误
3. **修复 LICM 外提位置错误（LIR 和 MIR 两层都错）** → 优化完全无效且可能引入错误
4. **修复 TRY_UNWRAP 提前返回不清理迭代器状态** → VM 资源泄漏 + 后续循环行为错乱
5. **修复闭包对可变变量的捕获语义不一致** → 函数式语言核心语义
6. **修复嵌套递归函数闭包捕获时机错误** → 嵌套递归函数完全不可用
7. **修复类型检查器 TypeVar 过于宽松导致的不健全** → 类型系统形同虚设
8. **修复模块系统路径遍历安全漏洞** → 可读取系统任意文件
9. **修复管道操作符优先级与 Tree-sitter 相反** → 语法定义层面根本矛盾
10. **修复 compiler_pipeline 中 native 后端映射错误** → 自研后端完全不可用
11. **修复 JSON 解析器无深度限制** → DoS 攻击向量
12. **修复 Map value 释放类型混淆** → 潜在段错误
13. **修复 HTTP 状态码硬编码 200** → 功能完全失效
14. **修复字符串/字符末尾反斜杠+EOF 崩溃** → 崩溃性 bug
15. **修复表达式求值无递归深度保护** → DoS 攻击向量

### 🟠 P1 级（高优先级，影响功能正确性）

16. **修复 Block 求值无 try-finally 导致的环境泄漏** → Evaluator 作用域正确性
17. **修复顶层 TRY_UNWRAP 失败后仍执行 main** → 入口点控制流语义
18. **修复 MIR Lowering 中 match/for/unwrap/list comprehension 降级错误** → 核心语言特性在 IR 层失效
19. **修复 native_backend 函数调用返回值丢失** → 最基本的功能
20. **修复 LIRBuildList/Tuple/ADT 栈分配逃逸** → 内存安全
21. **修复 ? 操作符只能应用一次（不在后缀循环内）** → 错误传播操作符核心用法
22. **修复 Fn[...] 返回类型恒为 Unit** → 类型语法核心 bug
23. **修复 ADT 模式匹配字段名不匹配（c_codegen）** → 生成的 C 代码编译失败
24. **修复 ErrorCollector 严重程度分类错误** → NOTE 被算成 ERROR
25. **修复 raise_all 错误降级为 NOTE** → 错误严重程度信息丢失
26. **修复导出名称零验证** → 模块系统核心功能缺陷
27. **修复符号链接导致模块重复加载** → 模块缓存正确性
28. **修复环境查找递归栈溢出风险** → 深层嵌套代码崩溃
29. **修复 CONTINUE/BREAK 无循环时静默失败** → 控制流基本正确性
30. **修复 match guard 位置与 Tree-sitter 不一致** → 语法规范矛盾
...
32. **实现 let 多态（泛化 + 实例化）** → 类型系统 HM 核心功能
33. **修复闭包全量捕获（自由变量分析）** → 性能和语义改进
34. **修复列表推导式不注册到 _loop_stack** → 推导式内 break/continue 行为错误
35. **修复 while 循环作用域与 for 不一致** → 语义一致性
36. **修复比较运算符左结合（应为非结合）** → a<b<c 语义错误
37. **修复错误信息缺少文件名** → 多文件项目基本要求
38. **修复错误高亮多字节字符错位** → 中文代码错误指示完全偏移
39. **修复 JSON 数字解析缓冲区截断** → 静默精度丢失
40. **修复 List/Map/ADT release 不递归释放元素** → 系统性内存泄漏
41. **修复块内 FnDef 等声明不支持** → 函数式语言基本能力
42. **修复顶层模式匹配绑定泄漏** → 作用域精确性
43. **实现 match 穷尽性检查** → 类型安全核心特性
44. **实现解析器语法错误恢复** → 开发体验基本要求
45. **实现词法分析结构化错误** → 错误报告一致性
46. **添加 Evaluator-VM 一致性测试框架** → 多后端语言基本质量要求
47. **添加 C 后端端到端测试** → 后端质量保证
48. **修复 Import 名称冲突检测不完整** → 模块系统可靠性
49. **修复 Char 类型运行时表示缺失** → 类型系统健全性
50. **实现 Tree-sitter 与 parser.py 完全对齐** → 语法一致性

### 🟢 长期规划

51. **重写 IR 降级链，实现真正的 SSA + Phi 消除**
52. **实现真正的 GC（标记-清除或分代 GC）**
53. **建立模块命名空间系统，摆脱 import * 模式**
54. **接入 Native 后端到编译管道（真正可用的方式）**
55. **实现 LSP 语言服务器支持**
56. **实现类型检查器错误恢复**
57. **添加 fuzz 测试、属性测试、边界值测试**
58. **添加端到端集成测试（所有后端）**
59. **实现 JIT 编译（基于 Cranelift）**
60. **实现调试支持（栈回溯、断点、单步执行）**
...
## [2026-07-16] 第二十三轮审查 — VM 虚拟机 (vm.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配专用指令集、TRY_UNWRAP 错误传播、for 迭代状态外置等设计有新意 |
| 可行性 | ⭐⭐⭐⭐ | 核心功能基本可用，指令集覆盖全面 |
| 正确性 | ⭐⭐ | while 循环 break/continue off-by-one、闭包多层嵌套可能不正确、字段压栈顺序存疑 |
| 安全性 | ⭐⭐⭐ | 迭代器泄漏在 finally 中有清理；闭包可变对象共享违反不可变性 |
| 一致性 | ⭐⭐ | 与 evaluator 在闭包捕获机制上存在根本性差异；MAKE_ADT 与 MATCH_CONSTRUCTOR 栈布局可能不一致 |
| 完整性 | ⭐⭐⭐⭐ | 66 个操作码全部实现，功能覆盖面广 |
| 工程质量 | ⭐⭐⭐ | 代码有较好注释，结构清晰；但散弹式修改点多、错误消息风格不统一 |
| 性能 | ⭐⭐⭐ | 纯 Python 解释器，指令分派用 if-elif 链，66 个操作码尚可接受 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [vm.py:920-924] **while 循环 BREAK 栈深度 off-by-one** → `del self.stack[base_sp + 1:]` 保留了 base_sp + 1 个元素，比正常退出多 1 个，导致 break 退出后栈上残留 body 的第一个值，栈不平衡 → 将 `base_sp + 1` 改为 `base_sp`
  - 追问：如果是 Haskell GHC 的 STG 机器栈管理有 bug，能被接受吗？→ **绝对不能。** 栈式 VM 最基础的不变式（stack invariant）破坏，OCaml 字节码解释器对每条指令的栈深度变化有严格的静态验证。

- [vm.py:949-955] **while 循环 CONTINUE 栈深度 off-by-one** → 每次 continue 都会在栈上多残留一个元素，循环 N 次后泄漏 N 个元素，最终导致栈污染和后续指令读取错误的值 → 同上，改为 `del self.stack[base_sp:]`
  - 追问：如果任何生产级语言的 continue 导致栈泄漏，能被接受吗？→ **绝对不能。** 这是典型的栈上溢 bug，会导致难以调试的内存安全问题。

- [vm.py:967-976] **CLOSURE 捕获整个局部帧而非自由变量** → 每次创建闭包都 dict 浅拷贝所有局部变量，时间 O(n)，且阻止 GC 回收不需要的变量；更严重的是多层嵌套函数无法访问外层函数的变量（内层闭包只捕获当前帧 locals，没有父链） → 编译器做闭包转换计算自由变量，CLOSURE 指令携带自由变量名列表，VM 只捕获指定变量；嵌套闭包需沿调用链向上查找
  - 追问：如果 OCaml 的闭包捕获了整个作用域的 dict 拷贝，性能影响能被接受吗？→ **绝对不能。** 内存使用量可能增加 10-100 倍，完全抵消函数式语言性能优势。

- [vm.py:1276-1294, 1357-1365] **MAKE_ADT 与 MATCH_CONSTRUCTOR 的字段栈顺序相反** → MAKE_ADT 期望栈上从深到浅是 field_0, field_1, ..., field_n-1（因为 _pop 会反转为正序）；而 MATCH_CONSTRUCTOR 弹出 subject 后用 reversed(subject.fields) 压栈，即 field_n-1 在栈底、field_0 在栈顶。两者栈布局相反，会导致模式匹配字段顺序错误 → 统一栈上字段顺序，建议 VM 在 MATCH_CONSTRUCTOR 中不要 reversed，直接按正序压栈
  - 追问：如果是 OCaml 的编译器，数据构造和解构的顺序不一致，能被接受吗？→ **绝对不能。** 这是数据构造/解构的基本一致性问题。

- [vm.py:1416-1435] **顶层代码 TRY_UNWRAP 提前返回后栈状态不一致** → 顶层 `?` 遇到 None/Err 时设置 early_return 并 break，但错误值仍留在栈顶，用户永远不会知道发生了什么 → 顶层 TRY_UNWRAP 失败时抛出 RuntimeError_ 或将错误值作为结果返回
  - 追问：如果是 Haskell 的 Maybe monad 在顶层静默丢失错误，能被接受吗？→ **不能。** 错误值绝不能静默丢失。

- [vm.py:1173-1182] **顶层模式匹配不做局部变量快照/恢复** → 顶层 match 的 arm 中绑定的变量会泄漏到全局作用域，与函数内 match 的作用域语义不一致 → 顶层也应该有 match_snapshots 机制
  - 追问：如果 OCaml 的 match 绑定泄漏到外层作用域，能被接受吗？→ **不能。** 模式匹配的变量绑定作用域必须明确。

#### 中等问题（影响特定场景）

- [vm.py:188-228] **绝大多数内置函数缺少类型检查和参数数量检查依赖层过多** → str_len/list_length 等对非序列参数崩溃；sqrt/log 不验证值域；许多内置函数依赖 Python 鸭子类型，传入错误类型时静默产生错误结果或抛出 Python 原生异常 → 每个内置函数入口处添加 isinstance 类型检查，失败时抛出 RuntimeError_

- [vm.py:249-251] **`_builtin_filter` 用 `is True` 做谓词判定过于严格** → 使用身份比较（identity）而非值比较，如果谓词函数返回 truthy 的非布尔值，会被当作 False 过滤掉 → 添加类型检查确保谓词返回 bool，然后直接使用真值判断

- [vm.py:191] **`read_line` 内置函数实现怪异** → `a == ()` 检查空元组毫无意义；input() 读取真实 stdin 与 print 收集到 output 的行为不一致 → 实现为正式方法，与 print 对称设计，提供输入注入机制便于测试

- [vm.py:987-992] **RETURN 指令在不同执行上下文中语义不同** → 函数内 RETURN 被 _execute_function 提前拦截，顶层 RETURN 会到达 _execute_instruction 设置 return_flag。同一操作码语义不同是维护噩梦 → 明确区分函数内 RETURN 和顶层 RETURN，或统一语义

- [vm.py:1088-1089, 1132-1133] **`_for_iters` 检测"首次迭代"的启发式方法脆弱** → 通过检查"最内层 for 循环的 loop_start 是否等于当前 FOR_ITER 指令位置"来判断是否首次迭代，依赖位置启发式而非显式 ID → 编译器应在 FOR_ITER 中携带一个循环 ID 操作数，VM 用这个 ID 来查找/创建迭代状态

- [vm.py:579-584] **`_pop(0)` 返回空列表但不检查下溢** → n == 0 时下溢检查永远通过，虽然调用 _pop(0) 无意义，但缺少防护 → 低优先级优化，可添加断言

- [vm.py:858-861] **JUMP 中更新 loop_start 的逻辑可能不可靠** → 通过"向前跳 + 当前在 while 循环中"推断是循环回跳，启发式方式在嵌套循环中可能出错 → 使用编译器提供的显式标记

#### 轻微问题（代码质量）

- [vm.py:742-743] DIV 整数除法使用 `//`（向下取整），与 C 语言的向零截断不同，应在规范中明确
- [vm.py:1084-1085, 1128-1129] `_range_index` 和 `_list_index` 延迟初始化，到处都是 hasattr 检查，应在 `__init__` 中初始化为空字典
- [vm.py:100-106] `NovaPartialBuiltin` 的 arity 可能变为负数（captured_args 超过 builtin.arity）
- [vm.py: 多处] 错误消息中英文混杂（部分中文部分英文）
- [vm.py:655, 669] JUMP_IF_FALSE 和 POP_JUMP_IF_FALSE 实现完全相同，可合并

#### 原创性分析

**Nova VM 的设计亮点：**
1. **模式匹配专用指令集**（MATCH_START/MATCH_ARM_START/MATCH_TEST_*/MATCH_CONSTRUCTOR/MATCH_END）：不同于简单的比较+跳转序列，Nova 设计了专门的模式匹配指令家族，并通过 match_stack_bases 和 match_snapshots 机制统一管理失败时的栈恢复和作用域清理
2. **TRY_UNWRAP 指令的早期返回机制**：通过 _execute_instruction 返回 bool 信号 + return_flag 的组合实现 `?` 操作符，避免了异常机制的开销
3. **for 循环迭代状态外置**：_range_index / _list_index 字典保存迭代进度，而非将迭代器压栈，将可变状态与操作数栈分离
4. **while 循环结果槽模式**：编译时压入 CONST_UNIT 作为结果槽，每次迭代用 body 值替换之，优雅地实现了"循环有返回值"的函数式语义

**借鉴/常见设计**：栈式 VM 架构、闭包 + 部分应用、ADT + 模式匹配、管道操作符均为 ML 家族语言标准设计

---

## [2026-07-16] 第二十三轮审查 — 编译器 (compiler.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配专用指令集、ADT 原生支持、PIPE_CALL 等设计体现函数式语言独特考量 |
| 可行性 | ⭐⭐⭐⭐ | 栈式 VM 设计成熟可行，指令集覆盖了语言主要特性 |
| 正确性 | ⭐⭐⭐ | 栈布局和跳转回填基本正确，但闭包语义、模式匹配回退等存在严重问题 |
| 安全性 | ⭐⭐⭐ | 类型检查在编译期外，字节码层面基本无类型安全保障 |
| 一致性 | ⭐⭐⭐ | 大部分设计一致，但 for 循环 vs 列表推导式的 loop_stack 处理、管道 vs 普通调用的内置函数路径不一致 |
| 完整性 | ⭐⭐⭐ | 核心特性都实现了，但缺少 PatternOr、PatternRecord、尾调用优化等函数式语言标配 |
| 工程质量 | ⭐⭐ | 存在明显死代码（66行死方法 + 死操作码）、冗余分支、`id()` 非确定性命名等问题 |
| 性能 | ⭐⭐ | 纯解释执行、无 TCO、闭包全量捕获、无 JIT，性能预期较低 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [compiler.py:403, vm.py:967-976] **闭包过度捕获 + 按值捕获可变变量** → CLOSURE 指令捕获当前帧的全部局部变量且是按值快照，导致：1) 内存浪费；2) 对 mut 变量的赋值在闭包调用间不持久，也不影响外部作用域 → 实现自由变量分析，CLOSURE 指令增加 free_vars 操作数；对于 mut 变量捕获需要引入间接层（ref cell）
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 闭包是函数式语言的核心语义，OCaml 中闭包精确捕获自由变量，引用（ref）捕获后内外可见。

- [compiler.py:858-859, 898-899] **未知模式类型静默回退——编译器无声失败** → `_compile_pattern_test_with_fail` 和 `_compile_pattern_extract_and_bind` 的 else 分支对未知模式分别返回空列表（恒匹配）和直接 POP。如果新增 Pattern 类型但忘记添加处理分支，编译器不会报错而是产生静默语义错误 → 将 else 分支改为抛出 RuntimeError，与 _compile_expr 末尾的处理方式一致
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** OCaml 的模式匹配编译器是 exhaustiveness 检查的典范，每个模式构造子都有完备的编译路径。

- [compiler.py:491-507] **break/continue 不在循环中无编译期报错** → 当 _loop_stack 为空（不在任何循环中）时，代码走 else 分支直接发出无操作数的 BREAK/CONTINUE，错误要到运行时才会被 VM 抛出 → 在 BreakExpr 和 ContinueExpr 编译时检查 _loop_stack 是否为空，为空则抛出编译错误
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能。** 结构错误必须在编译期捕获，OCaml 在类型检查阶段就会报告 "Break not in loop" 类错误。

#### 中等问题（影响特定场景）

- [compiler.py:901-966] **死代码 `_compile_pattern_test` 和 `_compile_pattern_bindings`** → 两个方法共约 66 行从未被调用，且其中逻辑是错误的（PatternTuple/PatternList 被当作 MATCH_WILDCARD 处理） → 删除这两个死方法

- [compiler.py:75, vm.py:1437-1441] **死操作码 LOOP** → Op.LOOP 在编译器中定义了，VM 中也有处理逻辑，但 compiler.py 中从未 emit 过 → 删除无用操作码或补充文档

- [compiler.py:600-603] **管道编译中内置函数检查是死分支** → if/else 两个分支完全相同（都 emit LOAD_VAR），与 _compile_fn_call 中内置函数走 CALL_BUILTIN 的策略不一致 → 删除冗余的 if 判断，或实现管道版本的内置函数调用优化

- [compiler.py:1092-1153] **列表推导式未加入 `_loop_stack`** → _compile_list_comprehension 中有自己的 FOR_ITER / LOOP_END 循环结构，但没有 push 到 _loop_stack。虽然 VM 端恰好能工作（因为 FOR_ITER 会添加到 _for_iters），但设计不一致 → 在 _compile_list_comprehension 中也 push/pop _loop_stack

- [compiler.py:364-369] **模块导入名称冲突检测不完整** → 只检查了 bytecode.functions 和 _builtin_names，没有检查顶层 let/mut 绑定的变量名 → 编译器维护一个已绑定名称集合，在冲突检测中检查这个集合

- [compiler.py:675] **Lambda 名称使用 `id()` 导致不确定性** → Python 的 id() 返回内存地址，每次运行可能不同，导致字节码 dump 输出不可重现、测试可能不稳定 → 使用递增计数器替代 id()

- [compiler.py:996, 1094] **ForExpr.iterable 类型混乱（AST 节点 vs tuple）** → 用 ("range", start, end, step) 元组表示 range 是一种"无标签联合"的 hack，破坏了类型安全性 → 定义一个 RangeExpr AST 节点

#### 轻微问题（代码质量）

- [compiler.py:421-422] CharLiteral 编译为 CONST_STRING，Char 类型在 VM 层不存在
- [compiler.py:432-434] "None" 标识符特判与其他零字段构造器不一致
- [compiler.py:1015-1019] for 循环的 break_patches 字段永远为空
- [compiler.py:198-206] patch_match_fail 依赖操作数数量推断结构，应根据 opcode 名称显式判断
- [compiler.py:385-386] 无尾调用优化（TCO），对于函数式语言是重要特性缺失

#### 原创性分析

**Nova 字节码的独特设计：**
1. **模式匹配专用指令集**：一整套 MATCH_* 指令，将模式匹配作为 VM 一等公民，VM 端的 _pattern_fail_cleanup 统一栈恢复机制很有想法
2. **统一循环抽象**：FOR_ITER + LOOP_END 组合同时支持列表迭代和范围迭代
3. **管道专用指令**：PIPE_CALL 指令专门处理管道操作符的参数重排
4. **ADT 原生支持**：MAKE_ADT、REGISTER_CTOR、MATCH_CONSTRUCTOR 等指令让 ADT 成为 VM 原生概念
5. **TRY_UNWRAP 提前返回**：`?` 操作符通过 TRY_UNWRAP 指令实现，利用返回值标志位实现函数级别的提前返回

---

## [2026-07-16] 第二十三轮审查 — 求值器 (evaluator.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 自主设计的函数式语言解释器，`?` 错误传播、for-as-expression 等特性有自己的设计思路 |
| 可行性 | ⭐⭐⭐⭐ | 整体架构清晰，AST → 求值器模式经典可行 |
| 正确性 | ⭐⭐⭐ | 核心功能基本正确，但闭包语义前后端不一致、运行时错误逃逸、顶层 `?` 崩溃等严重问题 |
| 安全性 | ⭐⭐⭐ | 缺少类型安全保障，运行时类型检查不完整（Python 异常逃逸） |
| 一致性 | ⭐⭐ | 前后端闭包语义不一致、运算类型不一致、eval_decl 单遍 vs eval_program 两遍不一致 |
| 完整性 | ⭐⭐⭐⭐ | 覆盖了主要语言特性：字面量、运算、函数、闭包、模式匹配、ADT、列表推导、循环、模块系统等 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，但有重复逻辑、缺少注释、命名规范尚可 |
| 性能 | ⭐⭐ | 纯树遍历解释器，递归深度限制 1000，无尾递归优化 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [evaluator.py:950-953] **取模运算除零未捕获 Python 异常** → `%` 操作缺少除零检查，right == 0 时 Python 的 ZeroDivisionError 直接向上抛出，不会被包装为 RuntimeError_，导致程序以 Python 原生 traceback 崩溃 → 为 `%` 添加除零检查，与 `/` 保持一致
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能接受。** 任何生产级编译器必须将所有运行时错误统一包装，不能让宿主语言异常泄漏。

- [evaluator.py:930-977] **二元运算类型错误未统一捕获，Python TypeError 直接逃逸** → `+`, `-`, `*`, `/`, `%` 等算术运算只检查了 Bool 类型，但没有检查操作数是否为数值类型。`1 + "hello"` 会触发 Python TypeError 直接逃逸 → 在每个运算前检查类型兼容性，或用 try/except TypeError 包裹
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 类型安全语言的运行时错误必须全部通过语言自身的错误系统报告。

- [evaluator.py:734-745] **顶层 `?` 操作符（TryExpr）会导致未捕获的 ReturnSignal** → ReturnSignal 只在 _call_fn 中被捕获，如果 `?` 出现在顶层代码（不在函数内），会一路向上到 eval_program 而不被捕获 → 在 eval_program 和 eval_expr 的顶层 catch ReturnSignal 并转换为有意义的 RuntimeError_
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** `?` 操作符的使用范围应有编译期保证，即使在解释器中也应该给出明确的错误信息。

- [evaluator.py:49-53, 754-760, 444-446] **闭包捕获语义与 VM 不一致（引用 vs 值语义）** → Evaluator 闭包捕获整个环境链的引用（引用语义，闭包内外 mutable 变量共享），VM 捕获当前帧局部变量的快照副本（值语义，闭包内外不共享）。这是根本性的语义差异 → 统一语义，推荐采用引用语义（与 OCaml 一致），VM 需要修改为通过环境指针/引用捕获
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能接受。** 闭包语义是函数式语言的核心语义，两种后端必须一致。

- [evaluator.py:444-466] **VM 闭包中 mutable 变量的修改不共享** → VM 中 `locals_ = dict(closure.captured_vars)` 是值拷贝，闭包体内对 mutable 捕获变量的修改只会修改当前帧的 locals，不会写回到闭包的 captured_vars → 统一采用引用语义，VM 中闭包的 captured_vars 应该通过引用共享

#### 中等问题（影响特定场景）

- [evaluator.py:930-953] **Int/Float 隐式类型转换** → 算术运算对 Int 和 Float 混合运算时，Python 会隐式转换为 Float，与 Nova "强静态类型" 的设计理念不一致 → 在类型检查阶段禁止混合类型运算

- [evaluator.py:331-380] **数学内置函数一律返回 Float** → abs, floor, ceil, round, min, max 等函数通过 _to_float 将输入转为 float，即使输入是 Int 也返回 Float → 对 Int 输入返回 Int，对 Float 输入返回 Float（或两个不同函数）

- [evaluator.py:1052-1086] **列表推导式中 break/continue 未处理** → _eval_list_comprehension 没有捕获 BreakSignal 和 ContinueSignal，如果列表推导式体内出现 break/continue，信号会逃逸到外层循环 → 添加 try/except 捕获 BreakSignal/ContinueSignal 并报错

- [environment.py:30-32] **同一作用域内变量重定义静默覆盖** → Environment.define 直接覆盖同名绑定，没有任何警告 → 在函数式语言中，shadowing 通常合法但应有警告

- [evaluator.py:702-703] **Char 与单字符 String 运行时无法区分** → Char 和 String 在运行时都是 Python str，单字符 String 在模式匹配中会被当作 Char 匹配 → 运行时使用独立的 Char 包装类型

- [evaluator.py:578-633] **eval_decl 与两遍扫描逻辑重复** → eval_decl 方法重复了 _collect_decl + _eval_decl_body 的逻辑，但只做了单遍扫描，导致通过 eval_decl 定义的函数不能相互递归 → 去重，统一使用 eval_program 的两遍扫描机制

#### 轻微问题（代码质量）

- [evaluator.py:390-391] _format_value 中 Python None 被格式化为 "null"，与 Nova Option.None 容易混淆
- [evaluator.py:101-106] UNIT_VALUE 与 VM 的 UNIT 类型不统一（不同类实例）
- [evaluator.py:808-811] Assignment 错误重新包装无意义（捕获 RuntimeError_ 后再抛出同样类型）
- [evaluator.py:324] JSON 转换中 dict 键强制转 str，反序列化时会丢失键的类型信息

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获方式 | 环境链引用（引用语义） | 局部变量值快照（值语义） | ❌ |
| mutable 闭包变量共享 | 闭包间双向共享 | 每次调用复制，不共享 | ❌ |
| Unit 值类型 | _UnitValue 类 | UNIT_TYPE 单例 | ❌（轻微） |
| 除零错误（% 运算） | Python ZeroDivisionError 逃逸 | 正确捕获为 RuntimeError_ | ❌ |
| Int/Float 混合运算 | 隐式转 Float | 隐式转 Float | ✅（同一设计问题） |
| break/continue 实现 | 异常信号 | 状态栈 | ✅（行为等价） |
| 模式匹配变量作用域 | child_env 子环境 | match_snapshots 快照恢复 | ✅（行为等价） |
| 变量作用域层级 | 多级链（任意深度） | 两级（局部+全局） | ⚠️（编译器负责扁平化） |
| 顶层 `?` 操作 | ReturnSignal 未捕获 → 崩溃 | TRY_UNWRAP 设置 early_return | ❌ |
| for 迭代方式 | 预计算全部元素 | 逐次迭代 | ✅（结果等价） |

#### 原创性分析

**Nova Evaluator 的原创设计：**
1. **双后端设计**：同时有树遍历求值器 + 栈式虚拟机，双轨验证思路有工程价值
2. **`?` 错误传播**：借鉴 Rust 的问号操作符，在函数式语言中融入命令式错误传播语法
3. **for-as-expression**：将 for 循环作为表达式返回列表，融合命令式循环和函数式列表操作
4. **两遍扫描**：eval_program 的两遍扫描支持前向引用和相互递归，是成熟设计
5. **管道操作符 + 列表推导 + ADT 模式匹配**的组合，在一门语言中集成了现代函数式语言的主要特性


---

## [2026-07-16] 第二十三轮审查 — 类型检查器 (type_checker.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 架构上借鉴了 HM 类型系统的术语和外观，但核心算法未实现合一。管道运算符、ADT 字段访问等特性有自己的设计 |
| 可行性 | ⭐⭐⭐ | 对于有类型标注的代码，可以做基本的类型检查。对于无标注代码，类型检查基本失效 |
| 正确性 | ⭐⭐ | 核心问题：没有合一，TypeVar 与任何类型兼容。这导致大量应该报错的代码通过了检查 |
| 安全性 | ⭐⭐ | 错误类型有一定级联防护，但类型系统的核心保证（well-typed programs cannot go wrong）不成立 |
| 一致性 | ⭐⭐⭐ | 大部分代码风格统一，但有几处不一致：TypeVar 函数调用绕过 _report_error、List/Map 硬编码特殊处理 |
| 完整性 | ⭐⭐ | 覆盖了基本类型语法的类型检查，但每个特性都有深度不足。缺少：真正的合一、let 泛化、穷尽性检查、递归类型正确处理 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，两遍扫描设计合理，有错误收集器基础设施。但缺少类型系统的核心数据结构 |
| 性能 | ⭐⭐⭐⭐ | 当前实现没有复杂算法，性能不是瓶颈 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [type_checker.py:1401-1429] **非完整 Hindley-Milner，无合一（unification）机制** → 当前"类型推断"不是真正的 HM 算法。只有 `_collect_type_bindings` 单向收集绑定和 `_types_compatible` 中 TypeVar 一律放行（只要任一方是 TypeVar 就返回 True）。没有合一、没有 occurs check、没有约束求解。例如 `fn f(x) { x + 1; x ++ "hello" }` 不会报错，尽管 x 不可能同时是 Int 和 String → 实现基于 union-find 的合一算法（Algorithm W），`_types_compatible` 替换为 `unify(t1, t2)` 函数
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 这相当于类型系统的核心引擎缺失。OCaml 的 type_expr 有完整的 union-find 合一结构。

- [type_checker.py:820-830, 535-546] **无 let-polymorphism（Damas-Hindley-Milner let 泛化）** → let 绑定直接将值的类型注册到环境，没有泛化步骤。`let id = fun x -> x in id 1 + id "a"` 这种在真正 HM 系统中合法的代码，在 Nova 中不是通过正确的多态机制实现的，而是通过"每次调用新建 binding 表"的巧合实现的 → 实现 `generalize(ty, env)` 和 `instantiate(ty)` 函数，这是 Algorithm W 的标准步骤
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** let-polymorphism 是 HM 类型系统的定义性特征。

- [type_checker.py:293-307] **内置 Option/Result 的构造函数类型变量是全局共享的，导致类型污染** → `_setup_builtins` 中创建的 `t_opt = TypeVar("opt_t")` 是全局共享的单一对象。每次使用 Some 都会使用同一个 TypeVar 对象。一旦实现真正的合一，全局共享的类型变量会导致严重 bug → 内置构造函数应存储为类型方案（type scheme），每次使用时调用 instantiate() 生成新鲜的类型变量副本
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能。** OCaml 中每个多态值的使用都会实例化新鲜的类型变量。

- [type_checker.py:699-711] **完全没有模式匹配穷尽性检查** → MatchExpr 只检查模式类型是否匹配和返回类型是否一致，完全没有穷尽性检查、冗余分支检查、无用分支检查。`match Some(42) { Some(x) -> x }` 缺少 None 分支不会报错 → 实现基于 Maranget 算法的穷尽性检查，简单情况下至少检查构造器集合是否完整
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** OCaml 默认开启穷尽性检查和冗余分支警告，这是模式匹配类型安全的核心保障。

- [type_checker.py:762-772] **高阶函数参数类型完全不检查** → 当被调用者类型是 TypeVar 时（比如一个没有类型标注的函数参数），直接放行并返回新的 TypeVar。完全无类型标注的高阶函数参数可以任意使用，类型检查完全失效 → 实现合一后，TypeVar 分支应将调用者类型与 FnType(arg_types, ret_TyVar) 进行合一

- [type_checker.py:1086-1103] **Pattern 类型检查使用 _types_compatible，TypeVar 一律放行** → 所有字面量模式都调用 `_types_compatible(subject_type, INT_T)` 等。当 subject 类型是类型变量时，任何模式都能通过检查 → 用合一替代 _types_compatible

#### 中等问题（影响特定场景）

- [type_checker.py:762-772] **TypeVar 函数调用绕过 `_report_error` 直接写入收集器** → 绕过了统一的错误报告路径，意味着即使 collect_errors=False，这个错误也只是被收集而不抛出 → 统一使用 _report_error 报告所有错误

- [type_checker.py:1347-1354] **TypeGeneric 中对 List/Map 的特殊处理绕过了 ADT 机制** → List 和 Map 被当作特殊情况，直接返回 ListType 和 MapType，而不是 ADTType。用户不能定义名为 List 或 Map 的 ADT，且 List/Map 不能用构造器模式匹配 → 将 List 和 Map 实现为内置 ADT，或在类型检查中统一处理

- [type_checker.py:437] **ADT 字段中引用自身时，类型参数可能不匹配** → 解析 ADT 字段类型时，如果字段类型引用了当前正在定义的 ADT 本身，解析出的 TypeVar 对象与 local_types 中的不是同一个对象。当前实现下不构成问题（因为 TypeVar 比较用名字），但一旦实现基于 union-find 的合一就会出错 → 解析 ADT 字段类型时，如果遇到对当前 ADT 的引用，使用 local_types 中已有的 TypeVar 对象

- [type_checker.py:463-465] **顶层 let 绑定使用命名 TypeVar 占位** → 第一遍遍历时，没有类型标注的顶层 let 被赋予一个命名的 TypeVar 占位。第一遍和第二遍之间，其他函数引用这个 let 绑定时类型检查完全失效 → 改进两遍扫描策略，确保签名在第一遍就被正确确定

- [type_checker.py:988] **ForExpr 中 iterable 是 tuple 的硬编码** → 用 ("range", start, end, step) 元组表示特殊形式，而不是用专用的 AST 节点类型。类型检查器需要知道这个内部约定，耦合度过高 → 定义专门的 AST 节点（如 RangeExpr）替代 tuple hack

- [type_checker.py:262] **collect_errors 默认关闭** → 默认行为是遇到第一个错误就抛出，不继续检查。ErrorCollector 基础设施存在但默认不使用 → 考虑默认开启错误收集，提升用户体验

#### 轻微问题（代码质量）

- [type_checker.py:1401-1429] _types_compatible 重复了 __eq__ 的逻辑
- [type_checker.py:169-176] TypeVar 计数器是类变量，跨实例共享，多线程环境下有竞态条件
- [type_checker.py:1213-1217] 比较操作符 < > <= >= 不支持 String/Char 比较
- [type_checker.py:975-979] TryExpr 硬编码检查 type_name == "Result" 和 "Option"，用户 shadow 这些名字会出错

#### 原创性分析

**Nova 类型检查器的原创性体现在：**
1. **"简化版 HM"的取舍设计**：作者了解 HM 术语，但有意识地做了简化——用 _collect_type_bindings + _substitute_type_vars 的"伪合一"替代真正的 union-find 合一
2. **ADT 字段访问的"公共字段"机制**：允许对 ADT 值直接进行字段访问，只要所有变体都有同名字段且类型相同，这是对传统函数式语言的一种改良
3. **管道运算符与部分应用的结合**：管道操作符的类型检查考虑了部分应用
4. **TypeVar 函数调用的"温和策略"**：对类型未确定的函数调用不是直接报错，而是记录错误但放行

---

## [2026-07-16] 第二十三轮审查 — 词法/语法分析器 (lexer.py / parser.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 综合了多种语言特性，但核心设计均有参考来源，缺乏突破性的原创概念 |
| 可行性 | ⭐⭐⭐⭐ | 递归下降解析器的基本架构是可行的，大部分语法结构有清晰的实现路径 |
| 正确性 | ⭐⭐⭐ | 基本功能正确，但存在多个严重问题：字段命名不一致、无错误恢复、缺少多行注释和多进制数字等 |
| 安全性 | ⭐⭐⭐ | 词法错误有基本的恢复（跳过非法字符），但语法错误无恢复；未知转义字符静默忽略是隐患 |
| 一致性 | ⭐⭐ | Token.end_col vs Span.end_column 命名不一致；PIPE_VARIANT 死代码；UNIT token 不生成 |
| 完整性 | ⭐⭐ | 缺少多行注释、十六进制/二进制数字、Unicode 转义、return 语句、复合赋值、错误恢复等基本功能 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，注释充分，有测试覆盖。但命名不一致、死代码、手动位置回退等问题降低了工程质量 |
| 性能 | ⭐⭐⭐ | 递归下降解析器的时间复杂度是线性的，但 _is_map_literal 的前瞻扫描在最坏情况下是 O(n²) |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [ast_nodes.py:42, lexer.py:107] **Span 与 Token 字段名不匹配** → `Span` 类使用 `end_column`，`Token` 类使用 `end_col`。虽然位置传参碰巧正确，但命名不一致导致维护困难，关键字参数传参会出错 → 统一命名，建议都改为 end_column
  - 追问：如果 GCC 或 Clang 的基础数据结构字段命名不一致，能被接受吗？→ **不能接受。** 基础数据结构的字段命名必须一致，否则后续维护会产生大量难以发现的 bug。

- [lexer.py:186-200] **无多行注释支持** → 只支持 `//` 单行注释，完全不支持 `/* */` 多行注释 → 添加 `/* */` 多行注释支持
  - 追问：如果 GCC 或 Clang 的词法分析器不支持多行注释，能被接受吗？→ **不能接受。** 多行注释是现代语言的基本配置。

- [lexer.py:202-221] **数字字面量不支持十六进制/八进制/二进制** → 只处理十进制整数和浮点数，完全不支持 0x、0o、0b 格式 → 添加 0x/0o/0b 前缀支持
  - 追问：如果 GCC 或 Clang 的词法分析器不支持十六进制数字，能被接受吗？→ **不能接受。** 所有主流编译器都支持多种进制的整数字面量。

- [parser.py:871-889] **`_is_map_literal` 前瞻扫描区分 map 和 block 的方式脆弱** → 依赖"顶层出现 => 就是 map"的启发式规则，如果将来语言增加了用到 => 的其他语法就会出问题 → 重新设计 map 字面量语法，使用明确的前缀（如 #{ k => v }）从语法根源消除歧义
  - 追问：如果 GCC 或 Clang 使用前瞻扫描来消除语法歧义，能被接受吗？→ **不能接受。** GCC/Clang 使用明确的语法规则来消除歧义，而不是依赖前瞻扫描 token 流。

- [parser.py: 整体] **语法错误恢复能力极弱** → Parser 遇到第一个语法错误就直接抛出 ParseError 异常，完全没有错误恢复机制。现代编译器（GCC, Clang, Rustc）都能在遇到语法错误后尝试恢复 → 实现基本的错误恢复策略，如 panic mode（在同步点如 ;、}、换行处恢复）
  - 追问：如果 GCC 或 Clang 遇到第一个语法错误就停止，能被接受吗？→ **不能接受。** 批量错误收集和错误恢复是现代编译器的标配。

#### 中等问题（影响特定场景）

- [lexer.py:246-257] **字符串转义序列不支持 Unicode 转义** → 只支持 \n, \t, \r, \\\\, \\\" 五种转义，未知转义字符直接保留原字符（不报错） → 添加 \u{XXXX} Unicode 转义支持，未知转义序列应产生警告或错误

- [lexer.py:275-324] **字符字面量错误恢复方式不佳** → 遇到错误时直接调用 `return self._next_token()`，跳过整个剩余的字符字面量内容，可能导致级联错误 → 遇到字符字面量错误时向前扫描直到找到闭合的 ' 或换行/EOF

- [parser.py:422-428] **赋值仅支持简单标识符** → 赋值目标只能是简单标识符，不支持索引赋值、字段赋值、元组解构赋值 → 扩展赋值目标语法

- [lexer.py:91] **UNIT token 类型定义了但从未被生成** → TokenType.UNIT 在枚举中定义，但 lexer 中从未生成，parser 中检查也永远不会匹配 → 移除 TokenType.UNIT，由 parser 处理空括号

- [lexer.py:69, 88] **PIPE 和 PIPE_VARIANT 是同一个字符的两种语义** → PIPE_VARIANT 从未被生成，是死代码 → 移除 PIPE_VARIANT token 类型

- [parser.py:470-472] **for 循环的 <- 语法由两个 token 拼接而成** → <- 没有作为独立 token 存在，而是由 < 和 - 拼接，中间有空格也能被解析 → 在 lexer 中添加 LEFT_ARROW (<-) token

- [parser.py:133-136] **export 语法过于简单** → 只能导出单个标识符，不支持导出多个名称、重命名导出、直接在定义前导出 → 扩展 export 语法

#### 轻微问题（代码质量）

- [lexer.py:326-350] 标识符只支持 ASCII，不支持 Unicode 标识符
- [lexer.py:341-343] _read_identifier 中 BOOL 关键字的特殊处理多余（两个分支返回语句完全一样）
- [ast_nodes.py:219-225] MatchArm 没有 span 字段，影响错误报告的位置准确性
- [lexer.py: 缺少] 缺少 return 关键字和对应的解析逻辑
- [parser.py:678-684] 比较运算符链式解析无歧义检查（a < b < c 会被解析为 (a < b) < c）

#### 原创性分析

**语言设计层面**，Nova 明显参考了 Rust（ADT、模式匹配、`?` 操作符、错误处理哲学）、Elixir/F#（管道操作符）、Python（列表推导式、for/in 循环）、TypeScript/Haskell（泛型语法）等语言。没有发现明显的原创语言特性或突破性的语法设计。

**实现层面**，递归下降解析器是标准实现，`_is_map_literal` 前瞻扫描是比较有特色的实现方式，但不是首创。错误报告系统的 Rust 风格多行高亮 + ANSI 颜色是当前潮流，实现质量不错但不是原创。

---

## [2026-07-16] 第二十三轮审查 — 错误处理 + 模块 + 环境 (errors.py/modules.py/environment.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 整体架构是标准编译器设计，亮点是中文错误信息和类 Rust 的源码上下文格式 |
| 可行性 | ⭐⭐⭐ | 核心机制可行，能跑通基本流程。但 ErrorCollector 只在类型检查阶段生效 |
| 正确性 | ⭐⭐ | 多处不一致：LexerError 定义了但不用、模块导出不验证存在性、define 允许静默覆盖 |
| 安全性 | ⭐⭐ | 模块系统无沙箱，闭包可能导致内存泄漏，全局单例无线程安全 |
| 一致性 | ⭐⭐ | 错误体系不一致（lexer 用字符串、parser 直接 raise、type_checker 用收集器） |
| 完整性 | ⭐⭐⭐ | 三个模块覆盖了基本需求，但缺少错误代码体系、修复建议机制、自动修复等生产级特性 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，有文档字符串，有测试。但技术债务和设计与实现脱节问题明显 |
| 性能 | ⭐⭐⭐ | 解释器性能不是瓶颈，但闭包全环境捕获可能导致内存问题 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [lexer.py:241,261,270,284, errors.py:290] **词法分析错误未使用 NovaError 体系，绕过 ErrorCollector** → 词法分析器的错误是纯字符串，直接 append 到 errors 列表并 print 到 stderr，完全绕过了 NovaError 的类型系统、ErrorCollector、源码上下文、ANSI 颜色等整套基础设施。LexerError 类定义了但从未被使用 → lexer 应持有 ErrorCollector，词法错误构造 LexerError 对象并 add 到收集器
  - 追问：如果 Rust 编译器有这个 bug，能被接受吗？→ **绝对不能。** Rustc 所有诊断都通过统一的 DiagCtxt 发出，lexer 也不例外。

- [parser.py: 多处, errors.py:358] **解析器遇错即停，ErrorCollector 形同虚设** → ErrorCollector 仅在 type_checker 中部分使用，parser 遇到第一个错误就直接 raise，lexer 也不用。"批量错误收集"只在类型检查阶段工作 → parser 引入错误恢复策略，通过 ErrorCollector 收集而非直接抛出
  - 追问：如果 Rust 编译器的 parser 遇到第一个错误就停止，能被接受吗？→ **不能。** Rustc 的 parser 有完整的错误恢复机制，能跳过错误 token 继续解析后续代码。

- [errors.py:396-398] **ErrorCollector.get_all() 丢失时间顺序** → 所有错误排在所有警告前面，与源码中出现的顺序无关。破坏了因果链，干扰调试 → 使用单一列表存储所有诊断，每项带 severity，输出时保持插入顺序

- [modules.py:216-218] **循环导入检测错误无源码位置信息** → 用户看到"循环导入检测: path1 -> path2 -> path1"，但不知道是哪一行的 import 语句导致的 → 创建 ModuleError 错误类型，接受 span 参数，在 import 调用处传入源码位置
  - 追问：如果 Rust 编译器的循环导入错误没有位置信息，能被接受吗？→ **不能。** Rust 的循环导入错误会精确定位到触发循环的那一行 import 语句。

- [modules.py:248-267] **模块缓存在类型检查失败时仍可能产生部分状态** → 在 collect_errors=True 模式下，即使有类型错误，模块仍然会被求值并缓存。后续导入该模块的代码会拿到一个类型不正确的模块 → 类型检查后检查 error_collector，有错误则不缓存模块

- [modules.py:276-291] **导出名称收集与实际可导出性不一致** → 只收集 ExportDecl 的名称，但不验证这些名称是否真的在模块中定义了。export foo 但没有 let foo = ...，用户永远不会知道导出了一个不存在的名称 → 收集导出名称时验证名称是否存在，不存在则报错

- [environment.py:26-28] **闭包捕获的是整个环境引用，存在内存泄漏风险** → 每个闭包持有整个 Environment 的引用，通过 parent 链向上引用直到全局环境。深层嵌套函数返回的闭包被长期持有会导致整个调用链的所有 Environment 都无法被 GC → 实现闭包转换，分析自由变量，只捕获被引用的变量
  - 追问：如果 Rust 编译器有这个 bug，能被接受吗？→ **不能。** Rust 的闭包精确捕获（precision capture）只捕获实际使用的变量。

- [environment.py:30-32] **define 允许遮蔽同名变量且不检查可变性变化** → 同一作用域内两次 define 同名变量会静默覆盖，包括改变可变性。在词法作用域语言中，同一作用域重复定义应该是错误 → define 方法应检查名称是否已存在，如果已存在则抛出错误

#### 中等问题（影响特定场景）

- [errors.py:82-106] 缺少错误代码（error code）体系，每个错误类型没有唯一编号
- [errors.py:85-96] 缺少文件名信息，多文件编译时无法告知用户哪个文件出错
- [errors.py:68-75] 缺少修复建议（suggestion）机制，没有 SUGGESTION severity
- [errors.py:265-283] 下划线高亮对 TAB 字符计算错误，终端显示宽度不是 1 列
- [errors.py:405-411] raise_all 丢失错误类型信息（后续错误被格式化为字符串 note）
- [errors.py:47-48] ANSI.enabled() 只检查 stderr，不检查 stdout；缺少 FORCE_COLOR 环境变量支持
- [modules.py:358-364] 标准库路径硬编码，相对路径相对于当前工作目录，从不同目录运行编译器标准库路径就变了
- [modules.py:90-95] 相对导入的基准目录逻辑混乱，混用 search_paths[0] 和 base_dir 概念
- [modules.py:329-330] import_module 定义的绑定永远是不可变的，类型环境的导入也没有 mutable 标记

#### 轻微问题（代码质量）

- [errors.py:93] highlight_span 旧格式兼容是技术债务
- [errors.py:186-190] 中文位置描述不规范（"第X行" vs 行业标准的 file:line:col）
- [errors.py:320] RuntimeError_ 命名不规范（尾随下划线）
- [modules.py:159-174] resolve_package_path 未被使用（死代码）
- [modules.py:293-299] _collect_exported_types 与 _collect_exports 重复
- [environment.py:34-48] lookup 和 lookup_binding 重复代码
- [environment.py:17-20] BindingInfo 的 name 字段冗余（存储在以 name 为 key 的 dict 中）

#### 原创性分析

**已有技术（非原创）**：作用域链环境、ErrorCollector 批量收集、模块缓存 + loading_stack 循环检测、闭包捕获词法环境、ANSI 颜色 + 源码上下文 + 下划线高亮（直接借鉴 Rust）。

**有一定特色的点**：中文本地化的错误信息体系（对国内初学者友好）、RelatedNote 同时支持 span 和独立 line/column 双模式、ModuleResolver 的三级解析策略。


---

## [2026-07-16] 第二十三轮审查 — 所有后端深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 自研 x86_64 编码器和 ELF 生成器是亮点；多后端架构有想法 |
| 可行性 | ⭐⭐ | C 后端基本可用；其他三个后端均无法实际运行 |
| 正确性 | ⭐⭐ | 有许多根本性 bug（函数调用、内存管理、类型系统） |
| 安全性 | ⭐ | 内存不安全、类型不安全、无边界检查 |
| 一致性 | ⭐⭐ | 四个后端语义不一致；编译管道对不同后端走不同路径 |
| 完整性 | ⭐⭐ | 指令覆盖表面上高，但核心功能（闭包、ADT、GC）实现不完整 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰、命名规范、有注释；但测试严重不足 |
| 性能 | ⭐⭐ | 原生后端有寄存器分配器但有缺陷；C 后端依赖 gcc 优化 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [native_backend.py:509-541] **Native 后端函数调用参数传递完全错误** → src_locs 是虚拟寄存器名而非参数值，vregs 字典中可能没有这些映射，参数寄存器不会被正确设置 → 重新设计 LIR 的函数调用约定，明确参数顺序和语义；确保编译前所有参数 vreg 已分配物理寄存器
  - 追问：如果 OCaml 的 native 编译器有这个 bug，能被接受吗？→ **绝对不能。** 函数调用是编译器的核心功能，参数传递错误意味着所有函数调用都无法正确工作，是 P0 级 bug。

- [native_backend.py:45-82] **寄存器分配器存在根本性缺陷** → 参数寄存器在函数入口已被占用但分配器不知道；溢出时返回 spill slot 编号而非寄存器，下游代码会把它当寄存器号用，产生完全错误的机器码；稍微复杂的函数就会绕过寄存器分配器 → 实现真正的 spill/reload 逻辑，将参数寄存器标记为已占用
  - 追问：如果 OCaml 的 native 编译器寄存器分配器不工作，能被接受吗？→ **不能。** 寄存器分配是编译器后端的核心，spill 机制完全不工作意味着寄存器分配器是装饰性的。

- [native_backend.py:1125-1189] **List/Tuple/ADT 构建在栈上分配，函数返回后失效** → 所有数据结构都在栈上分配（sub rsp），但函数返回时栈帧被销毁，返回值的指针悬空。所有返回复合数据的函数都会崩溃 → 使用堆分配或确保值语义
  - 追问：如果 OCaml 的 native 编译器有这个 bug，能被接受吗？→ **绝对不能。** 这是典型的 use-after-free / dangling pointer 漏洞。

- [native_backend.py:1317-1322] **ELF 入口地址和 p_offset 错误** → code section 的 p_offset=0 与文件布局不一致（代码实际在 ehdr + phdrs 之后） → p_offset 应等于代码在文件中的实际偏移量
  - 追问：如果 OCaml 的 native 编译器生成的 ELF 文件无法加载，能被接受吗？→ **不能。** 生成的可执行文件格式必须正确。

- [cranelift_backend.py:137-200] **Cranelift 后端生成的 IR 语法不正确** → LIRBinOp 的 src_locs 是字符串位置名而非 Cranelift SSA 值编号，生成的 .clif 文件无法被 clif-util 编译 → 维护 LIR 虚拟寄存器名 → Cranelift SSA 值名的映射表

- [cranelift_backend.py:263-286] **Cranelift 后端实际上无法工作** → compile_to_object 在找不到 clif-util 时 fallback 到保存 .clif 文件，本质上是个代码生成器而非真正的编译器 → 集成真正的 Cranelift 库，或诚实地标记为"IR 生成器"

- [wasm_backend.py:229-297] **Wasm 后端栈式 vs 寄存器式转换错误** → Wasm 是栈式虚拟机，LIR 是寄存器式的。编译 BinOp 时直接输出 i64.add 等指令，但 src_locs 对应的值从未被压入栈，栈会 underflow → 维护虚拟寄存器到 Wasm local 的映射，在使用操作数前用 local.get 压栈

- [wasm_backend.py:342-344] **Wasm 后端 `_emit_call` 不处理参数** → 只输出 call 指令，但参数值从未被压入栈 → 在 call 之前将所有参数按顺序压栈

- [wasm_backend.py:230-232] **Wasm 后端 Label 被编译为 block 而非 loop** → Wasm 的 block 只能向外跳出，不能向回跳，循环无法正确工作 → 识别循环结构，使用 loop 块替代 block 块用于循环头部

- [c_codegen.py:1277-1359] **C 后端类型推断非常粗糙，大量使用默认 int64_t** → Identifier 总是返回 "int64_t"，不管实际类型。如果标识符是字符串、列表、闭包等，类型推断是错误的 → 从类型检查器获取类型注解，或在 AST 节点上携带类型信息
  - 追问：如果 OCaml 的 native 编译器类型推断是错的，能被接受吗？→ **不能。** 类型错误会导致生成的 C 代码无法编译或产生未定义行为。

- [c_codegen.py:700-712] **C 后端 ADT 构造器模式匹配的字段访问路径错误** → 字段名命名约定与类型定义不一致（pattern.name__fieldN vs variant_fieldname） → 统一字段命名约定，确保类型定义、构造器、模式匹配三者一致

- [c_codegen.py:930-1013] **C 后端闭包调用约定不匹配** → Lambda 函数签名是单独参数，但 nova_closure_call 期望参数通过 void** 数组传递 → 统一调用约定

- [compiler_pipeline.py:33-35] **编译管道 Native 目标实际使用 Cranelift 后端** → BACKEND_NATIVE = "native" 但实际创建的是 CraneliftBackend()，自研 x86_64 后端完全没有被使用 → 修复为使用 NativeCodeGen，或重命名目标

#### 中等问题（影响特定场景）

- [native_backend.py:775-786] 浮点比较使用了错误的条件码（ucomisd 后 setb 对 NaN 处理不正确）
- [native_backend.py:1227-1238] Native 后端的 _start 调用 nova_init / nova_cleanup，但这些是 C 运行时函数，不在生成的代码中
- [cranelift_backend.py:247-255] _emit_call 硬编码参数类型为 i64，浮点参数会被错误处理
- [cranelift_backend.py:216-238] _emit_binop 不区分整数和浮点操作，默认使用 int_op_map
- [wasm_backend.py:161] 字符串扫描用 \\x00 转义（双反斜杠），实际生成的是字面量 \x00 而非 null 字节
- [wasm_backend.py:265-276] LIRBuildList/LIRBuildTuple/LIRBuildADT 只分配内存，不填充元素
- [c_codegen.py:637-673] _compile_match_expr_to_stmt 不检查穷尽性，缺少防御性默认分支
- [c_codegen.py:188-195] 全局变量在 C 中声明但未初始化，main 前访问会有问题
- [compiler_pipeline.py:81-84] C 后端直接使用 AST 而非 LIR，优化管道对 C 后端完全无效

#### 轻微问题（代码质量）

- [x86_64.py:567-571] movzx_reg32_reg8 函数命名有误导性
- [x86_64.py:451-457, 467-473] je_rel32 定义了两次（重复定义）
- [native_backend.py:921-924] LIRPanic 直接 exit(1)，没有 panic 消息
- [cranelift_backend.py:199-200] LIRStoreReg 是空实现（pass）
- [wasm_backend.py:85-110] 声称支持 WasmGC 但 GC struct 类型定义了但从未使用

#### 原创性分析

**亮点**：
1. **自研 x86_64 机器码编码器**：从零实现 x86_64 指令编码，包括 REX 前缀、ModR/M、SIB 编码，以及 SSE2 浮点指令。在 Python 编写的编译器中比较少见
2. **自研 ELF 生成器**：手动构建 ELF64 文件头、Program Header
3. **线性扫描寄存器分配器**：虽然有缺陷，但实现了基本的线性扫描算法
4. **多后端架构**：同时支持 native x86_64、Cranelift、WasmGC、C 四个后端

**不足**：各后端都是"浅尝辄止"，核心功能都有严重缺陷；缺乏端到端验证；轮子重复但质量不高。

---

## [2026-07-16] 第二十三轮审查 — IR 系统 + Pass 管理器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 三层 IR 设计借鉴 MLIR Dialect 思想，整体架构思路清晰 |
| 可行性 | ⭐⭐⭐ | 框架搭好了，但关键 lowering 有严重语义丢失，目前无法正确编译非平凡程序 |
| 正确性 | ⭐⭐ | 多个 lowering 路径有语义错误；优化 pass 有多处语义错误 |
| 安全性 | ⭐⭐ | 没有 IR 验证、没有 pass 异常处理、动态修改对象类、静默返回 None |
| 一致性 | ⭐⭐⭐ | 三层 IR 共享类型系统，层级边界不清晰；命名和结构风格基本一致 |
| 完整性 | ⭐⭐ | 大量功能是骨架或空壳：内联 pass 空壳、match lowering 无实际逻辑、没有寄存器分配、没有验证 |
| 工程质量 | ⭐⭐ | 代码结构有基本分层，但存在危险的编程实践（__class__ 赋值、del 属性） |
| 性能 | ⭐⭐⭐ | 常量折叠和 DCE 使用不动点迭代是合理的，但没有分析 pass 缓存 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [mir_lowering.py:285-289] **HIRListComprehension lowering 完全丢失语义** → 列表推导式被降级为一个空列表常量，完全丢失了迭代、过滤和结果表达式计算的语义。静默的语义丢失——编译不报错但结果完全错误 → 将列表推导式展开为 for 循环 + 列表 append 的等价形式，或在 lowering 中显式抛出未实现异常
  - 追问：如果 LLVM 的 lowering pass 静默丢失语义，能被接受吗？→ **绝对不能。** Lowering 必须保持语义等价，不能静默降级为空操作。

- [mir_lowering.py:351-384] **HIRMatchExpr lowering 无实际模式匹配逻辑** → match 表达式的 lowering 只是用 MIRJump 串联所有 arm 块，没有任何模式判别。所有 arm 会顺序执行，语义完全错误 → 为每个 arm 生成模式匹配条件判断 + 条件分支，匹配成功则执行 arm 体并跳转到 merge 块

- [mir_lowering.py:368-373] **MIRPhi 节点在 match lowering 中构造错误** → phi 节点用 arm_block.instructions[-1].result_name 作为 arm 结果，但最后一条指令不一定是 arm 体的返回值 → 保存 _lower_expr(arm.body, arm_block) 的返回值，将其作为 phi 源

- [mir_lowering.py:275-283] **SSA 构造违反 SSA 基本原则** → HIRAssignExpr 的 lowering 直接修改 self.env[hir_expr.target.name] = val_ssa，这在 SSA 形式中是错误的（每个变量只能赋值一次） → 实现真正的 SSA 构造算法（如 dominance frontier + phi 插入）

- [lir_lowering.py:188-193] **MIRMapBuild → LIRBuildList，Map 语义完全丢失** → 只保留了 count，key-value 对的结构完全丢失。后续无法区分 list 和 map → 创建 LIRBuildMap 指令，或在 lowering 中将 map 构建展开为哈希表分配 + 插入操作

- [lir_lowering.py:248-258] **MIRSwitch / MIRMatchJump 降级为普通跳转，语义完全丢失** → 都被降级为 LIRJump(target=default_target)，只跳转到默认目标，所有 case/variant 分支逻辑丢失 → MIRSwitch 应降级为比较 + 条件跳转序列或跳转表；MIRMatchJump 应降级为 tag 比较 + 条件跳转

- [pass_manager.py:104, 114] **HIR 常量折叠使用 expr.__class__ = ... 修改对象类，极度危险** → 通过动态修改对象的类和删除属性来实现常量折叠，在 Python dataclass 中是极不安全的做法，可能导致 AttributeError 或静默错误 → 创建新的 HIRIntLiteral 对象并在父节点中替换引用
  - 追问：如果 LLVM 的 opt 工具用修改对象 vtable 的方式做优化，能被接受吗？→ **绝对不能。** 这是未定义行为级别的危险编程实践。

- [pass_manager.py:474-479] **MIR 层 CSE 用 MIRLoad 替代重复计算，语义错误** → 发现重复表达式后用 MIRLoad 替代原指令，但 MIRLoad 的语义是"加载变量"，不是"复制 SSA 值"。会导致从一个不存在的全局变量加载数据 → 通过直接替换所有后续指令中的操作数引用来实现 SSA 值复用

- [pass_manager.py:651-655] **MIR 层 LICM 只分析 header 块，不分析整个循环体** → loop_defined 只收集 header 基本块中定义的 SSA 名，完全忽略了循环体中其他基本块的定义。导致几乎所有指令都被认为是"循环不变"的 → 正确计算循环体包含的所有基本块（使用 dominator tree + back-edge 分析）

- [pass_manager.py:713-744] **PassManager 完全没有异常处理——pass 异常会导致整个编译崩溃** → 所有 pass 都直接调用 pass_.run(module)，没有任何 try/except 包装。某个 pass 因 bug 抛出异常，整个编译过程会崩溃并产生不可读的 traceback → 在 pass 调用外层包裹 try/except，记录 pass 名称和错误信息；引入验证 pass
  - 追问：如果 LLVM 的 opt 工具静默吞掉所有 pass 异常，能被接受吗？→ **不能。** LLVM 有完整的错误报告机制和验证 pass。Nova 当前既没有异常捕获也没有验证机制。

- [整个 ir 目录] **完全没有 IR 验证机制** → 三层 IR 都没有验证 pass 来检查 SSA 正确性、CFG 正确性、类型一致性、结构完整性。优化 pass 中的 bug 可能产生无效 IR，且错误会沿管道传播 → 为每层 IR 实现验证 pass，在优化管道的关键节点插入验证

#### 中等问题（影响特定场景）

- [ir_nodes.py:524] MIR 层直接复用 HIR 类型定义（MIRModule.type_defs 使用 HIRTypeDef），造成层级污染
- [ir_nodes.py:840-869] LIR 层仍然保留高级抽象（BuildList/BuildADT/Index/FieldAccess），未真正"降低"到接近机器码
- [hir_lowering.py:292-300] HIRLetDecl 既是声明又是表达式，HIRBlockExpr.exprs 类型不一致
- [lir_lowering.py:53-56, 68-71] LIR "寄存器分配"只是 SSA 重命名，不是真正的寄存器分配
- [lir_lowering.py:221-228] MIRPhi → LIR 只取第一个源，phi 语义丢失
- [lir_lowering.py:107-119] MIRLoad / MIRStore 全部降为全局变量操作，局部变量被当作全局变量
- [mir_lowering.py:159-162] 标识符查找失败时静默返回 None，下游用空字符串填充，导致生成无效 MIR
- [mir_lowering.py:326-337] if 表达式无 else 分支时 phi 节点不完整
- [pass_manager.py:345] LIR DCE 的 side_effect_free_types 漏掉 LIRBinOp
- [pass_manager.py:330-331] LIR DCE 引用不存在的 LIRBranch.cond_reg 字段（实际使用 src_locs）
- [pass_manager.py:554-556] LIR LICM 循环体范围计算不正确（简单的 [header+1, back_edge_end]）
- [pass_manager.py:603-607] LICM 外提位置不正确（插入 header 之后而非之前），完全没有达到外提目的
- [pass_manager.py:256-261] Inlining pass 是空壳（直接 return False），但被加入默认优化管道
- [pass_manager.py:695-711] 无 Pass 依赖管理系统，运行顺序完全由添加顺序决定
- [整个 ir 目录] 完全没有 IR dump/序列化功能，无法调试和比较优化前后的 IR

#### 轻微问题（代码质量）

- [ir_nodes.py:23-119] 三层 IR 共享同一类型系统，PTR 类型在 HIR/MIR 层不应可见
- [pass_manager.py:90-98] HIR 常量折叠只递归处理 BinaryOp，不处理其他表达式类型
- [pass_manager.py:31-253] 缺少一元操作常量折叠
- [pass_manager.py:56-57] 缺少布尔短路常量折叠
- [pass_manager.py:130-171] MIR 常量折叠只在基本块内进行，不跨块
- [pass_manager.py:441-453] LIR CSE 不考虑类型，可能导致类型不匹配
- [pass_manager.py:280-283] _SIDE_EFFECT_TYPES 定义了但从未使用

#### 原创性分析

**原创/设计思考**：
1. **三层 IR + 每层多 pass 的架构**：借鉴 MLIR 的分层思想，简化为固定三层
2. **统一类型系统**：三层共享 NovaType，减少了类型降级的样板代码
3. **Pass 管理器的不动点迭代**：正确实现了"反复运行直到无变化"的模式
4. **LIR 层的统一 src_locs/dst_loc 设计**：所有 LIR 指令用统一的源/目标位置元组表示，便于 pass 编写

---

## [2026-07-16] 第二十三轮审查 — 运行时 + 测试 + Tree-sitter 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 语言设计借鉴大量 Rust/OCaml/Elm 元素，但多执行路径架构有一定新意 |
| 可行性 | ⭐⭐⭐⭐ | 整体架构清晰，各模块边界明确，Python 实现的原型可行性高 |
| 正确性 | ⭐⭐ | C 运行时有多处 UB（类型 punning、有符号溢出、函数指针转换）；C 后端没有端到端验证 |
| 安全性 | ⭐⭐ | C 运行时存在多处内存安全隐患（空指针、类型混淆、临时文件竞态） |
| 一致性 | ⭐⭐ | Parser 与 tree-sitter 语法存在差异；Evaluator 和 VM 之间没有一致性测试 |
| 完整性 | ⭐⭐⭐ | 核心特性基本齐全，但缺少 trait/interface、完整异常处理语义、并发/并行 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，测试数量多（~800个）但分布不均 |
| 性能 | ⭐⭐ | C 运行时哈希表用 FNV-1a + 链表法，性能中等；没有 SSO；GC 不存在 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [nova_runtime.c:99-103] **没有真正的 GC，只有引用计数，且不处理循环引用** → nova_gc_collect() 只是返回诊断值，并非真正的垃圾回收。纯引用计数模型无法回收循环引用 → 实现标记-清除 GC 或使用带循环检测的引用计数；至少在文档中明确声明不处理循环引用
  - 追问：如果 GHC 没有 GC，能被接受吗？→ **不能。** 函数式语言高度依赖 GC，没有 GC 会导致严重的内存泄漏。

- [nova_runtime.c:536-538] **NovaMap 的 value 类型混淆导致类型 punning** → nova_map_put 更新已有 key 的 value 时，将 entry->value 强制转换为 NovaValue* 并调用 nova_value_release。但 value 类型是 void*，可能是 NovaString*、int64_t 或其他类型。这是未定义行为（UB） → NovaMap 应该有明确的 value 类型标签，或使用带类型信息的 NovaValue* 统一封装

- [nova_runtime.c:135-148] **nova_string_new_len 在 str 为 NULL 时读取空指针** → 当 str == NULL && len > 0 时，memcpy(s->data, str, len) 会从 NULL 指针读取，导致崩溃 → 在 nova_string_new_len 中，当 str == NULL 时不执行 memcpy

- [nova_runtime.c:1103-1109] **JSON 解析器对畸形输入可能越界读取** → json_parse_object 中解析 key 时遇到 \ 时 p->pos += 2，可能跳过结尾的 " 导致越界 → 在每次 p->pos += 2 后检查是否越界

- [nova_runtime.c:1664-1669, 1723-1731] **nova_http_get / nova_http_post 临时文件竞态条件** → 临时文件名使用 PID 构造（/tmp/nova_http_%d.tmp），同一进程的多个线程/并发调用会互相覆盖；攻击者可预先创建符号链接进行路径遍历攻击 → 使用 mkstemp() 或 tmpfile() 创建安全的临时文件

- [nova_runtime.c:959] **nova_abs_int 对 INT64_MIN 是未定义行为** → x < 0 ? -x : x，当 x = INT64_MIN 时，-x 溢出，是有符号整数溢出 UB → 特殊处理 INT64_MIN，返回错误或饱和值

- [tests/ 整体] **核心语言特性缺少 evaluator 与 VM 两条路径的行为一致性测试** → 整个测试套件中没有任何测试验证 evaluator 和 VM 对同一程序产生相同结果 → 建立参数化测试套件，对每个测试用例同时运行 evaluator 和 VM，断言输出一致
  - 追问：如果 GHC 缺少核心语言特性的测试，能被接受吗？→ **不能。** 对于声称有多个执行路径的编译器，一致性测试是基本要求。

- [tests/test_c_codegen.py:146-171] **C 后端端到端测试几乎为零** → 52 个测试中绝大多数只检查生成的 C 代码字符串中"是否包含某个子串"。test_generate_valid_c 尝试用 gcc 做语法检查但不强制通过 → 在 CI 中用 gcc/clang 编译生成的 C 代码并运行，断言输出与 evaluator 一致

- [tree-sitter-nova/grammar.js] **Tree-sitter 缺少 `?`（try/错误传播）操作符** → Python parser 支持 TryExpr，但 Tree-sitter grammar.js 中完全没有 `?` 操作符的定义 → 在 grammar.js 中添加 try_expr 规则

#### 中等问题（影响特定场景）

- [nova_runtime.c:319-330] 引用计数不是原子的，多线程下不安全
- [nova_runtime.h:76-89] NovaValue.ref_count 冗余（双层引用计数）
- [nova_runtime.c:597-613] nova_map_remove 不释放 value 的引用计数，与 nova_map_put 行为不一致
- [nova_runtime.c:479-486] nova_list_release 不释放列表元素，可能造成内存泄漏
- [nova_runtime.c:405-413] nova_list_map/filter/reduce 的函数指针类型强制转换（void* → 函数指针），C 标准中是实现定义的
- [nova_runtime.c:459-473] nova_list_contains/index_of 使用指针相等比较，内容相同但指针不同的字符串会返回 false
- [nova_runtime.c:213-241] nova_string_split 在空分隔符下行为不一致（delim 为 NULL 和空字符串走同一分支）
- [nova_runtime.c:1289-1296] nova_json_parse 对畸形 JSON 处理不完善，静默返回部分结果或 NULL
- [tests/test_backends.py] Wasm 后端和 Cranelift 后端没有端到端测试，只检查生成文本
- [tests/ 闭包测试] 闭包和部分应用的 evaluator 测试覆盖不足（约 6 个测试）
- [tests/ ADT 测试] ADT 测试不够深入，缺少递归 ADT、嵌套 ADT 模式匹配、泛型 ADT 求值测试
- [tree-sitter-nova/test/corpus/] Tree-sitter 测试语料覆盖不足（只有 6 个文件），缺少 import/export、类型别名、元组、map 等

#### 轻微问题（代码质量）

- [nova_runtime.c:849-851] nova_read_file 的 size 截断问题（ftell 返回 long，32 位系统上最大 2GB）
- [nova_runtime.c:1629-1631] nova_time_format 缓冲区可能溢出（固定 256 字节）
- [nova_runtime.c:224] IOError 已过时（Python 3 中是 OSError 的别名）
- [tests/test_nova.py] Happy path 测试多，边界和错误测试少（相对而言）
- [tree-sitter-nova/grammar.js] Tree-sitter 的 concat_expr 优先级与 parser 是否一致需确认

#### 原创性分析

**工程实践价值**：
1. **多执行路径设计**：同时提供 AST evaluator、字节码 VM、C 代码生成、三层 IR + 多后端的架构，在一个教学/原型级语言中比较少见
2. **语法选择的融合**：将函数式语言特性与命令式特性融合，类似于 Rust 的路线，但语法更轻量
3. **错误传播操作符 `?`**：采用 Rust 风格的 `?` 操作符进行错误传播

**原创性有限**：核心语言设计（ADT、模式匹配、Option/Result、管道操作符、类型推断）都是 ML 家族语言的标准特性；C 运行时实现（引用计数字符串、列表、哈希表）都是经典实现；Tree-sitter 语法结构上与其他 tree-sitter 语言类似。

**总体评价**：Nova 更像是一个"集大成"的学习/原型项目，将现代编程语言的各种优秀理念整合在一起，其价值主要在于工程完整性——一个人实现了从词法分析到多后端代码生成的完整编译器链条。

---

## 第二十三轮审查总结

本轮为深度审查，覆盖全部 9 个核心模块，累计发现问题约 150+ 个，其中严重问题约 45 个，中等问题约 55 个，轻微问题约 50 个。

### 最关键的系统性问题

1. **类型系统核心缺失**：没有真正的合一（unification）算法和 let-polymorphism，TypeVar 几乎是"透明的"，导致类型检查对无标注代码基本失效
2. **闭包语义前后端不一致**：Evaluator 是引用语义（环境链共享），VM 是值语义（快照复制），这是函数式语言最核心的语义不一致
3. **IR lowering 大量语义丢失**：列表推导式、match 表达式、switch、map 构建等在 lowering 过程中静默丢失语义
4. **后端普遍不可用**：除 C 后端基本可用外，native、Cranelift、Wasm 三个后端都有根本性缺陷无法实际运行
5. **C 运行时内存安全问题**：类型 punning、有符号溢出、空指针解引用、循环引用无法回收等
6. **缺少端到端测试**：C 后端、native 后端、Wasm 后端均无真正的"编译→运行→验证"测试
7. **错误体系不统一**：lexer 用字符串、parser 直接 raise、type_checker 用收集器，三套错误报告机制

### 修复优先级建议

**P0（阻断级）**：
1. 修复闭包语义前后端不一致（统一为引用语义）
2. 实现真正的类型合一（unification）算法
3. 修复 VM 的 while 循环 break/continue off-by-one
4. 修复 C 运行时的类型 punning 和内存安全问题

**P1（重要）**：
5. 建立 evaluator vs VM 一致性测试套件
6. 统一错误报告体系（所有阶段都走 ErrorCollector）
7. 修复 IR lowering 中的语义丢失（match、列表推导式、switch）
8. 实现模式匹配穷尽性检查
9. 让至少一个后端（C 后端）达到生产可用质量

**P2（改进）**：
10. 实现 let-polymorphism（泛化 + 实例化）
11. 添加 IR 验证 pass
12. 实现尾调用优化（TCO）
13. 完善 Tree-sitter 语法覆盖
14. 添加多行注释、十六进制数字、Unicode 转义等基础功能
...
## [2026-07-16] 第二十四轮审查 — VM 虚拟机 (vm.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 栈式 VM + ADT + 模式匹配 + 错误传播的设计有自己的特色，match_stack_bases 统一栈恢复机制是不错的设计 |
| 可行性 | ⭐⭐⭐⭐ | 整体架构可行，指令集设计合理，能表达复杂的函数式语言特性 |
| 正确性 | ⭐⭐ | 存在多个严重正确性 bug：局部可变性检查失效、MATCH_CONSTRUCTOR 跨类型匹配、算术运算类型检查缺失 |
| 安全性 | ⭐⭐ | 类型安全边界多处被突破（Python 异常逃逸、可变性检查失效），内存安全无保障（闭包过度捕获） |
| 一致性 | ⭐⭐⭐ | 全局 vs 局部可变性追踪不一致、顶层 vs 函数作用域不一致、错误处理范式（异常 vs Result）不统一 |
| 完整性 | ⭐⭐⭐⭐ | 66 个操作码全部实现，覆盖了常量、运算、控制流、函数、数据结构、模式匹配、ADT、错误处理等各方面 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，注释丰富，但存在设计缺陷（可变检查依赖指令参数、动态属性创建、重复处理路径） |
| 性能 | ⭐⭐⭐ | 纯 Python 解释器性能有天花板，闭包全量捕获浪费内存，for 循环使用字典追踪迭代器状态开销较大 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [vm.py:672-675] **局部变量可变性检查完全失效** → 可变性检查使用指令的 `mutable` 标志而非变量自身属性，编译器对赋值操作总是生成 `mutable=True`，导致不可变局部变量可被随意修改 → 在 `Frame` 类中增加 `locals_mutable: set` 字段，绑定变量时记录其可变性，赋值时查询该集合
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 不可变性是函数式语言最核心的语义保证之一。

- [vm.py:1286-1289] **MATCH_CONSTRUCTOR 不检查 type_name，跨类型构造器可错误匹配** → 仅检查 `variant_name` 和字段数量，完全不检查 `type_name`，两个不同 ADT 类型的同名同参变体会混淆 → 将 `type_name` 作为操作数传入 `MATCH_CONSTRUCTOR` 指令，匹配时同时检查 `type_name` 和 `variant_name`
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 构造器在类型系统中是由类型+变体名共同唯一标识的。

- [vm.py:711-766] **算术运算未捕获 TypeError，类型错误以 Python 异常形式逃逸** → ADD/SUB/MUL/NEG 等指令仅检查 Bool 类型，未捕获 Python 的 `TypeError`，不兼容类型运算会抛出原生异常 → 对所有算术运算显式检查操作数类型，或在 try/except 中捕获 TypeError 并包装为 RuntimeError_
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能。** OCaml 字节码解释器会对每条指令的操作数进行完整的类型标签检查。

- [vm.py:1021-1031] **BUILD_MAP 未处理不可哈希键，Python TypeError 直接逃逸** → 直接将值用作 Python 字典键，不可哈希类型会导致原生异常逃逸 → 捕获 TypeError 并包装为 RuntimeError_，或显式检查键的可哈希性

- [vm.py:567-570, 527-532] **TRY_UNWRAP 顶层语义不明确，错误值残留栈上** → 顶层 TRY_UNWRAP 触发提前返回时，错误值留在栈上且无访问接口，函数级和顶层行为不一致 → `run()` 方法应返回执行结果（正常值或错误值），或在顶层 TRY_UNWRAP 时抛出运行时错误

- [vm.py:1271-1274, 1328-1342] **顶层 MATCH_BIND 永久污染全局命名空间** → 顶层模式匹配绑定写入 `self.globals`，MATCH_END 只清理函数帧局部变量，不清理顶层全局绑定 → 顶层 MATCH_START/MATCH_END 也应该对全局变量做快照和恢复

#### 中等问题（影响特定场景）

- [vm.py:973-974] **CLOSURE 捕获整个帧的所有局部变量，而非仅自由变量** → 内存浪费、内存泄漏风险、可变对象共享语义问题 → 编译器分析自由变量，CLOSURE 指令携带自由变量名列表，VM 仅捕获指定变量

- [vm.py:705-708] **全局变量 shadowing 时 mutable 标志残留** → 重新绑定不可变变量后，可变性标志未从 `global_mutable` 中清除 → 绑定操作（is_assignment=False）时，如果 mutable=False，应从 `global_mutable` 中移除该名称

- [vm.py:188-228] **内置函数普遍缺少参数类型检查** → head/tail/list_length/str_len/filter/map/sum 等几乎所有内置函数都缺少类型验证 → 为每个内置函数添加显式的参数类型检查，统一使用 RuntimeError_ 报告错误

- [vm.py:269-291] **文件 I/O 内置函数使用异常而非 Result 类型** → 与语言中其他错误处理（如 str_to_int 返回 Option）的设计不一致 → 文件 I/O 函数应返回 `Result` 类型（`Ok(content)` 或 `Err(message)`）

- [vm.py:1088, 1132] **FOR_ITER 迭代状态复用检测依赖脆弱的 ip-1 比较** → 依赖于执行前 ip 已递增的隐式约定，代码可读性差且重构易错 → 使用更明确的状态标记，或让编译器在 FOR_ITER 中传入唯一循环 ID

- [vm.py:1084-1085, 1128-1129] **_range_index / _list_index 使用 hasattr 动态创建，非初始化属性** → `__init__` 中没有这些属性的声明，多处使用 `hasattr` 检查，代码风格不一致 → 在 `__init__` 中初始化 `self._range_index = {}` 和 `self._list_index = {}`，移除所有 `hasattr` 检查

- [vm.py:1051-1056] **FIELD_ACCESS 对 tuple 和 ADT 的越界访问未捕获 IndexError** → 索引越界时 Python `IndexError` 直接逃逸 → 对索引访问添加 IndexError 捕获，包装为 RuntimeError_

- [vm.py:191] **read_line 内置函数实现有缺陷** → 使用 `a == ()` 检查参数是否为空元组，写法晦涩且多余 → 改为 `lambda: input()`，移除参数检查逻辑

#### 轻微问题（代码质量）

- [vm.py:507, 987] RETURN / HALT / AUTO_CALL_MAIN 存在重复处理路径（外层循环和 _execute_instruction 各一次）→ 统一处理逻辑或明确注释
- [vm.py:1437-1441] LOOP 指令与 JUMP 功能重叠，编译器似乎不使用 LOOP → 确认是否仍被使用，如未使用应移除
- [vm.py:579-584] _pop(0) 的边界检查顺序可优化，n==0 检查在 underflow 检查之后 → 将 n == 0 前置
- [vm.py:293-299] json_parse 错误使用 RuntimeError_ 而非 Result，与文件 I/O 类似的不一致问题
- [vm.py:392-397] _call_fn 中 NovaConstructor 的参数计数错误信息不一致，构造器部分应用未被支持
- [vm.py:251] filter 使用 `is True` 进行真值判断，谓词函数必须返回精确的 True 单例 → 应在文档中说明或改为布尔判断
- [vm.py:180] _loop_id 永不重置，理论上存在溢出风险（Python 中整数精度无限，实际影响可忽略）

#### 原创性分析
- **Nova 特色**：PIPE_CALL 专用管道调用指令、MATCH_START/MATCH_END 显式标记、TRY_UNWRAP 统一处理 Option/Result、ADT 原生指令集
- **参考已有**：基本栈机设计参考 CPython/JVM；FOR_ITER + LOOP_END 双指令循环设计常见于多种 VM

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 局部可变性检查 | Environment.assign 沿作用域链检查 mutable | 依赖指令 mutable 标志（失效） | ❌ |
| MATCH_CONSTRUCTOR type_name 检查 | 检查 type_name | 不检查 type_name | ❌ |
| 闭包捕获方式 | Environment 引用（引用语义） | locals dict 浅拷贝（值快照） | ❌ |
| Unit 值 bool 语义 | `_UnitValue` 类，__bool__=True | `UNIT_TYPE` 类，__bool__=False | ❌ |
| 顶层 ? 操作符 | ReturnSignal 未捕获（崩溃） | early_return 机制处理 | ❌ |
| 基本算术运算 | 正确 | 正确 | ✅ |
| ADT 构造 | 正确 | 正确 | ✅ |
| 模式匹配基本路径 | 正确 | 正确 | ✅ |
| 管道操作 | 正确 | 正确 | ✅ |
...
## [2026-07-16] 第二十四轮审查 — 编译器 (compiler.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆ | 栈式 VM + ADT + 模式匹配的组合不算新颖，但管道操作符、try 传播、for/while 表达式化等设计有自己的想法 |
| 可行性 | ⭐⭐⭐⭐ | 整体架构清晰可行，指令集设计合理，能支撑大部分函数式特性 |
| 正确性 | ⭐⭐ | 闭包捕获错误、char/string 混淆、传递依赖断裂、构造器非一等公民——多个核心语义问题 |
| 安全性 | ⭐⭐ | 没有模式穷尽性检查、运行时类型混淆（char=string）、静默失败（match 不匹配返回 unit） |
| 一致性 | ⭐⭐ | 导入警告绕过错误系统、内置构造器与用户构造器行为不一致、死代码与活代码并存 |
| 完整性 | ⭐⭐⭐ | 大部分核心特性已实现（ADT、模式匹配、闭包、管道、列表推导式），但缺少 Map 模式等高级特性 |
| 工程质量 | ⭐⭐ | 无编译错误位置信息、死代码残留、常量池半实现半废弃、指令集冗余 |
| 性能 | ⭐⭐⭐ | 解释执行的栈式 VM 性能预期一般，闭包过度捕获会有额外内存开销 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [compiler.py:335, 346, 530, 572, 582] **编译器错误完全没有位置信息** → 所有 5 处 `raise RuntimeError(...)` 都只包含错误消息文本，完全没有利用 AST 节点上的 `span` 字段 → 定义 `CompileError` 异常类（继承自 `NovaError`），每个 `raise` 都附带位置信息
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 函数式语言编译器的核心竞争力之一就是精准的错误定位。

- [compiler.py:683] **闭包捕获全部局部变量而非自由变量** → CLOSURE 指令在运行时捕获当前帧全部局部变量，编译器完全不做自由变量分析 → 编译器增加自由变量分析（FV analysis），CLOSURE 指令增加 `free_var_names` 操作数
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **在纯函数子集中可接受，但 Nova 有 mut 可变变量时按值快照捕获就是语义错误。**

- [compiler.py:349-352] **模块导入不处理传递依赖** → `_compile_import` 在内联导入时直接跳过 `ImportDecl`，如果模块 B 导入 C，A 导入 B 时 B 中 C 的函数未定义 → 不应该跳过 ImportDecl，而应该递归编译导入的模块，正确处理循环导入检测
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 模块系统是大型程序组织的基础，传递依赖不工作意味着任何超过两个文件的项目都会崩溃。

- [compiler.py:421-422] **Char 类型在运行时与 String 无法区分** → `CharLiteral` 被编译为 `CONST_STRING` 而非独立的 char 常量指令，运行时 Char 和 String 混淆 → 新增 `CONST_CHAR` 操作码，VM 中 char 值使用专用表示
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** Char 和 String 是完全不同的类型，运行时类型混淆是严重的正确性问题。

- [compiler.py:629-640] **内置 ADT 构造器不是一等公民** → `Some`、`Ok`、`Err` 三个内置 ADT 构造器在 `_compile_fn_call` 中被特殊处理为内联 `MAKE_ADT`，但它们没有被注册为运行时可调用的函数值 → 在编译器初始化中为内置 ADT 构造器生成 `REGISTER_CTOR` + `STORE_VAR`
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 在函数式语言中，数据构造器是一等公民函数。

#### 中等问题（影响特定场景）

- [compiler.py:901-965] **死代码：`_compile_pattern_test` 和 `_compile_pattern_bindings`** → 两个方法共 65 行代码，在整个代码库中没有任何调用点 → 直接删除这两个方法

- [compiler.py:364-369] **导入名称冲突检测不完整** → 只检查 `self.bytecode.functions` 和 `self._builtin_names`，遗漏了 let 绑定和 ADT 构造器变量 → 维护一个统一的已绑定名称集合，在每次 STORE_VAR 时更新

- [compiler.py:366-369] **导入警告使用裸 print 而非错误基础设施** → 导入 shadowing 警告用 `print(..., file=sys.stderr)` 输出，绕过了 `errors.py` 的错误报告系统 → 使用 `NovaError` + `Severity.WARNING`，附带 `ImportDecl` 的 span

- [compiler.py:1092-1153] **列表推导式不维护 `_loop_stack`** → break/continue 会错误地指向外层循环，与 `_compile_for` 的不一致性是维护隐患 → 要么在列表推导式中也维护 `_loop_stack`，要么检测到 break/continue 时报编译错误

- [compiler.py:996-1003] **`ForExpr.step` 字段是死字段** → AST 设计冗余，步长信息通过 iterable 元组获取，编译器从不使用 step 字段 → 要么移除 `step` 字段，要么统一从 `step` 字段读取

- [compiler.py:778-779] **模式匹配全部失败时返回 Unit 而非报错** → 没有"非穷尽模式匹配"警告或错误，用户写错模式时得不到反馈 → 编译器增加模式穷尽性检查，运行时全部匹配失败应抛出异常

#### 轻微问题（代码质量）

- [compiler.py:75] `Op.LOOP` 指令定义了但从未使用，编译器从不发出此指令
- [compiler.py:48] `Op.LOAD_CONST` 未被使用，常量池 `self.constants` 存在但几乎不用
- [compiler.py:291-292, 269-271] `AliasDef` 和 `ExportDecl` 编译空操作无注释
- [compiler.py:598-603] 管道操作中内置函数和普通函数走相同路径，没有利用 `CALL_BUILTIN` 优化

#### 原创性分析
- **Nova 特色**：PIPE_CALL 专用指令、MATCH_START/MATCH_END 配对标记、FOR_ITER + LOOP_END 双指令循环设计、ADT 原生指令集、常量值直接内联
- **参考已有**：基本栈机结构参考 CPython/JVM；跳转回填参考标准编译器教材

---

## [2026-07-16] 第二十四轮审查 — 求值器 (evaluator.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 整体架构是经典的解释器模式，闭包、模式匹配、管道操作等都是函数式语言的标准特性 |
| 可行性 | ⭐⭐⭐⭐ | 基于 AST 遍历的解释器架构简单直接，易于理解和维护 |
| 正确性 | ⭐⭐⭐ | 基本功能正确，但有几个严重 bug（闭包引用语义、`_call_depth` 双重递减、顶层 `?` 崩溃、ADT field_names 不一致） |
| 安全性 | ⭐⭐⭐ | 有递归深度保护，基本的类型运行时检查。但缺少内存使用限制，文件 I/O 没有沙箱保护 |
| 一致性 | ⭐⭐ | 与 VM 实现存在多处不一致（Unit 类型、闭包表示、构造函数类型、顶层错误传播），内部表示也有不一致 |
| 完整性 | ⭐⭐⭐⭐ | AST 节点 100% 覆盖，支持字面量、运算、函数、闭包、模式匹配、列表/元组/Map、循环、管道、ADT、错误传播、模块导入等 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，有注释，方法命名规范。但存在代码重复，错误处理不一致，一些边界条件考虑不周 |
| 性能 | ⭐⭐ | 基于 AST 遍历的树遍历解释器本身性能就不高，加上 `Environment` 使用 dict 链，变量查找是 O(n) 作用域深度 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [evaluator.py:49-53] **闭包捕获是引用语义，可变捕获变量会污染外部环境** → 闭包直接保存整个 `env` 引用，闭包内修改 mut 变量会直接修改父环境状态 → 闭包创建时深拷贝值或使用不可变持久化数据结构；mut 变量需要显式 ref 语义
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能接受。** 闭包的引用语义会导致难以调试的状态泄露 bug。

- [evaluator.py:450-465] **`_call_fn` 中 `_call_depth` 计数在异常路径下双重递减** → 触发 MAX_CALL_DEPTH 超限时手动 -1，然后 finally 又 -1，导致 `_call_depth` 被减了两次 → 移除第 452-453 行的手动回退，让 `finally` 统一处理清理
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 这是典型的资源管理错误，会导致运行时状态不一致。

- [evaluator.py:734-745] **TryExpr 在非函数上下文中会导致程序崩溃** → `?` 操作符通过抛出 `ReturnSignal` 实现，但只在 `_call_fn` 中被捕获，顶层代码中使用会崩溃 → 在 `eval_program` 和 `eval_expr` 的顶层入口处捕获 `ReturnSignal`，转换为有意义的运行时错误
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 错误传播应该在所有上下文中都有明确定义的行为。

- [evaluator.py:222-229] **`_builtin_head` 和 `_builtin_tail` 的空列表 `field_names` 不一致** → `None` 变体没有字段，却传入了 `field_names=["value"]`，导致 field_names 和 fields 长度不一致 → `None` 变体应使用空的 `field_names`
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 数据构造器的字段名必须与字段数量严格对应，这是 ADT 的基本不变量。

- [evaluator.py:819-831] **`MapExpr` 键求值顺序问题导致重复求值** → 第一次尝试失败后在异常处理中再次对所有键求值，键表达式会被求值两次 → 先求值所有键值对，再检查可哈希性，最后构建字典
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 在函数式语言中，求值顺序和次数是语义的重要组成部分。

#### 中等问题（影响特定场景）

- [evaluator.py:59-82] **`NovaADTValue` 缺少 `__bool__` 方法** → 所有 ADT 值在布尔上下文中都返回 True（包括 None），可能掩盖编程错误 → 为 `NovaADTValue` 添加 `__bool__` 方法，抛出 TypeError 或至少让 None 变体返回 False

- [evaluator.py:806-812] **`Assignment` 不支持对列表元素、Map 值的赋值** → 只能对简单变量名赋值，不支持 `list[0] = value` 等 → 如果语言设计支持，需要扩展 Assignment 节点的目标为表达式类型

- [evaluator.py:680-687, 450-454] **`_eval_depth` 与 `_call_depth` 双重计数** → 两个独立的深度计数器，实际可用的递归深度取决于函数体复杂度，行为不可预测 → 统一为单一的调用栈深度限制

- [evaluator.py:1131-1155] **模式匹配中守卫条件求值与分支体的环境构造重叠** → 守卫条件和分支体各自创建子环境，守卫条件中的副作用不会影响分支体 → 守卫条件和分支体可以共享同一个子环境

- [evaluator.py:1088-1122] **`ListComprehension` 中的 `break`/`continue` 未被正确处理** → 列表推导式内的 break/continue 信号会向上抛出，可能错误地被外层循环捕获 → 在列表推导式求值中捕获 BreakSignal/ContinueSignal 并转换为运行时错误

- [evaluator.py:386-406] **`_format_value` 对 dict（Map 值）没有特殊格式化** → Map 值使用 Python 默认的字典格式，与 Nova 语法不一致 → 添加 dict 类型的格式化，使用 Nova 的 Map 字面量语法

- [evaluator.py:998-1008] **比较运算符对字符串/列表等类型缺少类型检查** → 类型不匹配的比较会抛出 Python 原生 TypeError，而非 Nova 运行时错误 → 比较运算符应该明确检查操作数类型，并给出清晰的错误消息

#### 轻微问题（代码质量）

- [evaluator.py:709, 786] `UnitLiteral` 和空 Block 都返回 `UNIT_VALUE` 单例，与 Python None 混用容易混淆
- [evaluator.py:337-338] `_builtin_abs` 对整数输入返回浮点数 → 应按输入类型返回结果
- [evaluator.py:578-633] `eval_decl` 方法与 `_collect_decl` + `_eval_decl_body` 功能重复 → 确认是否还需要，如不需要则删除
- [evaluator.py:1176-1177] `PatternChar` 匹配时假设 Nova Char 就是 Python 单字符字符串 → 运行时无法区分 Char 和 String
- [evaluator.py:1124-1157] `_eval_match` 中没有检查模式的穷尽性 → 运行时应提供更好的错误消息

#### 原创性分析
- **Nova 特色**：两遍扫描支持相互递归、内置 Option/Result 类型与 ? 操作符、管道表达式
- **参考已有**：经典的树遍历解释器模式，环境链实现参考 Scheme/OCaml 解释器

---

## [2026-07-16] 第二十四轮审查 — 类型检查器 (type_checker.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆ | 基本结构是标准的 HM 风格实现，但核心算法（合一）未实现，整体是简化版类型检查器 |
| 可行性 | ⭐⭐⭐☆ | 对于有类型标注的简单代码可以工作，但泛型和类型推断能力非常有限 |
| 正确性 | ⭐⭐ | 缺少合一算法和发生检查，let 多态不正确，存在类型安全漏洞 |
| 安全性 | ⭐⭐ | 错误恢复机制使错误可能被掩盖；`?` 操作符类型检查不完整；`_types_compatible` 对 TypeVar 过度宽容 |
| 一致性 | ⭐⭐ | TypeVar 的身份语义在不同函数中不一致（id vs name）；管道和函数调用逻辑重复但可能有差异 |
| 完整性 | ⭐⭐ | 缺少穷尽性检查、冗余分支检测、类型类、高阶类型等；模式匹配支持不全 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，注释较完整，但存在死代码、重复逻辑和硬编码错误消息 |
| 性能 | ⭐⭐⭐⭐ | 由于算法简单（无合一），性能不会是瓶颈。但递归类型替换可能在极端情况下有性能问题 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [type_checker.py:178-179] **TypeVar.__eq__ 基于 name 而非 identity，作为 dict key 时同名变量被混淆** → 两个同名不同实例的 TypeVar 会被视为同一个 key，在复杂嵌套泛型场景中可能导致类型推断错误 → 统一使用 `id()` 作为 key 策略，或者让 TypeVar 具有唯一身份
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** OCaml 的类型变量每个都有唯一的 identity，绝不会因为名字相同而混淆。

- [type_checker.py:1325-1354] **无合一（unification）算法，`_collect_type_bindings` 只是单向绑定** → 只能将 expected 中的 TypeVar 绑定到 actual 的类型，不能处理双向约束和两个 TypeVar 之间的等价约束 → 实现基于 union-find 的类型合一算法（参考 Algorithm J 或 W）
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 没有合一算法就不能称为 Hindley-Milner 类型推断。

- [type_checker.py:1296-1323] **无发生检查（occurs check），递归类型会导致无限循环** → 没有检查类型变量是否出现在要绑定的类型中，构造 `T = List[T]` 这样的绑定会导致无限递归 → 添加 `_occurs_check(tv, ty)` 函数
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 发生检查是类型系统健全性的基本保障。

- [type_checker.py:822-832, 535-545] **let 多态未正确实现——泛化（generalization）缺失** → let 绑定的类型中的类型变量不会被"冻结"为多态的，lambda 的参数类型和返回类型是两个独立的 TypeVar 而非同一个 → 实现真正的合一算法 + let generalization
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** let 多态是 HM 类型系统的核心特性。

- [type_checker.py:974-986] **TryExpr 类型检查不完整，`?` 操作符返回类型错误** → 完全没有检查 `?` 所在函数的返回类型是否与错误类型兼容，`inner_ty.type_params[0]` 假设类型参数顺序 → `?` 操作符需要知道其所在函数的返回类型，检查错误类型是否兼容
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 这相当于完全破坏了 `?` 操作符的类型安全性。

- [type_checker.py:701-713] **模式匹配无穷尽性检查和冗余分支检测** → 只验证每个分支的模式与主题类型兼容，完全没有穷尽性检查和冗余分支检测 → 实现模式穷尽性检查算法（参考 Maranget 的算法）
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 穷尽性检查是 ML 家族语言类型系统的标志性特性之一。

- [type_checker.py:746-757] **FnCall 中类型绑定收集不一致，多参数泛型调用可能错误** → 绑定冲突时不检测，依赖递归降级处理，缺乏真正的 union-find 结构无法保证正确性和完备性 → 实现真正的 unification 和 union-find 结构

#### 中等问题（影响特定场景）

- [type_checker.py:169-176] **TypeVar._counter 是全局共享的，跨 TypeChecker 实例递增** → 错误消息中类型变量编号不具有可重现性，测试可能因为顺序不同而产生不同的错误消息 → 将计数器移到 TypeChecker 实例级别

- [type_checker.py:293-307] **内置 ADT 的构造函数类型变量名与 ADT 定义不一致** → Option 的 type_params 是 `["T"]`，但 None 构造函数用 `TypeVar("opt_t")`，命名不一致可能导致类型变量映射错误 → 统一类型变量命名

- [type_checker.py:1390-1403] **_from_ast_type 中泛型 ADT 的裸引用不报错** → `Option` 作为裸类型名使用时返回带 TypeVar 的 ADTType，而不是报错"缺少类型参数" → 对泛型 ADT 的裸引用应该报错或警告

- [type_checker.py:637, 655-656] **空列表/空 map 的类型变量名使用固定字符串** → 所有空列表共享同一个"类型身份"（因为 `__eq__` 基于 name），可能导致不应该的类型等价 → 使用唯一的 TypeVar 确保每个空列表独立

- [type_checker.py:1002-1003] **ForExpr 对 TupleType 迭代的处理不正确** → 直接取 elements[0] 作为元素类型，元组的元素可能有不同类型 → 要么禁止对元组使用 for 循环，要么正确处理

- [type_checker.py:1207-1220] **相等比较允许任意兼容类型，未限制为可比较类型** → 函数类型、ADT 类型等任意类型都可以进行相等比较，可能导致运行时错误 → 定义可比较类型的集合，或者实现 type class 机制

- [type_checker.py:1441-1459] **_expand_alias 函数是死代码** → 别名在 `_from_ast_type` 阶段就已经被展开了，`_expand_alias` 实际上什么也不做 → 确认是否真的需要，不需要则删除

- [type_checker.py:815-820] **Block 中丢弃非 Unit 类型的值无警告** → statements 中可以有任何表达式，包括返回非 Unit 类型的表达式，不会有警告 → 添加警告机制

#### 轻微问题（代码质量）

- [type_checker.py:1223-1231] `_check_binary_op` 中 `&&` 和 `||` 的错误消息硬编码为 `'&&'`，|| 操作也会显示 && 错误
- [type_checker.py:858-941] `FieldAccess` 对数字字段名的解析错误消息可更友好
- [type_checker.py:464-465] `_collect_decl` 中前向引用的 let 绑定使用 TypeVar 占位符，第二遍不更新
- [type_checker.py:42-58] `ErrorType` 单例模式与 `_types_compatible` 的"错误类型兼容一切"策略语义不一致
- [type_checker.py:779-813] `PipeExpr` 类型检查与 `FnCall` 逻辑重复，违反 DRY 原则
- [type_checker.py:1356-1369, 715-731] `_infer_fn_type` 与 lambda 的类型推断代码重复
- [type_checker.py:1077-1174] `_check_pattern` 最后没有 else 分支，未知模式类型静默返回

#### 原创性分析
- **Nova 特色**：简化版 HM 推断 + ErrorCollector 批量错误收集、内置 Option/Result 类型系统
- **参考已有**：类型检查器整体架构参考教科书实现，HM 推断的基本框架是标准的

---

## [2026-07-16] 第二十四轮审查 — 词法/语法分析器 (lexer.py / parser.py) 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 递归下降解析器是标准实现，语法设计综合了 Rust/Elm/Python 的元素 |
| 可行性 | ⭐⭐⭐½ | 基础架构可行，大部分语法结构能正确解析。但错误恢复缺失、隐式分号逻辑等降低了工程可行性 |
| 正确性 | ⭐⭐ | 多个功能级 Bug：match 负数字面量分支断裂、手动回退导致的泛型字段解析错误、尾随逗号不一致 |
| 安全性 | ⭐⭐ | 语法错误零恢复（第一个错误即崩溃）、Unicode 标识符无安全防护、隐式分号掩盖语法错误 |
| 一致性 | ⭐⭐ | 尾随逗号支持不一致（map 有而 list/tuple 没有）、死代码、字段命名不一致 |
| 完整性 | ⭐⭐ | 缺少多行注释、十六进制数字、Unicode 转义、错误恢复、范围表达式、导出语法受限 |
| 工程质量 | ⭐⭐½ | 代码结构清晰、注释充分，但手动位置回退、隐式分号逻辑、死代码拉低了质量 |
| 性能 | ⭐⭐⭐ | 递归下降线性复杂度，但 `_is_map_literal` 前瞻扫描最坏 O(n²) |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [parser.py:252-267] **`_parse_variant_def` 手动位置回退破坏解析器不变量** → 消费标识符后如果不是命名字段则回退位置，如果第一个标识符后面跟着 `[`（如 `List[Int]`），会错误地将 `List` 当作字段名，回退后从 `[` 开始解析完全错误 → 使用前瞻（peek）而非消费后回退，检查 tokens[pos] 和 tokens[pos+1]
  - 追问：如果 GCC 或 Clang 的解析器通过回退 token 位置来处理语法歧义，能被接受吗？→ **不能接受。** 现代编译器使用确定性的前瞻或 GLR 解析，从不手动回退游标位置。

- [parser.py:528] **Match arm 连续判断不完整——缺少 MINUS 和 CHAR** → 负数字面量模式和字符模式的 match 分支无法连续书写，第二个分支以 `-` 或字符字面量开头时循环终止 → 在 token 类型列表中添加 `TokenType.MINUS` 和 `TokenType.CHAR`
  - 追问：如果 GCC 或 Clang 的 switch case 漏掉了某些合法的 case 标签格式，能被接受吗？→ **不能接受。** 语法解析器的分隔符判断必须覆盖所有合法的起始 token。

- [parser.py:504] **if 条件允许嵌套 if/for/while 表达式而无需括号** → `if if x then y then z` 是合法语法，条件部分会被解析为完整的 if 表达式，导致可读性灾难和意外解析结果 → 将条件解析限制为 `_parse_or_expr()` 或更低优先级层级

- [parser.py:544, 521] **match 主体和 subject 允许完整表达式导致歧义** → match subject 可以是控制流表达式，分支体也可能因为隐式分号产生意外解析 → 将 match subject 限制为 `_parse_or_expr()` 或更低层级

- [parser.py:957-958] **列表字面量不支持尾随逗号** → `[1, 2,]` 会报错，但 Map 字面量支持尾随逗号，不一致 → 在 `_parse_list_expr`、`_parse_tuple_or_grouped` 等所有逗号分隔的列表中添加尾随逗号支持
  - 追问：如果 GCC 或 Clang 的数组初始化器不支持尾随逗号，能被接受吗？→ **不能接受。** C99 就已经支持数组初始化器的尾随逗号。

#### 中等问题（影响特定场景）

- [parser.py:408-417] **`_parse_block` 的隐式分号逻辑过于宽松** → `{ 1 + 2 3 * 4 }` 会被解析为两个语句，几乎肯定是用户笔误但被静默接受 → 移除隐式分号逻辑，强制要求分号分隔，或实现基于换行的分隔

- [lexer.py:332, 377] **标识符使用 `isalnum()` 允许任意 Unicode 字符** → 同形异义字攻击（Homoglyph attack）风险，没有任何文档说明支持 Unicode 标识符 → 要么明确只支持 ASCII 标识符，要么完整实现 Unicode 标识符安全策略

- [lexer.py:155-160] **`_make_error` 方法是完全的死代码** → 词法错误全部用字符串处理，不创建 `LexerError` 对象，错误消息缺少结构化位置信息 → 要么删除 `_make_error` 方法，要么真正使用它

- [parser.py:91-96, 120-122] **顶层表达式语句缺少分隔符检查** → 顶层多个表达式之间不需要任何分隔符，与 block 内的行为不一致 → 顶层声明应有明确的分隔规则

- [parser.py:133-136] **export 仅支持标识符，无法导出类型或函数定义** → 无法导出类型定义、函数定义，也无法导出多个名称，与 import 功能不对称 → 扩展 export 语法，支持内联导出和聚合导出形式

- [parser.py:686] **`_parse_cons_expr` 方法名误导** → 方法名叫 "cons" 但实际处理的是 `++` 字符串拼接操作 → 重命名为 `_parse_concat_expr` 或 `_parse_append_expr`

#### 轻微问题（代码质量）

- [lexer.py:202-221] `_read_number` 不支持前导小数点浮点数（`.5`）
- [lexer.py:202-221] 数字字面量不支持下划线分隔符（`1_000_000`）
- [parser.py:810-812] `UNIT` token 类型在解析器中存在冗余检查，lexer 从不生成这个 token
- [parser.py:474, 978] `RangeExpr` 缺失——`..` 只能用于 for 循环，不能作为通用表达式
- [parser.py:326-332] 类型解析中基础类型名称硬编码，可被用户类型遮蔽
- [ast_nodes.py:220-225] `MatchArm` 没有 `span` 字段，模式匹配错误无法定位分支

#### 原创性分析
- **Nova 特色**：表达式导向的语法设计（if/match/for/while 都返回值）、管道操作符、列表推导式语法
- **参考已有**：递归下降解析器是标准教科书实现，语法风格参考了 Rust 和 Elm

---

## [2026-07-16] 第二十四轮审查 — 错误处理 + 模块 + 环境深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | Rust 风格多行高亮、ANSI 颜色、错误收集器等设计有参考现代编译器的意识 |
| 可行性 | ⭐⭐⭐ | 基本功能可运行，但运行时错误无定位、闭包语义错误等核心问题严重影响可用性 |
| 正确性 | ⭐⭐ | 多处计算错误（多行下划线、Tab列数）、核心语义错误（闭包环境共享）、静默失败（导出验证缺失） |
| 安全性 | ⭐⭐⭐ | 无内存安全问题（Python 托管），但模块路径解析无沙箱限制，可加载任意路径文件 |
| 一致性 | ⭐⭐ | 命名不一致、严重级别分类不一致、位置表示双轨制（Span + highlight_span） |
| 完整性 | ⭐⭐⭐ | 覆盖了基本错误类型和模块功能，但缺少错误码、快照机制、前向引用、线程安全等 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰、注释充分，但死代码和冗余字段较多 |
| 性能 | ⭐⭐⭐⭐ | 环境查找 O(n) 作用域链深度尚可，模块缓存避免重复加载 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [errors.py:320-327] **运行时错误完全缺失源码上下文** → `RuntimeError_` 类继承自 `NovaError`，但所有运行时错误抛出点均未传入 source 和 span，用户无法定位错误位置 → `Environment` 类应持有 source_code 引用和当前执行位置追踪
  - 追问：如果是 Rust 编译器的错误信息缺少源码上下文，能被接受吗？→ **绝对不能接受。** Rust 编译器的核心竞争力之一就是精准的源码级错误定位。

- [errors.py:68-76, 235-261] **RelatedNote 跨文件诊断显示错误源码** → `RelatedNote` 没有自己的 source_code 或 file_path 字段，渲染 note 时使用主错误的源码，跨文件诊断完全误导 → 给 `RelatedNote` 添加 `source_code` 和 `file_path` 字段

- [modules.py:49-58, 276-291] **模块导出名称无验证，引用不存在的名称静默失败** → `_collect_exports` 只收集名称字符串，从不验证是否真的定义过，`get_exported_bindings` 用 try/except 吞掉错误 → 模块加载完成后遍历 exported_names，检查每个名称是否存在

- [environment.py:26-65] **闭包环境存在别名共享，父环境可被意外修改** → `Environment.child()` 只是创建新环境将 parent 指向当前环境，闭包捕获的是引用而非快照，子环境修改 mut 变量会直接修改父环境状态 → 闭包创建时应对父环境进行深拷贝

- [modules.py:215-218] **循环导入检测仅检测直接循环，不支持惰性/前向引用** → 任何形式的相互引用都被禁止，即使只是类型层面的相互引用 → 区分类型加载和值加载两个阶段，或实现两阶段加载

#### 中等问题（影响特定场景）

- [errors.py:82-106] **错误系统缺少错误码体系** → 所有错误只有消息字符串，没有数字错误码，无法程序化分类处理 → 建立错误码体系（如 LEX-001, PAR-002 等）

- [errors.py:265-283] **`_compute_underline` 多行下划线计算错误** → 结束行的下划线从行首开始画，与实际错误位置不符，多行错误的下划线完全错位 → 重新设计多行高亮的计算逻辑

- [modules.py:186, 212-213] **模块缓存键使用绝对路径，符号链接导致重复加载** → 没有经过 `os.path.realpath` 规范化，同一个文件通过不同路径访问会被加载多次 → 缓存键使用 `os.path.realpath(file_path)` 规范化后的路径

- [errors.py:365-370] **ErrorCollector.add 对 NOTE/HELP 严重级别处理错误** → NOTE 和 HELP 级别的诊断被错误地当作 ERROR 处理，`has_errors()` 在只有注释时也返回 True → 完整的 severity 判断

- [environment.py:23-73] **环境无快照/恢复机制** → 模式匹配等场景无法安全地进行环境操作，可能有状态泄漏 → 添加 `snapshot()` 和 `restore(snapshot)` 方法

- [errors.py:46-48] **ANSI 颜色不支持 CLICOLOR/FORCE_COLOR 标准** → 只检查 isatty 和 NO_COLOR，不支持通用的 CLICOLOR=0、FORCE_COLOR 等标准环境变量 → 按 NO_COLOR 和 CLICOLOR 标准实现优先级

- [errors.py:157-283] **Tab 字符列数计算错误** → 下划线位置基于字符索引，没有考虑 Tab 字符的显示宽度，包含 Tab 缩进的源码文件错误高亮完全错位 → 计算显示列数时将 Tab 展开为空格

#### 轻微问题（代码质量）

- [errors.py:86 vs 92] `source` 参数与 `source_code` 属性命名不一致
- [modules.py:293-299] `_collect_exported_types` 的 `type_checker` 参数未使用，与 `_collect_exports` 功能重复
- [errors.py:93, 172-174] `highlight_span` 旧格式兼容字段冗余，两种位置表示并存
- [modules.py:47] `ModuleInfo.is_loaded` 永远为 True，无状态转换
- [modules.py:366-371] 全局模块管理器单例缺乏线程安全
- [environment.py:67-73] `all_bindings()` 存在遮蔽问题，同名变量父作用域被子代覆盖
- [errors.py:405-411] `ErrorCollector.raise_all` 将后续错误转为 note 丢失严重级别
- [modules.py:98-105, 358-364] 默认搜索路径包含相对路径，行为不可预测

#### 原创性分析
- **Nova 特色**：Rust 风格多行高亮错误报告、ErrorCollector 批量错误收集、模块系统三阶段架构
- **参考已有**：错误报告格式参考 Rust 编译器；模块系统参考 Python 和 Node.js；环境链是标准实现

---

## [2026-07-16] 第二十四轮审查 — 所有后端深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐☆ | 自研 x86_64 编码器和 ELF 生成器是不错的尝试，三层 IR 设计有想法 |
| 可行性 | ⭐⭐☆☆☆ | C 后端相对可用但有严重 ADT 问题。Native 后端有栈分配、入口地址、寄存器溢出等多个致命 bug。其他后端均为骨架。 |
| 正确性 | ⭐☆☆☆☆ | 多个后端存在根本性正确性问题：Native 后端的栈分配和 ELF 入口错误、C 后端的 ADT 不兼容、Cranelift/Wasm 的语法/控制流错误 |
| 安全性 | ⭐⭐☆☆☆ | C 后端使用引用计数但无 GC，存在循环引用泄漏。Native 后端无内存安全保障。 |
| 一致性 | ⭐⭐☆☆☆ | 各后端输入接口不统一（C 后端走 AST，其他走 LIR）。ADT 在各后端表示不一致。 |
| 完整性 | ⭐⭐☆☆☆ | C 后端覆盖了较多特性但核心的 ADT/模式匹配有缺陷。Native 后端仅覆盖基础指令。Wasm/Cranelift 是骨架。 |
| 工程质量 | ⭐⭐⭐☆☆ | 代码结构清晰，注释较丰富，有单元测试。但缺少端到端测试，缺少错误处理。 |
| 性能 | ⭐⭐☆☆☆ | C 后端依赖 gcc/clang 优化尚可。Native 后端无优化。整体没有像样的优化 pass。 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [native_backend.py:1135-1148, 1158-1166, 1179-1189] **Native 后端：List/Tuple/ADT 在栈上分配，函数返回后失效** → 所有数据结构都在栈上分配，函数返回后栈帧被释放，指针变为悬空指针 → 实现 bump allocator 或集成 nova_runtime 的内存分配
  - 追问：如果 OCaml 的 native 编译器生成的代码中所有数据结构都分配在栈上，能被接受吗？→ **绝对不能。这是使整个后端完全不可用的致命缺陷。**

- [native_backend.py:1317-1322, 1288-1289] **Native 后端：ELF e_entry 是 0 而非正确的虚拟地址** → `_make_elf_header(entry=start_offset)` 而 `start_offset = 0`，入口点虚拟地址应为 `base_addr + start_offset = 0x400000` → `entry = base_addr + start_offset`
  - 追问：如果 OCaml 编译器生成的可执行文件入口点是 0，一运行就崩溃，能被接受吗？→ **绝对不能。这是最基本的 ELF 生成错误。**

- [native_backend.py:72-77, 433-445] **Native 后端：寄存器分配溢出时静默失败** → 寄存器不足时 fallback 到按需分配策略，未分配时直接跳过指令发射 → 实现真正的寄存器溢出（spill），或至少在寄存器不足时抛出明确错误
  - 追问：如果 OCaml 的 native 编译器在寄存器不足时直接跳过指令发射而不报错，能被接受吗？→ **绝对不能。这是正确性灾难。**

- [c_codegen.py:200-237, 850-871] **C 后端：ADT 实现与运行时 NovaADT 结构完全不兼容** → 为每个 ADT 生成独立的 C 结构体（tagged union），与运行时的通用 `NovaADT` 内存布局完全不同 → 统一使用运行时的 `NovaADT*` 表示所有 ADT

- [c_codegen.py:590-600] **C 后端：Try 表达式引用不存在的枚举常量，编译必失败** → 代码引用了 `NOVA_OPTION_NONE_TAG` 和 `NOVA_RESULT_ERR_TAG`，但这些常量不存在 → 使用运行时提供的 `nova_option_is_some` / `nova_result_is_ok` 函数判断

- [cranelift_backend.py:203-214, 167-168, 145, 248-255] **Cranelift 后端：生成的 CLIF 语法错误，无法被真实 Cranelift 编译** → `iconst` 应为 `i64.const`，`brz` 指令不存在，`symbol_value` 语法不正确，基本块格式错误 → 参考 Cranelift 官方文档重写，使用正确的 CLIF 语法
  - 追问：如果 OCaml 的后端生成的 LLVM IR 语法完全错误，连 LLVM 验证都通不过，能被接受吗？→ **绝对不能。这意味着后端根本不存在。**

- [wasm_backend.py:230-232, 257-263] **Wasm 后端：控制流模型根本性错误——用 block 模拟 label/goto** → Wasm 的 `br` 指令只能跳出到外层 block，不能跳转到任意标签，生成的 Wasm 模块验证失败 → 实现 LIR→Wasm 结构化控制流转换（relooper 算法）

- [native_backend.py:756-769] **Native 后端：除法和取模操作破坏寄存器分配不变量** → 硬编码使用 RAX 和 RDX，没有检查是否正在被其他虚拟寄存器使用，静默覆盖 → 保存/恢复可能被覆盖的寄存器，或将 RAX、RDX 从可用寄存器列表中排除

- [compiler_pipeline.py:33-35] **编译管道：BACKEND_NATIVE 实际使用的是 Cranelift** → 命名严重误导，用户期望获得自研原生后端，实际得到的是骨架级 Cranelift 后端 → 修正命名或真正实例化 NativeCodeGen

- [c_codegen.py:1035] **C 后端：闭包调用签名与运行时不匹配** → 管道表达式中调用闭包时只传了两个参数，运行时 `nova_closure_call` 需要 (closure, void** args, arg_count) → 正确构建参数数组，按运行时签名调用

#### 中等问题（影响特定场景）

- [x86_64.py:451-457, 467-473] **x86_64.py：je_rel32 函数重复定义** → 第二次定义覆盖第一次，虽功能相同但是维护隐患 → 删除重复定义
- [c_codegen.py:189-195] **C 后端：全局变量声明但类型推断可能错误** → Identifier 返回 int64_t 默认类型，复杂全局绑定可能类型不匹配 → 使用类型检查器的结果而非自行推断
- [native_backend.py:1225] **Native 后端：_start 函数中栈对齐可能出错** → 调用函数时栈对齐可能不符合 ABI 要求，可能导致 SSE 指令崩溃 → 正确处理 _start 的栈对齐
- [native_backend.py:771-786] **Native 后端：浮点比较 NaN 处理不正确** → ucomisd 遇 NaN 时 seta/setae 返回 1，导致 NaN > x 和 NaN >= x 都返回 true → 检查 PF 标志处理 NaN 情况
- [c_codegen.py:1301-1302] **C 后端：标识符类型推断默认 int64_t，与实际类型可能不符** → 利用类型检查器的类型信息
- [cranelift_backend.py:30-45] **Cranelift 后端：所有指针/引用类型都映射为 i64，丢失类型信息** → 使用 Cranelift 的多返回值和结构体类型
- [wasm_backend.py:161] **Wasm 后端：字符串偏移计算使用了 b"\\x00" 而非 b"\x00"** → 字符串在数据段中的偏移计算错误
- [c_codegen.py:954-955] **C 后端：闭包捕获所有可见变量而非仅被使用的变量** → 进行自由变量分析，只捕获实际使用的变量
- [compiler_pipeline.py:76-84] **编译管道：C 后端走 AST 路径，其他后端走 LIR 路径，架构不一致** → 统一后端接口为 LIR

#### 轻微问题（代码质量）

- [x86_64.py:68-71] REX 前缀发射逻辑有冗余
- [c_codegen.py:470-471] UnitLiteral 生成 `((void)0)`，在某些上下文中可能有问题
- [native_backend.py:196-201] 字符串常量没有对齐处理
- [cranelift_backend.py:90-98] _detect_target 返回的 target 字符串可能不符合 Cranelift 格式
- [wasm_backend.py:85-110] WasmGC 类型定义硬编码，未根据实际 ADT 生成
- [c_codegen.py:408-409, 1111] for 循环中列表元素强制转换为 int64_t，假设列表元素总是整数类型
- [native_backend.py:1195-1217] _compile_counted_loop 是空方法

#### 原创性分析
- **Nova 特色**：自研 x86_64 指令编码器和 ELF 生成器、多后端架构、三层 IR 管道
- **参考已有**：C 后端参考常见的源到源编译模式；Wasm/Cranelift 后端参考标准后端架构

---

## [2026-07-16] 第二十四轮审查 — IR 系统 + Pass 管理器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 三层 IR 架构参考 MLIR 思路是合理的，但节点设计和 lowering 策略较为常规 |
| 可行性 | ⭐⭐☆☆☆ | 框架搭好了，但核心 lowering（match、phi、switch）都有严重正确性问题，实际不可用 |
| 正确性 | ⭐☆☆☆☆ | 多个核心特性的 lowering 存在根本性语义错误（match、phi、字段访问、switch），SSA 形式不完整 |
| 安全性 | ⭐⭐☆☆☆ | 没有验证 pass、异常处理不足、动态改类等问题导致编译器可能静默产生错误输出 |
| 一致性 | ⭐⭐☆☆☆ | 三层 IR 共享类型系统但层级不清；HIRBlockExpr 中混入 Decl 类型；参数类型使用错误等 |
| 完整性 | ⭐⭐⭐☆☆ | HIR 节点覆盖较全面，MIR/LIR 指令集基本定义，但多个 lowering 和优化 pass 是半实现或空壳 |
| 工程质量 | ⭐⭐☆☆☆ | 代码结构清晰但有危险的 hack（__class__ 赋值），缺乏测试、验证、错误处理等工程基础设施 |
| 性能 | ⭐⭐⭐☆☆ | 优化 pass 框架存在，但实际生效的优化有限（常量折叠部分可用，DCE 有缺陷，CSE 局部，LICM 基本不工作） |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [mir_lowering.py:351-384] **MIR match lowering 完全缺失模式匹配逻辑** → 只是简单地按顺序跳转到每个 arm 块，完全没有根据 value 进行模式匹配判断的逻辑，所有 arm 按顺序串联执行 → 实现正确的模式匹配编译策略（决策树或回溯匹配）
  - 追问：如果 LLVM 的 opt 工具静默吞掉所有 pass 异常，能被接受吗？→ **绝对不能接受。** 静默吞掉异常意味着编译器可能产生错误的输出而不告知用户。

- [lir_lowering.py:221-228] **LIR Phi 节点 lowering 只取第一个源，完全破坏 SSA 语义** → MIRPhi 节点 lowering 时只取 `instr.sources[0]`，忽略了 phi 节点的核心语义——根据进入的前驱块选择对应值 → Phi 节点应该在寄存器分配阶段处理，或在 LIR 中保留直到寄存器分配

- [lir_lowering.py:248-258] **MIRSwitch / MIRMatchJump 退化为无条件跳转** → lowering 到 LIR 时都变成了简单的 LIRJump，条件值和 case 分支完全被丢弃 → 实现正确的 lowering——生成比较 + 条件跳转序列或跳转表

- [mir_lowering.py:275-283] **MIR SSA 构造不正确——赋值不创建新 SSA 版本** → if-else 两个分支对同一变量赋值后，汇合处应该有 phi 节点但实际没有 → 实现完整的 SSA 构造算法（如 Cytron 算法）

- [pass_manager.py:713-744] **Pass 管理器完全没有异常处理机制** → 任何一个 pass 抛出异常都会导致整个编译管道直接崩溃，没有错误恢复、没有 pass 级别的错误报告 → 每个 pass 的执行用 try/except 包裹，捕获异常后记录 pass 名称和错误信息
  - 追问：如果 LLVM 的 opt 工具静默吞掉所有 pass 异常，能被接受吗？→ **绝对不能接受。** 生产级编译器要么正确报告错误并终止，要么优雅降级并记录。

- [pass_manager.py:104-107, 114-117] **HIR 常量折叠通过 `__class__` 赋值修改对象类型** → 动态改变对象的类，然后删除旧属性，是极度危险的 hack，破坏对象的类型不变量 → 使用节点替换模式——在父节点中用新创建的字面量节点替换旧的二元操作节点

#### 中等问题（影响特定场景）

- [pass_manager.py:90-120] **HIR 常量折叠遍历不完整** → 只在顶层表达式是 HIRBinaryOp 时才递归处理子节点，嵌套在其他结构中的常量不会被折叠 → 实现完整的 HIR 表达式访问者，递归遍历所有表达式类型

- [pass_manager.py:615-692] **MIR LICM 只处理 header 块，且循环检测错误** → loop_defined 只收集 header 基本块内定义的 SSA 名，完全忽略循环体内其他基本块；回边检测不完整 → 基于 dominator tree 正确识别自然循环

- [pass_manager.py:345] **LIR DCE 的副作用分类错误** → 漏掉了 LIRBinOp，二元运算也是纯计算指令，应被纳入死代码消除范围 → 将 LIRBinOp 加入无副作用指令列表

- [hir_lowering.py:97-98] **HIR 类型别名降级丢失目标类型** → AliasDef lowering 为 HIRAliasDecl 时只保存了名称，目标类型直接设为 TYPE_VAR → 正确降级 AliasDef，解析并保存其目标类型

- [mir_lowering.py:232-237] **MIRFieldAccess 的 field_index 始终为 0** → 只设置了 field_name，field_index 保持默认值 0，但 LIR lowering 时使用 field_index 作为偏移量 → 根据对象类型的类型定义，查找字段名对应的索引

- [lir_lowering.py:147-163] **LIRCall 的参数类型全部使用返回值类型** → 所有参数的类型都被设为函数返回值类型，而非每个参数各自的实际类型 → 从函数签名中获取每个参数的正确类型

- [mir_lowering.py:159-162] **MIR 未定义变量静默返回 None** → 变量名不在 env 中直接返回 None，后续使用时变成空字符串 SSA 名 → 对未定义变量抛出明确的 MIRLoweringError

- [hir_lowering.py:292-299] **HIRBlockExpr 中混入 HIRDecl 类型** → HIRLetDecl 不是 HIRExpr 的子类，却被放入 exprs 列表中 → HIRBlockExpr 应该区分声明和表达式

#### 轻微问题（代码质量）

- [ir_nodes.py:全文] 所有 IR 节点都没有携带源码位置信息，错误报告无法定位源码
- [pass_manager.py:全文] 没有任何 IR 验证 Pass 验证各层 IR 的正确性
- [pass_manager.py:256-261] Inlining pass 是空壳，直接 return False
- [pass_manager.py:288-291] HIR/MIR 层 DCE 是空壳，只有 LIR 层有实现
- [pass_manager.py:763-766] 优化 Pass 顺序不合理，DCE 应该在 CSE 和 LICM 之后运行
- [pass_manager.py:414-418] LIR CSE 只是局部（基本块内）CSE
- [mir_lowering.py:285-289] HIRListComprehension lowering 为空列表，完全忽略了推导逻辑
- [pass_manager.py:534-539] LIR LICM 不处理 LIRBranch 形成的回边
- [ir_nodes.py:38, 42-73] 三层 IR 共享类型系统，LIR 专属类型可能泄漏到高层
- [ir_nodes.py:777-786] LIRLoadReg 与 LIRStoreReg 语义模糊，命名和区分不清晰

#### 原创性分析
- **Nova 特色**：三层 IR 设计（HIR→MIR→LIR）参考 MLIR 思路，Pass 管理器框架完整
- **参考已有**：SSA 形式、优化 pass 类型（常量折叠、DCE、CSE、LICM）都是标准编译器优化

---

## [2026-07-16] 第二十四轮审查 — 运行时 + 测试 + Tree-sitter 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 语言特性组合有想法，但各部分都是常见设计的组合，缺乏独创的核心创新 |
| 可行性 | ⭐⭐⭐⭐☆ | Python 解释器 + C 运行时 + 多后端的架构是可行的，各模块边界清晰 |
| 正确性 | ⭐⭐☆☆☆ | 引用计数类型混淆、Map remove 内存泄漏、JSON 解析不验证字面量、ADT release 不释放字段等问题严重影响正确性 |
| 安全性 | ⭐⭐☆☆☆ | 类型混淆释放、未初始化内存、非线程安全、HTTP 临时文件竞态等安全漏洞较多 |
| 一致性 | ⭐⭐⭐☆☆ | 大部分特性在 Evaluator 和类型检查器中一致，但 C 运行时与 Python 端数据模型不一致 |
| 完整性 | ⭐⭐⭐☆☆ | 核心语言特性较完整，但标准库薄弱、错误处理不完善、GC 缺失 |
| 工程质量 | ⭐⭐⭐☆☆ | 代码组织清晰，有 CI，但测试深度不足（后端不验证结果），缺少模糊测试 |
| 性能 | ⭐⭐☆☆☆ | 引用计数开销大、FNV-1a 哈希无扩容优化、字符串操作无 SSO、无逃逸分析 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [nova_runtime.c:536-538] **`nova_map_put` 中类型混淆导致内存损坏** → 无条件地将 entry->value 强制转换为 NovaValue* 并调用 nova_value_release，Map 的 value 是 void* 泛型，实际可能是任何类型 → Map 应该只存 NovaValue*，或提供带类型标签的 value 结构
  - 追问：如果 GHC 的运行时把任意指针都当作同一种类型来释放，能被接受吗？→ **绝对不能接受。这是类型安全的根本违反。**

- [nova_runtime.c:597-614] **`nova_map_remove` 不释放 value，导致内存泄漏** → 只释放了 key 和 entry，完全没有释放 entry->value。nova_map_release 也有同样问题 → 添加 value 释放逻辑

- [nova_runtime.c:99-103] **引用计数无法处理循环引用，且无任何 GC 回退机制** → nova_gc_collect() 只是返回分配数差值，完全没有实际的 GC 功能，名为 GC 却不做 GC → 至少实现简单的标记-清除 GC 作为回退，或重命名为更诚实的名称
  - 追问：如果 GHC 的 GC 实际上什么都不做只是返回统计数字，能被接受吗？→ **不能接受。名为 GC 却不做 GC，是 API 欺诈。**

- [nova_runtime.c:1165-1188, 1279-1284] **JSON 解析器的 true/false/null 不验证完整字面量** → 只要第一个字符匹配就跳过固定字节数，不验证后续字符是否正确，`txxx` 会被解析为 true → 在跳过多字符前验证剩余字符是否与预期完全匹配

- [nova_runtime.c:135-148] **`nova_string_new_len(NULL, len)` 未初始化内存** → 分配了 cap 字节的内存但不进行初始化，只设置了最后一个字节，中间字节是未初始化的垃圾数据 → 使用 calloc 或 memset 初始化为 0

- **测试套件缺少 Evaluator 与 VM 的行为一致性验证** → 两套测试各自独立，没有任何测试验证同一输入在 Evaluator 和 VM 下产生完全相同的输出 → 添加参数化测试，对同一组测试用例同时运行 Evaluator 和 VM
  - 追问：如果 GHC 的解释器和原生代码对同一程序产生不同结果却没有测试发现，能被接受吗？→ **不能接受。多执行路径一致性是编译器正确性的基本保障。**

#### 中等问题（影响特定场景）

- [nova_runtime.c:39-43] **全局状态导致完全非线程安全** → 4 个全局静态变量无同步保护，多线程环境下竞态条件 → 使用原子操作或线程局部存储

- [nova_runtime.c:205-211] **`nova_string_find` 空字符串和 NULL 指针返回 0** → NULL 指针返回 0 可能被误判为"在位置 0 找到" → NULL 指针应返回 -1

- [nova_runtime.c:959] **`nova_abs_int` 对 INT64_MIN 是未定义行为** → x == INT64_MIN 时 -x 超出 int64_t 表示范围，是有符号整数溢出 UB → 对 INT64_MIN 特殊处理

- [nova_runtime.c:845-862] **`nova_read_file` 对大文件存在整数溢出风险** → ftell 返回 long 类型，32 位系统上只有 32 位 → 使用 fstat/stat 获取文件大小

- [nova_runtime.c:1663-1708] **`nova_http_get/post` 临时文件存在竞态条件** → 仅基于 PID，同一进程内多线程并发调用会使用相同的临时文件名 → 使用 mkstemp()/tmpfile() 生成唯一临时文件名

- **后端测试只验证"能编译"，不验证"结果正确"** → C 代码生成测试几乎全部只检查是否包含某个字符串，没有端到端测试 → C 后端应编译并运行生成的程序，断言输出正确

- **Tree-sitter concat 优先级与 parser.py 不一致** → grammar.js 中 CONCAT=7, ADD=8；parser.py 中 concat 在 comparison 级别处理 → 统一两边的运算符优先级表

- [nova_runtime.c:1468-1494] **`nova_value_release` 不递归释放子元素** → 嵌套的 NovaValue 结构（如列表的列表）会在释放时只释放最外层，内部元素全部泄漏 → 递归释放所有子对象

#### 轻微问题（代码质量）

- **Tree-sitter 语料测试严重不足** → 只有 6 个测试文件，缺少 import/export、类型别名、元组、Map 字面量、嵌套模式等特性的测试
- [nova_runtime.c:193-196] `nova_string_char_at` 返回字节而非字符，UTF-8 多字节字符会返回不完整的字节片段
- [nova_runtime.c:459-473] `nova_list_contains` 和 `nova_list_index_of` 使用指针比较而非值比较
- [nova_runtime.c:454-457] `nova_list_tail` 对空列表返回空列表（无错误），静默错误
- [nova_runtime.c:1614-1632] `nova_time_format` 缓冲区溢出风险，固定大小 256 字节
- **测试文件混用 unittest 和 pytest 两种风格** → 测试风格不统一，维护成本增加
- [nova_runtime.c:213-241] `nova_string_split` 空分隔符行为不一致，按字节拆分对 UTF-8 是错误的
- **Tree-sitter grammar 中 assignment_expr 优先级可能有问题** → 赋值和管道的交互需要验证

#### 原创性分析
- **Nova 特色**：引用计数 + 类型标签的 C 运行时、多后端测试架构、Tree-sitter 语法集成
- **参考已有**：C 运行时参考 CPython 和 Lua 的 C API 设计；测试框架是标准 pytest/unittest
...
| 错误/模块/环境 | 5 | 7 | 8 | 20 |
| 所有后端 | 10 | 9 | 7 | 26 |
| IR 系统 + Pass | 6 | 8 | 10 | 24 |
| 运行时 + 测试 + Tree-sitter | 6 | 8 | 8 | 22 |
| **合计** | **55** | **67** | **62** | **184** |

### 最关键的 P0 问题（本轮新发现）

1. **Native 后端数据结构全部分配在栈上** — 函数返回后全部失效，后端完全不可用
2. **Native 后端 ELF e_entry = 0** — 生成的可执行文件一运行就段错误
3. **类型检查器缺少合一（unification）算法** — 不是真正的 HM 类型推断
4. **类型检查器 let 多态不正确** — 函数式语言的核心类型系统特性缺失
5. **VM 局部变量可变性检查完全失效** — 函数式语言最基本的不可变性保障被突破
6. **VM MATCH_CONSTRUCTOR 不检查 type_name** — ADT 类型安全性被破坏
7. **C 运行时 nova_map_put 类型混淆** — 强制类型转换导致内存损坏
8. **MIR match lowering 完全缺失模式匹配逻辑** — IR 系统核心特性崩溃
9. **LIR Phi 节点只取第一个源** — 从根本上破坏 SSA 语义
10. **编译器 Char 与 String 运行时混淆** — 类型系统在运行时失效

### 建议优先修复顺序

**P0（致命）**：
1. 修复 Native 后端的栈分配和 ELF 入口问题（或明确标记为实验性并禁用）
2. 修复 VM 局部可变性检查和 MATCH_CONSTRUCTOR type_name 检查
3. 实现类型检查器的合一（unification）算法
4. 修复 C 运行时的类型混淆和内存泄漏问题

**P1（重要）**：
5. 建立 evaluator vs VM 一致性测试套件
6. 统一错误报告体系（所有阶段都走 ErrorCollector）
7. 修复 IR lowering 中的语义丢失（match、phi、switch）
8. 实现模式匹配穷尽性检查
9. 让至少一个后端（C 后端）达到生产可用质量
10. 修复编译器的 Char/String 类型混淆

**P2（改进）**：
11. 实现 let-polymorphism（泛化 + 实例化）
12. 添加 IR 验证 pass
13. 实现尾调用优化（TCO）
14. 完善 Tree-sitter 语法覆盖
15. 添加多行注释、十六进制数字、Unicode 转义等基础功能
...
## [2026-07-16] 第二十五轮审查 — VM 虚拟机深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 模式匹配栈式恢复、TRY_UNWRAP early return 有特色；栈机设计基本标准 |
| 可行性 | ⭐⭐⭐☆☆ | 核心路径可用；闭包语义、顶层作用域有严重 bug |
| 正确性 | ⭐⭐☆☆☆ | 闭包值拷贝破坏引用语义、顶层模式绑定泄漏、非穷尽 match 栈不平衡 |
| 安全性 | ⭐⭐☆☆☆ | 多数内置函数缺类型检查、BUILD_MAP 无哈希性检查、FIELD_ACCESS 异常泄露 |
| 一致性 | ⭐⭐☆☆☆ | 与 Evaluator 在闭包语义、顶层绑定作用域上有根本性差异 |
| 完整性 | ⭐⭐⭐⭐⭐ | 66 个操作码全部有处理路径 |
| 工程质量 | ⭐⭐⭐☆☆ | 注释充分，但 RETURN/HALT 双路径、JUMP_IF_FALSE 冗余等结构问题 |
| 性能 | ⭐⭐☆☆☆ | 闭包捕获整个帧 dict 浅拷贝，高频场景性能差；_pop 效率低 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [vm.py:987-988] **闭包捕获可变变量不共享状态（值拷贝 vs 引用捕获）** → CLOSURE 通过 `dict(...)` 浅拷贝当前帧 locals，每次调用闭包时都获得全新副本。可变变量在闭包间不共享，多次调用间赋值不持久化 → 完全破坏闭包核心语义 → 将可变变量包装在可变容器中，捕获容器引用而非值
  - 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 闭包捕获变量（引用）是函数式语言最基本的语义，值拷贝会导致所有依赖闭包可变状态的程序行为错误。

- [vm.py:986-988] **闭包捕获整个帧而非自由变量** → 捕获当前帧 ALL locals，而非仅函数实际引用的自由变量 → 内存泄漏、语义错误风险（shadowing 场景）、与 Evaluator 不一致 → 编译器计算自由变量集，CLOSURE 指令携带变量名列表，VM 只捕获指定变量
  - 追问：如果 OCaml 的闭包捕获了整个作用域的 dict 拷贝，性能影响能被接受吗？→ **不能。** 这不仅是效率问题，也是语义正确性问题——复杂作用域中可能绑定错误的变量。

- [vm.py:1189-1191, 1201-1212, 1351-1362] **顶层模式匹配绑定泄漏到全局作用域** → MATCH_START/MATCH_ARM_START/MATCH_END 的快照机制仅在 call_stack 非空时生效，顶层 match 的 arm 绑定写入 globals 永不清理 → 顶层 match 模式绑定永久污染全局命名空间，嵌套 match 内层绑定泄漏 → 顶层也增加 match 快照机制，或顶层用 Frame 执行
  - 追问：如果 OCaml 的顶层 match 绑定泄漏到全局作用域，能被接受吗？→ **不能。** 模式匹配的变量作用域严格限于 arm 内，泄漏是严重的作用域违规。

- [vm.py:1348-1366] **模式匹配非穷尽时栈不平衡且静默失败** → 所有 arm 匹配失败时，fail_ip 跳转到 MATCH_END 之后，栈上仍保留 subject，MATCH_END 不检查栈状态也不抛错 → 栈不平衡导致后续指令全部错位；静默失败，用户不知道 match 没有匹配到任何 arm → MATCH_END 检查栈深度或抛出 Match_failure 错误
  - 追问：如果 Haskell GHC 模式匹配失败时栈错乱，能被接受吗？→ **不能。** 即使是非穷尽 match（编译期就该被警告），运行时也应该是明确的 Match_failure 异常，而不是静默的栈损坏。

#### 中等问题（影响特定场景）

- [vm.py:754-755, 767-768] **整数除法和取模用 Python 向下取整，与主流函数式语言不一致** → Python `//` 和 `%` 是 floor division，OCaml/C/Java 等用向零取整 → 负数除法和取模结果与用户预期不符 → 明确语言规范，如需对齐 OCaml 则实现 truncation toward zero
- [vm.py:195-232] **多数内置函数缺乏类型检查** → int_to_str/str_len/list_length/sum/filter/map 等不对参数类型做验证 → 类型错误泄露 Python 异常或产生静默错误结果 → 为每个内置函数添加参数类型验证
- [vm.py:1035-1045] **BUILD_MAP 不检查键的可哈希性** → 直接用栈上值作为 dict 键，不可哈希类型（如 list）触发 Python 原生 TypeError → 错误信息不友好，暴露实现细节 → 尝试 hash(key)，捕获 TypeError 并转换为 RuntimeError_
- [vm.py:1065-1066] **FIELD_ACCESS 元组索引的 ValueError 未捕获** → `int(field)` 对非数字字符串抛 ValueError，未被捕获 → Python 原生异常泄露 → 用 try/except 包裹或先检查格式
- [vm.py:1430-1438] **HALT 和 AUTO_CALL_MAIN 在函数内是空操作** → 仅在 _run_code 中前置特殊处理，在 _execute_function 中变成 no-op → 架构不一致，同样指令在不同执行路径语义不同 → 统一在 _execute_instruction 中通过标志位处理
- [vm.py:517-521, 1001-1006] **RETURN 有两套独立实现且语义不一致** → _execute_function 内联处理直接 return，_execute_instruction 中设 return_flag，两套逻辑并存 → 代码冗余、容易出错 → 统一使用 return_flag 机制
- [vm.py:875-912] **JUMP_IF_FALSE 和 POP_JUMP_IF_FALSE 完全冗余** → 两个操作码做完全相同的事情，仅 POP_JUMP_IF_FALSE 多了 while 循环检测 → 指令集膨胀，增加维护成本 → 统一为一个操作码
- [vm.py:273-279] **read_file 未捕获 PermissionError/UnicodeDecodeError 等** → 只捕获 FileNotFoundError，其他异常以 Python 原生形式泄露 → 用户看到 Python 错误栈而非 Nova 友好错误 → 捕获更广泛异常并转换为 RuntimeError_
- [vm.py:928, 957] **WHILE 循环 BREAK/CONTINUE 检测依赖操作数存在性** → 通过 `if instr.operands` 区分 while 与 for 循环，是脆弱的隐式约定 → 代码可维护性差，容易引入回归 → 使用明确的操作码或循环类型标识操作数
- [vm.py:205-213] **_builtin_filter/_builtin_map 谓词返回类型用 is True 检查** → 使用身份比较 `is True`，truthy 值（非零整数等）被视为 False，过滤/映射行为与直觉不符 → 显式检查谓词返回 Bool 类型，非 Bool 则抛类型错误

#### 轻微问题（代码质量）

- [vm.py:多处] 错误消息中英文混杂（"VM stack underflow" vs "未定义的变量"）
- [vm.py:589-594] `_pop(n)` 用 n 次 pop+反转实现，效率低，可用切片一次性完成
- [vm.py:42-43] Unit 类型 `__bool__=False` 是代码味道，暗示 Unit 有布尔语义
- [vm.py:195] `read_line` lambda 中 `if a == ()` 检查完全多余（arity=0 保证参数为空）
- [vm.py:305-345] JSON 序列化/反序列化不对称：stringify 支持任意 ADT，parse 不还原
- [vm.py:234-237] `_to_float` 命名不准确：只处理 int→float，其他类型直接返回
- [vm.py:多处] 手动栈检查与 `_pop` 风格不统一，可封装 `_peek()` 方法
- [vm.py:1266-1277, 1240-1251] MATCH_TEST_CHAR 与 MATCH_TEST_STRING 几乎重复，可抽取公共逻辑
- [vm.py:1096-1181] FOR_ITER 中 range 和 list 迭代的代码结构高度重复，可抽取公共部分
- [vm.py:1098-1099, 1142-1143] `_range_index` 和 `_list_index` 延迟初始化，用 hasattr 模式不如 __init__ 中初始化清晰

#### 原创性分析
- **Nova 特色**：模式匹配的栈式恢复（VM 统一负责失败时栈清理）、TRY_UNWRAP 的 early return 布尔标志、for 循环的 FOR_ITER+LOOP_END 高层抽象
- **参考已有**：整体栈式 VM 设计参考 Python VM；闭包、数据结构构建、控制流跳转均为标准设计

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获方式 | 捕获 Environment 引用（词法作用域链），可变变量共享 | 捕获当前帧 locals 的值拷贝，可变变量不共享 | ❌（根本性差异） |
| 闭包可变变量持久化 | 多次调用间持久化（通过 env 链） | 每次调用都是新副本，赋值不持久化 | ❌ |
| 顶层模式绑定作用域 | child env 创建子作用域，arm 结束自动恢复 | 绑定写入 globals，永不清理 | ❌ |
| for 循环返回值 | 返回每次迭代 body 结果的列表 | 相同（result_list 累积） | ✅ |
| TRY_UNWRAP 实现 | 用 ReturnSignal 异常传播 | 用 early return 布尔标志传播 | 机制不同但语义应一致 |
| 递归深度检查 | 同时有 call_depth 和 eval_depth 两个限制 | 只有 call_depth 限制 | Evaluator 有额外保护 |
| MAP 键可哈希性检查 | 有检查，转换为 RuntimeError_ | 无检查，泄露 Python TypeError | ❌ |
| Char 运行时表示 | Python str（与 String 无区分） | Python str（与 String 无区分） | ⚠️ 两者都有同样的 bug |

---

## [2026-07-16] 第二十五轮审查 — 编译器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 模式匹配 VM 侧栈恢复有特色；其余为标准栈式 VM 编译器设计 |
| 可行性 | ⭐⭐⭐☆☆ | 大部分功能可用，但多字段混合模式、列表推导式 break 有严重 bug |
| 正确性 | ⭐⭐☆☆☆ | 多字段构造器/元组/列表模式混合测试-绑定时栈错位、Char 编译为 String |
| 安全性 | ⭐⭐☆☆☆ | 模块导入冲突检测不完整、类型标注完全忽略 |
| 一致性 | ⭐⭐☆☆☆ | 模式匹配字段顺序与 VM 逆序压栈不匹配、列表推导式未纳入循环管理 |
| 完整性 | ⭐⭐⭐☆☆ | 大部分 AST 节点有处理，但类型标注完全忽略、无穷尽性检查 |
| 工程质量 | ⭐⭐⭐☆☆ | 有大量死代码、注释错误、操作数重载；结构尚可 |
| 性能 | ⭐⭐⭐☆☆ | 生成的字节码效率中等，无死代码消除和常量折叠 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [compiler.py:834-860] **多字段构造器/元组/列表模式中混合测试-绑定模式的栈错位** → MATCH_CONSTRUCTOR/MATCH_TEST_TUPLE/MATCH_TEST_LIST 逆序压栈字段值，`_compile_pattern_test_with_fail` 正序递归测试，测试模式（如 PatternInt）成功时弹出栈顶值，非测试模式（PatternIdentifier）不弹出，中间有标识符模式时后续字段测试读取错误的栈位置 → 所有包含 2 个以上字段且中间存在标识符/通配符模式的构造器、元组、列表模式都会错误匹配 → 测试阶段只 peek 比较不弹出，弹出和绑定全部交给提取阶段
  - 追问：如果 Haskell GHC 编译器跳过某些 Pattern 的测试代码生成，能被接受吗？→ **绝对不能。** 元组/构造器模式中混合字面量和变量绑定是最常见的用法之一，这种 bug 在生产级编译器中是 P0 级缺陷。

- [compiler.py:1097-1158] **列表推导式未纳入 `_loop_stack` 管理，break/continue 行为错误** → `_compile_list_comprehension` 完全没有操作 `_loop_stack`，当列表推导式嵌套在 while 循环内时，break/continue 会被编译为 while 风格的 BREAK/CONTINUE，但 VM 中列表推导式通过 `_for_iters` 管理（for 语义），导致 VM 状态损坏 → 迭代器状态泄漏、栈深度错误 → 在列表推导式的 FOR_ITER 前后压入/弹出 `_loop_stack`（type 为 "for"）
  - 追问：如果任何生产级语言的编译器声称支持 break/continue，却在某些循环结构中错误处理，能被接受吗？→ **不能。** 不一致的循环状态管理是严重的设计缺陷。

- [compiler.py:365-372] **模块导入冲突检测不完整，可能静默覆盖已有绑定** → 只检查 `functions` 和 `_builtin_names`，遗漏 let/mut 绑定、ADT 构造器等；且冲突仅警告不报错 → 导入模块可能在用户无感知的情况下覆盖已有绑定 → 维护统一的全局绑定名称集合，冲突检测检查所有类型的绑定，将 warning 升级为 error
  - 追问：如果 OCaml 的模块系统允许名称冲突仅警告且检测不完整，能被接受吗？→ **不能。** OCaml 有严格的命名空间管理，Haskell 的 import 也有明确的遮蔽规则。

- [compiler.py:424-425] **CharLiteral 编译为 CONST_STRING，运行时类型完全混淆** → Char 和 String 在运行时都是 Python str，虽然 MATCH_TEST_CHAR 额外检查 len==1，但 Char 值可以参与所有 String 操作，String "a" 可以匹配 PatternChar → Char 类型在运行时完全不存在，所有类型检查依赖类型检查器 → 在 VM 中引入真正的 Char 包装类，或从语言层面移除 Char 类型
  - 追问：如果 OCaml 的 char 和 string 在运行时是同一个类型，能被接受吗？→ **绝对不能。** 运行时类型混淆是基础缺陷。

#### 中等问题（影响特定场景）

- [compiler.py:659-686] **闭包捕获所有局部变量而非自由变量** → CLOSURE 捕获全部 locals 而非仅 lambda 实际引用的自由变量 → 内存浪费、意外生命周期延长 → 实现自由变量分析，CLOSURE 指令传递捕获变量名列表
- [compiler.py:726-787] **模式匹配无穷尽性检查** → match 所有 arm 不匹配时静默返回 Unit，编译器不做任何穷尽性检查 → 用户遗漏模式分支时无提示，默认返回 Unit 可能导致下游类型错误 → 实现模式穷尽性检查算法
- [compiler.py:全文] **顶层表达式的类型标注完全被忽略** → AST 节点的 type_annotation/return_type 字段编译器完全不读取、不验证、不使用 → 如果类型检查器被跳过或有漏洞，编译器层面没有任何防护 → 编译器至少验证类型标注的一致性
- [compiler.py:905-970] **死代码：`_compile_pattern_test` 和 `_compile_pattern_bindings`** → 两个完整方法从未被调用，是旧版模式匹配编译的遗留代码 → 代码维护负担，容易误导后续开发者 → 删除死代码
- [compiler.py:48, 75] **LOAD_CONST 和 LOOP 操作码定义但从未使用** → 常量直接作为操作数内联，常量池基本闲置；LOOP 从未发出 → 指令集膨胀，文档与实际不符 → 删除或实际使用
- [compiler.py:601-606] **管道操作符中内置函数检测的冗余分支** → if/else 两个分支都执行 `LOAD_VAR name`，完全冗余 → 代码质量问题，可能是重构残留 → 删除冗余分支
- [compiler.py:478] **STORE_VAR 操作数语义重载** → 绑定模式 2 个操作数，赋值模式 3 个操作数，且赋值模式下 mutable 操作数被 VM 忽略 → 指令语义不清晰，维护困难 → 重新设计指令格式
- [compiler.py:435-436] **None 标识符的特殊处理与其他零字段构造器不一致** → None 每次创建新 ADT 值，用户定义的零字段构造器存储为全局变量 → 不一致的运行时行为、对 None 的硬编码 → 统一所有零字段构造器的处理方式
- [compiler.py:480] **ForExpr.iterable 有时是 tuple（"range" 形式）而非 AST 节点** → 范围循环用 Python tuple 表示，不是纯 AST 节点 → AST 类型不一致，增加维护成本 → 创建正式的 RangeExpr AST 节点
- [compiler.py:708-724] **无 else 的 if 表达式栈布局效率问题** → 用 3 条指令（JUMP_IF_FALSE + JUMP + CONST_UNIT），可简化为 2 条 → 微小性能影响，代码可读性差 → 优化为更简洁的模式

#### 轻微问题（代码质量）

- [compiler.py:多处] Op 类注释与实际操作数不符（CLOSURE、LOOP_END 等）
- [compiler.py:多处] `patch_match_fail` 方法的操作数长度分支与实际使用不完全对应
- [compiler.py:多处] 管道操作符中 FnCall 路径的 callee 检测逻辑重复
- [compiler.py:多处] `_get_decl_name` 与导入冲突检测的覆盖范围不匹配
- [compiler.py:多处] `Bytecode.add_const` 的去重依赖 Python list.index 的异常控制流
- [compiler.py:多处] 错误消息中英文混杂

#### 原创性分析
- **Nova 特色**：VM 侧模式匹配栈恢复（把复杂性从编译器转移到 VM）、TRY_UNWRAP 触发函数提前返回、FOR_ITER+LOOP_END 的 for 循环高层抽象
- **参考已有**：整体栈式字节码设计参考 Python VM；常量加载、运算指令、控制流跳转、闭包、数据结构构建均为标准设计

---

## [2026-07-16] 第二十五轮审查 — 求值器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 经典树遍历解释器，双深度计数器有特色 |
| 可行性 | ⭐⭐⭐⭐☆ | 核心功能基本可用，边角情况有 bug |
| 正确性 | ⭐⭐☆☆☆ | 闭包引用 vs 值拷贝与 VM 不一致、Char 运行时无区分、TryExpr 顶层崩溃 |
| 安全性 | ⭐⭐⭐☆☆ | 不可变性检查到位，但 filter/map 谓词类型不检查 |
| 一致性 | ⭐⭐☆☆☆ | 与 VM 在闭包语义、捕获范围上有根本性差异 |
| 完整性 | ⭐⭐⭐⭐☆ | 几乎所有 AST 节点有处理，Range 用 tuple hack 是例外 |
| 工程质量 | ⭐⭐⭐☆☆ | 结构清晰但有重复代码、静默失败、冗余 try/except |
| 性能 | ⭐⭐⭐☆☆ | 树遍历解释器标准性能，闭包过度捕获有额外开销 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [evaluator.py:761-767] **闭包捕获整个环境链，与 VM 的值拷贝语义根本性不一致** → Evaluator 闭包保存 `self.env` 引用（引用语义），多个闭包共享 mut 变量；VM 闭包做 dict 浅拷贝（值语义），每个闭包独立副本 → 同一程序在 Evaluator 和 VM 中行为不同，是根本性的语义差异 → 明确设计选择并确保两个后端一致
  - 追问：如果 OCaml 的两个不同执行后端对同一语言产生不同语义，能被接受吗？→ **绝对不能。** 多执行路径一致性是编译器正确性的基本保障。

- [evaluator.py:709-710] **Char 和 String 在运行时无类型区分** → CharLiteral 求值结果是 Python str，与 StringLiteral 结果类型完全相同 → Char 类型的运行时语义完全失效，PatternChar 可以匹配单字符 String 值 → 使用包装类（如 NovaChar）或元组标记区分
  - 追问：如果 OCaml 中 char 和 string 在运行时无法区分，能被接受吗？→ **不能。** 类型系统的基本承诺在运行时失效。

- [evaluator.py:741-752] **TryExpr 在顶层代码中导致未捕获的 ReturnSignal 异常崩溃** → `?` 操作符通过抛出 ReturnSignal 实现提前返回，仅在 `_call_fn` 中被捕获；顶层使用时 ReturnSignal 一直向上抛出 → 顶层使用 `?` 操作符会导致解释器崩溃，而非友好错误 → 在 eval_program 的顶层表达式求值中捕获 ReturnSignal 并转换为运行时错误
  - 追问：如果任何生产级语言的某个构造在顶层直接导致解释器崩溃，能被接受吗？→ **不能。** 语言构造在任何上下文中都应该有定义良好的行为或明确的错误。

- [evaluator.py:1040-1050, 1098-1107] **ForExpr 和 ListComprehension 的 range 迭代使用原始 tuple 而非 AST 节点** → `iterable` 字段可能是 Python tuple `("range", start, end, step)` 而非 AST 节点 → AST 类型安全被破坏，隐式契约容易导致 bug → 创建正式的 RangeExpr AST 节点类型
  - 追问：如果 OCaml 的 AST 中有"匿名"节点用原始 tuple 表示，能被接受吗？→ **不能。** 在 ML 家族语言中，AST 是严格的代数数据类型，每个节点都有明确的构造器。

#### 中等问题（影响特定场景）

- [evaluator.py:539-541] **零字段 ADT 构造器是值而非函数，与带字段构造器语义不一致** → 带字段的构造器注册为 BuiltinFn（函数），零字段的直接注册为 NovaADTValue（值） → 零字段构造器不能用于管道操作、不能作为高阶函数参数 → 统一所有构造器为函数（零参数函数）
- [evaluator.py:228-229, 233-234] **_builtin_head/_builtin_tail 中 None 变体的 field_names 不一致** → fields 是空列表但 field_names 是 ["value"]，长度不一致 → 通过字段名访问时可能 IndexError → 零字段变体的 field_names 应为空列表
- [evaluator.py:670-675] **模块导入时静默忽略找不到的导出名** → try/except 吞掉 NameError 和 RuntimeError_，找不到的绑定静默跳过 → 模块导出声明与实际定义不一致时用户无反馈 → 至少发出警告或在开发模式下抛出错误
- [evaluator.py:554-555] **ExportDecl 不验证名称是否存在** → 只是将名字加入 _exported_names 集合，不检查是否真的在模块中定义 → 导出不存在的名字不会报错 → 第二遍求值结束后验证所有导出名称都存在
- [evaluator.py:826-838] **MapExpr 不检查重复键** → Python dict 推导式遇到重复键静默保留最后一个 → `{"a" => 1, "a" => 2}` 静默得到 `{"a": 2}`，用户可能意识不到 → 检测重复键并报错
- [evaluator.py:584-641] **eval_decl 方法存在但 eval_program 不使用，代码冗余** → eval_decl 和 _collect_decl + _eval_decl_body 高度重复 → 代码漂移风险 → 统一声明处理逻辑，消除重复
- [evaluator.py:214-220] **_builtin_filter/_builtin_map 不检查谓词返回类型** → 使用 `is True` 身份比较，truthy 值被视为 False → `filter(|x| x, [1, 2, 0, 3])` 返回空列表，与直觉不符 → 显式检查谓词返回 Bool 类型

#### 轻微问题（代码质量）

- [evaluator.py:969-976] _eval_binary_op 中除零检查位置冗余（手动检查 + try/except ZeroDivisionError）
- [evaluator.py:744-752] TryExpr 错误消息重复，两处完全相同的 RuntimeError_ 抛出
- [evaluator.py:1138-1162] _eval_match 中守卫和分支体各自创建独立的子环境，重复绑定
- [evaluator.py:815-818] Assignment 中异常捕获和重抛无意义（捕获 RuntimeError_ 然后用相同消息重抛）
- [evaluator.py:686-694] _eval_depth 计数方式可能不够精确（Block 中每个语句都增加深度）
- [evaluator.py:46-56] NovaClosure 没有 __eq__ 方法
- [evaluator.py:多处] 错误消息中英文混杂

#### 原创性分析
- **Nova 特色**：同时维护 call_depth 和 eval_depth 两个深度计数器（分层保护）、_adt_constructors 字典在运行时追踪 variant 到 type 的映射
- **参考已有**：树遍历解释器是经典模式；两遍扫描支持前向引用是标准技术；基于异常的控制流转移是经典实现；词法作用域 + 环境链是教科书式标准

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获语义 | 引用整个环境链（引用语义），多个闭包共享 mut 变量 | 捕获当前帧局部变量的 dict 拷贝（值拷贝），每个闭包独立副本 | ❌（严重不一致） |
| 闭包捕获范围 | 捕获整个环境链（过度捕获） | 只捕获当前帧局部变量 | ❌ |
| Unit 值表示 | _UnitValue 类，单例 UNIT_VALUE | UNIT_TYPE 类，单例 UNIT | 内部不同但语义一致 |
| ADT 构造器表示 | 带字段：BuiltinFn；零字段：NovaADTValue | 统一使用 NovaConstructor 类 | 不一致 |
| 顶层模式绑定作用域 | child env，arm 结束自动恢复 | 写入 globals，永不清理 | ❌ |
| Char 运行时表示 | Python str（与 String 无区分） | Python str（与 String 无区分） | ⚠️ 两者都有同样的 bug |
| 顶层 ? 操作符处理 | ReturnSignal 未捕获 → 崩溃 | _run_code 返回 False 表示提前返回 | VM 处理更优雅 |


---

## [2026-07-16] 第二十五轮审查 — 类型检查器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐☆☆☆ | 类型表示标准，算法简化程度高，无明显创新 |
| 可行性 | ⭐⭐☆☆☆ | 能对简单程序做基本检查，但复杂场景大量漏检 |
| 正确性 | ⭐⭐☆☆☆ | 无真正的合一算法，TypeVar 过度宽松，let 多态是伪实现 |
| 安全性 | ⭐⭐☆☆☆ | 大量类型错误漏检，类型标注可能被忽略 |
| 一致性 | ⭐⭐⭐☆☆ | 基本类型和内置函数一致；数字隐式转换、Int/Float 运算语义有差异 |
| 完整性 | ⭐⭐☆☆☆ | 模式匹配无穷尽性检查，递归类型别名检测失效，无 occurs check |
| 工程质量 | ⭐⭐☆☆☆ | check_expr 单方法近 500 行，函数调用与管道操作重复逻辑 |
| 性能 | ⭐⭐⭐☆☆ | 简化算法效率尚可，但正确的 HM 算法应使用 union-find |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [type_checker.py:1401-1430] **无真正的合一（unification）算法，非 Hindley-Milner 实现** → `_collect_type_bindings` 是单向匹配，只将 expected 中的 TypeVar 绑定到 actual 中的具体类型，不会反向绑定，也不会将两个 TypeVar 合一 → 高阶函数参数类型推断严重受限，相互递归的类型约束无法正确解决 → 实现基于 union-find 的真正合一算法，包含 occurs check
  - 追问：如果 OCaml 的类型检查器没有合一算法，能被接受吗？→ **绝对不能。** 合一是 HM 类型推断的核心算法，没有合一就不是 HM。

- [type_checker.py:1541-1542] **`_types_compatible` 对 TypeVar 过度宽松，等同于"未知即兼容"** → 只要任一操作数是 TypeVar 就返回 True，Int 和 String 只要中间有一个 TypeVar 节点就可能被认为兼容 → 大量类型错误无法检测，类型标注完全无法约束类型 → 实现真正的合一后，_types_compatible 应先对两个类型做合一尝试
  - 追问：如果 OCaml 的类型检查器把 'a 与 int 和 string 都认为兼容，能被接受吗？→ **绝对不能。** 这会使类型系统完全失去意义——类型变量成了 any/dynamic 类型。

- [type_checker.py:835-845, 537-547] **无泛化（generalization）步骤，let 多态是伪实现** → 只实现了实例化（instantiate），没有泛化；let 绑定处不将自由类型变量提升为多态类型方案 → 顶层函数因参数类型本身是 TypeVar 所以看起来有多态性，但非函数的多态值的多态性完全依赖于实例化时复制 TypeVar → 引入 TypeScheme 类，在 let 绑定处调用 generalize
  - 追问：如果 Haskell 的类型检查器没有 generalize，能被接受吗？→ **绝对不能。** 泛化是 let-polymorphism 的另一半，没有泛化就没有 let 多态。

- [type_checker.py:1407-1414] **无 occurs check，可能产生无穷类型** → 将 TypeVar 绑定到类型时，不检查该 TypeVar 是否出现在被绑定的类型内部 → 复杂嵌套泛型函数调用中可能构造出自引用类型，导致后续操作无限递归或栈溢出 → 在绑定前检查 _occurs_in(type_var, target_type)
  - 追问：如果 OCaml 的类型检查器没有 occurs check，能被接受吗？→ **不能。** occurs check 是类型系统正确性的基本保证。

- [type_checker.py:847-850] **块表达式中 MutBinding 不检查类型标注** → 在 check_expr 中处理 MutBinding 时，完全忽略了 expr.type_annotation → 块内的 `mut x: Int = "hello"` 不会报类型错误 → 复制 LetBinding 的模式，添加 type_annotation 检查
  - 追问：如果 Rust 的 `let mut x: i32 = "hello"` 不报错，能被接受吗？→ **绝对不能。** 类型标注是用户与编译器的契约，忽略标注等于破坏类型安全保证。

- [type_checker.py:714-726] **模式匹配完全没有穷尽性检查** → match 表达式只检查各分支返回类型一致，完全不检查模式是否覆盖所有可能情况 → 用户遗漏模式分支时无提示，运行时可能崩溃 → 实现穷尽性检查算法，至少检查 ADT 的所有变体是否被覆盖
  - 追问：如果 OCaml 的 match 不检查穷尽性，能被接受吗？→ **不能。** 穷尽性检查是 ML 家族语言模式匹配的招牌特性。

- [type_checker.py:1470-1474, 1517-1535] **类型别名循环检测机制失效** → _alias_stack 检测循环但定义顺序导致别名不被识别时循环无从谈起；_expand_alias 函数名不副实，实际只做深拷贝 → 循环类型别名要么报"未知类型名"错误要么实际上不循环 → 两遍处理类型别名，第一遍收集所有别名名称，第二遍解析目标类型
  - 追问：如果 Haskell 的 type 别名循环不检测，能被接受吗？→ **不能。** 类型别名循环是编译期必须检测的错误。

- [type_checker.py:777-787] **FnCall 中 TypeVar 类型的被调用者直接放行，绕过类型检查** → 被调用者类型是 TypeVar 时，虽然添加错误到收集器，但返回新的 TypeVar 作为返回类型让程序继续"通过" → 在 collect_errors 模式下这类代码被认为通过了类型检查，但调用合法性完全未验证 → 返回 ERROR_TYPE 而非新的 TypeVar

#### 中等问题（影响特定场景）

- [type_checker.py:792-826 vs 746-790] **PipeExpr 完全复制 FnCall 逻辑，代码重复且可能不一致** → 两处约 80 行重复，任何对 FnCall 类型检查的修复都需要同步到 PipeExpr → 抽取 _check_fn_call 辅助方法，两处共用
- [type_checker.py:1245-1254, 1278-1282] **算术运算符无隐式转换但比较运算符隐含 Int/Float 二态性** → 比较运算符硬编码了两种情况，泛型函数中无法使用比较运算符 → 引入类型类或特质系统，或至少为比较运算符添加 TypeVar 兼容逻辑
- [type_checker.py:364-365] **内置 `json_parse` 返回类型完全无约束** → 返回类型是 TypeVar("json_value")，本质上等于"任何类型" → JSON 解析结果完全没有类型安全保证 → 返回专用的 JsonValue ADT 或明确文档化这是不安全操作
- [type_checker.py:1174-1182] **构造器模式查找使用线性扫描，效率低且有命名冲突风险** → 遍历所有 ADT 的所有变体找到第一个匹配的就停止，O(n) 查找，同名构造器会出错 → 维护全局的 variant_name -> adt_name 映射表
- [type_checker.py:302, 449-450] **None 构造函数的类型存储方式与其他变体不一致** → 无参构造器存储为 ADTType 本身，有参构造器存储为 FnType → 无参构造器不能像函数一样被传递 → 统一将所有构造器注册为函数类型
- [type_checker.py:560-598] **递归函数的类型推断不完整** → 自递归函数体内调用自身时，lookup 返回的函数类型被实例化产生新 TypeVar 副本，与原本的 TypeVar 无关联 → 返回类型推断可能不正确 → 使用 fixpoint combinator 或显式的递归类型变量绑定
- [type_checker.py:648-659] **ListExpr 空列表的元素类型与类型标注不合一** → 空列表的类型标注被忽略，后续使用时元素类型仍是未知的 TypeVar → 有类型标注时应将推断类型与标注类型合一
- [type_checker.py:1065-1066] **ForExpr 中 TupleType 的元素类型取第一个元素的类型** → 元组遍历取第一个元素类型作为循环变量类型，但元组元素类型可能不同 → 元组遍历要么报错要么计算所有元素的公共超类型

#### 轻微问题（代码质量）

- [type_checker.py:618-1124] check_expr 方法过长（近 500 行），应按表达式类型拆分
- [type_checker.py:178-182] TypeVar 的 __eq__ 使用 identity 比较，__hash__ 使用 id()，调试困难
- [type_checker.py:1368-1382] _substitute_type_vars 每次调用都检测 bindings 的 key 类型，效率低
- [type_checker.py:372-386] _setup_builtins 中数学函数全部为 Float，未考虑 Int，类型检查比运行时更严格
- [type_checker.py:1271-1277] 比较运算符 ==/!= 允许任意类型比较，只要两边相同，函数类型也可以比较
- [type_checker.py:781-786] _report_error 和直接 error_collector.add 混用
- [type_checker.py:1517-1535] _expand_alias 函数名不副实，实际为深拷贝
- [type_checker.py:1079-1083] WhileExpr 返回 body 类型但语义可能为 Unit（0 次迭代时）
- [type_checker.py:多处] 错误消息中英文混杂

#### 原创性分析
- **Nova 特色**：ADT 字段访问的"所有变体共名字段"检查、? 操作符与函数返回类型的联动检查
- **参考已有**：类型表示标准（PrimType, ListType, FnType, ADTType, TypeVar）；推断算法是简化的双向检查而非真正 HM；整体模式参考所有教学型 HM 实现

---

## [2026-07-16] 第二十五轮审查 — 词法/语法分析器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 递归下降 + 优先级爬升是经典模式，语法融合多语言特性 |
| 可行性 | ⭐⭐⭐☆☆ | 基础语法可用，缺少数字字面量格式、块注释等基础功能 |
| 正确性 | ⭐⭐☆☆☆ | Token 命名不一致、死 Token、字符字面量不验证、模式匹配歧义等 |
| 安全性 | ⭐⭐☆☆☆ | 语法错误后无恢复机制，一个错误终止整个解析 |
| 一致性 | ⭐⭐☆☆☆ | Token.end_col vs Span.end_column 命名不一致；死代码多 |
| 完整性 | ⭐⭐☆☆☆ | 缺少十六进制/科学计数法/Unicode 转义/块注释/多行注释 |
| 工程质量 | ⭐⭐⭐☆☆ | 代码组织清晰，递归下降结构标准，但死代码和命名问题较多 |
| 性能 | ⭐⭐⭐☆☆ | 线性扫描词法分析、递归下降解析，标准性能水平 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [lexer.py:107 + ast_nodes.py:42 + parser.py:70-71] **Span 字段名不匹配 — Token.end_col vs Span.end_column** → Token 类使用 end_col，Span 类使用 end_column，Parser 用位置参数传入恰好对上但命名不一致 → 代码可读性差，使用关键字参数会 TypeError → 统一命名
  - 追问：如果 GCC 的 location_t 和 source_range 字段命名不一致，能被接受吗？→ **不能。** 生产级编译器有严格一致的命名规范。

- [lexer.py:155-160] **`_make_error` 是死代码，且逻辑有 bug** → 定义了但从未被调用；即使被调用，end_col 计算用 self.column 而非基于传入的起始位置 → 死代码占用维护成本，启用会产生错误位置信息 → 删除或修复并统一使用
  - 追问：如果 GCC 有从未调用的错误构造函数，能被接受吗？→ **不能。** 每个诊断函数都应有明确的调用路径。

- [lexer.py:91 + parser.py:810-812] **TokenType.UNIT 从未由词法分析器生成，parser 中 UNIT 分支是死代码** → UNIT 在枚举中定义但 lexer 从不生成，() 被解析为 LPAREN + RPAREN → 死代码误导维护者 → 删除 UNIT token 和对应的死分支
  - 追问：如果 GCC 的 token 定义与实际生成不一致，能被接受吗？→ **不能。** token 枚举必须与生成路径严格一致。

- [lexer.py:88] **TokenType.PIPE_VARIANT 从未生成，完全是死 Token** → 定义了"ADT 变体分隔符"但只生成 PIPE，全项目只出现一次 → 死枚举值，容易误导 → 删除 PIPE_VARIANT
  - 追问：如果 GCC 有"定义了但不生成"的 token 类型，能被接受吗？→ **不能。**

- [parser.py:64-73] **语法错误后无任何恢复机制 — 一个错误导致整个解析终止** → _expect 直接 raise ParseError，整个解析立即终止，没有错误同步或批量错误报告 → 用户每次只能看到一个错误，开发体验差；IDE 集成困难 → 实现 Panic Mode 错误恢复，跳过 token 直到同步点
  - 追问：如果 GCC 或 Clang 遇到第一个语法错误就终止，能被接受吗？→ **绝对不能。** 生产级编译器可以一次编译报告数十甚至上百个错误。

- [lexer.py:275-324] **字符字面量不验证字符数量 — `'ab'` 会被静默接受为 `'a'`** → 读取一个字符后只检查下一个字符是否是 '，不检查单引号之间是否只有一个字符 → 多字符字符字面量产生误导性错误消息，错误恢复后剩余字符产生级联解析错误 → 读取字符内容后检查下一个字符是否立即是 '，否则报错并正确跳过到闭合处
  - 追问：如果 GCC 对多字符字符字面量静默处理而不警告，能被接受吗？→ **不能。** GCC 对多字符字符常量有明确警告。

#### 中等问题（影响特定场景）

- [parser.py:438-445, 642-660] **管道运算符 |> 优先级位置有争议，高于 &&/|| 不符合主流函数式语言惯例** → 实际优先级：|| < && < |> < ==/!=；F#/Elixir 等语言管道优先级非常低 → 用户从其他函数式语言迁移时会产生优先级错误 → 明确文档化，或调整到 || 之下
- [parser.py:470-472, 974-976] **<- 被解析为两个独立 token（LT + MINUS），脆弱且有歧义** → 没有对应的 LEFT_ARROW token，通过匹配 LT 再 _expect(MINUS) 模拟 → for x < -3 会被误解析为范围循环 → 在 lexer 中添加 LEFT_ARROW token
- [lexer.py:202-221] **缺少十六进制、八进制、二进制整数字面量支持** → 只处理十进制数字 → 无法表达位掩码、颜色值、权限位等 → 添加 0x/0o/0b 前缀支持
- [lexer.py:202-221] **缺少科学计数法浮点数和数字分隔符** → 不支持 1e10、1.5e-3、1_000_000 → 大数字可读性差；科学/工程计算场景受限 → 补充科学计数法和数字分隔符
- [lexer.py:236-257] **字符串转义序列不完整，缺少 Unicode 支持** → 只支持 5 种转义，缺少 \\0、\\a、\\b、\\xHH、\\uXXXX 等；未知转义静默处理 → 无法表达常见特殊字符；国际化不友好 → 补充完整转义序列，未知转义至少警告
- [lexer.py:186-200] **无块注释（多行注释）支持** → 只处理 // 单行注释 → 无法临时注释大段代码；文档注释无法实现 → 添加 /* */ 块注释支持
- [parser.py:850-890] **_is_map_literal 无界前瞻扫描，最坏情况 O(n²) 复杂度** → 每次遇到 { 都向前扫描直到匹配的 } → 大型文件解析性能差 → 使用更简单的启发式或限制扫描深度
- [parser.py:504, 521] **for 循环和 match 的条件中调用 _parse_expression 导致递归过深** → 嵌套的 if/match 递归很深 → 极端嵌套可能栈溢出 → 设置递归深度限制
- [parser.py:621-633] **模式匹配中构造器模式与标识符模式歧义** → 首字母大写的标识符（如 None）如果不带参数，会被解析为标识符绑定模式而非构造器模式 → 无参数的构造器无法在模式匹配中使用 → 遵循 ML 传统，首字母大写的标识符视为构造器
- [parser.py:128-136] **导入语法过于简单，缺少选择性导入和重命名** → 只能导入整个模块，只能导出单个名称 → 模块系统功能受限，命名空间管理困难 → 扩展 import/export 语法

#### 轻微问题（代码质量）

- [parser.py:686-693] _parse_cons_expr 命名误导，实际处理 ++ 字符串拼接而非 cons 运算符
- [parser.py:480] ForExpr.iterable 字段类型不一致（有时是表达式，有时是 range tuple）
- [parser.py:392-397] 块中赋值语句的检测依赖 lookahead，但顶层赋值不支持
- [parser.py:57-62] _advance 在 EOF 处不推进但返回 EOF token，缺少断言保护
- [lexer.py/parser.py 多处] 错误消息中英文混杂
- [lexer.py:117-137] Keyword 表中 true/false 映射到 BOOL，其他关键字映射到自身，逻辑可更简洁
- [lexer.py 全文] 缺少 return 关键字和 return 表达式
- [parser.py 全文] ++ 运算符优先级位置存疑（高于 + 但低于比较）
- [lexer.py:258-264] 未闭合字符串的错误恢复跳过整个字符串内容

#### 原创性分析
- **Nova 特色**：map 字面量 { key => value } 使用 => 与代码块区分；for 循环两种语法（for x in list 和 for i <- start..end）；? 后缀错误传播
- **参考已有**：递归下降 + 优先级爬升是教科书式 Pratt parser 简化版；if-then-else 用 then 关键字借鉴 ML/OCaml；管道运算符借鉴 F#/Elixir；Lambda 用 |params| 借鉴 Ruby；ADT + pattern matching 是标准 ML/Haskell 风格

---

## [2026-07-16] 第二十五轮审查 — 错误处理/模块系统/环境深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | Rust 风格错误高亮、ErrorCollector、模块三阶段架构有现代编译器意识 |
| 可行性 | ⭐⭐☆☆☆ | 基本框架可运行，但运行时错误无定位、模块无命名空间、环境无快照 |
| 正确性 | ⭐⭐☆☆☆ | 多处计算错误（多行下划线末行偏移）、核心语义模糊、静默失败 |
| 安全性 | ⭐⭐⭐☆☆ | Python 托管无内存安全问题，但模块路径无沙箱、BindingInfo 可变引用泄漏 |
| 一致性 | ⭐⭐☆☆☆ | 命名双轨制、错误格式两套、导入逻辑三处重复实现 |
| 完整性 | ⭐⭐☆☆☆ | 错误类型覆盖基本场景但缺错误码体系；模块系统缺命名空间/重导出/选择性导入 |
| 工程质量 | ⭐⭐⭐☆☆ | 代码结构清晰、注释充分，但死代码冗余字段多、PassError 破坏继承契约 |
| 性能 | ⭐⭐⭐⭐☆ | 环境查找 O(scope_depth) 可接受，模块缓存避免重复加载 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [errors.py:320-327 + environment.py:40,48,55,61] **运行时错误完全缺失源码定位信息** → RuntimeError_ 继承自 NovaError 支持格式化，但 Environment 抛出的所有运行时错误均未传入 source/span/line/column 任何位置信息 → 用户在运行时遇到错误，完全不知道错误发生在第几行，无法调试 → Environment 持有 source_code 引用和当前执行位置，所有方法增加可选 span 参数
  - 追问：如果是 Rust 编译器的错误信息缺少源码上下文，能被接受吗？→ **绝对不能。** Rust 编译器的核心竞争力之一就是精准的源码级错误定位。

- [errors.py:68-76, 235-261] **跨文件诊断使用错误的源码上下文** → RelatedNote 没有自己的 source_code 或 file_path 字段，渲染时直接使用主错误的 source_code → 任何跨文件的诊断（循环导入、类型不匹配源于其他模块）都会显示错误的源码行 → 给 RelatedNote 添加 source_code 和 file_path 字段

- [modules.py:49-58, 276-291] **模块导出名称无验证，引用不存在的名称静默失败** → _collect_exports 只收集 export 声明的名称字符串，从不验证是否真的定义过；get_exported_bindings 用 try/except 吞掉错误 → 开发者拼写错误的导出名称不会收到任何错误提示 → 模块加载完成后遍历 exported_names，检查每个名称是否存在于环境中

- [errors.py:330-350] **PassError 破坏继承契约，完全绕过格式化系统** → PassError 继承自 NovaError 却重写 __str__ 直接返回 self.message，绕过了 _format()、ANSI 颜色、相关注释等整个基础设施 → 所有 Pass 失败的错误都以纯文本形式输出，没有颜色和上下文 → 删除 PassError.__str__ 的重写，正确调用父类构造器

- [modules.py:328-337 + evaluator.py:670-675] **导入名称静默遮蔽已有绑定，无冲突检测** → import 直接调用 target_env.define(name, value)，如果目标环境中已存在同名绑定直接覆盖，无任何警告或错误 → 模块 A 定义 print 并导出，模块 B 导入 A 后内置 print 被静默覆盖 → 导入前检查目标环境是否已存在同名绑定，根据策略处理

- [modules.py:305-339 + evaluator.py:643-675 + type_checker.py:481-533] **环境/模块系统三处重复实现导入逻辑，必然产生不一致** → ModuleManager.import_module、Evaluator._handle_import_decl、TypeChecker._handle_import_decl 三处实现，细节不一致 → 每次修改导入逻辑需要改三处，极易遗漏 → 统一到 ModuleManager.import_module，evaluator 和 type_checker 都调用此方法

#### 中等问题（影响特定场景）

- [errors.py:388-393] **ErrorCollector.add 对 NOTE/HELP 严重级别分类错误** → 只判断 severity == WARNING，其余全部归入 errors 列表 → has_errors() 在只有注释/帮助提示时也返回 True → 按 severity 完整分类：ERROR → errors，WARNING → warnings，NOTE/HELP → notes
- [errors.py:280-281] **多行错误下划线末行计算偏移错误** → 多行错误的最后一行下划线总是从行首开始画到 end_col，与实际错误范围不符 → 明确 span 语义并修正计算
- [errors.py:419-421] **ErrorCollector.get_all() 丢失时间顺序** → 返回 errors + warnings，所有错误排在所有警告前面 → 使用单一列表存储所有诊断，带序号按插入顺序返回
- [modules.py:186, 212-213] **模块缓存键未规范化，符号链接导致重复加载** → 缓存键使用 os.path.abspath 结果，没有经过 realpath 解析符号链接 → 同一文件通过不同符号链接访问会被加载多次 → 缓存键使用 os.path.realpath 规范化
- [modules.py:215-218] **循环导入检测过于激进，不支持前向引用** → 任何形式的循环导入都被立即拒绝，即使只是类型层面的相互引用 → 无法实现相互递归的数据类型 → 实现两阶段加载，类型级别的循环引用应被允许
- [environment.py:23-73] **环境无快照/恢复机制** → Environment 类没有 snapshot() 和 restore() 方法 → VM 中手动管理局部变量快照，Evaluator 中模式匹配分支间绑定泄漏 → 添加 snapshot/restore 方法
- [errors.py:46-48] **ANSI 颜色不支持 CLICOLOR/FORCE_COLOR 标准** → 只检查 isatty() 和 NO_COLOR，不支持 CLICOLOR=0、CLICOLOR_FORCE=1 等业界标准 → CI/CD 管道无法正确控制颜色输出 → 按优先级实现：FORCE_COLOR > NO_COLOR > CLICOLOR > isatty()
- [errors.py:265-283] **Tab 字符列数计算错误** → 下划线位置基于字符索引，不考虑 Tab 的显示宽度 → 使用 Tab 缩进的项目，错误提示下划线位置不正确 → 计算显示列数时将 Tab 展开为空格
- [errors.py:157-263] **错误信息中缺少文件名** → 只显示行号和列号，从不显示文件名 → 多文件项目中用户看到错误但不知道是哪个文件的 → 给 NovaError 添加 file_path 字段

#### 轻微问题（代码质量）

- [errors.py:86 vs 92] source 参数与 source_code 属性命名不一致
- [modules.py:245, 293-299] _collect_exported_types 的返回值被丢弃，死代码
- [errors.py:93, 172-174] highlight_span 旧格式兼容字段冗余
- [modules.py:47] ModuleInfo.is_loaded 永远为 True，无状态转换
- [modules.py:366-371] 全局模块管理器单例缺乏线程安全
- [environment.py:67-73] all_bindings() 存在遮蔽问题但无提示
- [errors.py:428-434] raise_all 将后续错误转为 note 丢失严重级别和类型
- [modules.py:98-105, 358-364] 默认搜索路径包含相对路径，行为不可预测
- [errors.py:134 vs 186] 错误格式两套中文化方案不一致
- [environment.py:42-48] lookup_binding 返回内部可变引用，封装性被破坏

#### 原创性分析
- **Nova 特色**：错误报告系统模仿 Rust 风格（多行源码上下文、波浪下划线、严重级别标签、相关注释）；ErrorCollector 的批量错误收集模式；模块系统的三阶段架构
- **参考已有**：错误报告格式直接参考 Rust 编译器；模块系统参考 Python import 机制；环境作用域链是教科书级标准实现


---

## [2026-07-16] 第二十五轮审查 — 所有后端深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 三层 IR + 多后端架构有野心，自研 x86_64 编码器在学习项目中少见 |
| 可行性 | ⭐⭐☆☆☆ | Native 后端仅 demo 级别，Cranelift/Wasm 不可用，C 后端相对可用 |
| 正确性 | ⭐⭐☆☆☆ | 多处严重语义错误：ELF 入口点错、栈分配 ADT 返回悬垂指针、Wasm 控制流颠倒 |
| 安全性 | ⭐☆☆☆☆ | Native 后端无 GC、无分配器，内存安全完全无保障 |
| 一致性 | ⭐⭐☆☆☆ | 各后端独立实现，数据结构布局、调用约定不统一 |
| 完整性 | ⭐⭐☆☆☆ | 仅覆盖基础算术/比较/控制流，大量 LIR 指令未实现或残缺 |
| 工程质量 | ⭐★☆☆☆ | 指令编码有 bug（REX 前缀、寄存器顺序）、编译管道绑定错误 |
| 性能 | ⭐⭐☆☆☆ | 线性扫描分配器有思路但溢出未完成，整体优化空间大 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [native_backend.py:1317-1318] **Native 后端 ELF 入口点地址计算错误** → e_entry 应该是虚拟地址而非代码段内偏移，当前 entry=start_offset=0 → 生成的 ELF 文件入口点指向虚拟地址 0，操作系统加载时发生段错误，程序完全无法运行 → 入口点应设为 base_addr + code_offset_in_file
  - 追问：如果 OCaml 的 native 编译器生成的可执行文件入口点错了，能被接受吗？→ **绝对不能。** 入口点错误是最基础的可执行文件格式错误，属于 P0 级缺陷。

- [native_backend.py:1253-1270] **Native 后端数据段 RIP-relative 重定位计算错误** → 用文件偏移差来计算 RIP-relative 偏移，而应该基于虚拟地址 → 所有字符串常量、浮点常量、全局变量的 RIP-relative 访问都会访问错误的内存地址，导致段错误或读取垃圾数据 → 确保 program header 的 p_offset 与实际数据位置一致，基于虚拟地址计算偏移
  - 追问：如果 OCaml native 编译器生成的数据引用地址全部错误，能被接受吗？→ **不能。** 这是基础架构级错误。

- [native_backend.py:1125-1189] **Native 后端 List/ADT/Tuple 在栈上分配，函数返回后失效** → LIRBuildList/LIRBuildTuple/LIRBuildADT 全部通过 sub rsp 在栈帧上分配空间 → 任何返回列表/元组/ADT 的函数都会返回悬垂指针，调用者使用时读到垃圾数据或崩溃 → 实现堆分配器，所有动态数据结构在堆上分配
  - 追问：如果 OCaml 的 native 编译器把 cons cell 分配在栈上然后返回，能被接受吗？→ **绝对不能。** 函数式语言的代数数据类型必须在堆上分配，这是最基本的语义。

- [native_backend.py 全文] **Native 后端无内存分配器，所有动态数据结构无法正常工作** → 整个后端没有任何堆内存分配机制，没有 malloc 调用，没有 brk/sbrk 系统调用，没有 mmap 分配 → 任何需要动态分配内存的操作都无法正确工作，只能运行纯整数/浮点计算的 trivial 程序 → 实现至少一个基础的堆分配器（bump allocator + mmap 申请页）
  - 追问：如果 OCaml 编译器不提供内存分配，所有数据结构都无法构建，能被接受吗？→ **不能。**

- [cranelift_backend.py:103-118, 141-255] **Cranelift 后端生成的 IR 语法错误，无法被 Cranelift 实际编译** → 参数使用 $loc 格式（应为 %name）、iconst 指令名错误、label/block 语法错误、条件分支语法错误、copy 不是 Cranelift 指令等 → 生成的 .clif 文件完全不符合 Cranelift 语法，100% 编译失败 → 参考 Cranelift 官方文档修正所有 IR 语法
  - 追问：如果 OCaml 编译器生成的 LLVM IR 语法全错，根本无法编译，能被接受吗？→ **不能。**

- [wasm_backend.py:230-232] **WasmGC 后端 Label 实现错误：用 block 替代 label 导致控制流错乱** → 将 LIRLabel 实现为 (block $block_xxx) 的开始，然后 LIRJump 用 br 跳出到目标块 → Wasm 的 block 只能向外跳，向后跳转（循环）不可能，所有包含循环的代码都会生成错误的 Wasm → 重新设计控制流 lowering，使用 loop + block 的嵌套结构或 relooper 算法
  - 追问：如果 OCaml 编译器生成的代码中循环全部变成了跳出，能被接受吗？→ **不能。**

- [compiler_pipeline.py:33-35] **编译管道中 Native 后端绑定错误：native 目标用的是 CraneliftBackend** → BACKEND_NATIVE = "native" 目标实际使用的是 CraneliftBackend，而非 NativeCodeGen → 用户选择 --target native 时得到的是 Cranelift 后端，自研的 x86_64 后端完全无法通过正常管道访问 → 修正绑定让 native 目标使用 NativeCodeGen

#### 中等问题（影响特定场景）

- [x86_64.py:82-89] **mov_reg_imm64 小立即数路径 REX 前缀错误** → 当 reg >= 8（R8-R15）时，小立即数路径只发射 0x48（REX.W），没有设置 REX.B 位 → 对 R8-R15 使用小立即数 mov 会编码为错误指令，操作的是 RAX 而非 R8 → 小立即数路径也使用 _rex_rb 或手动计算正确的 REX 前缀
- [x86_64.py:167-172] **imul_reg_reg ModR/M 中 reg 和 rm 位置颠倒** → _rex_rb(src, dst) 中 REX.R 扩展的是 src（reg 字段），REX.B 扩展的是 dst（r/m 字段），但 ModR/M 中 reg=dst, rm=src → 当 src 或 dst 是 R8-R15 时，imul 指令编码错误 → 将 _rex_rb(src, dst) 改为 _rex_rb(dst, src)
- [native_backend.py:756-769] **除法/取模破坏 RDX 寄存器但未保存** → idiv 指令同时修改 RAX（商）和 RDX（余数），寄存器分配器没有考虑 idiv 对 RDX 的隐式使用 → 如果 RDX 中持有活跃值会被静默破坏 → 编译除法/取模前检查 RDX 是否被分配给其他活跃 vreg，是则先保存
- [native_backend.py:509-541] **函数调用时栈对齐未处理** → System V AMD64 ABI 要求 call 前 RSP 必须 16 字节对齐，当前实现未保证 → 调用的函数如果依赖 16 字节栈对齐（如使用 movaps）会发生段错误 → 在函数序言中调整栈分配大小，确保调用点处 RSP 16 字节对齐
- [c_codegen.py:214, 707, 867] **C 后端 ADT 构造器字段命名与模式匹配访问不一致** → 结构体定义中的字段名是 {variant_name}_{field_name}（单下划线），模式匹配和构造器中使用的是 {variant_name}__field{i}（双下划线 + 数字索引） → ADT 模式匹配和构造器访问的字段在结构体中不存在，C 编译失败 → 统一字段命名方案
- [c_codegen.py:591-600] **C 后端 TryExpr 错误传播使用了错误的结构体字段名** → variant_tag 与生成的 tag 字段名不匹配，枚举常量名格式也不一致 → 包含 ? 操作符的代码无法编译通过
- [cranelift_backend.py + wasm_backend.py 全文] **Cranelift/Wasm 后端完全未实现模式匹配** → 只处理了基础操作，完全没有模式匹配 → 任何包含 match 表达式的代码都无法通过这两个后端编译
- [native_backend.py:74-77] **线性扫描分配器溢出时负号标记与使用不一致** → 注释说"负数表示 spill"但实际存储的是非负数；且只要有溢出就返回 None（分配失败），溢出机制实际上没有被使用 → 溢出机制名存实亡

#### 轻微问题（代码质量）

- [x86_64.py:451-457, 467-473] je_rel32 定义了两次，第二个覆盖第一个
- [native_backend.py:1012-1017] _compile_store_global 硬编码使用 RBX 作为临时寄存器，没有检查是否被分配
- [wasm_backend.py:161] 字符串扫描中使用字面量转义字节 \\x00（4个字节）而非 NUL 终止符 \x00
- [c_codegen.py:1301-1302] _infer_c_type_from_expr 对 Identifier 默认返回 int64_t，大多数情况下错误
- [native_backend.py:921-924] LIRPanic 直接 exit(1) 不输出错误信息，忽略了 message 字段
- [cranelift_backend.py:187-188] LIRIndex 硬编码 v0 + 0，完全忽略了 src_locs 中的基址和索引
- [wasm_backend.py:278-282] LIRFieldAccess 未获取基址寄存器值，假设栈上已经有基址值
- [c_codegen.py:530-534] BreakExpr/ContinueExpr 返回字符串 "break"/"continue" 作为表达式，在期望表达式的上下文中会生成非法 C 代码

#### 原创性分析
- **Nova 特色**：三层 IR 设计（参考 MLIR）、自研 x86_64 指令编码器和 ELF 生成器、多后端并行开发、线性扫描寄存器分配器
- **参考已有**：各后端架构是标准编译器设计；C 后端是标准的源到源编译模式；Wasm/Cranelift 后端参考标准后端架构

#### 各后端可行性评估
| 后端 | 评估 | 说明 |
|------|------|------|
| Native (自研 x86_64) | 演示级 | 仅能运行最简单的整数算术程序。ELF 入口点错误、数据段重定位错误、栈分配 ADT/List、无堆分配器 |
| Cranelift | 实验性（不可用） | 生成的 Cranelift IR 语法错误，无法通过 clif-util 编译 |
| WasmGC | 实验性（不可用） | 控制流实现根本性错误（block vs label 语义颠倒），循环无法工作 |
| C 后端 | 基本可用 | 四个后端中最成熟的一个。能将大部分 Nova 代码翻译为 C，但 ADT 模式匹配有字段名不一致问题 |

---

## [2026-07-16] 第二十五轮审查 — IR 系统 + Pass 管理器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 三层 IR 架构参考 MLIR 思路合理，LIR 线性表示有独特之处 |
| 可行性 | ⭐⭐☆☆☆ | 框架搭好了，但核心 lowering（match、phi、switch）都有严重正确性问题 |
| 正确性 | ⭐☆☆☆☆ | 多个核心特性的 lowering 存在根本性语义错误（match、phi、字段访问、switch），SSA 形式不完整 |
| 安全性 | ⭐⭐☆☆☆ | 没有验证 pass、__class__ 赋值 hack、动态改类等问题导致可能静默产生错误输出 |
| 一致性 | ⭐⭐☆☆☆ | 三层 IR 共享类型系统但层级不清；HIRBlockExpr 中混入 Decl 类型 |
| 完整性 | ⭐⭐⭐☆☆ | HIR 节点覆盖较全面，MIR/LIR 指令集基本定义，但多个 lowering 和优化 pass 是半实现或空壳 |
| 工程质量 | ⭐⭐☆☆☆ | 代码结构清晰但有危险的 hack（__class__ 赋值），缺乏测试、验证、错误处理 |
| 性能 | ⭐⭐⭐☆☆ | 优化 pass 框架存在，但实际生效的优化有限 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [mir_lowering.py:351-384] **MIR match lowering 完全缺失模式匹配逻辑** → 只是简单地按顺序跳转到每个 arm 块，完全没有根据 value 进行模式匹配判断的逻辑，所有 arm 按顺序串联执行 → 所有 match 表达式语义完全错误，程序行为与预期严重不符 → 实现正确的模式匹配编译策略（决策树或回溯匹配）
  - 追问：如果 LLVM 的 opt 工具静默吞掉所有 pass 异常，能被接受吗？→ **绝对不能接受。** 静默吞掉异常意味着编译器可能产生错误的输出而不告知用户。

- [lir_lowering.py:221-228] **LIR Phi 节点 lowering 只取第一个源，完全破坏 SSA 语义** → MIRPhi 节点 lowering 时只取 instr.sources[0]，忽略了 phi 节点的核心语义——根据进入的前驱块选择对应值 → 所有依赖 Phi 节点的控制流合并语义完全错误，if/match 表达式的结果值始终只取第一条分支 → Phi 节点应该在寄存器分配阶段处理，或通过"在前驱块末尾插入复制指令"实现
  - 追问：如果 Haskell GHC 的 SSA 形式中 Phi 节点只取第一个源，能被接受吗？→ **绝对不能。** 这从根本上破坏了 SSA 语义。

- [lir_lowering.py:248-258] **MIRSwitch / MIRMatchJump 退化为无条件跳转** → lowering 到 LIR 时都变成了简单的 LIRJump，条件值和 case 分支完全被丢弃 → 所有 switch 和 match_jump 的分支判定完全失效，总是执行 default 分支 → 实现正确的 lowering——生成比较 + 条件跳转序列或跳转表

- [mir_lowering.py:275-283] **MIR SSA 构造不正确——赋值不创建新 SSA 版本** → if-else 两个分支对同一变量赋值后，汇合处应该有 phi 节点但实际没有 → MIR 不是真正的 SSA 形式，任何基于 SSA 的优化都会产生错误结果 → 实现完整的 SSA 构造算法（如 Cytron 算法）

- [pass_manager.py:104-107, 114-117] **HIR 常量折叠通过 `__class__` 赋值修改对象类型** → 动态改变对象的类，然后删除旧属性添加新属性，是极度危险的 hack，破坏对象的类型不变量 → dataclass 的 __dataclass_fields__ 不会更新，asdict()/replace() 等功能全部异常；身份标识混乱 → 使用节点替换模式——在父节点中用新创建的字面量节点替换旧的二元操作节点
  - 追问：如果 LLVM 用修改对象类的方式来做常量折叠，能被接受吗？→ **绝对不能。** 这是工程上不可接受的 hack。

- [pass_manager.py:605-609] **LICM 外提位置错误：代码仍在循环内** → LIR 层 LICM 将"循环不变量"插入到 header_idx + 1 的位置（header 标签之后），但标签之后的指令仍然在循环体内 → LICM 完全没有起到外提效果，性能优化无效 → 正确的插入位置应该是 header_idx（在标签之前，即循环入口之前），或引入 preheader 基本块

- [pass_manager.py:347] **DCE 误将 LIRBinOp 视为有副作用** → side_effect_free_types 中没有包含 LIRBinOp → 死的二元运算指令无法被消除，DCE 效果大打折扣 → 将 LIRBinOp 加入 side_effect_free_types

#### 中等问题（影响特定场景）

- [pass_manager.py:92-122] **HIR 常量折叠只处理二元运算，遗漏一元运算和其他常量表达式** → 不处理 HIRUnaryOp、常量条件 if 折叠、字符串拼接、比较运算中布尔操作数 → -3 + 5 中的 -3 不会被视为常量，无法折叠 → 扩展 _fold_hir_expr 覆盖一元运算和其他可折叠的常量模式
- [pass_manager.py:50] **整数除法使用 Python 的 //（向下取整），与主流语言语义不一致** → Python // 是 floor division，C/Java/Rust 用向零取整 → 如果 Nova 语义是向零取整，则常量折叠会在负数除法时产生错误结果 → 明确 Nova 的整数除法语义，如需对齐则使用 int(a / b)
- [pass_manager.py:459-486] **CSE 是纯局部的，且 MIR CSE 替换语义错误** → 只在单个基本块内做 CSE；且用 MIRLoad 替换重复计算，但 MIRLoad 的语义是加载变量而非复制 SSA 值 → MIR CSE 可能产生错误结果 → 添加 MIRCopy 指令或用真正的值编号算法做全局 CSE
- [pass_manager.py:653-657] **MIR LICM 只分析 header 块，不分析整个循环体** → 循环定义的变量应该包括所有循环体内基本块定义的变量，只看 header 块会大量误判 → 可能将依赖循环体内定义值的指令错误地外提 → 正确识别循环的所有基本块，收集所有循环内定义的 SSA 名
- [pass_manager.py:336-343] **DCE 中不可达代码判定有缺陷** → 简单假设 LIRJump 之后下一个 LIRLabel 之前的指令都是不可达的 → 可能错误地删除可达代码 → 正确的不可达代码分析需要从函数入口做前向可达性分析
- [ir_nodes.py:723-729] **LIR 结构混乱：线性指令序列混有标签，非标准 CFG 表示** → LIR 函数体是线性的 List[LIRInstr]，夹杂 LIRLabel → 难以进行 CFG 分析，基本块边界模糊，所有 LIR 层优化都需要手动处理标签边界 → LIR 也使用基本块结构，保持与 MIR 一致
- [lir_lowering.py:114-119] **MIRStore 全部 lowering 为 LIRStoreGlobal，局部变量被当作全局变量** → 所有 MIRStore 都被 lowering 为 LIRStoreGlobal，MIRLoad 也都 lowering 为 LIRLoadGlobal → 局部变量和全局变量在 LIR 层没有区别，两个函数同名局部变量会产生冲突 → 区分局部变量和全局变量的存储加载
- [pass_manager.py 全文] **无 IR 验证 Pass** → 没有任何 IR 验证 pass 检查各层 IR 的正确性 → 优化 Pass 产生的错误 IR 无法被及时发现 → 实现 IRVerifier Pass，检查基本块终结指令、SSA 形式、类型一致性、CFG 完整性

#### 轻微问题（代码质量）

- [ir_nodes.py 全文] 所有 IR 节点都没有源码位置信息，错误报告无法定位源码
- [pass_manager.py:258-263] Inlining pass 是空壳，直接 return False，但被加入默认优化管道
- [mir_lowering.py:285-289] MIR ListComprehension lowering 为空实现，直接返回空列表
- [lir_lowering.py:188-193] MIRMapBuild lowering 为 LIRBuildList，类型信息丢失
- [hir_lowering.py:292-300] HIRLetDecl 被放入 HIRBlockExpr 的 exprs 列表中，违反类型约束（HIRLetDecl 不是 HIRExpr）
- [lir_lowering.py:242-246] LIR Return 的 src_locs 类型硬编码为 UNIT_TYPE，而非实际返回类型
- [pass_manager.py:108, 155] 常量折叠中比较运算结果用 HIRIntLiteral 表示布尔常量，不规范
- [pass_manager.py:724, 743, 762] PassError 使用 __class__.__name__ 而非 name 属性
- [pass_manager.py:763-766] 优化 Pass 顺序不合理，DCE 应该在 CSE 和 LICM 之后运行

#### 原创性分析
- **Nova 特色**：三层 IR 设计（HIR→MIR→LIR）参考 MLIR 思路；LIR 线性指令序列 + 标签的设计比较独特（更接近汇编表示）；Pass 管理器框架完整
- **参考已有**：SSA 形式、优化 pass 类型（常量折叠、DCE、CSE、LICM）都是标准编译器优化

#### 所有优化 Pass 实现状态表
| Pass 名称 | HIR 层 | MIR 层 | LIR 层 | 总体状态 |
|-----------|--------|--------|--------|----------|
| ConstantFolding | 部分实现（仅二元运算，__class__ hack） | 部分实现（仅局部，仅 int/float） | 部分实现（仅线性扫描，仅 int/float） | 部分实现 |
| Inlining | 空壳 | 未实现 | 未实现 | 空壳 |
| DeadCodeElimination | 空壳 | 空壳 | 部分实现（副作用列表不完整，不可达判定有误） | 部分实现 |
| CommonSubexprElimination | 未实现 | 部分实现（纯局部，替换语义错误） | 部分实现（纯局部，无全局优化） | 部分实现 |
| LoopInvariantCodeMotion | 未实现 | 部分实现（只看 header 块） | 有缺陷（外提位置错误） | 严重缺陷 |
| IRVerifier | 不存在 | 不存在 | 不存在 | 完全缺失 |

---

## [2026-07-16] 第二十五轮审查 — 运行时 + 测试 + Tree-sitter 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐☆☆ | 引用计数 + 类型标签的 C 运行时有想法；多后端测试架构不错 |
| 可行性 | ⭐⭐☆☆☆ | 基本数据结构可用，但内存泄漏严重、GC 不存在、HTTP 状态码硬编码 |
| 正确性 | ⭐⭐☆☆☆ | release 不释放子对象导致系统性泄漏、GC 空壳、JSON 解析格式校验不足 |
| 安全性 | ⭐⭐☆☆☆ | 类型混淆释放、未初始化内存、非线程安全、JSON 越界读取风险 |
| 一致性 | ⭐⭐⭐☆☆ | 大部分特性在 Evaluator 和类型检查器中一致，但 C 运行时与 Python 端数据模型不一致 |
| 完整性 | ⭐⭐⭐☆☆ | 核心数据结构有实现，但标准库薄弱、缺少一致性测试 |
| 工程质量 | ⭐⭐☆☆☆ | 代码组织清晰，但全局状态多、注释承认"碰巧不崩溃"的危险推理 |
| 性能 | ⭐⭐☆☆☆ | 引用计数开销大、FNV-1a 哈希无扩容优化、字符串操作无 SSO |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [nova_runtime.c:99-103] **`nova_gc_collect` 完全是空壳——GC 不存在** → 函数名为 gc_collect 但实际只是返回 g_alloc_count - g_free_count 的统计值，不回收任何内存，不检测循环引用 → 循环引用导致的内存泄漏完全无法回收；任何依赖 gc_collect 做内存回收的代码都会持续泄漏 → 要么实现真正的 tracing GC，要么重命名为更诚实的名称
  - 追问：如果 GHC 的 GC 实际上什么都不做只是返回统计数字，能被接受吗？→ **不能接受。名为 GC 却不做 GC，是 API 欺诈。**

- [nova_runtime.c:479-486, 651-668, 749-756, 791-798] **list/map/adt/closure 的 release 不释放子对象——系统性内存泄漏** → nova_list_release 只释放 items 数组指针不释放每个元素；nova_map_release 只释放 key 不释放 value；nova_adt_release 只释放 fields 数组不释放每个字段；nova_closure_release 只释放 captured 数组不释放捕获值 → 任何包含堆分配对象的 List/Map/ADT/Closure 都会泄漏所有子对象，嵌套结构泄漏呈指数级 → 为容器添加类型标签或 release 函数指针，递归释放所有子对象
  - 追问：如果 CPython 的 list 释放时不释放元素，能被接受吗？→ **绝对不能。** 这是运行时最基本的内存管理正确性。

- [nova_runtime.c:536-538] **`nova_map_put` 中类型混淆导致内存损坏** → 无条件地将 entry->value 强制转换为 NovaValue* 并调用 nova_value_release，Map 的 value 是 void* 泛型，实际可能是任何类型 → 存入非 NovaValue* 类型的 value 时，更新操作会破坏被指对象的内存，可能导致数据损坏、崩溃、安全漏洞 → Map 需要知道 value 的类型信息，添加类型标签或 dtor 函数指针
  - 追问：如果 GHC 的运行时把任意指针都当作同一种类型来释放，能被接受吗？→ **绝对不能接受。这是类型安全的根本违反。**

- [nova_runtime.c:597-613] **`nova_map_remove` 不释放 value，导致内存泄漏** → 只释放了 key 和 entry，完全没有释放 entry->value；nova_map_release 也有同样问题 → 每次 remove 操作泄漏一个 value → 添加 value 释放逻辑（需先解决类型混淆问题）

- [nova_runtime.c:1700-1703, 1770-1772] **HTTP 响应状态码硬编码为 200** → 使用了 curl -w "%{http_code}" 但从未读取或解析状态码，status_code 直接硬编码为 200 → 404、500、403 等所有非 200 响应都被报告为 200，调用方无法判断请求是否成功 → 捕获 curl 的 stdout（即 -w 的输出），解析为整数状态码

- [tests/ 全文] **无 Evaluator vs VM 行为一致性测试** → 两套测试各自独立，没有任何测试验证同一输入在 Evaluator 和 VM 下产生完全相同的输出 → 两个后端的语义漂移无法检测 → 添加一致性测试套件，对同一组测试用例同时运行 Evaluator 和 VM
  - 追问：如果 GHC 缺少核心语言特性的跨后端一致性测试，能被接受吗？→ **不能接受。多执行路径一致性是编译器正确性的基本保障。**

- [nova_runtime.c:1103-1105] **JSON 解析器 key 字符串扫描中 `p->pos += 2` 可能越界读取** → 当 JSON 字符串以 \ 结尾（未闭合转义）时，+=2 可能使 pos 超出 len，后续 nova_string_new_len 读取越界内存 → 这是缓冲区过读漏洞 → 遇到 \ 时只 p->pos++ 一次，然后再检查边界

#### 中等问题（影响特定场景）

- [nova_runtime.c:1009-1048] **JSON 数字解析器不校验格式——非法数字也能"解析"** → 输入 "-"、"-. "、"1e" 等非法数字不会报错，静默产生错误值 → 格式错误的 JSON 数字不会报错 → 添加格式校验，保证数字格式符合 JSON 规范
- [nova_runtime.c:79-87] **nova_realloc 不更新 g_alloc_count/g_free_count** → realloc 分配新内存并释放旧内存时两个计数都不更新 → nova_gc_collect() 返回的净分配数不准确 → 正确更新计数
- [nova_runtime.c:1240-1256] **JSON \u 转义不支持代理对（surrogate pairs）** → 每个 \uXXXX 独立转换为 UTF-8，对于代理对会产生两个独立的无效 UTF-8 序列 → 包含 emoji 或其他非 BMP 字符的 JSON 字符串解析不正确 → 实现代理对组合逻辑
- [tree-sitter-nova/grammar.js 全文] **Tree-sitter 语法缺少 `?`（try/错误传播）运算符** → Python parser 支持 expr?（TryExpr），但 tree-sitter 语法中完全没有 → 所有包含 ? 运算符的代码在 Tree-sitter 中无法正确解析 → 在 grammar.js 中添加 try 后缀运算符
- [nova_runtime.c:1165-1188] **json_parse_true/false/null 不验证完整匹配** → 直接跳过固定字节数，不验证输入是否真的是 true/false/null → 格式错误的 JSON（如 { "a": truthy }）不会报错 → 验证剩余字符是否与预期完全匹配
- [nova_runtime.c:827-843] **nova_read_line 固定缓冲区 4096 字节——长行被截断** → 使用固定大小的栈缓冲区，fgets 只读取部分内容 → 长输入行被静默截断，数据丢失 → 动态分配缓冲区或循环读取
- [nova_runtime.c:39-43] **全局状态无任何同步原语，完全非线程安全** → 4 个全局静态变量（g_argc, g_argv, g_alloc_count, g_free_count）无同步保护 → 多线程环境下竞态条件 → 使用原子操作或线程局部存储
- [grammar.js + parser.py] **Tree-sitter 运算符优先级与 parser.py 不一致** → 管道优先级 tree-sitter 最低（低于 OR），parser.py 中在 AND 和 equality 之间；concat 优先级也不同 → 语法高亮和代码导航可能与实际解析结果不一致 → 统一两边的运算符优先级表
- [nova_runtime.c:205-211] **nova_string_find 空字符串和 NULL 指针返回 0** → NULL 指针返回 0 可能被误判为"在位置 0 找到" → NULL 指针应返回 -1

#### 轻微问题（代码质量）

- [nova_runtime.h:76-89] NovaValue 的 ref_count 字段冗余（双层引用计数）
- [nova_runtime.c:1468-1494] nova_value_release 的 switch 缺少 NOVA_VAL_UNIT 和 NOVA_VAL_NULL case（用 default: break 掩盖）
- [nova_runtime.c:1711-1712] nova_http_post 的 headers 参数被忽略（(void)headers;）
- [nova_runtime.c:926-932] nova_get_cwd 固定 4096 字节缓冲区，长路径可能截断
- [nova_runtime.c:137-138] nova_string_new_len 最小容量 16 字节，大量短字符串场景内存浪费
- [tests/] 测试文件命名不一致，有些测试在 test_nova.py 中，有些在独立文件中
- [tree-sitter-nova/grammar.js] block_expr 的分号处理可能不正确（三个表达式之间没有分号也合法）
- [tree-sitter-nova/] 语料测试严重不足（只有 6 个测试文件）
- [tests/] 后端测试只验证"能编译"，不验证"结果正确"
- [tests/] 测试文件混用 unittest 和 pytest 两种风格

#### 测试覆盖统计表
| 测试模块 | 测试数量 | 所在文件 | 覆盖范围 |
|---------|---------|---------|---------|
| Lexer | ~20 | test_nova.py | 基本 token 类型、注释、行号、转义 |
| Parser | ~40 | test_nova.py | 字面量、绑定、函数、控制流、运算符优先级、ADT、lambda、import/export |
| TypeChecker | ~12 | test_nova.py | 基本类型、算术、比较、逻辑、函数、类型不匹配 |
| Evaluator | ~80+ | test_nova.py | 字面量、算术、字符串、列表、函数、闭包、ADT、Option、管道、内置函数 |
| Bytecode VM | ~122 | test_nova.py | 字面量、算术、字符串、控制流、函数、闭包、列表、ADT、循环、栈平衡 |
| Error Reporting | ~36 | test_errors.py | 错误收集、格式化、span、严重级别 |
| Backends | ~43 | test_backends.py | Cranelift、WasmGC、编译管道 |
| C Codegen | ~52 | test_c_codegen.py | C 代码生成 |
| IR | ~94 | test_ir.py | HIR/MIR/LIR lowering、pass manager |
| Modules | ~28 | test_modules.py | 模块系统 |
| Native Backend | ~118 | test_native_backend.py | x86_64 后端、寄存器分配、代码生成 |
| Type System | ~100 | test_type_system.py | 类型推断、泛型、ADT 类型 |
| **总计** | **~848** | - | - |

**关键空白区域**：无 Evaluator vs VM 一致性测试、无 GC/内存管理测试、无模糊测试、C 运行时无自动化测试、无性能基准测试
...
| 所有后端 | 7 | 8 | 8 | 23 |
| IR 系统 + Pass | 7 | 8 | 9 | 24 |
| 运行时 + 测试 + Tree-sitter | 7 | 9 | 10 | 26 |
| **合计** | **53** | **80** | **79** | **212** |

### 最关键的 P0 问题（本轮新发现）

1. **闭包语义在 Evaluator 和 VM 之间根本性不一致** — 引用语义 vs 值拷贝，可变变量共享行为不同
2. **MIR match lowering 完全缺失模式匹配逻辑** — IR 系统核心特性崩溃，所有 match 表达式语义错误
3. **类型检查器无真正的合一（unification）算法** — 不是真正的 HM 类型推断，TypeVar 过度宽松
4. **类型检查器 let 多态不正确** — 无 generalize 步骤，函数式语言的核心类型系统特性缺失
5. **Native 后端栈分配 ADT/List 返回悬垂指针** — 函数式语言最基本的语义违反
6. **Native 后端 ELF e_entry = 0** — 生成的可执行文件一运行就段错误
7. **C 运行时 release 不释放子对象，系统性内存泄漏** — 任何非平凡程序都会大量泄漏内存
8. **C 运行时 nova_gc_collect 是空壳** — 名为 GC 却不做 GC
9. **无 Evaluator vs VM 一致性测试** — 两个后端语义漂移无法检测
10. **编译器多字段混合模式匹配栈错位** — 构造器/元组/列表模式中混合字面量和变量绑定时读取错误的栈值

### 建议优先修复顺序

**P0（致命）**：
1. 修复闭包语义一致性（引用 vs 值拷贝）——这是最核心的语义分歧
2. 修复类型检查器的合一（unification）算法
3. 修复编译器模式匹配多字段混合模式栈错位问题
4. 修复 MIR match lowering——添加真正的模式匹配判定逻辑
5. 修复 C 运行时的内存泄漏（release 递归释放子对象）

**P1（重要）**：
6. 建立 evaluator vs VM 一致性测试套件
7. 修复 Native 后端的 ELF 入口点和栈分配问题（或明确标记为实验性并禁用）
8. 实现模式匹配穷尽性检查
9. 修复顶层模式绑定泄漏和非穷尽 match 栈不平衡
10. 统一错误报告体系（所有阶段都走 ErrorCollector，运行时错误携带位置信息）

**P2（改进）**：
11. 实现 let-polymorphism（泛化 + 实例化）
12. 添加 IR 验证 pass
13. 完善 Tree-sitter 语法覆盖（? 运算符、优先级统一）
14. 添加十六进制/科学计数法/Unicode 转义/块注释等基础词法功能
15. 修复模块系统的命名空间隔离和冲突检测

---

---

## [2026-07-16] 第二十六轮审查 — VM 虚拟机深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配栈基指针恢复、while 循环栈槽结果值、循环 ID 计数器等有独到思考 |
| 可行性 | ⭐⭐⭐⭐ | 核心功能均已实现且有测试验证，能跑通实际程序 |
| 正确性 | ⭐⭐⭐ | 核心路径正确，但多处错误类型逃逸、顶层 TRY_UNWRAP 语义不明确 |
| 安全性 | ⭐⭐⭐ | _loop_id 替代 id() 是改进，但循环状态字典泄漏风险、动态属性检查仍存问题 |
| 一致性 | ⭐⭐⭐ | 大部分功能与 evaluator 一致，但错误处理、边界情况、内置函数类型检查有多处差异 |
| 完整性 | ⭐⭐⭐⭐ | 66 个操作码全部实现，覆盖语言主要特性 |
| 工程质量 | ⭐⭐⭐ | 代码组织清晰但函数过长，状态管理分散，防御性编程不足 |
| 性能 | ⭐⭐⭐ | 纯 Python 解释器性能受限，闭包全量捕获影响效率 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [vm.py:986-989] **CLOSURE 过度捕获整个帧（内存泄漏）** → 闭包持有全部局部变量引用，包括无关大对象，阻碍 GC 回收 → 编译器分析自由变量，CLOSURE 指令仅携带所需变量列表
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能接受。** 闭包转换是函数式语言编译器的核心步骤，过度捕获不仅浪费内存，还会阻碍 GC 回收。

- [vm.py:1065-1066] **FIELD_ACCESS 元组索引越界未捕获为 RuntimeError** → 抛出 Python 原生 IndexError 而非 Nova 错误，与 evaluator 行为不一致 → 捕获 IndexError 并转换为 RuntimeError_
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 生产级 VM 必须将所有内部运行时错误统一为语言定义的错误类型。

- [vm.py:1035-1045] **BUILD_MAP 键不可哈希时抛出 Python 原生 TypeError** → Python TypeError 直接逃逸，对比 evaluator 有详细可哈希性检查和友好错误信息 → 捕获 TypeError 并转换为 RuntimeError_
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 统一错误类型是生产级解释器/VM 的基本要求。

- [vm.py:577-587] **顶层 TRY_UNWRAP 静默失败，错误值丢失** → 顶层 `?` 操作符触发错误传播时程序静默退出，用户永远不知道程序为什么没有输出 → 顶层检测到错误传播时打印错误信息并以非零状态退出
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 顶层错误传播应该有明确定义的行为（报错或崩溃），而非静默失败。

- [vm.py:947] **FOR_ITER 循环中 BREAK 通过索引访问 result_list 无边界检查** → 栈被意外破坏时会抛出 Python IndexError 而非语言级错误 → 添加防御性检查

#### 中等问题（影响特定场景）
- [vm.py:194-232] **内置函数普遍缺少参数类型检查** → str_len/list_length/sum/filter/map 等完全不检查参数类型 → 为每个内置函数添加参数类型验证
- [vm.py:195] **read_line 内置函数不处理 EOFError** → 遇到 EOF 时直接抛出 Python EOFError 导致崩溃 → 捕获 EOFError 并返回空字符串
- [vm.py:517-521, 1001-1006] **RETURN 指令在两处重复实现，逻辑不一致** → _execute_function 中的特殊处理与 _execute_instruction 中的实现语义不同 → 统一 RETURN 的处理逻辑
- [vm.py:900-912] **while 循环的 base_sp 记录时机依赖 POP_JUMP_IF_FALSE 的副作用** → 循环控制状态初始化与条件跳转指令耦合，逻辑脆弱 → 使用专门的循环开始指令标记循环入口
- [vm.py:178, 181, 1098-1177] **循环状态分散在三套独立数据结构中** → _for_iters/_range_index/_list_index 三套管理，增加复杂度和泄漏风险 → 将循环索引统一存储在 _for_iters 条目中

#### 轻微问题（代码质量）
- [vm.py:619-1470] _execute_instruction 巨型 if-elif 链（约 850 行），建议改用 opcode→handler 分发表
- [vm.py:594] _pop 返回列表的多余反转操作，可优化
- [vm.py:473, 500, 504] 函数调用的循环状态保存使用 hasattr 动态检查，应在 __init__ 中初始化
- [vm.py:348-351] _format_value 中 None 与 UNIT 的区分增加概念复杂度
- [vm.py:1461-1465] LOOP 指令语义模糊，编译器实际使用 JUMP，LOOP 似乎未被生成

#### 原创性分析
- **Nova 特色**：模式匹配的栈基指针恢复机制（match_stack_bases + _pattern_fail_cleanup）、while 循环的栈槽结果值方案、循环 ID 计数器替代 id()、TRY_UNWRAP 的 bool 返回值提前返回机制
- **参考已有**：整体栈式 VM 架构经典（Python/JVM/Lua 风格），ADT + 构造函数的运行时表示为 ML 家族标准

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| read_line EOF 处理 | 捕获 EOFError 返回 "" | 不处理，抛 Python EOFError | ❌ |
| 顶层 `?` 错误传播 | ReturnSignal 冒泡崩溃 | 静默退出，错误值留栈上 | ❌（都不理想） |
| FIELD_ACCESS 元组越界 | RuntimeError_("元组索引越界") | Python IndexError 逃逸 | ❌ |
| BUILD_MAP 不可哈希键 | RuntimeError_ + 友好信息 | Python TypeError 逃逸 | ❌ |
| 闭包 Unit 值单例 | UNIT_VALUE（_UnitValue 类） | UNIT（UNIT_TYPE 类） | 语义一致，实现不同 |
| 闭包捕获语义 | 引用语义（可变变量修改影响外部） | 值语义（复制快照） | ❌ **严重不一致** |
| 基本算术 | 正确 | 正确 | ✅ |
| ADT 构造 | 正确 | 正确 | ✅ |
| 模式匹配 | 正确 | 正确 | ✅ |
| 管道操作 | 正确 | 正确 | ✅ |
...
## [2026-07-16] 第二十六轮审查 — 编译器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配 VM 端统一清理、PIPE_CALL 专用指令、TRY_UNWRAP 字节码级提前返回等有亮点 |
| 可行性 | ⭐⭐⭐⭐ | 核心编译流程可用，基本功能正确 |
| 正确性 | ⭐⭐⭐ | Char 类型缺失、闭包全捕获、match 静默失败都是正确性问题 |
| 安全性 | ⭐⭐ | 无穷尽性检查、导入覆盖无报错、可变捕获不精确 |
| 一致性 | ⭐⭐⭐ | 大部分栈布局一致，但列表推导式不进循环栈等不一致 |
| 完整性 | ⭐⭐⭐ | AST 节点全覆盖，但 TCO、常量池、错误处理等未完成 |
| 工程质量 | ⭐⭐⭐ | 死代码多、注释与实现不一致 |
| 性能 | ⭐⭐ | 无 TCO、全量闭包捕获、内联导入重复编译 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [compiler.py:406, 686] **闭包捕获全部局部变量，无自由变量分析** → 每次创建闭包都复制整个 locals 字典，内存泄漏 + 语义错误 → 实现自由变量分析，CLOSURE 指令仅携带自由变量列表
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能接受。** 全环境捕获是教学级解释器的做法，不是生产级编译器。

- [compiler.py:424-425] **CharLiteral 被编译为 CONST_STRING，字符类型完全缺失** → 'a' 与 "a" 在运行时无法区分，类型系统根基被破坏 → 引入独立的 Char 运行时类型和 CONST_CHAR 指令
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **完全不能接受。** Char 是独立的基本类型，与 String 明确区分。

- [compiler.py:781-783] **模式匹配非穷尽时静默返回 Unit，无任何警告** → 所有模式都不匹配时静默返回 ()，掩盖大量逻辑错误 → 实现穷尽性检查，运行时非穷尽触发 Match_failure 异常
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** OCaml 会发出警告，GHC 默认报错。静默返回 Unit 会掩盖大量逻辑错误。

- [compiler.py:367-372] **导入冲突检测仅覆盖函数，漏掉 Let/Mut/Type 绑定** → 主文件 let x = 5，导入模块也 export x = 10，导入会静默覆盖连警告都没有 → 扩展冲突检测到所有绑定类型
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** Nova 的内联导入模型本身就危险，连基本的冲突检测都不完整。

- [compiler.py:1097-1158] **列表推导式不加入 _loop_stack，break/continue 语义错位** → 列表推导式的循环不进循环栈，break/continue 可能找到外层循环 → 列表推导式也 push 到 _loop_stack

#### 中等问题（影响特定场景）
- [compiler.py:905-970] 死代码 _compile_pattern_test/_compile_pattern_bindings 包含错误逻辑（PatternTuple/PatternList → MATCH_WILDCARD），应立即删除
- [compiler.py:48, 75] LOAD_CONST/LOOP 指令定义了但从未使用，整个常量池架构是死代码
- [compiler.py:81] CLOSURE 操作数注释与实际不符（注释说 code_key，实际只有 2 个操作数）
- [compiler.py:478] Assignment 的 STORE_VAR 操作数位置不明确，mutable 标志位硬编码为 True
- 无尾调用优化（TCO）— 对于函数式语言是基本期望
- [compiler.py:323-374] Import 内联导致函数体字节码重复，多模块导入同一依赖时重复编译

#### 轻微问题（代码质量）
- [compiler.py:601-608] pipe 编译中 builtin 分支和 else 分支完全相同，可合并
- [compiler.py:632-643] _compile_fn_call 中 ADT 构造器硬编码（仅 Some/Ok/Err）
- [compiler.py:319-321] _get_decl_name 未覆盖 VariantDef
- [compiler.py:193-209] patch_jump 与 patch_match_fail 职责重叠，可合并
- 多处命名不一致、方法名过长

#### 原创性分析
- **Nova 特色**：VM 端统一模式匹配失败栈清理（编译器简化，VM 复杂化的权衡）、PIPE_CALL 专用管道调用指令、FOR_ITER + LOOP_END 配对循环指令、MATCH_START/MATCH_END 显式标记
- **参考已有**：基本栈机设计参考 CPython/JVM；字节码回填技术为经典两遍编译方法

---

## [2026-07-16] 第二十六轮审查 — 求值器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 标准树遍历解释器架构，两遍扫描支持前向引用是亮点 |
| 可行性 | ⭐⭐⭐⭐ | 作为教学/原型语言的解释器完全可行 |
| 正确性 | ⭐⭐⭐ | 大部分功能正确，但闭包语义与 VM 不一致是硬伤 |
| 安全性 | ⭐⭐⭐ | 递归深度保护到位，但缺少类型安全保证，错误消息缺少位置信息 |
| 一致性 | ⭐⭐⭐ | 与 VM 后端存在闭包语义差异，错误处理风格不一致 |
| 完整性 | ⭐⭐⭐⭐ | 覆盖所有 AST 节点类型，内置函数较丰富 |
| 工程质量 | ⭐⭐⭐ | 代码重复、错误处理冗余、缺少位置信息 |
| 性能 | ⭐⭐ | 树遍历解释器天然较慢，无 TCO，break/continue 用异常实现有开销 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [evaluator.py:49-53, 450-469] **闭包捕获是引用语义，与 VM 的值语义根本不一致** → Evaluator 中闭包修改 mut 捕获变量影响外部，VM 中则不会，同一程序在两个后端产生不同结果 → 统一闭包语义（建议采用值语义，与 VM 对齐）
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 同一语言的不同执行路径必须语义一致，这是最基本的正确性要求。

- [evaluator.py:741-752] **TryExpr（`?` 操作符）在顶层/非函数上下文中会崩溃** → ReturnSignal 只在 _call_fn 中被捕获，顶层 `?` 会导致程序崩溃而非正常错误传播 → 顶层检测 ReturnSignal 并给出明确错误
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 顶层的 `?` 应该被类型检查器拒绝，运行时也应有防御性检查。

- [evaluator.py:1037-1071] **ForExpr 完全忽略 step 字段，依赖 tuple hack** → AST 节点的 step 字段从未被读取，通过检查是否为 ("range", ...) 元组判断范围循环 → 直接使用 ForExpr.step 和 ForExpr.iterable 的类型判断
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **不能接受。** 这是典型的"stringly typed"反模式，AST 字段被忽略转而依赖非类型化的 tuple 结构。

- [evaluator.py:817] **MapExpr 之前完全缺失（现已修复？需确认）** → 任何使用 map 字面量的程序之前会崩溃 → 确认已实现并验证正确性
- 追问：如果是 OCaml/Haskell 的编译器，已定义的 AST 节点在解释器中完全没有处理能被接受吗？→ **不能。** 相当于前端识别了语法但后端无法执行。

#### 中等问题（影响特定场景）
- [evaluator.py:1166-1226] PatternList 不支持 cons 模式（[head :: tail]）— 函数式语言核心功能缺失
- [evaluator.py:826-838] MapExpr 的键求值两次（try 块一次，except 块重新遍历），有副作用时会执行两次
- [evaluator.py:813-819] Assignment 错误处理冗余，assign 本身就抛 RuntimeError_ 又被捕获重抛
- [evaluator.py:972-974] 整数除法使用 // 但浮点除法使用 /，类型混淆
- [evaluator.py:1037-1071] ForExpr 返回值语义不明确（for 返回 List，while 返回最后迭代值）
- 环境查找无作用域层级检查，无法区分"局部 vs 闭包 vs 全局"

#### 轻微问题（代码质量）
- [evaluator.py:394-397] _format_value 中 None 输出为 "null"，UNIT_VALUE 输出为 "()"，两个空值概念易混淆
- [evaluator.py:343-344] _builtin_abs 返回 float 而非保留输入类型
- [evaluator.py:418-421] 内置函数的部分应用使用 Python 闭包，不保留 BuiltinFn 的完整语义
- 所有 raise RuntimeError_(...) 调用都缺少 span 信息，错误消息无法显示出错位置
- 没有 Tail Call Optimization (TCO)
- eval_decl 与 _eval_decl_body 代码重复

#### 原创性分析
- **Nova 特色**：两遍扫描支持前向引用、`?` 错误传播操作符、管道操作符、表达式导向的控制流
- **参考已有**：树遍历解释器架构经典（LISP 时代即存在）、作用域链环境模型标准（类似 JS 原型链/Scheme 环境模型）

---

## [2026-07-16] 第二十六轮审查 — 类型检查器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两遍扫描架构、ErrorType 错误恢复、ADT 字段访问有工程巧思 |
| 可行性 | ⭐⭐⭐ | 对于简单程序（有类型标注的函数、基本泛型 ADT）可以工作 |
| 正确性 | ⭐⭐ | 核心类型兼容性检查存在致命缺陷（TypeVar 与任何类型兼容） |
| 安全性 | ⭐⭐ | ErrorType 避免崩溃，但类型系统本身无法提供足够的类型安全保证 |
| 一致性 | ⭐⭐⭐ | 类型表示体系设计较一致，但错误报告有两条路径 |
| 完整性 | ⭐⭐ | 支持的类型语法较完整，但类型推断核心功能（合一、泛化、occurs check）全部缺失 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，注释充分，但缺少核心算法的深度实现 |
| 性能 | ⭐⭐⭐⭐ | 简单结构比较，复杂度 O(n) 级，小型程序性能足够 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [type_checker.py:1541-1542] **_types_compatible 中 TypeVar 与任何类型兼容** → 只要任何一方是类型变量，类型检查就直接通过，大量类型错误无法检测 → 实现真正的合一（unification）算法
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 这相当于关闭了类型检查器的核心功能。

- [type_checker.py 全文] **没有真正的合一（unification）算法** → 仅有单向的 _collect_type_bindings，无法处理双向类型推导 → 实现完整的合一算法（含 occurs check）
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 合一是 HM 类型推断的核心引擎，没有合一就没有类型推断。

- [type_checker.py 全文] **没有泛化（generalization）步骤** → 没有 generalize 函数将自由类型变量提升为多态类型方案，let 多态不正确 → 实现 generalize + 类型方案（type scheme）
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 泛化是 let 多态的基石，没有它就没有 HM 系统。

- [type_checker.py 全文] **缺少 occurs check** → 没有防止构造无限类型（如 a = List[a]）的机制，类型检查器可能无限循环 → 在合一算法中添加 occurs check
- 追问：如果是 OCaml/Haskell 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 缺少 occurs check 会导致类型检查器在某些输入上无限循环或产生无意义类型。

- [type_checker.py:560-598] **递归函数参数类型无法推断** → 由于 _types_compatible 遇到 TypeVar 直接返回 True，递归函数体内对参数的使用不会约束参数类型 → 这是合一算法缺失的直接后果

#### 中等问题（影响特定场景）
- [type_checker.py:781] FnCall 中绕过 _report_error 直接调用 error_collector.add，错误报告路径不一致
- [type_checker.py:1232-1237] PatternList 仅检查元素类型，不验证模式长度与主题列表长度是否匹配
- [type_checker.py:1289, 1292] 逻辑操作符错误消息硬编码为 '&&'，当操作符是 || 时消息错误
- [type_checker.py:1065-1066, 1101-1102] ForExpr/ListComprehension 中 Tuple 遍历取第一个元素类型，元组本不应支持 for 遍历
- [type_checker.py:169-174] 类型变量计数器是全局静态的，多实例共享可能导致名称冲突
- [type_checker.py:1517-1535] _expand_alias 不处理 TypeVar，泛型别名无法正确展开

#### 轻微问题（代码质量）
- [type_checker.py:1447] _from_ast_type 的 _alias_stack 参数命名以下划线开头但不是私有的
- [type_checker.py:667] _collect_decl 中 LetBinding/MutBinding 的占位符类型变量命名方案可能冲突
- [type_checker.py:889-952] ADT 字段访问中数字索引和名称访问的代码重复，可重构
- [type_checker.py:1206] 冗余的 isinstance(subject_type, ADTType) 检查

#### 原创性分析
- **Nova 特色**：两遍扫描架构（支持前向引用和相互递归）、ErrorType 单例 + 错误恢复模式、ADT 字段访问的"所有变体共有字段"检查、管道运算符的独立类型推断、TryExpr/? 操作符的类型检查
- **参考已有**：类型表示体系（PrimType/ListType/MapType 等）是标准做法；TypeEnv 作用域链是经典词法作用域实现；_instantiate 是 Algorithm W 的标准步骤

---

## [2026-07-16] 第二十六轮审查 — 词法/语法分析器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 综合 Elm/F# 风格管道、Rust 风格 ADT、`then` 关键字消除悬挂 else 等有特色 |
| 可行性 | ⭐⭐⭐ | 核心语法可工作，但 for/while 无法参与管道运算严重限制表达能力 |
| 正确性 | ⭐⭐ | 管道与 tree-sitter 优先级不一致、控制流表达式与管道系统脱节、错误恢复可能栈溢出 |
| 安全性 | ⭐⭐⭐ | 无内存安全问题，但词法错误恢复的递归调用可能导致栈溢出（DoS 风险） |
| 一致性 | ⭐⭐ | 死 Token、与 tree-sitter grammar 优先级不一致、step 双重存储 |
| 完整性 | ⭐⭐⭐ | 基本语法齐全，但缺少十六进制/科学计数法/Unicode 转义/块注释/字段赋值 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，递归下降分层合理，但缺少断言/防御性编程 |
| 性能 | ⭐⭐⭐⭐ | 单遍词法 + 递归下降，O(n) 复杂度，整体足够 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [parser.py:434-454] **for/while/if/match 表达式无法参与管道运算** → 控制流表达式被放在最低优先级层且只解析一次，`for x in xs { x } |> f` 只能解析出 for 表达式，`|> f` 被遗弃 → 将管道解析移到更外层，使控制流表达式可以参与管道
- 追问：如果是 GCC 或 Clang 的编译器前端，这个 bug 能被接受吗？→ **绝对不能接受。** 这是结构性的优先级设计错误。在一门"一切皆表达式"的语言中，控制流表达式不能参与管道操作，等于直接废掉了表达式导向的核心价值。

- [parser.py:438-445 + grammar.js:612-624] **管道优先级与 tree-sitter grammar 严重不一致** → parser 中管道高于逻辑运算，grammar 中管道是最低优先级，编辑器高亮与实际解析结果不一致 → 统一两边的运算符优先级表
- 追问：如果是 GCC 或 Clang 的编译器前端，这个 bug 能被接受吗？→ **不能接受。** 语法规范与实现不一致属于最严重的前端缺陷类别。

- [lexer.py:243, 264, 273, 297, 320, 470] **词法错误恢复使用递归调用可能导致栈溢出** → 多处错误恢复路径使用 return self._next_token() 递归调用自身，大文件非法字符可导致 Python 栈溢出 → 改为循环实现错误恢复
- 追问：如果是 GCC 或 Clang 的编译器前端，这个 bug 能被接受吗？→ **不能接受。** 这是可被利用的 DoS 漏洞。恶意构造的输入可以让编译器崩溃。

- [parser.py:57-62] **parser _advance 在 EOF 处静默停止推进** → 当 pos 指向最后一个 token 时再次调用 _advance() 不会报错，持续返回同一个 EOF token，错误恢复时可能无限循环 → EOF 处重复 advance 应触发致命错误或断言失败
- 追问：如果是 GCC 或 Clang 的编译器前端，这个 bug 能被接受吗？→ **不能接受。** 静默失败是编译器前端最忌讳的设计。

#### 中等问题（影响特定场景）
- [lexer.py:88, 91] PIPE_VARIANT 和 UNIT 是死 Token
- [lexer.py:202-221] 数字字面量不支持十六进制/八进制/二进制/科学计数法/数字分隔符
- [lexer.py:223-324] 字符串/字符不支持 Unicode 转义/原始字符串/多行字符串
- [lexer.py:275-324] 字符字面量不校验字符长度
- [parser.py:678-684] 比较运算符链式解析语义不明确（a < b < c 被解析为 (a < b) < c）
- [parser.py:422-428] 赋值仅支持简单标识符，不支持字段/索引赋值
- [parser.py:470-472] `<-` 用两个 token 拼接而非专用 token
- [lexer.py:186-200] 缺少块注释 `/* */` 支持

#### 轻微问题（代码质量）
- [lexer.py:341-343] BOOL 分支代码冗余
- [lexer.py:158] _make_error 的 end_col 计算可疑
- [lexer.py:206-216] 数字字符串拼接效率低（O(n²)）
- [parser.py:850-890] _is_map_literal 向前扫描复杂度高
- [parser.py:392-396] _parse_block 中赋值检测逻辑脆弱
- [parser.py:366-367] 类型表达式无错误恢复

#### 原创性分析
- **Nova 特色**：`then` 关键字消除悬挂 else、`|>` 管道 + `|param| body` lambda 的组合语法、`<-` 范围循环语法、`{ key => value }` Map 字面量避免与类型注解歧义
- **参考已有**：递归下降解析经典方法、管道操作源自 F#/Elixir、ADT + 模式匹配源自 ML 家族

---

## [2026-07-16] 第二十六轮审查 — 错误处理/模块系统/环境深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | Rust 风格错误格式化、中文本地化错误消息、PassError 专用类型 |
| 可行性 | ⭐⭐⭐ | 核心功能可用，但多个严重 bug 意味着生产环境下会出问题 |
| 正确性 | ⭐⭐⭐ | 存在多个影响正确性的严重问题：不可变性可被绕过、错误分类错误、导出名称未验证 |
| 安全性 | ⭐⭐⭐ | 模块路径解析中相对路径的脆弱性可能导致意外文件加载 |
| 一致性 | ⭐⭐⭐ | 错误系统有 span 和 highlight_span 两套位置系统，模块系统有两套缓存 |
| 完整性 | ⭐⭐⭐ | 基本功能都有：错误分级、源码高亮、模块缓存、循环检测、作用域链 |
| 工程质量 | ⭐⭐⭐ | 有 dataclass、类型注解、文档字符串，但存在死代码、脆弱依赖、重复逻辑 |
| 性能 | ⭐⭐⭐ | 环境查找 O(depth) 是标准实现可接受，但 all_bindings 的 O(depth²) 有优化空间 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [environment.py:30-32] **define 允许同一作用域内静默覆盖，绕过不可变性约束** → 同一个作用域内两次 define 同一名称会静默替换不可变绑定的值，不可变性仅在 assign 路径上被检查 → define 时检查是否已存在绑定，存在则报错
- 追问：如果是 Rust/OCaml 的编译器，这个 bug 能被接受吗？→ **绝对不能。** 环境是解释器的核心数据结构，define 应该是幂等的或有明确的重定义语义。

- [errors.py:388-393] **ErrorCollector.add() 分类逻辑错误** → NOTE 和 HELP 被归入 errors 列表，has_errors() 在只有注释时也返回 True → 严格区分 error/warning/note/help，只有 ERROR 才计入 errors
- 追问：如果是 Rust/OCaml 的编译器，这个 bug 能被接受吗？→ **不能。** Rust 的 Diagnostic 系统严格区分 error/warning/note/help。

- [errors.py:164-165] **无 span 时 end_col 默认值计算错误** → column 为 -1 时 end_col = 0，高亮位置完全错误 → 无 span 时给出合理的默认高亮或标记为位置未知
- 追问：如果是 Rust/OCaml 的编译器，这个 bug 能被接受吗？→ **不能。** Rust 编译器的每一个诊断都必须有精确的 span。

- [modules.py:124-130] **相对路径导入依赖 search_paths[0] 的脆弱设计** → 相对导入基准依赖 search_paths 的顺序，current_file 未提供时相对 CWD 而非当前文件 → 为相对路径导入设置独立的基准目录字段
- 追问：如果是 Rust/OCaml 的编译器，这个 bug 能被接受吗？→ **不能。** 模块路径解析必须严格基于当前文件位置。

- [modules.py:244-262] **导出名称收集在类型检查/求值之前执行，且不验证存在性** → 可以导出不存在的名称，_collect_exported_types() 返回值完全未被使用 → 在类型检查和求值后收集导出名称，并验证被导出的名称确实存在

#### 中等问题（影响特定场景）
- [errors.py:278-279] 多行高亮首行下划线可能越界
- [errors.py:280-281] 多行高亮末行下划线计算错误
- [errors.py:428-434] raise_all 将后续错误降级为 note，丢失严重级别
- [modules.py:216] 循环导入检测使用列表而非集合（O(n) 查找 + O(n) 删除）
- [modules.py:98-105] 默认搜索路径包含脆弱的相对路径（相对于 CWD）
- [environment.py:67-73] all_bindings() 时间复杂度为 O(depth² × avg_bindings)
- [modules.py:358-364] 全局模块管理器默认路径包含硬编码路径
- [errors.py:93] highlight_span 旧格式兼容字段冗余

#### 轻微问题（代码质量）
- [errors.py:244] 注释行上下文显示 0 行前、2 行后，前后不对称
- [errors.py:47-48] ANSI 检测未考虑 TERM=dumb
- [modules.py:54-57] get_exported_bindings 静默忽略查找失败
- [environment.py:34-48] lookup 和 lookup_binding 重复逻辑
- [modules.py:293-299] _collect_exported_types 与 _collect_exports 重复，且返回值从未使用
- [errors.py:349-350] PassError.__str__ 不使用格式化，绕过了 _format() 方法

#### 原创性分析
- **Nova 特色**：中文本地化的错误消息、PassError 专用类型（含 pass_name/pass_type/iteration）、_try_extensions 的三级 fallback
- **参考已有**：错误系统直接借鉴 Rust 编译器诊断系统；模块系统经典的 resolver + cache 架构（类似 Python importlib）；环境/作用域是 SICP 风格的经典解释器实现

---

## [2026-07-16] 第二十六轮审查 — 所有后端深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 自研 x86_64 编码器 + ELF 生成有一定原创性，三层 IR 架构借鉴 MLIR |
| 可行性 | ⭐⭐ | Native 后端生成的 ELF 不能正确执行，C 后端相对可行但依赖不存在的运行时 |
| 正确性 | ⭐ | 多处根本性错误导致生成的代码无法正确运行：参数传递失效、栈分配复合数据、入口点错误 |
| 安全性 | ⭐ | 无边界检查、无类型安全运行时、栈上分配返回指针、无 GC 导致的用后释放 |
| 一致性 | ⭐⭐ | 四个后端架构完全不同，命名不一致，行为不一致 |
| 完整性 | ⭐⭐ | LIR 指令覆盖度尚可，但每个指令的实现深度很浅，很多是 stub |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰、注释丰富、有测试框架，但测试深度不足 |
| 性能 | N/A | 无法评估——代码不能正确运行 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [native_backend.py:1136-1189] **List/ADT/Tuple 全部在栈上分配，函数返回即失效** → 复合数据结构通过 sub rsp 在栈上分配，函数返回时指针悬垂 → 在堆上分配所有 boxed 类型（需要 GC 或引用计数运行时）
- 追问：如果是 OCaml 的 native 编译器，这个 bug 能被接受吗？→ **绝对不能。** OCaml 的 native 编译器使用分代 GC 管理堆，所有 boxed 类型都在堆上分配。这是根本性的设计错误。

- [native_backend.py 全文] **无堆分配器，无 GC，无引用计数** → 整个 NativeCodeGen 中没有任何 malloc/heap 分配机制，函数式语言核心数据结构都需要堆分配 → 实现堆分配器和内存管理策略
- 追问：如果是 OCaml 的 native 编译器，这个 bug 能被接受吗？→ **绝对不能。** 没有 GC 就无法正确运行任何非平凡的函数式程序。

- [native_backend.py:1227-1238] **_start 入口中 nova_init/nova_cleanup 是未定义符号** → 生成的 ELF 引用了从未定义的 nova_init/nova_cleanup 符号，执行时会崩溃 → 要么实现这些运行时入口，要么移除引用
- 追问：如果是 OCaml 的 native 编译器，这个 bug 能被接受吗？→ **不能。** ocamlopt 生成的目标文件会与运行时静态链接，所有入口点都是已定义的符号。

- [native_backend.py:509-541, 616-621] **函数参数传递与函数序言不匹配** → 调用方按 System V ABI 放参数到寄存器，但被调用方从未将参数寄存器的值移动到虚拟寄存器中 → 函数序言中从参数寄存器加载到虚拟寄存器映射
- 追问：如果是 OCaml 的 native 编译器，这个 bug 能被接受吗？→ **绝对不能。** 这是最基本的调用约定实现错误。

- [native_backend.py:1317-1319] **ELF 入口点错误（start_offset = 0）** → 入口点指向 ELF 头的第一个字节（\x7fELF），执行时即非法指令 → 入口点应指向 _start 函数的虚拟地址
- 追问：如果是 OCaml 的 native 编译器，这个 bug 能被接受吗？→ **绝对不能。** 入口点错误意味着生成的二进制完全无法执行。

- [compiler_pipeline.py:33-35] **BACKEND_NATIVE 实际使用的是 Cranelift 而非 Native** → 自研 native 后端在编译管道中完全未被使用，命名欺骗 → 修正命名或修正管道
- 追问：如果是 OCaml 的 native 编译器，这个 bug 能被接受吗？→ **不能。** 产品命名与实际实现必须一致。

- [wasm_backend.py:230-232] **LIRLabel 被错误地编译为嵌套 block** → 每个 label 转为一个打开的 block 而不关闭，生成语法错误的 WAT 代码 → 正确实现标签和控制流结构

#### 中等问题（影响特定场景）
- [native_backend.py:73-77] 寄存器分配器溢出后无 reload 机制，溢出时直接当作物理寄存器使用
- [native_backend.py:1266-1270] RIP-relative 重定位计算基于错误的基址
- [cranelift_backend.py 全文] 生成的 CLIF 语法不正确（iconst 应为 i64.const 等）
- [c_codegen.py:853-871] ADT 构造器使用指定初始化，但结构体字段命名不一致
- [native_backend.py:771-786] 浮点比较使用了错误的 setcc 指令，且 setcc 操作 XMM 寄存器完全错误
- [wasm_backend.py:161] 字符串扫描时使用字面量 \\x00 而非实际 null 字节
- [x86_64.py:507-565] sete/setne 等指令缺少 REX 前缀，R8-R15 扩展寄存器操作错误
- [lir_lowering.py:188-193] MIRMapBuild 被降级为 LIRBuildList，Map 语义丢失

#### 轻微问题（代码质量）
- [x86_64.py:451-473] je_rel32 定义了两次
- [native_backend.py:1195-1217] _compile_counted_loop 是空方法
- [wasm_backend.py 全文] 名称 "WasmGC" 误导，实际使用线性内存 + nova_alloc/nova_free
- [compiler_pipeline.py:80-84] C 后端不走 IR 管道，与其他后端架构不一致

#### 原创性分析
- **Nova 特色**：自研 x86_64 指令编码器（从零实现，不依赖外部汇编器）、自研 ELF 生成器（手工构造 ELF64 header + program headers）、三层 IR 设计、线性扫描寄存器分配器
- **参考已有**：C 代码生成器是 transpiler 模式（标准教学编译器做法）；Cranelift/Wasm 后端是文本生成模式；ADT 编译为 tagged union 是函数式语言标准技术

---

## [2026-07-16] 第二十六轮审查 — IR 系统 + Pass 管理器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 三层 IR 架构参考 MLIR，但 Python dataclass 从零实现有工程原创性 |
| 可行性 | ⭐⭐⭐ | 架构方向正确，但 lowering 质量差，关键功能存在语义错误 |
| 正确性 | ⭐⭐ | 多个严重语义错误：match 不匹配、phi 降级错误、for 无迭代逻辑、列表推导变空列表 |
| 安全性 | ⭐⭐ | Pass 异常没有静默吞掉，但缺少 IR 验证器，错误可能静默传播 |
| 一致性 | ⭐⭐⭐ | 三层 IR 命名和结构基本一致，但类型系统共享导致层次边界模糊 |
| 完整性 | ⭐⭐ | 框架完整但每个组件都有不同程度的空缺：无验证器、内联空壳、关键 lowering 缺失 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰、命名规范，但使用 __class__ 赋值等危险技巧，dataclass 使用不规范 |
| 性能 | N/A | 没有实际运行数据，无法评估 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [pass_manager.py:106-109] **HIR 常量折叠通过 __class__ 赋值修改 dataclass 类型——严重违反 Python 对象模型** → 动态修改 dataclass 的 __class__，字段布局不一致，可能导致后续访问崩溃 → 使用标准的替换 API（创建新节点替换旧节点）
- 追问：如果是 LLVM 的 opt 工具，这个 bug 能被接受吗？→ **不能接受。** LLVM 通过 ReplaceInstWithValue() 等安全 API 替换指令，绝不会直接修改 C++ 对象的 vptr 或类信息。

- [mir_lowering.py:275-283] **MIR SSA 构造存在根本性缺陷——变量重赋值不生成新 SSA 名** → 赋值操作既更新 env 又生成 MIRStore，矛盾；跨基本块的变量定义完全没有 phi 节点插入逻辑 → 正确实现 SSA 构造（mem2reg + phi 插入 + 支配树分析）
- 追问：如果是 LLVM 的 opt 工具，这个 bug 能被接受吗？→ **不能接受。** LLVM 的 mem2reg pass 会系统地将 alloca/load/store 转换为纯 SSA + phi。

- [mir_lowering.py:351-384] **MIR _lower_match_expr 完全没有匹配逻辑——所有分支顺序跳转** → match 表达式只用无条件跳转把所有 arm 串起来，第一个 arm 总是被执行 → 实现模式判别和条件分支（MIRSwitch 或 MIRMatchJump）
- 追问：如果是 LLVM 的 opt 工具，这个 bug 能被接受吗？→ **不能接受。** 这是功能正确性 bug，会导致 match 表达式完全错误地执行。

- [lir_lowering.py:221-228] **LIR Phi 降级静默丢弃多源情况——只取第一个 source** → Phi 节点的多源特性被完全忽略，if-else 和 match 的结果全部计算错误 → 正确实现 phi 降级（根据前驱块选择值）
- 追问：如果是 LLVM 的 opt 工具，这个 bug 能被接受吗？→ **绝对不能接受。** LLVM 的 SelectionDAG 构建器会正确地将 phi 节点降级为目标架构的物理寄存器传递。

- [lir_lowering.py:248-258] **LIR MIRSwitch/MIRMatchJump 降级为无条件跳转——丢失所有分支信息** → switch/match_jump 变成了跳转到 default 的无条件跳转，完全破坏控制流语义 → 正确实现条件分支降级
- 追问：如果是 LLVM 的 opt 工具，这个 bug 能被接受吗？→ **不能接受。** 这相当于把 switch 指令直接变成了 br default。

- [mir_lowering.py:285-289] **HIR 列表推导式降级为空列表——完全丢失推导逻辑** → [expr for x in iterable if cond] 被降级为空列表常量，用户代码得到完全错误的结果而无任何报错 → 正确实现列表推导式的 lowering
- 追问：如果是 LLVM 的 opt 工具，这个 bug 能被接受吗？→ **不能接受。** 这是静默的功能丢失 bug。

- [pass_manager.py:617-694] **MIR LICM 外提指令后不更新 SSA name 的支配性** → 回边识别错误、循环体定义收集不完整、外提逻辑只处理 header 块、外提插入位置可能不支配所有使用 → 基于 dominator tree 正确实现 LICM

#### 中等问题（影响特定场景）
- 整个 ir/ 目录没有任何 IR 验证器（Verifier）— 缺少 SSA 验证、CFG 验证、类型验证
- [hir_lowering.py 多处] HIR 类型全部是 TYPE_VAR 占位符，HIR 层实际上无类型
- [mir_lowering.py:159-162] MIR HIRIdentifier 找不到时返回 None，后续或运算变成空字符串
- [mir_lowering.py:404-406] MIR for 循环将 iterable 直接作为条件分支的条件，类型不匹配
- [lir_lowering.py:244-245] LIR MIRReturn 的返回值类型硬编码为 UNIT_TYPE
- [pass_manager.py:258-263] Inlining pass 是空壳——直接 return False
- [pass_manager.py:290-293] MIR/HIR DCE 是空壳——直接 return False
- [lir_lowering.py:43-46] LIR 全局变量初始化值被当作字符串编码，丢失类型信息

#### 轻微问题（代码质量）
- [hir_lowering.py:97-98] HIR _lower_decl 中 AliasDef 的目标类型未降级
- [hir_lowering.py:332-333] HIRConstructorPattern 的 type_name 为空字符串
- [mir_lowering.py:299-305] HIRUnwrapExpr 降级为 MIRFieldAccess("value", 0)，假设 ADT 布局
- [lir_lowering.py:88] stack_size 计算过于简化（loc_counter * 8）
- [pass_manager.py:416-420] LIR CSE 只在基本块内做，跨块不消除
- [pass_manager.py:715, 734, 753] max_iterations=10 是硬编码魔法数字

#### 原创性分析
- **Nova 特色**：Python dataclass 从零实现三层 IR（不依赖 MLIR/LLVM 框架）、HIR 层保留完整高级语言特性（管道、?、列表推导、ADT 模式匹配）、LIR 层简化设计（直接 1:1 映射）
- **参考已有**：三层 IR 架构经典（Clang AST→LLVM IR→MachineInstr，MLIR 多 dialect）、SSA + CFG 直接借鉴 LLVM/Rust MIR、Pass 管理器 + 不动点迭代是 LLVM 标准模式

---

## [2026-07-16] 第二十六轮审查 — 运行时 + 测试 + Tree-sitter 深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 表达式导向 + 管道 + ADT + 部分应用的组合有特色，多后端架构是加分项 |
| 可行性 | ⭐⭐⭐ | Python 解释器和字节码 VM 已可用，C 运行时框架搭好但内存管理有严重缺陷 |
| 正确性 | ⭐⭐⭐ | C 运行时引用计数有系统性缺陷，优先级表不一致，Evaluator/VM 无交叉验证 |
| 安全性 | ⭐⭐ | 内存泄漏普遍存在，类型混淆可能导致崩溃，HTTP 临时文件有竞争条件 |
| 一致性 | ⭐⭐ | parser.py 与 grammar.js 优先级不一致，Evaluator/VM 无交叉验证 |
| 完整性 | ⭐⭐⭐ | 核心语言特性基本可用，但标准库、模块系统、错误处理测试不足 |
| 工程质量 | ⭐⭐⭐ | 代码组织清晰，测试数量不少，但测试深度不够 |
| 性能 | ⭐⭐⭐ | Python 解释器性能受限预期内，C 运行时 Map 性能一般 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [nova_runtime.c:99-103] **GC 完全不处理循环引用，且 nova_gc_collect 是虚假 API** → nova_gc_collect() 仅返回 alloc_count - free_count 差值，没有任何实际 GC 逻辑 → 实现真正的标记-清除 GC 或引用计数循环检测
- 追问：如果是 GHC 缺少核心 GC 功能，能被接受吗？→ **不能接受。** GHC 的运行时以精准的分代 GC 为核心竞争力。

- [nova_runtime.c:536-538] **nova_map_put 中对 value 的引用计数管理存在类型混淆，是未定义行为** → 将 void* value 强制转换为 NovaValue* 并调用 release，通过"碰巧字段偏移正确"侥幸工作 → 统一对象头部（类似 CPython 的 PyObject ob_refcnt + ob_type）
- 追问：如果是 CPython 的字典实现有这种类型混淆，能被接受吗？→ **绝对不能。** 生产级运行时通过统一的对象头部保证所有对象可安全地泛型引用计数。

- [nova_runtime.c:479-486, 651-668, 749-756, 791-798] **list/map/adt/closure 的 release 不释放子对象引用** → List 释放只 free items，不逐个 release 子元素；Map 只 release key 不 release value；全部系统性内存泄漏 → 所有容器 release 时递归释放子对象
- 追问：如果是 CPython list 释放时不 DECREF 元素，能被接受吗？→ **绝对不能。** 这是运行时最核心的内存安全契约。

- [nova_runtime.c:597-614] **nova_map_remove 不释放 value，也不释放 entry 的 value 引用** → 删除 entry 时只释放 key 和 entry 本身，value 直接泄漏 → map_remove 中正确 release value

- [tests/ 全文] **完全没有 Evaluator vs VM 行为一致性测试** → 两条执行路径的语义漂移无法被自动检测 → 建立一致性测试套件，对每个测试同时运行两个后端并比较结果
- 追问：如果是 GHC 有两条执行路径但没有一致性测试，能被接受吗？→ **不能接受。** GHC 的 testsuite 中有大量跨后端一致性测试。

- [grammar.js + parser.py] **优先级表与 parser.py 严重不一致** → PIPE 位置、for/while/if/match 优先级都不同，编辑器高亮与实际语义不符 → 统一两边的优先级表

#### 中等问题（影响特定场景）
- [nova_runtime.c:1191-1287] JSON 解析器对未闭合字符串/对象/数组无错误处理
- [nova_runtime.c:217-223] nova_string_split 空分隔符行为语义模糊
- [nova_runtime.c:459-473] nova_list_contains/nova_list_index_of 使用指针相等而非值相等
- [nova_runtime.c:193-196] nova_string_char_at 按字节索引而非字符索引
- [nova_runtime.c:1668] HTTP 临时文件名基于 PID，存在 TOCTOU 竞争条件
- [nova_runtime.c:845-862] nova_read_file 不检查 fread 返回值与 size 的关系
- C 运行时 test_runtime.c 测试不完整（~100 行 smoke test）
- Tree-sitter 测试语料极度匮乏（6 个文件，约 14 个测试）

#### 轻微问题（代码质量）
- [nova_runtime.c:135-148] nova_string_new_len 传入 NULL 字符串时未初始化数据
- [nova_runtime.c:492-499] nova_fnv1a_hash 无种子，易受 HashDoS 攻击
- [nova_runtime.c:554-575] Map 扩容只增不减，没有缩容
- [nova_runtime.c 全文] 没有线程安全机制（引用计数非原子操作）
- 测试大量使用 check_types=False 跳过类型检查（约 60% 的 Evaluator 测试）
- 核心语言特性缺乏测试：Map 数据结构、模块系统、? 操作符完整场景、类型别名、导出、字符串操作完整 API

#### 测试覆盖统计表
| 测试文件 | 测试函数数 | 主要覆盖领域 |
|---------|-----------|-------------|
| test_nova.py | 369 | 核心语言（词法/语法/类型/求值器/VM/ADT/管道/内置/循环/IO/JSON/数学/列表推导） |
| test_type_system.py | 100 | 泛型ADT、类型推断、模式匹配类型检查 |
| test_native_backend.py | 118 | x86_64 代码生成、寄存器分配、ELF |
| test_ir.py | 94 | HIR/MIR/LIR 降级、优化 pass |
| test_backends.py | 43 | Cranelift/WasmGC/编译管线 |
| test_c_codegen.py | 52 | C 代码生成、ADT、表达式 |
| test_modules.py | 28 | 模块解析、导入导出、循环检测 |
| test_errors.py | 36 | 错误格式化、错误收集、ANSI 颜色 |
| test_depth_counter.py | 8 | 调用深度/求值深度清理 |
| **总计** | **848** | |

**关键空白区域**：无 Evaluator vs VM 一致性测试、无 GC/内存管理测试、无模糊测试、C 运行时无自动化测试、无性能基准测试、Map 数据结构无测试、网络/HTTP 无测试

#### 原创性分析
- **Nova 特色**：多范式融合设计（函数式核心 + 命令式特性 + 表达式导向）、for 循环的双语法（in / <-）且返回列表、统一的错误传播 ? 操作符、多后端架构广度
- **参考已有**：C 运行时参考 CPython 和 Lua 的 C API 设计；测试框架标准 pytest/unittest；Tree-sitter 语法集成是现代语言标准做法
...
| 所有后端 | 7 | 8 | 4 | 19 |
| IR 系统 + Pass | 7 | 8 | 7 | 22 |
| 运行时 + 测试 + Tree-sitter | 6 | 6 | 8 | 20 |
| **合计** | **48** | **63** | **53** | **164** |

### 最关键的 P0 问题（本轮新确认/深化）

1. **类型检查器无真正的合一算法** — TypeVar 与任何类型兼容，相当于关闭了类型检查的核心功能，不是真正的 HM 推断
2. **MIR match lowering 完全没有匹配逻辑** — IR 系统核心特性崩溃，所有 match 表达式在 IR 层语义错误
3. **Native 后端栈分配 ADT/List 返回悬垂指针** — 函数式语言最基本的语义违反，生成的二进制完全不能正确执行
4. **Native 后端 ELF e_entry = 0** — 入口点指向 ELF 头，执行即段错误
5. **C 运行时 release 不释放子对象，系统性内存泄漏** — 任何非平凡程序都会大量泄漏内存
6. **C 运行时 nova_gc_collect 是空壳** — 名为 GC 却不做 GC
7. **闭包语义在 Evaluator 和 VM 之间根本性不一致** — 引用语义 vs 值拷贝，可变变量共享行为不同
8. **无 Evaluator vs VM 一致性测试** — 两个后端语义漂移无法检测
9. **LIR Phi 降级静默丢弃多源情况** — 所有控制流合并点的值选择都错误
10. **for/while/if/match 无法参与管道运算** — 表达式导向语言的核心价值被废掉

### 建议优先修复顺序

**P0（致命）**：
1. 实现类型检查器的合一（unification）算法 + occurs check — 这是类型系统的根基
2. 修复闭包语义一致性（统一为值语义与 VM 对齐）— 最核心的语义分歧
3. 修复 MIR match lowering — 添加真正的模式匹配判定逻辑
4. 修复 LIR Phi 降级 — 控制流合并点的值选择是 IR 正确性的基础
5. 修复 C 运行时的内存泄漏（release 递归释放子对象）

**P1（重要）**：
6. 建立 evaluator vs VM 一致性测试套件
7. 修复 for/while/if/match 与管道运算符的优先级问题
8. 修复 parser 与 tree-sitter grammar 的优先级不一致
9. 修复 Native 后端的 ELF 入口点和函数参数传递问题（或明确标记为实验性并禁用）
10. 实现模式匹配穷尽性检查
...
## [2026-07-16] 第二十七轮审查 — VM 虚拟机深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配栈恢复机制有特色，VM辅助模式匹配是优雅设计 |
| 可行性 | ⭐⭐⭐ | 核心路径可用；边界条件处理不足 |
| 正确性 | ⭐⭐⭐ | TRY_UNWRAP栈不一致、顶层match绑定泄漏、read_line EOF崩溃 |
| 安全性 | ⭐⭐⭐ | 栈下溢保护已实现；内置函数类型检查不完整 |
| 一致性 | ⭐⭐⭐ | 核心特性与Evaluator基本一致；read_line/range step=0不一致 |
| 完整性 | ⭐⭐⭐⭐ | 62个操作码全部有实现；LOOP指令死代码 |
| 工程质量 | ⭐⭐⭐ | 架构清晰；多套循环状态管理增加复杂度 |
| 性能 | ⭐⭐⭐ | 闭包全帧捕获影响内存效率 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [vm.py:575-577] **TRY_UNWRAP提前返回路径不弹出栈顶值** → `_execute_function`中RETURN路径用`self.stack.pop()`，而TRY_UNWRAP路径用`self.stack[-1]`只读取不弹出，设计不一致。虽然最终被`_call_closure`的栈截断掩盖，但增加了维护风险和栈不平衡隐患 → 统一返回路径，让TRY_UNWRAP也弹出栈顶值
- 追问：如果OCaml的字节码VM中同功能有两条栈不一致的返回路径，能被接受吗？→ **不能。** VM栈管理必须100%一致，这是正确性的根基。

- [vm.py:1056-1067] **闭包捕获整个局部帧而非仅自由变量** → 每次创建闭包都dict浅拷贝所有局部变量，时间O(n)，阻止GC回收不需要的变量；与Evaluator的闭包语义有深层差异 → 编译器实现自由变量分析，CLOSURE指令只携带需要捕获的变量名列表
- 追问：如果OCaml的闭包捕获了整个作用域的dict拷贝，性能影响能被接受吗？→ **绝对不能。** 内存使用量可能增加10-100倍，是函数式语言的核心性能问题。

- [vm.py:1209] **range步长为0时静默空循环，与Evaluator不一致** → Evaluator中step==0抛出RuntimeError，VM中静默当作空循环，行为不一致 → 在FOR_ITER的range分支添加step==0检查，抛出运行时错误
- 追问：如果同一份代码在两条执行路径下行为不同，能被接受吗？→ **不能。** 语言的语义必须唯一，与执行路径无关。

- [vm.py:237] **read_line内置函数不捕获EOFError，EOF时崩溃** → Evaluator版捕获EOFError返回空串，VM版不捕获会崩溃；且超额参数时静默返回空串而非报错 → 改为独立方法，捕获EOFError，与Evaluator行为一致
- 追问：如果GHC的标准库函数在边界条件下崩溃而不是优雅处理，能被接受吗？→ **不能。** 标准库函数必须处理所有边界情况。

- [vm.py:1378-1386] **MATCH_BIND绑定的变量在顶层match中泄漏** → 顶层match arm绑定的变量永久保留在globals中，arm之间不清理，作用域不正确 → 为顶层代码也实现match_snapshots机制，MATCH_END时清理绑定变量
- 追问：如果Haskell的顶层模式匹配会泄漏绑定变量，能被接受吗？→ **不能。** 作用域规则是语言的基础契约。

- [vm.py:814-815] **整数除法取整方向未在语言规范中定义** → Python的`//`是向下取整，C/Java是向零取整。当前VM与Evaluator一致，但语言规范未明确定义，未来native后端可能行为不一致 → 在语言规范中明确定义取整方向，所有后端统一实现
- 追问：如果OCaml的整数除法在不同后端下行为不同，能被接受吗？→ **不能。** 语言语义必须跨后端一致。

- [vm.py:414] **_format_value未处理NovaPartialBuiltin类型** → print部分应用的内置函数时输出Python默认repr而非友好表示 → 在isinstance检查中加入NovaPartialBuiltin
- 追问：如果Haskell的print函数对部分应用的函数输出不友好的内存地址，能被接受吗？→ **不能。** 标准输出函数应对所有值提供合理表示。

#### 中等问题（影响特定场景）
- [vm.py:1078-1083] RETURN指令在_execute_instruction中是死代码（函数路径提前拦截）
- [vm.py:579-583] _execute_function中return_flag路径与TRY_UNWRAP路径功能重叠
- [vm.py:970-989] POP_JUMP_IF_FALSE中while循环检测是启发式的（通过end_ip匹配）
- [vm.py:943-950] JUMP指令中while循环回跳检测的loop_start字段从未被使用
- [vm.py:1555-1559] LOOP指令定义了但编译器从未使用（死指令）
- [vm.py:238-277] 多个内置函数缺乏完整的类型和参数检查
- [vm.py:298-304] _builtin_filter谓词返回非bool时静默过滤所有元素
- [vm.py:394] json_stringify中dict键被强制转为字符串，丢失类型信息
- [vm.py:1085-1095] CALL_BUILTIN绕过正常函数调用路径，与LOAD_VAR+CALL功能重复
- [vm.py:217,1281-1290] 顶层与函数帧的模式匹配状态管理不对称

#### 轻微问题（代码质量）
- [vm.py:644-649] _pop(0)先检查栈深度再返回空列表，逻辑冗余
- [vm.py:42-43] UNIT_TYPE.__bool__返回False可能导致意外行为
- [vm.py:65-69] NovaADTValue.__eq__不比较field_names（语义上合理但需文档化）
- [vm.py:525-526] _call_closure中用getattr/hasattr管理循环状态，设计脆弱
- [vm.py:1024] for循环中BREAK的result_list获取方式依赖精确栈布局
- [vm.py:1288-1289] MATCH_START栈下溢检查不使用统一_pop机制
- [vm.py:1156-1157] FIELD_ACCESS中元组索引越界错误消息不准确（ValueError也说越界）
- [vm.py:1118-1131] BUILD_MAP错误恢复路径冗余，二次遍历效率低

#### 原创性分析
- **Nova特色**：模式匹配栈恢复机制（通过match_stack_bases统一截断）、MATCH_ARM_START自动清理上一arm变量、TRY_UNWRAP提前返回机制（bool返回信号而非异常）、BREAK/CONTINUE双形态设计（while带操作数/for不带）
- **参考已有**：基本栈机设计参考CPython/JVM；FOR_ITER + LOOP_END双指令循环是常见模式；部分应用/柯里化是函数式语言标准特性

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 整数除法取整方向 | //向下取整 | //向下取整 | ✅ |
| read_line EOF处理 | 捕获EOFError返回"" | 不捕获，崩溃 | ❌ 严重 |
| range step=0 | 抛出错误 | 静默空循环 | ❌ |
| 闭包捕获语义 | mut变量值快照，immut环境链 | 全部变量值拷贝 | ⚠️ 功能等价 |
| 顶层match绑定作用域 | 每个arm独立环境 | 泄漏到全局 | ❌ |
| for循环返回值 | 结果列表 | 结果列表 | ✅ |
| while循环返回值 | 最后一次body值 | 最后一次body值 | ✅ |
| break/continue语义 | 异常机制 | VM状态机 | ⚠️ 功能等价 |
| 调用深度限制 | MAX_CALL_DEPTH=1000 | MAX_CALL_DEPTH=1000 | ✅ |
| 可变变量赋值检查 | 检查mut标记 | 检查local_mutable | ✅ |

---

## [2026-07-16] 第二十七轮审查 — 编译器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | PIPE_CALL指令、MATCH_START/END标记、VM统一栈恢复模式有特色 |
| 可行性 | ⭐⭐⭐⭐ | 基本编译流程可用；AST覆盖率100% |
| 正确性 | ⭐⭐⭐⭐ | 所有Pattern类型均有测试生成；但存在设计脆弱点 |
| 安全性 | ⭐⭐⭐⭐ | 栈布局整体一致；模式匹配栈管理较复杂但基本正确 |
| 一致性 | ⭐⭐⭐ | 编译器假设的栈布局与VM执行基本一致 |
| 完整性 | ⭐⭐⭐⭐⭐ | AST节点覆盖率100%（表达式/声明/模式均有处理） |
| 工程质量 | ⭐⭐⭐ | 死代码、冗余代码、接口不统一 |
| 性能 | ⭐⭐⭐ | 闭包全量捕获而非自由变量精确捕获 |
...
#### 严重问题（阻碍正常使用）
- [compiler.py:827-837] **PatternIdentifier对零字段构造器的识别依赖运行时状态** → 如果match表达式出现在对应TypeDef之前（递归类型或前向引用），零字段构造器会被错误地当作变量绑定模式处理 → 在编译match表达式之前进行完整的ADT构造器收集pass
- 追问：如果Haskell的编译器在类型定义之前使用构造器模式会静默产生错误语义，能被接受吗？→ **不能。** 编译器必须保证语义正确，不应该依赖编译顺序的巧合。

- [compiler.py:407,687] **闭包全量捕获所有局部变量而非仅自由变量** → 内存浪费、嵌套闭包逐级膨胀、大作用域小闭包携带大量无关数据 → 编译器实现自由变量分析，CLOSURE指令传递精确的自由变量列表
- 追问：如果OCaml的闭包捕获了整个作用域，性能影响能被接受吗？→ **绝对不能。** 这是函数式编译器的核心优化。

- [compiler.py:366-373] **模块导入的名称冲突检测不完整** → 只检查functions和builtin_names，不检查已编译的全局变量（let绑定/零字段ADT构造器）和之前导入的同名声明 → 维护统一的全局绑定名称集合，导入时统一检查
- 追问：如果Python的import静默覆盖已有同名变量而不警告，能被接受吗？→ **不能。** 名称冲突必须被检测并报告。

- [compiler.py:1030-1034,1148-1152] **for循环break_patches字段创建但从不使用** → _loop_stack数据结构与实际使用不一致，break_patches只对while循环有意义 → 统一设计（要么for也用回填，要么移除break_patches字段）

#### 中等问题（影响特定场景）
- [compiler.py:915-966,968-980] 死代码：_compile_pattern_test和_compile_pattern_bindings从未被调用
- [compiler.py:82] CLOSURE操作码注释说3个操作数但实际只有2个（code_key不存在）
- [compiler.py:733] MATCH_START的arm_count操作数在VM中未使用
- [compiler.py:76 + vm.py:1555] LOOP指令定义但从未被编译器生成
- [compiler.py:602-607] Pipe编译中内置函数检测的if/else分支完全相同
- [compiler.py:311-312] 顶层表达式后无条件POP，顶层返回值被丢弃
- [compiler.py:199-210] patch_match_fail通过操作数数量判断格式，脆弱易出错

#### 轻微问题（代码质量）
- [compiler.py:790-795] _compile_pattern_test_with_fail的docstring描述不准确
- [compiler.py:174-176] 常量池去重使用list.index()，O(n)性能
- [compiler.py:495-511] 编译器不验证BreakExpr/ContinueExpr是否在循环内
- [compiler.py:450-452] TRY_UNWRAP顶层检测在VM中进行而非编译器
- [compiler.py:1109-1115] ListComprehension中iterable类型混合（tuple或AST节点）
- [compiler.py:295-296] 导入时AliasDef被跳过但冲突检测仍会执行

#### 原创性分析
- **Nova特色**：VM统一栈恢复模式（编译器不生成清理代码，VM统一处理）、MATCH_ARM_START+局部变量快照机制、PIPE_CALL专用指令、部分应用通过闭包捕获实现
- **参考已有**：基本栈机结构参考CPython/JVM；跳转回填参考标准编译器教材

---

## [2026-07-16] 第二十七轮审查 — 求值器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 闭包值语义设计有特色；其他为标准解释器实现 |
| 可行性 | ⭐⭐⭐ | 核心特性可用；存在多处深层语义问题 |
| 正确性 | ⭐⭐⭐ | filter谓词静默失败、列表推导break逃逸、字符串索引类型不一致 |
| 安全性 | ⭐⭐⭐ | 基本安全；导入模块构造器未注册有类型安全风险 |
| 一致性 | ⭐⭐⭐ | 与VM多处行为差异；闭包捕获范围不一致 |
| 完整性 | ⭐⭐⭐⭐ | AST覆盖率高；MapExpr已实现 |
| 工程质量 | ⭐⭐ | 大量重复代码、架构债务（tuple hack） |
| 性能 | ⭐⭐⭐ | 闭包过度捕获影响效率 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [evaluator.py:266] **_builtin_filter谓词非Bool时使用`is True`静默失败** → 谓词返回非Bool真值时所有元素被静默过滤掉，不报错。check_types=False时尤为危险 → 对谓词返回值做显式Bool类型检查，非Bool则抛出RuntimeError_
- 追问：如果Haskell的filter函数在谓词返回非Bool时静默返回空列表，能被接受吗？→ **绝对不能。** 这是类型安全的基本要求。

- [evaluator.py:1220-1254] **列表推导式中break/continue会逃逸出推导式** → ListComprehension没有捕获BreakSignal和ContinueSignal，信号向外传播到外层循环，破坏控制流 → 在列表推导式中捕获BreakSignal/ContinueSignal并转为运行时错误
- 追问：如果Python的列表推导式中的break会影响外层循环，能被接受吗？→ **不能。** 列表推导式是表达式，不应该允许控制流穿透。

- [evaluator.py:996-1009] **IndexExpr对字符串索引返回str而非NovaChar** → `"abc"[0] == 'a'`会返回False（Python str与NovaChar比较），类型系统不一致 → 索引String时将结果包装为NovaChar
- 追问：如果OCaml中字符串索引结果与字符字面量类型不同，能被接受吗？→ **不能。** 类型一致性是静态类型语言的基础。

- [evaluator.py:468-482] **_capture_mut_vars过度捕获所有mut变量而非仅自由变量** → 沿整个作用域链捕获所有可变变量，内存泄漏风险；与VM行为不一致（VM只捕获当前帧locals） → 实现自由变量分析，只捕获实际使用的mut变量
- 追问：如果闭包捕获了从未使用的变量导致内存泄漏，能被接受吗？→ **不能。** 生产级语言必须精确管理闭包环境。

- [evaluator.py:1155-1175] **for循环使用tuple格式判断range是架构性债务** → ForExpr.iterable字段类型不稳定（可能是AST节点，也可能是Python tuple("range", ...)），破坏类型安全 → 在AST层面正确区分range循环和列表循环，使用专用AST节点
- 追问：如果编译器的核心数据结构类型不稳定，能被接受吗？→ **不能。** 类型安全是编译器自身可靠性的基础。

- [evaluator.py:844-855] **TryExpr在模块导入路径中的行为未定义** → _handle_import_decl没有捕获ReturnSignal，如果导入模块的顶层使用?会以原始异常形式逃逸 → 在所有入口点统一捕获ReturnSignal并给出一致错误消息

- [evaluator.py:746-778] **导入模块的ADT构造器未注册到_adt_constructors** → 跨模块模式匹配的类型安全性丧失，不同模块的同名variant可能错误匹配 → 导入模块时也导入其_adt_constructors映射
- 追问：如果Haskell导入模块后模式匹配的构造器类型检查失效，能被接受吗？→ **不能。** 跨模块的类型安全是模块系统的基本契约。

- [evaluator.py:598-649 vs 685-744] **_eval_decl_inner与_collect_decl+_eval_decl_body大量重复** → 两套代码实现基本相同逻辑，维护风险高，容易只改一处漏改另一处 → 统一为单一实现，通过参数控制是否求值函数体

#### 中等问题（影响特定场景）
- [evaluator.py:279,285] _builtin_head/_builtin_tail的None variant field_names不一致
- [evaluator.py:256] _builtin_str_to_int的None variant也有field_names不一致
- [evaluator.py:920-923] Assignment错误重新包装丢失原始错误的span和related_notes
- [evaluator.py:538-540] _call_depth和_eval_depth两个深度计数器设计意图不清晰
- [evaluator.py:931-943] MapExpr键求值顺序依赖Python字典推导内部实现
- [evaluator.py:978-992] FieldAccess对ADT先试索引访问再试名称访问有歧义（数字字段名）
- [evaluator.py:512] 闭包部分应用时captured_mut_vars不更新
- [evaluator.py:1182-1183] ForExpr循环变量始终不可变，语义不明确
- [evaluator.py:1200,1211] while循环空迭代时返回UNIT_VALUE语义需明确
- [evaluator.py:395-396] _builtin_abs总是返回float，Int输入也返回float
- [evaluator.py:345-348] _convert_json_to_nova中dict转Python dict而非Nova Map

#### 轻微问题（代码质量）
- [evaluator.py:156 vs vm.py:46] UNIT_VALUE与UNIT命名不一致
- [evaluator.py:63 vs vm.py:127] NovaClosure属性名name vs func_name不一致
- [evaluator.py:777-778] 导入时忽略找不到的绑定是静默的
- [evaluator.py:315] _builtin_list_dir返回排序后的列表（应文档化）
- [evaluator.py:333,362,448] Python None与Nova None混用易出错
- [evaluator.py:1078] 整数除法取整方向未文档化

#### 原创性分析
- **Nova特色**：闭包值语义设计（将可变变量做快照），类似Rust的move语义或Haskell的纯函数式语义；双执行路径设计
- **参考已有**：AST遍历解释器是标准模式；异常实现控制流是标准技术；环境链是SICP经典实现

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获范围 | 整个作用域链所有mut | 当前帧所有locals | ❌ 不一致 |
| 闭包语义 | 值语义（mut变量快照） | 值语义（全量值拷贝） | ⚠️ 功能等价 |
| read_line EOF | 捕获返回空串 | 不捕获，崩溃 | ❌ 严重 |
| range step=0 | 抛出错误 | 静默空循环 | ❌ |
| 字符串索引结果 | Python str | NovaChar | ❌ |
| 调用深度限制 | call_depth + eval_depth | 仅调用栈深度 | ⚠️ 机制不同 |
| for循环返回值 | 结果列表 | 结果列表 | ✅ |
| ?操作符传播 | ReturnSignal异常 | 提前返回+栈截断 | ⚠️ 功能等价 |
| 主函数自动调用 | 支持 | 支持 | ✅ |

---

## [2026-07-16] 第二十七轮审查 — 类型检查器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两阶段检查支持相互递归有特色；instantiate实现穷人的let多态 |
| 可行性 | ⭐⭐⭐ | 带类型标注的代码可正确检查；无标注时推断失效 |
| 正确性 | ⭐⭐ | TypeVar与任何类型兼容，类型系统健全性失守 |
| 安全性 | ⭐⭐ | 无真正的unification，类型错误可能漏检 |
| 一致性 | ⭐⭐⭐ | 与Evaluator/VM的类型行为基本匹配 |
| 完整性 | ⭐⭐⭐ | 基本类型/泛型/元组/函数类型支持完整；缺少高阶类型 |
| 工程质量 | ⭐⭐⭐ | 结构清晰但核心算法缺失 |
| 性能 | N/A | 性能不是当前问题，正确性才是 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [type_checker.py:1550-1551] **TypeVar与任何类型兼容，类型系统健全性失守** → `_types_compatible`遇到TypeVar直接返回True，类型变量从不被真正约束。任何带未确定类型变量的代码都会通过类型检查 → 实现真正的unification算法（union-find + occurs check），维护替换环境
- 追问：如果OCaml的类型系统中'a与任何类型都兼容，那还叫类型系统吗？→ **绝对不能。** 这是类型健全性的根本失守，相当于关闭了类型检查的核心功能。

- [type_checker.py:4,1321-1361,1405-1434] **声称实现HM但实际无unification、无generalization** → 文件注释说"简化的Hindley-Milner类型推断"，但没有合一算法、没有泛化步骤、没有发生检查、没有union-find → 实现Algorithm W或Algorithm M的核心：unify + generalize
- 追问：没有unification的类型推断能叫Hindley-Milner吗？→ **严重失实。** 这是带类型变量的简单类型检查器，不是HM推断。

- [type_checker.py:1546-1574] **_types_compatible缺少TupleType递归处理** → 所有复合类型（List/Map/Fn/ADT）都有递归兼容检查，唯独元组漏掉了 → 添加TupleType递归兼容检查
- 追问：所有复合类型都有递归检查唯独元组漏掉了，这是copy-paste遗漏吗？→ **是。** 会导致含类型变量的元组类型被错误判定为不兼容。

- [type_checker.py:728-744,560-598] **函数参数类型推断完全失效** → 无类型标注的函数参数永远是TypeVar，函数体中的使用方式从不约束参数类型 → 实现unification，使函数体中参数的使用能真正约束参数类型
- 追问：如果无类型标注的函数参数完全不被推断，调用时任何参数都能通过检查，这叫类型安全吗？→ **不叫。** 这是类型健全性的核心漏洞。

- [type_checker.py:560-598] **递归函数参数/返回类型无法推断** → 递归函数参数类型始终是TypeVar，递归调用也不会帮助推断类型 → 实现proper unification + 固定点迭代

- [type_checker.py:1243-1301] **二元运算符类型推断方向错误** → 只检查"是否兼容"，不执行实际的类型绑定/推断。变量可以被使用方式"暗示"但从不被约束 → 在运算符检查中，当一侧是TypeVar时记录类型约束

- [type_checker.py:1000-1015,1021-1043] **?操作符在函数外静默通过** → _current_fn_return_type为None时直接返回解包后类型，完全不检查错误传播目标 → 当_current_fn_return_type is None时报告错误："?操作符只能在函数内部使用"

- [type_checker.py:1070-1071,1107-1108] **ForExpr/ListComprehension非列表迭代不报错** → 迭代对象不是ListType也不是TupleType时，不报错而是默默给一个TypeVar作为元素类型 → 当iterable类型不是ListType且不是TypeVar时报告类型错误

#### 中等问题（影响特定场景）
- [type_checker.py:714-726] Match穷尽性检查完全缺失
- [type_checker.py:714-726] 模式匹配冗余分支不检测
- [type_checker.py:1548-1549] ErrorType过度兼容掩盖级联错误
- [type_checker.py:429-430,445-450] 类型与值共享命名空间，同名type和variant会覆盖
- [type_checker.py:1405-1434,759-769] _collect_type_bindings与_types_compatible语义不统一
- [ast_nodes.py:446-450] AliasDef没有type_params字段，不支持泛型类型别名
- [type_checker.py:519] 导入的名称被加入_user_defined_names，命名有误导性
- [type_checker.py:1521-1544] _expand_alias不处理TypeVar中的别名
- [type_checker.py:169-174] TypeVar._counter全局永不重置
- [type_checker.py:365] json_parse返回类型过于宽松（TypeVar模拟dyn类型）

#### 轻微问题（代码质量）
- [type_checker.py:1146-1149] _check_pattern中重复import（已在文件顶部import）
- [type_checker.py:650] 空列表TypeVar命名不一致（unknown_list_elem）
- [type_checker.py:1554-1559] _types_compatible的FnType检查与__eq__重复代码
- [type_checker.py:823-828] Block中语句类型检查结果被丢弃
- [type_checker.py:311-312] print函数参数类型是TypeVar（合理但需文档化）
- [type_checker.py:1088-1092] BreakExpr/ContinueExpr返回Unit而非bottom type
- [type_checker.py:302] None构造器的类型变量命名（opt_t）
- [type_checker.py:1321-1329] _instantiate的docstring说"Algorithm W核心步骤"但没有generalization

#### 原创性分析
- **Nova特色**：两阶段检查（收集签名→检查主体）支持前向引用和相互递归；_instantiate标识符查找时实例化实现"穷人的let多态"；ADT字段访问的product-like语义
- **参考已有**：整体结构参考传统函数式语言类型检查器；类型表示是标准ML风格；ErrorCollector是编译器标准模式

---

## [2026-07-16] 第二十七轮审查 — 词法/语法分析器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | if-then-else消除悬挂else、管道优先级设计有特色 |
| 可行性 | ⭐⭐⭐⭐ | 主要语法元素均可用；存在边界情况bug |
| 正确性 | ⭐⭐⭐ | 词法错误被管道忽略、match负数模式检测遗漏、<-双token歧义 |
| 安全性 | ⭐⭐⭐ | 基本安全；无语法错误恢复遇错即崩溃 |
| 一致性 | ⭐⭐⭐ | 与Tree-sitter优先级不一致 |
| 完整性 | ⭐⭐⭐⭐ | Token覆盖完整；缺少块注释、十六进制、数字分隔符 |
| 工程质量 | ⭐⭐⭐ | 结构清晰但死代码、脆弱消歧 |
| 性能 | ⭐⭐⭐⭐ | 递归下降线性时间；_is_map_literal最坏O(n²) |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [compiler_pipeline.py:50, _cli.py:43-44] **编译器管道完全忽略词法错误** → lexer.errors中的非法字符、未闭合字符串等在主编译管道中被完全丢弃，带词法错误的代码继续进入parser产生级联错误 → 在tokenize()后检查lexer.errors，若非空则收集并报告
- 追问：如果GCC的词法错误被静默忽略继续编译，能被接受吗？→ **绝对不能。** 词法错误应当阻止编译继续。

- [parser.py:528] **match分支检测遗漏负数模式起始Token** → _parse_match_expr的while循环检测更多分支时未包含TokenType.MINUS，但_parse_pattern实际上支持负数模式。无逗号分隔且下一分支以负数开头时误判为分支结束 → 在token列表中添加TokenType.MINUS
- 追问：如果解析器支持负数模式但分支检测逻辑漏掉了，这是功能不完整吗？→ **是。** 这是明确的bug。

- [parser.py:470-472,974-976] **<-运算符由两个独立token拼接，歧义风险高** → `for x < -1 { ... }`会被误解析为range for循环，错误信息与用户意图严重偏离；LT和MINUS之间有空白也会被当作<- → 在lexer中添加专用LEFT_ARROW token（<-）
- 追问：如果Rust的<-不是单一token而是两个字符的组合，能被接受吗？→ **不能。** 生产级语言将其作为单一token处理。

- [parser.py:64-73] **Parser无任何语法错误恢复机制，遇错即崩溃** → 遇到第一个语法错误直接抛出ParseError异常，不进行错误恢复。用户每次只能看到一个错误 → 实现基本的panic mode错误恢复，在语句/声明边界处同步token流
- 追问：对于生产级编译器，单错误模式能被接受吗？→ **不能。** 这是parser最基本的质量指标之一。

#### 中等问题（影响特定场景）
- [lexer.py:155-160] _make_error方法是死代码，lexer错误为纯字符串
- [lexer.py:91, parser.py:810-812] TokenType.UNIT定义但从不产生
- [lexer.py:88] TokenType.PIPE_VARIANT定义但从不使用
- [parser.py:850-890] _is_map_literal无界前向扫描，最坏情况O(n)
- [parser.py:98-122] 顶层赋值语句不支持，错误信息具误导性
- [parser.py:480,980] ForExpr.iterable使用字符串标签元组，类型不安全
- [lexer.py:275-324] 字符字面量空值''错误识别与误导性报错
- [lexer.py:256-257,309-310] 转义字符错误无提示，静默透传

#### 轻微问题（代码质量）
- [lexer.py:202-221] _read_number不支持十六进制/八进制/二进制字面量
- [lexer.py:212-218] 浮点数不支持无前导零（.5）和科学计数法
- [lexer.py:186-200] 缺少块注释/* */支持
- [parser.py:466-489] for循环step_expr重复存储
- [parser.py:236] 无尾随逗号的ADT变体仅靠换行识别，可读性差
- [parser.py:678-684] 比较运算符链式比较无语法报错但语义可能意外
- [lexer.py:134] step关键字与标识符冲突（应考虑上下文关键字）
- [parser.py:57-62] _advance在EOF处静默停驻，可能隐藏bug

#### 原创性分析
- **Nova特色**：if-then-else使用then关键字彻底消除悬挂else；管道操作符优先级位置合理（低于相等性高于逻辑与）；ADT变体支持命名字段和匿名字段两种形式；?后缀错误传播操作符
- **参考已有**：递归下降+优先级爬升是教科书式实现；_is_map_literal无界扫描是JavaScript/TypeScript经典问题；|单token多语义是函数式语言常见做法

---

## [2026-07-16] 第二十七轮审查 — 错误处理/模块系统/环境深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | Rust风格错误格式化有特色；闭包值语义有设计 |
| 可行性 | ⭐⭐⭐ | 核心功能可用；存在多个影响正确性的严重问题 |
| 正确性 | ⭐⭐ | 下划线off-by-one、闭包捕获时机不一致、路径遍历风险 |
| 安全性 | ⭐⭐ | 路径遍历漏洞、符号链接循环、全局单例污染 |
| 一致性 | ⭐⭐ | end_column语义不统一、顶层函数与嵌套闭包语义不一致 |
| 完整性 | ⭐⭐⭐ | 基本功能齐全；缺少错误码、错误恢复、路径规范化 |
| 工程质量 | ⭐⭐⭐ | 结构清晰但重复代码多、性能考虑不足 |
| 可调试性 | ⭐⭐ | 缺少上下文建议、变量未定义不列可用变量 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [errors.py:271-274] **单线下划线计算off-by-one错误——所有Token高亮少一个字符** → lexer将end_col设为包含式（最后一个字符的列号），但错误格式化将end_column当作排除式处理（u_end - u_start个caret），所有单线下划线偏短一个字符 → 将单线下划线计算改为u_end - u_start + 1，或统一所有地方的end_column语义为排除式
- 追问：如果Rust编译器的错误高亮少一个字符，能被接受吗？→ **绝对不能。** 错误高亮必须精确到字符级，这是生产级编译器的基本要求。

- [errors.py:280-281] **多线下划线末行同样off-by-one** → `end_col - 1`个caret，但如果end_col是包含式的，末行应该高亮end_col个字符 → 统一end_column语义后修正计算

- [evaluator.py:468-482 + environment.py] **闭包可变变量捕获时机不一致——顶层函数可修改外层mut变量，嵌套函数不能** → 顶层函数在第一遍注册时captured_mut_vars为空，调用时沿链向上找到顶层环境的mut绑定并直接修改；嵌套函数在运行时创建，已捕获外层mut变量为快照。同一语言中函数语义不一致 → 统一语义，要么都是值语义要么都是引用语义
- 追问：如果同一语言中顶层函数和嵌套函数的变量语义不同，能被接受吗？→ **绝对不能。** 语言的变量语义必须在所有层级保持一致。

- [modules.py:134-138] **包导入路径遍历漏洞——可读取任意文件系统位置** → 包导入路径直接拼接到search_path后未做安全检查，攻击者可构造如`std/../../etc/passwd`的路径跳出搜索目录 → 解析后检查最终路径是否在允许的搜索路径内，禁止包路径包含..段
- 追问：如果Python的import允许路径遍历跳出site-packages，能被接受吗？→ **绝对不能。** 这是严重的安全漏洞。

- [modules.py:216-218] **循环导入检测在部分初始化场景下过于严格** → 简单的栈检测，合法的钻石形依赖可正确处理，但相互递归模块需要类型签名时无法支持 → 实现两阶段加载（第一阶段解析+类型检查，第二阶段求值完成）

- [errors.py:438-444] **raise_all()将后续错误扁平化为字符串，丢失所有结构化信息** → 后续错误的severity全部降级为NOTE，嵌套ANSI颜色码被当成普通文本，结构化span信息完全丢失 → 直接将后续错误作为独立的RelatedNote保留，或实现多错误聚合渲染

- [errors.py:232-261] **RelatedNote复用主错误source_code渲染——跨文件注释显示错误源码** → RelatedNote没有自己的source_code字段，如果note指向另一个文件，显示的源码完全错误 → RelatedNote增加source_code字段，独立渲染

- [modules.py:240-241] **load_module中Evaluator/TypeChecker未传递current_file——嵌套导入路径解析错误** → 被加载的模块内部有相对导入时，解析基准不是当前模块的目录 → 传递current_file=file_path

#### 中等问题（影响特定场景）
- [errors.py:165] end_col默认值错误——无span时默认column+1无意义
- [errors.py:186-190] 位置格式中文化但缺少文件名信息
- [errors.py:359-360] PassError.__str__绕过整个格式化系统
- [modules.py:98-105] 默认搜索路径含相对路径——受进程工作目录影响
- [modules.py:49-58] get_exported_bindings静默吞异常
- [modules.py:276-299] _collect_exports与_collect_exported_types完全重复
- [environment.py:67-73] all_bindings递归创建dict——深作用域链性能差
- [errors.py:148-155] _severity_color每次调用重建字典
- [modules.py:228,273-274] loading_stack使用list.remove——O(n)操作
- [modules.py:358-364] 全局单例模块管理器——测试隔离困难

#### 轻微问题（代码质量）
- [errors.py:249] note_start = max(0, note_idx - 0)冗余
- [errors.py:86,92] 构造参数名source但属性名source_code命名不一致
- [errors.py:93] highlight_span旧格式兼容——技术债务
- [errors.py:320] RuntimeError_命名带下划线——奇怪的命名
- [environment.py:17-20] BindingInfo.name字段冗余（dict key也是name）
- [errors.py:429-431] get_all()错误在前警告在后——丢失时序信息
- [environment.py:30-32] define不检查重复定义
- [errors.py:47-48] ANSI.enabled()只检查stderr
- [modules.py:307] import_module返回值与副作用混合
- [errors.py:367-384] 控制流信号应继承BaseException而非Exception

#### 原创性分析
- **Nova特色**：中文本地化的错误消息；闭包值语义设计（有特色但实现不一致）；ErrorCollector收集模式
- **参考已有**：错误系统直接借鉴Rust编译器诊断系统；模块系统经典resolver+cache架构类似Python importlib；环境/作用域链是SICP风格经典实现

---

## [2026-07-16] 第二十七轮审查 — 所有后端深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 自研x86_64编码器+ELF生成有一定原创性 |
| 可行性 | ⭐⭐ | Native后端生成的ELF不能正确执行；C后端相对可行但依赖运行时 |
| 正确性 | ⭐ | 多处根本性错误：入口点错误、栈分配无回收、栈指针不恢复 |
| 安全性 | ⭐ | 无边界检查、无类型安全运行时、栈上分配返回指针 |
| 一致性 | ⭐⭐ | 四个后端架构完全不同，命名不一致，行为不一致 |
| 完整性 | ⭐⭐ | LIR指令覆盖度尚可，但很多是stub |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰、注释丰富，但测试深度不足 |
| 性能 | N/A | 无法评估——代码不能正确运行 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [native_backend.py:1317-1322] **ELF入口点地址完全错误（e_entry = 0）** → 生成的ELF e_entry字段值为0而非正确的虚拟地址，程序加载后跳转到地址0执行立即段错误 → 计算正确的虚拟入口点（base_addr + ehdr_size + phdr_total_size + start_offset）
- 追问：如果OCaml的native编译器生成的二进制入口点指向ELF头，能被接受吗？→ **绝对不能。** 入口点错误意味着生成的二进制完全无法执行。

- [native_backend.py:1339-1349] **ELF数据段p_offset与p_vaddr不满足对齐同余** → 违反ELF规范（p_vaddr % p_align ≠ p_offset % p_align），严格的ELF加载器会拒绝加载 → 将数据段文件偏移也向上页对齐填充

- [native_backend.py:1125-1189] **栈上分配的List/Tuple/ADT在函数返回后失效** → 复合数据结构通过sub_rsp在栈上分配，作为函数返回值时悬垂指针 → 通过malloc在堆上分配，或实现RVO约定
- 追问：如果OCaml的native编译器在栈上分配ADT然后返回指针，能被接受吗？→ **绝对不能。** 这是根本性的设计错误，函数式语言的核心数据结构必须在堆上分配。

- [native_backend.py:1136,1160,1179] **栈指针在build_list/build_tuple/build_adt后未恢复** → 只分配不释放，后续所有栈操作使用错误的RSP值，整个程序栈损坏 → 每次build后跟踪栈指针偏移量，或在prologue中一次性分配

- [compiler_pipeline.py:33-35] **BACKEND_NATIVE实际使用Cranelift而非NativeCodeGen** → 用户指定target="native"期望使用自研原生后端，但实际使用Cranelift。自研的NativeCodeGen完全没有接入编译管道 → 要么接入NativeCodeGen，要么重命名为BACKEND_CRANELIFT
- 追问：如果产品命名与实际实现完全不一致，能被接受吗？→ **不能。** 这是命名欺骗。

- [x86_64.py:451-473] **je_rel32函数重复定义** → 第451行和第467行各定义了一次，第二个覆盖第一个 → 删除重复定义

- [cranelift_backend.py:162-168] **Cranelift后端LIRBranch硬编码block_false/block_true标签** → 所有条件分支都跳转到硬编码的目标，函数中多个分支会全部跳转到同一个目标 → 使用instr.true_label和instr.false_label生成正确的块名

- [wasm_backend.py:230-232] **Wasm后端LIRLabel只开block不关闭** → 每个LIRLabel生成(block $name但从不生成)，产生语法完全无效的WAT → 正确管理block嵌套，或改用其他方式实现标签跳转

- [wasm_backend.py:161,371] **Wasm后端字符串扫描中null终止符双重转义** → b"\\x00"产生4个字节而非一个null字节，字符串没有正确的null终止符 → 改为b"\x00"（单重转义）

- [native_backend.py:1227-1238] **Native后端nova_init/nova_cleanup调用无定义** → _start函数调用这两个函数但从未定义，程序因未定义符号无法运行 → 要么提供实现，要么移除调用

- [wasm_backend.py:260-263] **Wasm后端LIRBranch硬编码$block_false** → 条件分支总是跳转到硬编码目标，多个分支会冲突

#### 中等问题（影响特定场景）
- [native_backend.py:1106] _compile_index破坏性修改基址寄存器
- [x86_64.py:83] mov_reg_imm64对32位有符号负数使用了10字节编码
- [cranelift_backend.py:137-200] Cranelift后端大量LIR指令未处理
- [wasm_backend.py:229-297] Wasm后端大量LIR指令未处理
- [c_codegen.py:1138,1272,1296] C后端NovaTuple类型使用但未定义
- [native_backend.py:430-447] Native后端寄存器分配器无实际溢出机制
- [native_backend.py:607-654] Native后端函数参数未从参数寄存器移到虚拟寄存器
- [native_backend.py:525-531] _compile_call中参数超过6个时栈参数顺序错误
- [c_codegen.py:594-600] C后端TryExpr的return语句类型不安全

#### 轻微问题（代码质量）
- [x86_64.py:275-287] movsd_reg_imm命名误导（实际是RIP-relative加载）
- [native_backend.py:503] _compile_branch中cond_reg默认值逻辑不一致
- [native_backend.py:1195-1217] _compile_counted_loop是空方法
- [native_backend.py:1414-1532] SimpleNativeCompiler是孤立类，未接入任何管道
- [cranelift_backend.py:216-238] Cranelift后端_emit_binop未区分浮点/整型操作
- [cranelift_backend.py:212-213] Cranelift后端closure类型返回iconst 0
- [wasm_backend.py:117-141] Wasm后端import列表与实际使用不一致
- [c_codegen.py:1301-1302] C后端_infer_c_type_from_expr对Identifier默认int64_t
- [c_codegen.py:52-59] C关键字集合中混入了运行时函数名

#### 原创性分析
- **Nova特色**：自研x86_64指令编码器（从零实现60+条指令机器码编码）、自研ELF生成器（手工构造ELF64 header）、线性扫描寄存器分配器、三层IR设计
- **参考已有**：C代码生成器是transpiler标准模式；Cranelift/Wasm后端是文本生成模式；ADT编译为tagged union是函数式语言标准技术

---

## [2026-07-16] 第二十七轮审查 — IR系统+Pass管理器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 三层IR架构概念借鉴MLIR；LIR的src_locs设计有独特性 |
| 可行性 | ⭐⭐⭐ | 架构方向正确，但lowering质量差，关键功能语义错误 |
| 正确性 | ⭐⭐ | SSA不完整、match降级错误、Phi节点取第一个源、for循环无迭代 |
| 安全性 | ⭐⭐ | 无IR验证器，错误可能静默传播 |
| 一致性 | ⭐⭐⭐ | 三层IR命名和结构基本一致；类型系统共享导致层次边界模糊 |
| 完整性 | ⭐⭐ | 框架完整但每个组件都有不同程度的空缺 |
| 工程质量 | ⭐⭐ | __class__突变、类型违规、死代码 |
| 性能 | N/A | 没有实际运行数据，无法评估 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [pass_manager.py:106-109] **HIR常量折叠使用__class__突变，破坏dataclass不变量** → 将HIRBinaryOp实例的类直接改为HIRIntLiteral，并用del删除原始字段。__dataclass_fields__不会更新，repr/asdict/copy都会崩溃 → 使用标准的替换API（创建新节点替换旧节点）
- 追问：如果LLVM的opt工具直接修改C++对象的vptr，能被接受吗？→ **不能接受。** LLVM通过ReplaceInstWithValue()等安全API替换指令。

- [mir_lowering.py:275-283] **MIR SSA构造存在根本性缺陷——变量重赋值不生成新SSA名** → 赋值操作直接覆盖env中的变量映射，控制流汇合点没有插入phi节点。所有基于SSA的优化结果都不可靠 → 实现经典SSA构造算法（minimal SSA + dominance frontier）
- 追问：如果LLVM的mem2reg pass不存在，SSA形式不正确，能被接受吗？→ **不能接受。** SSA正确性是编译器优化的基础。

- [mir_lowering.py:351-384] **MIR match降级完全错误——所有分支顺序执行** → 所有arm的body都会顺序执行，只有最后一个arm的值通过phi节点传递到merge。完全没有模式匹配逻辑 → 每个arm应生成"匹配判定+条件跳转"结构
- 追问：如果LLVM把switch指令变成顺序执行所有case，能被接受吗？→ **绝对不能。** 这是功能正确性bug。

- [lir_lowering.py:221-228] **LIR Phi节点降级丢失语义——直接取第一个源** → MIRPhi的核心语义（根据前驱基本块选择对应的值）被完全忽略，if表达式的结果永远是true分支的值 → 正确实现phi降级（前驱块末尾store到phi目标位置，phi节点位置load）
- 追问：如果LLVM的SelectionDAG把phi节点直接变成第一个源的copy，能被接受吗？→ **绝对不能接受。** 这相当于把控制流语义完全删除了。

- [hir_lowering.py:292-300] **HIRBlockExpr中混入HIRDecl——类型系统违规** → HIRBlockExpr.exprs类型声明为List[HIRExpr]，但实际塞入了HIRLetDecl（继承自HIRDecl，不是HIRExpr） → 引入HIRLetExpr，或让HIRBlockExpr同时包含decls和exprs两个列表
- 追问：如果编译器的核心数据结构违反了自己的类型声明，能被接受吗？→ **不能。** 这是架构层面的类型安全违规。

- [mir_lowering.py:396-417] **MIR for循环降级无迭代器推进——死循环或零次循环** → 循环条件只是检查iterable本身的真值，没有任何"取下一个元素"操作，循环变量甚至没有被绑定到任何值 → 生成迭代器协议调用（iter→next→is_some判断）

#### 中等问题（影响特定场景）
- [mir_lowering.py:307] MIR降级对未知表达式静默返回None
- [hir_lowering.py:302-303] HIR降级对未知表达式静默返回Unit
- [lir_lowering.py:107-112] MIRLoad全部降级为LIRLoadGlobal——本地变量丢失
- [pass_manager.py:347] DCE副作用分析不完整——LIRBinOp未被视为无副作用
- [pass_manager.py:617-694] MIR LICM严重简化——只看header块，无正确循环体计算
- [pass_manager.py:548-612] LIR LICM多循环索引偏移错误
- [pass_manager.py:92-122] HIR常量折叠只递归BinaryOp——嵌套表达式无法折叠
- [lir_lowering.py:88] LIR stack_size计算过于简化（loc_counter * 8）
- 整个ir/目录无任何IR Verifier——层间无验证

#### 轻微问题（代码质量）
- [pass_manager.py:282-285] _SIDE_EFFECT_TYPES是死代码
- [ir_nodes.py:821-825 vs lir_lowering.py:236-240] LIRBranch.cond_reg字段从未被填充
- [lir_lowering.py:248-258] MIRSwitch/MIRMatchJump降级为无条件跳转——丢失语义
- [pass_manager.py:258-263] Inlining Pass是空壳
- [pass_manager.py:29-30 vs 262-263] Pass基类与实现返回类型不一致
- [ir_nodes.py:809-811] LIRCallIndirect空类——无字专用段
- [lir_lowering.py:43-45] MIR全局变量init_value降级为字符串编码
- [ir/__init__.py:1] __init__.py无导出
- [hir_lowering.py:332-333] HIRConstructorPattern的type_name为空

#### 原创性分析
- **Nova特色**：Python dataclass从零实现三层IR（不依赖MLIR/LLVM框架）；HIR层保留完整高级语言特性；LIR的src_locs/dst_locs元组设计
- **参考已有**：三层IR架构经典（Clang AST→LLVM IR→MachineInstr）；SSA+CFG直接借鉴LLVM/Rust MIR；Pass管理器+不动点迭代是LLVM标准模式

---

## [2026-07-16] 第二十七轮审查 — 运行时+测试+Tree-sitter深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 全栈自研架构有特色；双执行路径设计独特 |
| 可行性 | ⭐⭐⭐ | Python解释器和字节码VM已可用；C运行时框架搭好但内存管理有严重缺陷 |
| 正确性 | ⭐⭐ | 引用计数不完整、类型混淆、子对象不释放 |
| 安全性 | ⭐⭐ | 内存泄漏普遍存在，类型混淆可能导致崩溃 |
| 一致性 | ⭐⭐ | parser.py与grammar.js优先级不一致；Evaluator/VM无交叉验证 |
| 完整性 | ⭐⭐⭐ | 核心语言特性基本可用；标准库、模块系统、错误处理测试不足 |
| 工程质量 | ⭐⭐⭐ | 代码组织清晰，测试数量不少，但测试深度不够 |
| 性能 | ⭐⭐⭐ | Python解释器性能受限预期内；C运行时Map性能一般 |

### 发现的问题

#### 严重问题（阻碍正常使用）
- [nova_runtime.c:597-614] **nova_map_remove不释放value，造成确定性内存泄漏** → 删除键时只释放key和entry本身，value直接泄漏 → map_remove中正确release value
- 追问：如果CPython的dict删除键时不DECREF值，能被接受吗？→ **绝对不能。** 这是运行时最核心的内存安全契约。

- [nova_runtime.c:525-538] **nova_map_put中强制类型转换(NovaValue*)entry->value是类型混淆炸弹** → 将void* value强制转换为NovaValue*并调用release，通过"碰巧字段偏移正确"侥幸工作 → 为map增加类型标签，或提供typed map API
- 追问：如果CPython的字典实现有这种类型混淆，能被接受吗？→ **绝对不能。** 生产级运行时通过统一的对象头部保证所有对象可安全地泛型引用计数。

- [nova_runtime.c:79-87] **nova_realloc不更新g_alloc_count/g_free_count，诊断数据完全错误** → 所有通过realloc扩容的操作都不被计数，nova_gc_collect()返回的净分配数是错的 → nova_realloc中正确维护计数
- 追问：如果GC诊断数据完全错误，能被接受吗？→ **不能。** 诊断功能要么正确要么不要。

- [nova_runtime.c:99-103] **纯引用计数GC完全无法处理循环引用** → nova_gc_collect()只是返回分配计数差值，没有任何真正的GC逻辑 → 实现标记-清扫作为兜底，或提供弱引用API
- 追问：如果GHC缺少核心GC功能，能被接受吗？→ **不能接受。** GHC的运行时以精准的分代GC为核心竞争力。

- [nova_runtime.c:479-486,651-668,749-756,791-798] **list/map/adt/closure的release不释放子对象引用** → List释放只free items不逐个release子元素；Map只release key不release value；全部系统性内存泄漏 → 所有容器release时递归递减子对象引用
- 追问：如果CPython list释放时不DECREF元素，能被接受吗？→ **绝对不能。** 这是运行时内存管理的基础。

- [nova_runtime.c:1240-1256] **JSON字符串解析中\uXXXX转义不处理代理对** → 遇到代理对时会生成无效的UTF-8编码 → 检查高代理+低代理组合，合并为单个code point再编码为UTF-8
- 追问：如果JSON解析器不支持emoji等BMP以外的字符，能被接受吗？→ **不能。** 这是JSON标准合规性问题。

- [tree-sitter-nova/grammar.js] **Tree-sitter语法缺少?（try/question）操作符** → parser.py支持?后缀操作符，但tree-sitter grammar中完全没有 → 添加try_expr规则并加入_expression选择中
- 追问：如果语言的核心语法特性在Tree-sitter语法中完全缺失，能被接受吗？→ **不能。** 语法工具链必须与语言实现同步。

- [tree-sitter-nova/grammar.js:612-624 vs parser.py:438-717] **Tree-sitter优先级与parser.py不一致** → 管道优先级、逻辑运算符位置、赋值优先级都有重大差异 → 统一优先级顺序，以parser.py（实际生效的）为准
- 追问：如果编辑器语法高亮与实际编译器解析结果不一致，能被接受吗？→ **不能。** 语法工具链必须与编译器语义一致。

#### 中等问题（影响特定场景）
- [nova_runtime.c:1650-1709] nova_http_get状态码解析错误，硬编码200
- [nova_runtime.c:213-241] nova_string_split空分隔符行为需文档化
- [tree-sitter-nova/grammar.js:405-426] Tree-sitter缺少for range语法的step关键字
- [nova_runtime.c:959] nova_abs_int对INT64_MIN是未定义行为
- [nova_runtime.c:1614-1632] nova_time_format格式字符串来自用户输入未验证
- [nova_runtime.c:356-368] nova_list_get/nova_list_set支持负索引但文档未说明
- tests/ 无Evaluator vs VM行为一致性对比测试
- [nova_runtime.c:1289-1296] nova_json_parse对无效JSON错误处理为静默返回NULL
- [nova_runtime.c:1664-1669] nova_http_get临时文件名用PID，并发时冲突

#### 轻微问题（代码质量）
- [nova_runtime.c:136-148] nova_string_new_len中cap最小值16可能浪费内存
- [nova_runtime.c:337,394,455] 空列表/空切片初始容量一致性
- [nova_runtime.c:819-821] nova_print_float使用%.17g格式
- [tree-sitter-nova/grammar.js:293-296] Tree-sitter中缺少\u转义序列支持
- [nova_runtime.c:492-499] nova_fnv1a_hash使用64位哈希但bucket_count是int64_t
- [nova_runtime.c:1495] nova_value_release中NOVA_VAL_UNIT分支缺失，依赖default
- tests/ 测试文件命名不一致，test_nova.py过于庞大
- [nova_runtime.c:79-87] nova_realloc中size <= 0时设为1，但不更新计数

#### 测试覆盖统计表
| 测试文件 | 测试函数数 | 主要覆盖领域 |
|---------|-----------|-------------|
| test_nova.py | 396 | 核心语言（词法/语法/类型/求值器/VM/ADT/管道/内置/循环/IO/JSON/数学/列表推导） |
| test_type_system.py | 103 | 泛型ADT、类型推断、模式匹配类型检查 |
| test_native_backend.py | 118 | x86_64代码生成、寄存器分配、ELF |
| test_ir.py | 94 | HIR/MIR/LIR降级、优化pass |
| test_backends.py | 43 | Cranelift/WasmGC/编译管线 |
| test_c_codegen.py | 52 | C代码生成、ADT、表达式 |
| test_modules.py | 28 | 模块解析、导入导出、循环检测 |
| test_errors.py | 36 | 错误格式化、错误收集、ANSI颜色 |
| test_depth_counter.py | 8 | 调用深度/求值深度清理 |
| **总计** | **878** | |

**关键空白区域**：无Evaluator vs VM一致性测试、无GC/内存管理测试、无模糊测试、C运行时无自动化测试、无性能基准测试、Map数据结构测试不足、网络/HTTP无测试、双执行路径行为一致性测试为0

#### 原创性分析
- **Nova特色**：五层全栈自研架构（前端+解释器+字节码VM+IR优化+多后端）在同类项目中非常少见；双执行路径设计（Evaluator+VM）便于调试对比；表达式导向设计
- **参考已有**：引用计数内存管理（常见入门级GC方案）；FNV-1a哈希函数（广泛使用）；递归下降解析器（标准做法）；栈式字节码VM（标准实现）；Tree-sitter语法定义（现代语言标准做法）
...
| 所有后端 | 11 | 9 | 9 | 29 |
| IR 系统 + Pass | 6 | 9 | 9 | 24 |
| 运行时 + 测试 + Tree-sitter | 8 | 9 | 8 | 25 |
| **合计** | **64** | **83** | **75** | **222** |

### 最关键的 P0 问题（本轮新确认/深化）

1. **类型检查器无真正的合一算法** — TypeVar与任何类型兼容，相当于关闭了类型检查的核心功能，不是真正的HM推断。这是整个类型系统的根基性缺陷。
2. **MIR match lowering完全没有匹配逻辑** — IR系统核心特性崩溃，所有match表达式在IR层语义错误，第一个arm总是被执行。
3. **Native后端栈分配ADT/List返回悬垂指针** — 函数式语言最基本的语义违反，生成的二进制完全不能正确执行。加上ELF入口点错误和栈指针不恢复，Native后端整体完全不可用。
4. **C运行时子对象不递归释放引用** — 系统性内存泄漏，list/map/adt/closure释放时都不释放子对象引用。
5. **闭包全帧捕获而非自由变量捕获** — 不仅是性能问题，还导致Evaluator与VM的闭包语义深层不一致。
6. **错误下划线off-by-one** — 所有语法错误高亮都少一个字符，影响开发体验。
7. **Tree-sitter与parser优先级不一致** — 编辑器高亮与实际语义不符，工具链分裂。
8. **无Evaluator vs VM一致性测试** — 两条执行路径的语义漂移无法被自动检测。

---

## [2026-07-16] 第二十八轮审查 — VM 虚拟机深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | PIPE_CALL 专用指令、MATCH_START/END 标记、TRY_UNWRAP 统一处理有特色 |
| 可行性 | ⭐⭐⭐ | 核心路径可用；闭包过度捕获、管道语义不一致 |
| 正确性 | ⭐⭐ | 管道值参数位置错误、闭包值语义与直觉不符、内置函数缺类型检查 |
| 安全性 | ⭐⭐⭐ | 栈安全基本达标；迭代器状态有泄漏风险 |
| 一致性 | ⭐⭐ | 与 Evaluator 在管道语义、闭包捕获范围上有重大差异 |
| 完整性 | ⭐⭐⭐⭐⭐ | 67 个操作码全部有处理路径 |
| 工程质量 | ⭐⭐⭐ | 结构清晰但有死代码、注释不一致 |
| 性能 | ⭐⭐ | 闭包全帧捕获性能差，高频创建闭包场景影响大 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [vm.py:1056-1067] **闭包捕获当前帧所有局部变量（过度捕获）** → CLOSURE 指令对当前帧 locals 做完整 dict 浅拷贝，而非仅捕获自由变量。内存浪费、意外延长大对象生命周期、语义模糊 → 编译器计算自由变量集合，作为操作数传递给 CLOSURE，VM 只捕获指定变量
- 追问：如果 OCaml 的闭包捕获了整个作用域的 dict 拷贝，性能影响能被接受吗？→ **绝对不能。** 生产级编译器都精确计算自由变量，过度捕获既是性能问题也是内存安全隐患。

- [vm.py:1463-1472] **PIPE_CALL 管道值作为最后一个参数，与 Evaluator 语义不一致** → VM 中 `x |> f(a, b)` 等价于 `f(a, b, x)`，而 Evaluator 中管道值是第一个也是唯一一个参数（右侧先完整求值再调用）。对于带参数的管道调用，两条路径行为完全不同 → 统一语义，建议采用主流设计（管道值作为第一个参数），并同步修改 Evaluator 支持右侧函数调用形式
- 追问：如果是成熟语言的编译器，两条执行路径的核心语法糖行为不一致，能被接受吗？→ **绝对不能。** 管道操作符是函数式语言的核心语法，行为不一致会导致严重的用户困惑和调试困难。

- [vm.py:298-316] **内置函数缺少参数类型检查，Python 异常直接泄露** → filter/map/head/tail/read_file/write_file 等内置函数不检查参数类型，传入错误类型抛出 Python 原生 TypeError/AttributeError 而非 Nova 运行时错误 → 所有内置函数入口处添加参数类型校验，失败时抛出 RuntimeError_，考虑使用统一的参数校验装饰器
- 追问：如果是成熟语言的 VM，Python 异常泄露到用户层面能被接受吗？→ **不能。** VM 作为语言运行时必须将所有底层异常封装为语言级错误，泄露实现细节既是用户体验问题也是安全隐患。

- [vm.py:1056-1067, 499-508] **闭包按值快照捕获可变变量，与主流语言直觉不符** → 闭包创建时对所有局部变量做浅拷贝快照，调用时再创建新 dict。闭包内外的可变变量互不影响，同一闭包多次调用之间状态不共享 → 方案 A（推荐）：实现按引用捕获，闭包与外部共享可变变量存储；方案 B：在文档中明确说明值捕获语义并提供替代方案
- 追问：如果是成熟语言的编译器，闭包语义与用户直觉严重不符且无文档说明，能被接受吗？→ **不能。** 闭包捕获语义是语言核心特性，必须清晰一致并有完善文档。

#### 中等问题（影响特定场景）

- [vm.py:1078-1083] **顶层 RETURN 指令不报错** → 顶层代码执行 RETURN 会设置 return_flag 并"正常"结束，RETURN 在顶层没有语义应报错 → 在 RETURN 中检查 call_stack，为空则抛 RuntimeError_
- [vm.py:579-581] **_execute_function 中 return_flag 处理是死代码** → RETURN 指令被 _execute_function 在调用 _execute_instruction 之前就捕获了，return_flag 在函数中永远不会被设为 True → 删除死代码或重构 RETURN 处理逻辑使其更清晰
- [vm.py:1196-1198, 1240-1242] **FOR_ITER 通过指令地址识别循环，脆弱且不可靠** → 比较 _for_iters[-1].loop_start 和 self.ip-1 判断是否同一循环，依赖指令地址的隐式关联 → 在 FOR_ITER 操作数中携带循环唯一标识
- [vm.py:1541-1550] **TRY_UNWRAP 不校验 type_name 与 variant_name 的对应关系** → type_name="Option" 但 variant_name="Ok" 不会报错，走到 Some/Ok 分支解包 → 增加对应关系校验，Option 只能有 Some/None，Result 只能有 Ok/Err
- [vm.py:1177-1181] **BUILD_RANGE 总是 pop 3 个值，注释暗示 step 可选** → Op 类注释说 step 可选但实现总是 pop 3 个值 → 更新注释明确说明总是有 3 个操作数
- [vm.py:1005-1013] **while 循环 BREAK 的 base_sp 依赖隐式约定** → _while_loops 信息在 POP_JUMP_IF_FALSE 的 else 分支添加，理论上 BREAK 只在循环体内执行但这是隐式约定 → 添加断言确保 loop_info 结构完整

#### 轻微问题（代码质量）

- [vm.py:1504-1513] DUP/SWAP 手动检查栈深度，与 _pop() 风格不一致
- [vm.py:1515-1522] PRINT 指令与 print 内置函数功能重复
- [vm.py:237] read_line lambda 有参数时返回空字符串而非报错，逻辑奇怪
- [vm.py:525-526, 552-559] 循环状态清理用 key 差集，隐式依赖 _loop_id 单调递增
- [vm.py:1378-1386] MATCH_BIND 顶层修改全局变量，可能产生意外副作用
- [vm.py:1192-1193, 1236-1237] _range_index/_list_index 使用 hasattr 延迟初始化而非 __init__ 中初始化
- [vm.py:814-815] DIV 整数除法使用地板除（//），负数行为需文档化

#### 原创性分析
- **Nova 特色**：PIPE_CALL 专用管道调用指令、MATCH_START/MATCH_END 显式标记、TRY_UNWRAP 统一处理 Option/Result、ADT 原生指令集（MAKE_ADT/REGISTER_CTOR/MATCH_CONSTRUCTOR）、常量值直接内联无需常量池
- **参考已有**：基本栈机设计参考 CPython/JVM；FOR_ITER + LOOP_END 双指令循环参考 Python；迭代器状态字典管理参考常见解释器实现

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 管道操作（带参数函数调用） | 右侧先完整求值再调用（单参数） | 管道值作为最后一个参数 | ❌ **严重** |
| 闭包捕获范围 | 整个作用域链所有 mut 变量 | 当前帧所有 locals | ❌ |
| 不可变变量捕获 | 引用语义（环境链查找） | 值语义（快照） | ❌ |
| 递归深度计数 | 2个计数器（call + eval） | 1个计数器（call） | ❌ |
| MatchFailure 错误类型 | RuntimeError_ | MatchFailure | ❌ |
| 基本算术运算 | 正确 | 正确 | ✅ |
| ADT 构造 | 正确 | 正确 | ✅ |
| for 循环返回列表 | 正确 | 正确 | ✅ |
| range 包含右端点 | 包含 | 包含 | ✅ |
...
## [2026-07-16] 第二十八轮审查 — 编译器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | PIPE_CALL 指令、MATCH_START/END 标记、ADT 原生指令有特色 |
| 可行性 | ⭐⭐⭐ | 基本编译流程可用；模式匹配作用域、POP_JUMP_IF_FALSE 滥用有严重 bug |
| 正确性 | ⭐⭐ | MATCH_END 永不执行、POP_JUMP_IF_FALSE 污染 while 栈、列表推导式 filter 控制流异常 |
| 安全性 | ⭐⭐⭐ | 栈布局基本正确；但控制流副作用交叉污染 |
| 一致性 | ⭐⭐ | 与 VM 的管道语义、闭包语义不一致 |
| 完整性 | ⭐⭐⭐⭐ | AST 大部分节点有编译处理；内部函数定义不支持 |
| 工程质量 | ⭐⭐ | 死代码多、注释过时、命名不一致 |
| 性能 | ⭐⭐ | 闭包不做自由变量分析影响效率 |
...
- [compiler.py:784-788] **MATCH_END 永远不会执行——模式匹配变量泄漏** → MATCH_END 被放置在 end_pos 之前，但所有匹配成功的 arm 都跳转到 end_pos（即 MATCH_END 之后），导致 MATCH_END 永不执行。match 分支中绑定的变量不会被清理，_match_stack_bases 泄漏，嵌套 match 失效 → 将 MATCH_END 移到 end_pos 之前，让成功分支跳转到 MATCH_END 而不是跳过它
- 追问：如果 Haskell GHC 编译器每次 match 表达式都泄漏变量绑定和栈元数据，能被接受吗？→ **绝对不能。** 这是核心功能的作用域正确性缺陷，嵌套 match 会产生错误结果。

- [compiler.py:544, 1160] **POP_JUMP_IF_FALSE 被用于非 while 循环场景，污染 _while_loops 栈** → && 运算符和列表推导式 filter 中使用 POP_JUMP_IF_FALSE，但该指令在 VM 中附带 while 循环簿记逻辑（条件为真时推入 _while_loops）。这些地方根本不是 while 循环，会导致假的循环条目被推入 → && 运算符和列表推导式 filter 改用 JUMP_IF_FALSE，POP_JUMP_IF_FALSE 只在 while 循环条件处使用
- 追问：如果任何生产级语言的编译器将循环指令复用到普通条件跳转，导致控制流状态污染，能被接受吗？→ **绝对不能。** 指令语义被错误复用是隐蔽但严重的控制流 bug。

- [compiler.py:1144-1178] **列表推导式带 filter 时 _for_iters 栈状态不一致** → filter 条件使用 POP_JUMP_IF_FALSE 意外地向 _while_loops 推入假条目，循环结束时 _for_iters 被正确弹出但 _while_loops 中的假条目不会被清理 → 将 filter 的 POP_JUMP_IF_FALSE 改为 JUMP_IF_FALSE

#### 中等问题（影响特定场景）

- [compiler.py:633-644] **内置 ADT 构造器在函数调用位置无法被遮蔽** → Some/Ok/Err 被硬编码为 ADT 构造器调用，即使用户定义了同名变量遮蔽也仍然执行 ADT 构造 → 这些内置构造器应通过 REGISTER_CTOR 注册为变量，通过常规函数调用路径访问，删除 _compile_fn_call 中的特殊处理
- [compiler.py:602-607] **_compile_pipe 中 builtin 分支与 else 分支代码完全重复** → 两个分支都生成 LOAD_VAR name，if 判断完全多余 → 删除多余的 if/else，直接使用 LOAD_VAR
- [compiler.py:366-373] **导入时 ADT 构造器名称冲突无检测** → 导入的 TypeDef 构造器与现有构造器重名时静默覆盖，导致模式匹配时 MATCH_CONSTRUCTOR 使用错误的 type_name → 导入 TypeDef 时检查每个 variant 名称是否已存在于 _adt_constructors，存在则发出警告
- [compiler.py:870-913] **_compile_pattern_extract_and_bind 是无操作的死代码** → 所有模式变量绑定都在测试阶段通过 MATCH_BIND 完成，该函数对于所有叶子模式都是 pass → 删除该函数及其调用，或明确注释为未来扩展预留
- [compiler.py:915-980] **_compile_pattern_test 和 _compile_pattern_bindings 是未使用的死代码** → 两个函数从未被任何外部代码调用，是旧版模式匹配编译方案的残留 → 删除这两个函数及其相关死代码

#### 轻微问题（代码质量）

- [compiler.py:1011-1018] ForExpr.step 字段未被编译器使用，从 expr.iterable[3] 获取步长
- [compiler.py:82] CLOSURE 指令注释的操作数与实际不符（注释 3 个，实际 2 个）
- [compiler.py:1030-1034, 1148-1152] for 循环 _loop_stack 条目的 break_patches 和 continue_target 字段未使用
- [compiler.py:796-799] PatternWildcard 用 POP 而非 MATCH_WILDCARD，不一致
- [compiler.py:867-868] _compile_pattern_test_with_fail 的 else 分支对未知模式静默返回空列表
- [compiler.py:989] _compile_block 的 POP 排除列表不完整，新增无值语句类型需手动更新
- [compiler.py:311-312] 顶层表达式结果被 POP 丢弃但无类型/值检查
- [compiler.py:199-210] patch_match_fail 保留了对旧格式的兼容代码
- [compiler.py:407] 闭包捕获所有局部变量而非仅自由变量（性能问题）

#### 原创性分析
- **Nova 特色**：PIPE_CALL 专用指令、MATCH_START/MATCH_END 配对标记（方便调试）、FOR_ITER + LOOP_END 双指令循环设计、ADT 原生指令集、常量值直接内联
- **参考已有**：基本栈机结构参考 CPython/JVM；跳转回填参考标准编译器教材；模式匹配编译参考函数式语言经典方案
...
## [2026-07-16] 第二十八轮审查 — 求值器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两遍扫描支持相互递归；内置 Option/Result 类型 |
| 可行性 | ⭐⭐⭐ | 核心特性可用；块内函数定义缺失、闭包语义不一致 |
| 正确性 | ⭐⭐ | 块内不支持函数定义、闭包语义不一致、部分应用闭包语义错误 |
| 安全性 | ⭐⭐ | 无递归深度保护（eval 深度）、Map 键重复求值 |
| 一致性 | ⭐⭐ | 与 VM 在管道语义、闭包捕获、Unit bool 等方面不一致 |
| 完整性 | ⭐⭐⭐ | 大部分 AST 节点有处理；Block 内声明不支持 |
| 工程质量 | ⭐⭐ | 重复代码多、eval_expr 过长、命名不一致 |
| 性能 | ⭐⭐⭐ | 闭包引用语义效率可接受；但过度捕获 mut 变量 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [evaluator.py:891-903, 799-1012] **Block 内不支持 FnDef/TypeDef 等声明** → _eval_expr_inner 中没有处理 FnDef/TypeDef/AliasDef/ImportDecl/ExportDecl，出现在 Block 内部时抛"未知的表达式类型"错误。嵌套函数定义是函数式语言的基本特性 → 在 _eval_expr_inner 中添加对 FnDef 的处理，Block 的 statements 先扫描收集所有声明再求值
- 追问：如果是成熟语言的解释器，不支持嵌套函数定义能被接受吗？→ **绝对不能。** 嵌套函数定义是闭包和函数式编程的基础，缺失意味着语言表达能力存在根本性缺陷。

- [evaluator.py:468-482] **闭包捕获整个作用域链所有 mut 变量（过度捕获）** → _capture_mut_vars 沿整个作用域链向上收集所有 mut 绑定的快照，而非只捕获闭包体内实际引用的变量。性能浪费且语义不清晰，还与 VM 行为不一致 → 实现自由变量分析，只捕获实际引用的变量
- 追问：如果是成熟语言的解释器，闭包捕获所有外层可变变量而不是仅引用的变量，能被接受吗？→ **不能。** 虽然功能上可能碰巧正确，但这是严重的设计缺陷，也与 VM 行为不一致。

- [evaluator.py:46-64, 527-533] **闭包对不可变变量是引用语义，对 mut 变量是值语义——语义不一致** → 不可变变量通过环境链查找（引用语义），mut 变量通过 captured_mut_vars 快照（值语义）。两种语义混用，且与 VM 的全快照语义不一致 → 统一闭包语义，要么全部引用语义要么全部值语义快照。建议采用与 VM 一致的方案：创建闭包时快照所有捕获变量的值
- 追问：如果同一语言中不可变变量和可变变量的闭包捕获语义不同，能被接受吗？→ **不能。** 闭包语义是语言的核心特性，必须有清晰、一致的定义。与 VM 的行为差异更是严重 bug。

- [evaluator.py:598-744] **两次扫描的重复代码与不一致性** → 存在三套声明处理逻辑（_collect_decl、_eval_decl_body、_eval_decl_inner），_eval_decl_inner 几乎是前两者的合并重复代码，且有细微差异 → 消除重复代码，让 eval_program 的两遍扫描复用同一套底层函数

- [evaluator.py:500-520] **部分应用的闭包没有正确重新快照 mut 变量** → 部分应用时 captured_mut 直接复制原始闭包的 captured_mut_vars，但新绑定的参数如果通过某种方式是可变的不会进入快照。部分应用创建的新闭包使用 captured_env 作为其环境，与 mut 快照的作用域基础不一致 → 部分应用创建新闭包时，调用 _capture_mut_vars(captured_env) 重新快照 mut 变量

#### 中等问题（影响特定场景）

- [evaluator.py:1263-1276] 模式匹配 guard 求值和 body 求值各创建一个环境，重复且效率低
- [evaluator.py:1289] 模式匹配失败使用 RuntimeError_ 而非专用的 MatchFailure 错误类
- [evaluator.py:1189-1190] for 循环 break 返回已收集的 results 列表，while 循环返回最后一次 body 值，两者行为不一致
- [evaluator.py:170-173, 789-797] 两个深度计数器（call + eval），关系不清晰，与 VM 只有一个计数器不一致
- [evaluator.py:1220-1254] 列表推导式中没有捕获 BreakSignal/ContinueSignal，break/continue 会意外传播到外层循环
- [evaluator.py:1183] for 循环变量总是不可变，不支持 mut
- [evaluator.py:633-635] ADT 构造器名称冲突时静默覆盖
- [evaluator.py:996-1009] 索引访问对字符串返回 Python str 而非 NovaChar，与 CharLiteral 语义不一致
- [evaluator.py:970-993] 元组字段访问不检查负索引边界，ADT 字段有检查但元组没有

#### 轻微问题（代码质量）

- [evaluator.py:920-923] Assignment 错误处理冗余，捕获 RuntimeError_ 然后重新抛出相同类型
- [evaluator.py:448-449] _format_value 中 None 返回 "null"，Python None 在 Nova 中不应出现
- [evaluator.py:282-285] _builtin_tail 对空列表 None variant 的 field_names 不准确
- [evaluator.py:468] _capture_mut_vars 的 env 参数名与 self.env 易混淆
- [evaluator.py:932-943] MapExpr 键在错误处理路径中被求值两次，有副作用的键产生不正确结果
- [evaluator.py:567-597, 674-683] 顶层 eval_program 和 eval_decl 两个入口点逻辑不统一

#### 原创性分析
- **Nova 特色**：两遍扫描支持相互递归函数；内置 Option/Result 类型的构造器；闭包 mut 变量快照语义（有特色但需统一）
- **参考已有**：环境/作用域链是 SICP 风格经典实现；模式匹配是标准递归下降；内置函数表驱动设计
...
## [2026-07-16] 第二十八轮审查 — 类型检查器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两阶段检查支持前向引用；_instantiate 实现"穷人的let多态" |
| 可行性 | ⭐⭐ | 基本类型检查可用；但核心的合一算法缺失 |
| 正确性 | ⭐ | _types_compatible 对 TypeVar 完全放行，类型检查形同虚设 |
| 安全性 | ⭐⭐ | 无真正的类型安全保证；无穷类型不被拒绝 |
| 一致性 | ⭐⭐ | 与运行时的类型行为基本一致；但推断结果不可靠 |
| 完整性 | ⭐⭐⭐ | 类型结构齐全；但合一、generalization、occurs check 缺失 |
| 工程质量 | ⭐⭐⭐ | 结构清晰；但 bindings 格式混乱、重复代码多 |
| 性能 | N/A | 无法评估——核心功能不正确 |
...
- [type_checker.py:1550] **_types_compatible 对 TypeVar 完全放行——类型检查形同虚设** → 只要两个类型中任意一方是 TypeVar 就直接返回 True。List[Int] 与 List[String]、Fn(Int)->String 与 Fn(String)->Int，只要一方含 TypeVar 就被认为兼容。类型推断过程中几乎所有约束检查都会失效 → 引入真正的合一（unification）算法，使用 union-find 或替换表管理类型变量；至少递归检查结构兼容性而非直接返回 True
- 追问：如果 OCaml 的类型检查器遇到 TypeVar 就直接认为兼容，能被接受吗？→ **绝对不能。** 这是类型系统的核心正确性问题，会导致大量类型错误的程序通过检查，在运行时崩溃。

- [type_checker.py:1405-1434] **没有真正的合一（Unification）算法** → _collect_type_bindings 只是单向地从 expected 向 actual 收集绑定。只有 expected 是 TypeVar 时才绑定，actual 是 TypeVar 时不绑定。没有冲突检测，没有双向合一 → 实现基于 union-find 的高效合一算法，实现 occurs check，合一失败时报告清晰的类型错误
- 追问：如果是成熟语言的类型检查器，没有正确的合一算法，能被接受吗？→ **不能接受。** 合一是 HM 类型推断的基石，没有正确的合一，类型推断的结果是不可靠的。

- [type_checker.py:644-646] **没有 generalization——let 多态不正确** → 代码注释声称实现了 Algorithm W 的 instantiation，但缺少对应的 generalization 步骤。没有 type scheme 概念，无法区分单态类型和多态类型 → 引入 TypeScheme 类表示多态类型方案；实现 generalize 和 instantiate；let 绑定后调用 generalize，标识符引用时调用 instantiate
- 追问：如果 OCaml 的 let 多态没有正确实现，能被接受吗？→ **不能接受。** let-polymorphism 是 HM 类型系统的核心特性，没有正确的 generalization，类型系统既不完整也不正确。

- [type_checker.py:全文] **没有 occurs check——允许无穷类型** → 整个文件无 occurs check 实现。如果类型变量 a 被约束为 List[a]，会产生无穷类型，可能导致栈溢出或错误的推断结果 → 在合一算法中添加 occurs check：将 TypeVar 绑定到某类型前，检查该 TypeVar 是否出现在类型内部
- 追问：如果是成熟语言的类型检查器，没有 occurs check 允许无穷类型，能被接受吗？→ **不能接受。** Occurs check 是类型系统正确性的基本保障。

- [type_checker.py:560-598] **递归函数参数类型无法正确推断** → 函数参数如果没有类型标注，第一遍赋予 TypeVar，但类型检查过程中没有合一操作来约束这些 TypeVar。没有类型标注的函数参数永远保持为未约束的 TypeVar → 实现真正的合一算法，使参数类型能从函数体使用中被约束；对于递归函数，迭代直到类型收敛
- 追问：如果是成熟语言的类型检查器，函数参数类型永远推断不出来，能被接受吗？→ **不能接受。** 类型推断的基本能力就是从函数体推导参数类型。

- [type_checker.py:714-726] **模式匹配完全没有穷尽性检查** → match 表达式只检查各分支的类型一致性，完全不检查穷尽性和冗余性。漏掉某些变体时不会有编译期警告，运行时发生 MatchFailure → 实现穷尽性检查算法，对 ADT 匹配检查是否所有变体都被覆盖；检测不可达的分支（冗余模式）
- 追问：如果 Rust/OCaml 的类型检查器不检查 match 穷尽性，能被接受吗？→ **不能接受。** 穷尽性检查是模式匹配类型系统的标配，是类型安全的重要组成部分。

- [type_checker.py:1521-1544] **_expand_alias 函数名不副实——不展开任何别名** → 只是递归遍历类型结构，没有任何实际的别名查找和替换逻辑。_alias_stack 参数被传入但从未使用。别名不支持前向引用 → 第一遍只注册别名的名字，第二遍再解析别名的目标类型；或删除无用的 _expand_alias 函数

#### 中等问题（影响特定场景）

- [type_checker.py:1178-1186] 构造器模式查找效率低（线性扫描所有 ADT 的所有变体），且同名变体可能找到错误的
- [type_checker.py:1249-1258] 二元操作符的 Int/Float 推断不精确，TypeVar 时直接返回 INT_T 而不更新约束
- [type_checker.py:998-1016] TryExpr 对 Option 不检查错误类型兼容性，Result 有检查但 Option 漏掉了
- [type_checker.py:1070-1071] ForExpr 中非列表迭代类型不报错，静默创建 TypeVar 放行
- [type_checker.py:650] ListExpr 空列表元素类型命名不一致（硬编码 "unknown_list_elem"）
- [type_checker.py:873-883] FieldAccess 对元组非数字索引的错误信息不准确（说"越界"而非"不支持命名字段"）
- [type_checker.py:777-782] FnCall 中 TypeVar 被调用者返回新 TypeVar 而非 ERROR_TYPE，可能产生级联错误

#### 轻微问题（代码质量）

- [type_checker.py:1372-1386] _substitute_type_vars 动态检测 bindings 格式（字符串 key vs TypeVar key），设计脆弱
- [type_checker.py:169-176] TypeVar._counter 是类变量，多实例共享导致编号全局递增
- [type_checker.py:1130-1142] check_match_arm 的 match_expr 参数未使用
- [type_checker.py:457-467] 顶层 let/mut 占位符类型在检查前可能被引用，前向引用推断不正确
- [type_checker.py:303-308] _setup_builtins 中 Ok/Err 构造器的类型变量不共享，缺少注释说明
- [type_checker.py:42-58] ErrorType 单例模式与 isinstance 检查的交互需文档说明

#### 原创性分析
- **Nova 特色**：两阶段检查（收集签名→检查主体）支持前向引用和相互递归；_instantiate 标识符查找时实例化实现"穷人的let多态"；ADT 字段访问的 product-like 语义
- **参考已有**：整体结构参考传统函数式语言类型检查器；类型表示是标准 ML 风格；ErrorCollector 是编译器标准模式

---

## [2026-07-16] 第二十八轮审查 — 词法/语法分析器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | if-then-else 消除悬挂 else、管道优先级设计有特色 |
| 可行性 | ⭐⭐⭐ | 主要语法元素均可用；存在边界情况 bug 和安全问题 |
| 正确性 | ⭐⭐ | 控制流表达式不参与管道、词法错误递归恢复栈溢出、Unit 类型双重表示 |
| 安全性 | ⭐⭐ | 词法错误递归恢复存在 DoS 风险；标识符允许任意 Unicode |
| 一致性 | ⭐⭐ | 与 Tree-sitter 优先级不一致；AST 类型不一致 |
| 完整性 | ⭐⭐⭐ | Token 覆盖完整；缺少块注释、十六进制、数字分隔符、原始字符串等 |
| 工程质量 | ⭐⭐⭐ | 结构清晰但死代码多、脆弱消歧、递归错误恢复 |
| 性能 | ⭐⭐⭐ | 递归下降线性时间；_is_map_literal 最坏 O(n²) |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [parser.py:64-73] **解析器完全没有语法错误恢复机制** → _expect 遇到不匹配的 token 直接抛出 ParseError，整个解析立即终止。用户每次只能看到一个错误 → 实现 Panic Mode 错误恢复，在同步点（;、}、EOF、顶层关键字）处重新同步，通过 ErrorCollector 收集错误后继续解析
- 追问：如果 GCC/Clang 的语法分析器遇错即停，只能看到一个错误，能被接受吗？→ **绝对不能接受。** 现代编译器都实现了错误恢复，一次性报告多个错误。这是生产级编译器前端的基本要求。

- [parser.py:434-454] **控制流表达式（for/while/if/match）无法参与管道运算** → 优先级链结构导致 for/while/if/match 表达式的优先级低于管道，`for x in xs { x } |> f` 只能解析出 for 表达式，|> f 被遗弃 → 将管道解析移到更外层，使所有表达式都能参与管道运算
- 追问：如果一门号称"一切皆表达式"的语言，控制流表达式不能参与管道运算，能被接受吗？→ **绝对不能接受。** 这是结构性的优先级设计错误，废掉了表达式导向的核心价值。

- [lexer.py:243, 264, 273, 287, 297, 320, 470] **词法错误恢复使用递归调用，存在栈溢出 DoS 风险** → 7 处错误恢复路径均使用递归调用 _next_token()。连续大量非法字符（如 1MB 的 @ 字符）会使递归深度线性增长，超过 Python 默认递归深度限制 → 将 _next_token 改为 while True 循环结构，错误时设置标记并 continue 到下一次循环迭代
- 追问：如果 GCC 的词法分析器遇到大量非法字符会栈溢出崩溃，能被接受吗？→ **绝对不能接受。** 这是一个可被利用的拒绝服务漏洞，是编译器前端的基本安全要求。

- [parser.py:480, 980] **for 循环和列表推导式的 iterable 使用原始 tuple 污染 AST 类型系统** → ForExpr.iterable 可能是表达式节点，也可能是 Python 元组 ("range", start, end, step)。破坏了 AST 的类型安全性 → 创建 RangeExpr AST 节点类型替代 tuple 表示；清理 ForExpr.step 冗余字段
- 追问：如果是GCC/Clang的AST有这个bug，能被接受吗？→ **不能接受。** AST 是编译器的核心数据结构，类型不一致会导致整个下游管道的脆弱性。

- [parser.py:317-323, 328] **Unit 类型有两种表示：TypeUnit 和 TypeTuple([])** → Unit 关键字生成 TypeUnit，() 元组类型生成 TypeTuple(elements=[])。语义上完全相同的类型有两种不同的 AST 表示 → 统一表示，检测空元组 () 并返回 TypeUnit

- [parser.py:98-122] **顶层赋值语句不支持，错误信息具误导性** → 顶层写 x = 5 会先解析 x 为标识符表达式，然后 = 无法被消费，触发"意外的 token '='"错误 → 在 _parse_top_level 中增加赋值语句检测，或给出更明确的错误消息

#### 中等问题（影响特定场景）

- [parser.py:528] match 分支隐式分隔检测缺少 CHAR 和 MINUS
- [parser.py:666-672, 678-684] 比较运算符和相等性运算符为左结合，应为无结合性（链式比较无明确语义）
- [parser.py:438-445, 654-660] 管道操作符优先级高于 && 和 ||，不符合函数式语言惯例
- [lexer.py:202-221] 数字字面量不支持十六进制/八进制/二进制
- [lexer.py:212-218] 浮点数不支持科学计数法、前导点、尾随点
- [lexer.py:246-257] 字符串转义序列不完整，未知转义静默通过
- [lexer.py:186-200] 不支持块注释（多行注释）
- [lexer.py:223-273] 不支持原始字符串和多行字符串
- [parser.py:392-396, 422-428] 赋值仅支持简单标识符，不支持索引/字段赋值
- [parser.py:957-959, 1007-1013] 列表/元组不支持尾随逗号，与 Map 不一致
- [lexer.py:332, 377] 标识符使用 isalnum() 允许任意 Unicode 字符，存在同形异义词攻击风险
- [lexer.py:179-183] \r 回车符不增加行号
- [lexer.py:275-324] 字符字面量不验证字符数量，多字符字符字面量错误信息误导
- [parser.py:850-890] _is_map_literal 无界前瞻扫描，最坏 O(n²) 复杂度
- [parser.py:867-869] 空 {} 永远解析为空 Map，空 Block 无法表示
- [parser.py:252-267] ADT 变体定义的命名字段/匿名字段使用手动位置回退
- [parser.py:974-980] 列表推导式的范围形式不支持 step
- [parser.py:470-472, 974-976] <- 由两个独立 token 拼接，空白不敏感且有歧义
- [parser.py:198-201, 748-750] 函数参数/调用参数不支持尾随逗号

#### 轻微问题（代码质量）

- [lexer.py:88] PIPE_VARIANT 是死 Token
- [lexer.py:91, parser.py:810-812] UNIT Token 和对应解析分支是死代码
- [lexer.py:155-160] _make_error 方法是死代码，且逻辑有 bug
- [lexer.py:117-137] 缺少 return 关键字和 return 表达式
- [lexer.py:208-209] 不支持数字分隔符（1_000_000）
- [parser.py:686-693] ++ 字符串拼接优先级高于加减，不符合直觉
- [parser.py:57-62] _advance 在 EOF 处静默停驻，可能隐藏 bug
- [parser.py:551-636] 模式匹配缺少多种高级模式（Or 模式、As 模式、Rest 模式等）
- [lexer.py:53-74] 缺少复合赋值操作符（+=、-= 等）
- [lexer.py:107] Token.end_col 与 Span.end_column 命名不一致
- [parser.py:488-489] ForExpr.step 字段冗余（已包含在 iterable 中）

#### 原创性分析
- **Nova 特色**：if-then-else 使用 then 关键字彻底消除悬挂 else；管道操作符优先级位置合理（低于相等性高于逻辑与）；ADT 变体支持命名字段和匿名字段两种形式；?后缀错误传播操作符
- **参考已有**：递归下降+优先级爬升是教科书式实现；_is_map_literal 无界扫描是 JavaScript/TypeScript 经典问题；| 单 token 多语义是函数式语言常见做法

---

## [2026-07-16] 第二十八轮审查 — 错误处理/模块系统/环境深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | Rust 风格错误格式化有特色；闭包值语义有设计 |
| 可行性 | ⭐⭐⭐ | 核心功能可用；存在多个影响正确性的严重问题 |
| 正确性 | ⭐⭐ | end_col 语义混用、路径遍历漏洞、导出名称不验证、define 静默 shadow |
| 安全性 | ⭐⭐ | 路径遍历漏洞、全局单例污染、闭包环境引用语义 |
| 一致性 | ⭐⭐ | end_column 语义不统一、闭包语义不一致 |
| 完整性 | ⭐⭐⭐ | 基本功能齐全；缺少错误码、错误恢复、路径规范化 |
| 工程质量 | ⭐⭐⭐ | 结构清晰但重复代码多、性能考虑不足 |
| 可调试性 | ⭐⭐ | 缺少上下文建议、变量未定义不列可用变量 |
...
- [errors.py:104, 171, 274, lexer.py:107, 218] **end_col 语义不一致：包含式 vs 排除式混用** → Token.end_col 在 lexer 中用 self.column - 1 设置（包含式），但 _compute_underline 中计算 u_end - u_start 时假设 end_col 是排除式。所有单线下划线少一个字符。默认 end_col = self.column + 1（排除式语义），与 span 传入的包含式混用 → 统一为排除式语义。lexer 中 end_col = self.column，更新所有使用点
- 追问：如果 Rust 编译器的错误高亮少一个字符，能被接受吗？→ **绝对不能。** 错误高亮必须精确到字符级，这是生产级编译器的基本要求。

- [errors.py:281] **多行错误下划线末行同样 off-by-one** → end_line 行的下划线是 "^" * max(1, end_col - 1)，如果 end_col 是包含式的应该是 end_col 个字符 → 统一 end_col 语义后修正计算

- [modules.py:134-138] **包导入路径遍历漏洞——可读取任意文件系统位置** → 包导入路径直接拼接到 search_path 后未做安全检查，foo/../../bar 这样的路径会走包导入逻辑，可以遍历到任意系统位置 → 所有路径解析后都 os.path.normpath 并检查是否在允许的根目录内；包导入限制在 search_paths 的子目录中
- 追问：如果 Rust 的模块系统允许通过路径遍历读取任意系统文件，能被接受吗？→ **绝对不能。** 这是一个严重的安全漏洞。

- [modules.py:276-291] **导出名称不验证：可以导出不存在的名称** → _collect_exports 只收集 ExportDecl 的 name，完全不验证这个名称是否真的在模块中定义过。拼写错误的导出名称不会有任何错误提示 → 收集导出后验证每个导出名称在模块环境中存在；不存在时报错
- 追问：如果 Rust 编译器允许 pub 一个不存在的函数且不报错，能被接受吗？→ **绝对不能。** Rust 会报 E0425 未解析名称错误。

- [errors.py:438-444] **ErrorCollector.raise_all() 丢失错误类型信息** → 只抛出第一个错误的类型，其余错误被序列化为字符串塞进 related_notes。如果第二个错误是 LexerError，类型信息完全丢失，变成普通 note → 引入 NovaErrorGroup 异常类，包含完整的错误列表

- [environment.py:30-32] **define 允许静默 shadow 同名绑定，没有任何检查** → 同一作用域中两次 define("x", ...) 会静默覆盖。对于不可变语言来说，同一作用域内重复定义应该是错误。闭包调用时参数名与捕获 mut 变量同名也会静默覆盖 → define 增加 shadow 参数或检查重定义；闭包环境构建时检测参数名与捕获变量名冲突

- [evaluator.py:468-482 + environment.py] **闭包捕获整个作用域链所有 mut 变量，而非仅自由变量** → _capture_mut_vars 沿整个作用域链向上收集所有 mut 绑定的快照，而不是只捕获闭包体内实际引用的变量 → 实现自由变量分析，只捕获实际引用的变量

- [modules.py:216-218] **循环导入检测不支持相互递归模块** → 简单的栈检测，相互递归的模块完全不支持 → 实现两阶段加载：第一阶段只收集导出签名并注册到缓存（标记为 loading），第二阶段才求值

#### 中等问题（影响特定场景）

- [errors.py:179] _format_with_context 中 ctx_end 计算错误，不显示 end_line 的下一行作为下文
- [errors.py:398-403] ErrorCollector.add() 中 Severity.NOTE 和 Severity.HELP 被当作 error 处理
- [errors.py:261] RelatedNote 的 underline 永远使用 ANSI.BLUE，不按 severity 着色
- [errors.py:249] 相关注释的源码行使用主错误的 max_line_num_width，行号位数更多时对齐错乱
- [errors.py:359-360] PassError 绕过整个格式化系统，__str__ 直接返回 message
- [modules.py:205] 每次导入都创建新的 ModuleResolver，evaluator 和 type_checker 还各自独立创建
- [modules.py:293-299] _collect_exported_types 完全没有被使用
- [modules.py:329-330] import_module 将导入的绑定定义为不可变，未考虑模块内 mut 变量
- [modules.py:186] 模块缓存键只用 file_path，忽略类型检查状态
- [modules.py:358-364] 全局模块管理器的默认搜索路径包含相对路径，易受 CWD 影响
- [evaluator.py:607, environment.py:27] 闭包环境是引用语义，修改外层环境会影响已创建的闭包（违反词法作用域）
- [environment.py:67-73] all_bindings 方法名可能误导，实际是 shadow 后的扁平绑定

#### 轻微问题（代码质量）

- [errors.py:148-155] _severity_color 字典每次调用都重建
- [errors.py:93] highlight_span 旧格式兼容字段未标注 deprecated
- [errors.py:124-128] NovaError.__str__ 和 format() 重复
- [modules.py:重导出] 不支持 re-export（export import）
- [modules.py:47] ModuleInfo.is_loaded 永远是 True
- [environment.py:17] BindingInfo.name 是冗余的（dict key 也是 name）
- [environment.py:全文] 没有 has(name) 或 get(name, default) 方法
- [environment.py:9] 导入了 List 但未使用

#### 原创性分析
- **Nova 特色**：中文本地化的错误消息；闭包值语义设计（有特色但实现不一致）；ErrorCollector 收集模式
- **参考已有**：错误系统直接借鉴 Rust 编译器诊断系统；模块系统经典 resolver+cache 架构类似 Python importlib；环境/作用域链是 SICP 风格经典实现


---

## [2026-07-16] 第二十八轮审查 — 所有后端深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 自研 x86_64 编码器 + ELF 生成有一定原创性 |
| 可行性 | ⭐⭐ | Native 后端生成的代码不能正确执行；C 后端相对可行 |
| 正确性 | ⭐ | 多处根本性错误：参数传递错误、栈分配返回悬垂指针、条件分支硬编码 |
| 安全性 | ⭐ | 无边界检查、栈上分配返回指针、寄存器冲突 |
| 一致性 | ⭐⭐ | 四个后端架构完全不同，命名不一致，行为不一致 |
| 完整性 | ⭐⭐⭐ | LIR 指令覆盖度尚可，但很多是 stub 或硬编码 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰、注释丰富，但测试深度不足 |
| 性能 | N/A | 无法评估——代码不能正确运行 |
...
- [native_backend.py:515-526] **函数调用约定参数传递错误——第7个参数丢失** → int_idx > 6 的检查错误（System V 有 6 个整型参数寄存器，第 7 个才压栈），当 int_idx >= 6 时就应该压栈但代码检查 > 6。浮点参数超出 8 个时被静默丢弃 → 将 if int_idx > 6 改为 if int_idx >= 6；对浮点参数超出 8 个的情况也要压栈
- 追问：如果 OCaml 的 native 编译器生成的函数调用代码参数丢失，能被接受吗？→ **不能。** 编译器生成错误的函数调用代码会导致所有超过 6 个参数的函数调用产生未定义行为，这是编译器正确性的核心问题。

- [native_backend.py:1132-1189] **栈分配的 ADT/List/Tuple 返回后指针悬空** → _compile_build_list/tuple/adt 都使用 sub rsp 在栈上分配内存，函数返回后栈帧释放，数据结构指针变成悬空指针。这是根本性的设计错误 → 改为使用堆分配（调用 nova_alloc 或类似的运行时分配函数），或使用 SROA 将小结构拆分到寄存器
- 追问：如果 OCaml 的 native 编译器在栈上分配 ADT 然后返回指针，能被接受吗？→ **绝对不能。** 这是典型的"返回局部变量地址"bug，函数式语言的核心数据结构必须在堆上分配。

- [compiler_pipeline.py:33-35] **BACKEND_NATIVE 实际使用 CraneliftBackend 而非 NativeCodeGen** → 常量名 BACKEND_NATIVE（值为 "native"）映射到的是 CraneliftBackend，自研原生后端在整个编译管道中完全没有被使用 → 要么将 BACKEND_NATIVE 映射到 NativeCodeGen，要么重命名为 BACKEND_CRANELIFT 并明确说明
- 追问：如果产品命名与实际实现完全不一致，能被接受吗？→ **不能。** 这是命名欺骗，文档和实际行为严重不一致。

- [cranelift_backend.py:162-168] **Cranelift 后端条件分支使用硬编码标签名** → 所有 LIRBranch 都跳转到硬编码的 block_true 和 block_false，而不是使用 instr.true_label 和 instr.false_label。函数中有多个条件分支时控制流完全混乱 → 使用 instr.true_label 和 instr.false_label 生成正确的跳转目标
- 追问：如果 OCaml 的 native 编译器所有条件分支都跳转到同一个硬编码标签，能被接受吗？→ **不能。** 所有多分支程序的控制流都会错误。

- [wasm_backend.py:230-232] **Wasm 后端 LIRLabel 被编译为 block 嵌套而非标签** → 遇到 LIRLabel 时只增加缩进打开 block，从不闭合。WAT 文件语法错误，所有标签都变成嵌套的 block 结构 → 使用 Wasm 的 loop + br 或 br_table 来模拟非结构化跳转，或在 MIR 层就进行结构化控制流转换

- [native_backend.py:756-769] **除法/取模操作破坏调用者保存寄存器 RDX** → idiv 指令同时修改 RAX（商）和 RDX（余数），但代码只考虑了结果寄存器，没有考虑 RDX 被破坏的问题。如果 RDX 中保存着活跃变量的值，会被静默覆盖 → 在寄存器分配时将 RAX 和 RDX 标记为除法指令的隐式定义；或在除法指令前保存/恢复 RDX
- 追问：如果 OCaml 的 native 编译器除法操作会静默覆盖活跃变量的值，能被接受吗？→ **不能。** 除法和取模是基本算术操作，生成错误代码会导致任意计算错误。

- [native_backend.py:1225] **_start 入口读取 argc 但从未使用，且未设置 argv** → 从栈上读取 argc 到 RDI，但后续调用 nova_init、main、nova_cleanup 时都没有传递这个参数 → 明确 nova_init 的签名，正确传递 argc/argv

#### 中等问题（影响特定场景）

- [cranelift_backend.py:216-238] Cranelift 后端浮点运算使用整数操作码，float_op_map 定义了但从未使用
- [wasm_backend.py:260-263] Wasm 后端 LIRBranch 使用硬编码 $block_false
- [native_backend.py:73-77] 线性扫描分配器溢出后值为负数索引，与按需分配不兼容（注释说负数表示 spill 但实际是正数）
- [c_codegen.py:188-195] C 后端全局变量只声明类型不初始化，BSS 零初始化而非声明初始化
- [c_codegen.py:655-664] C 后端 match 表达式守卫的大括号结构错误，守卫失败时不跳转到下一个分支
- [cranelift_backend.py:109-112] Cranelift 后端函数参数名直接用作 SSA 变量名，与临时变量命名空间不一致
- [wasm_backend.py:161, 371] Wasm 后端字符串扫描用双反斜杠转义 \x00（b"\\x00" 是 4 个字节而非 1 个 null 字节）
- [native_backend.py:1012-1017] 全局变量存储使用 RBX 作为临时寄存器但未检查 RBX 中是否有活跃变量
- [x86_64.py:451-457, 467-473] je_rel32 函数重复定义

#### 轻微问题（代码质量）

- [native_backend.py:1195-1217] _compile_counted_loop 是空方法
- [cranelift_backend.py:199-200] LIRStoreReg 静默忽略
- [wasm_backend.py:296-297] LIRStoreReg 静默忽略
- [cranelift_backend.py:204] iconst 指令名可能不正确（应该是 i64.const）
- [native_backend.py:770-813] 比较结果使用左操作数寄存器，可能破坏活跃值
- [c_codegen.py:596] TryExpr 使用不存在的字段名 variant_tag（实际是 tag）
- [native_backend.py:742-745] 浮点取模直接抛 NotImplementedError
- [cranelift_backend.py:187-188] LIRIndex 硬编码 v0 作为基址

#### 各后端可行性评估
| 后端 | 可行性级别 | 可工作功能 | 完全不能工作 |
|-----|-----------|-----------|-------------|
| native_backend | Demo 级别 | 简单整数算术、比较、基本控制流、直接函数调用（≤6 参数） | >6 参数调用、返回 ADT/List（悬垂指针）、除法寄存器冲突、闭包调用 |
| cranelift_backend | Demo 级别 | 函数骨架、整数常量、整数算术比较 | 浮点运算、条件分支（硬编码）、全局变量存储、间接调用 |
| wasm_backend | Demo 级别 | 模块骨架、类型声明、简单常量加载 | 控制流（block 不闭合）、条件分支（硬编码）、全局变量 |
| c_codegen | 相对完整（~70%） | 基本算术逻辑、函数定义调用、控制流、列表/元组/Map、闭包、ADT、基本模式匹配 | 带守卫的模式匹配、Try 表达式字段名、全局变量初始化 |

#### 原创性分析
- **Nova 特色**：自研 x86_64 指令编码器（从零实现 60+ 条指令机器码编码）、自研 ELF 生成器（手工构造 ELF64 header）、线性扫描寄存器分配器、五层全栈自研架构
- **参考已有**：C 代码生成器是 transpiler 标准模式；Cranelift/Wasm 后端是文本生成模式；ADT 编译为 tagged union 是函数式语言标准技术

---

## [2026-07-16] 第二十八轮审查 — IR 系统 + Pass 管理器深度审查报告

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 三层 IR 架构概念借鉴 MLIR；Python dataclass 从零实现有特色 |
| 可行性 | ⭐⭐⭐ | 架构方向正确，但 lowering 质量差，关键功能语义错误 |
| 正确性 | ⭐⭐ | SSA 不完整、Phi 节点取第一个源、match lowering 完全错误、block 内 let 不更新环境 |
| 安全性 | ⭐⭐ | 无 IR 验证器，错误可能静默传播；__class__ 突变不安全 |
| 一致性 | ⭐⭐⭐ | 三层 IR 命名和结构基本一致；类型系统共享导致层次边界模糊 |
| 完整性 | ⭐⭐ | 框架完整但每个组件都有不同程度的空缺 |
| 工程质量 | ⭐⭐ | __class__突变、类型违规、死代码、静默失败 |
| 性能 | N/A | 没有实际运行数据，无法评估 |
...
- [pass_manager.py:106-109, 116-119] **HIR 常量折叠使用 __class__ 突变，破坏 dataclass 不变量** → 将 HIRBinaryOp 实例的类直接改为 HIRIntLiteral，并用 del 删除原始字段。__dataclass_fields__ 不会更新，repr/asdict/copy 都会崩溃 → 使用标准的替换 API（创建新节点替换旧节点）
- 追问：如果 LLVM 的 opt 工具直接修改 C++ 对象的 vptr 来做常量折叠，能被接受吗？→ **不能接受。** LLVM 通过 ReplaceInstWithValue() 等安全 API 替换指令。__class__ 突变是极其危险的反模式。

- [lir_lowering.py:221-228] **LIR Phi 节点 lowering 完全错误——只取第一个源** → MIRPhi 的核心语义（根据前驱基本块选择对应的值）被完全忽略，直接取 instr.sources[0]。所有条件分支的结果永远是 true 分支的值 → 在每个前驱基本块末尾插入 store 移动指令，将对应的值移动到 Phi 结果的位置；或在 LIR 中保留 Phi 节点直到寄存器分配阶段
- 追问：如果 LLVM 的 SelectionDAG 把 phi 节点直接变成第一个源的 copy，能被接受吗？→ **绝对不能接受。** 这相当于把控制流语义完全删除了，是 SSA 最基本的语义错误。

- [lir_lowering.py:236-240] **LIR Branch 指令丢失条件寄存器和目标标签** → 只设置了 src_locs，完全没有设置 cond_reg、true_label、false_label。条件跳转不知道跳去哪里 → 正确映射 MIRBranch.condition → LIRBranch.cond_reg，MIRBranch.true_target → LIRBranch.true_label，MIRBranch.false_target → LIRBranch.false_label
- 追问：如果 LLVM 的 opt 工具有这个 bug，能被接受吗？→ **绝不能接受。** 条件跳转是控制流的基础，丢失目标标签意味着所有条件分支都会跳转到空标签。

- [mir_lowering.py:351-384] **MIR Match 表达式 lowering 不生成条件判断——所有分支顺序执行** → 直接用 MIRJump 无条件跳转到第一个分支，没有任何模式匹配的条件判断。所有分支按顺序串联，相当于只有第一个分支会被执行 → 为每个分支生成条件判断（模式匹配成功检查），根据匹配结果跳转到对应分支体或下一个分支
- 追问：如果 LLVM 把 switch 指令变成顺序执行所有 case，能被接受吗？→ **绝对不能。** 这是功能正确性 bug，match 表达式是函数式语言的核心控制结构。

- [hir_lowering.py:292-300, mir_lowering.py:200-204] **HIR BlockExpr 中的 let 绑定不更新环境——后续表达式无法引用** → HIRBlockExpr.exprs 的类型声明为 List[HIRExpr]，但实际塞入了 HIRLetDecl（继承自 HIRDecl，不是 HIRExpr）。MIR lowering 中遇到 HIRLetDecl 时走到最后 return None，变量名从未加入 self.env → 修复类型不一致：HIRBlockExpr 应该包含声明和表达式，或引入 HIRLetExpr；在 MIR lowering 中正确处理 HIRLetDecl
- 追问：如果 LLVM 的 opt 工具有这个 bug，能被接受吗？→ **绝不能接受。** 这意味着所有 block 内的局部变量绑定都无法工作，是最基本的变量作用域 bug。

- [lir_lowering.py:242-246] **LIR Return 指令返回值类型硬编码为 UNIT_TYPE** → 返回值的类型被硬编码为 UNIT_TYPE，而不是实际的返回类型。代码生成后端如果依赖 src_locs 中的类型信息，会生成错误的代码 → 从函数的 return_type 或 term.value 对应的 SSA 类型中获取正确的类型

#### 中等问题（影响特定场景）

- [pass_manager.py:631-642] MIR LICM 回边识别错误，所有前向跳转都被视为回边（无支配树分析）
- [pass_manager.py:601-609] LIR LICM 多循环外提后索引偏移（外提操作改变了 body 长度）
- [pass_manager.py:92-122] HIR 常量折叠不递归遍历非 BinaryOp 节点，嵌套在其他表达式中的 BinaryOp 永远不会被折叠
- [pass_manager.py:475-481] MIR CSE 用 MIRLoad 替代 BinOp，但语义不同（MIRLoad 是加载变量不是 SSA 值复制）
- [pass_manager.py:347] LIR DCE 中 LIRBinOp 被视为有副作用，永远不会被删除
- [mir_lowering.py:159-162] HIR 标识符查找失败时静默返回 None，不报错
- [lir_lowering.py:248-258] MIRSwitch 和 MIRMatchJump 降级为普通 Jump，所有 case 分支都被丢弃

#### 轻微问题（代码质量）

- [hir_lowering.py:97-98] HIR AliasDecl 不保存目标类型，直接设为 TYPE_VAR
- [hir_lowering.py:332-333] HIRConstructorPattern 中 type_name 为空字符串
- [lir_lowering.py:174-200] LIR BuildList/Tuple/ADT 只有 count 字段，没有元素位置信息
- [mir_lowering.py:285-289] MIR ListComprehension 完全未实现，返回空列表常量
- [mir_lowering.py:247-250] MIR Lambda lowering 不生成函数体，只创建闭包对象
- [pass_manager.py:715-770] Pass 管理器不动点迭代中 pass 顺序固定，没有 pass 间依赖管理
- [mir_lowering.py:299-305] HIR UnwrapExpr lowering 用字段访问替代，无错误传播逻辑
- [pass_manager.py:589-590] LIR LICM 中检查 LIRBranch 但 LIRBranch 不在 side_effect_free 中，死代码
- [pass_manager.py:188-227] LIR 常量折叠 const_map 在函数全局有效，跨基本块污染
- [ir_nodes.py:531] MIR Function 的 params 类型字段与 HIR 不一致

#### 架构层面问题
- 没有 IR Verifier——层间无验证，错误可能静默传播
- 没有类型系统贯穿三层 IR——类型初始化为 TYPE_VAR 后基本不更新
- LIR 层是线性指令序列而非 CFG，丢失基本块结构
- Pass 管理器没有 pass 依赖图

#### 原创性分析
- **Nova 特色**：Python dataclass 从零实现三层 IR（不依赖 MLIR/LLVM 框架）；HIR 层保留完整高级语言特性；LIR 的 src_locs/dst_locs 元组设计
- **参考已有**：三层 IR 架构经典（Clang AST→LLVM IR→MachineInstr）；SSA+CFG 直接借鉴 LLVM/Rust MIR；Pass 管理器 + 不动点迭代是 LLVM 标准模式

---

## [2026-07-16] 第二十八轮审查 — 运行时 + 测试 + Tree-sitter 深度审查报告
...
| 原创性 | ⭐⭐⭐⭐ | 全栈自研架构有特色；双执行路径设计独特 |
| 可行性 | ⭐⭐⭐ | Python 解释器和字节码 VM 已可用；C 运行时框架搭好但内存管理有严重缺陷 |
| 正确性 | ⭐⭐ | 引用计数不完整、类型混淆、子对象不释放、JSON 字面量不验证 |
| 安全性 | ⭐⭐ | 内存泄漏普遍存在，类型混淆可能导致崩溃 |
| 一致性 | ⭐⭐ | parser.py 与 grammar.js 优先级不一致；Evaluator/VM 无交叉验证 |
| 完整性 | ⭐⭐⭐ | 核心语言特性基本可用；标准库、模块系统、错误处理测试不足 |
| 工程质量 | ⭐⭐⭐ | 代码组织清晰，测试数量不少，但测试深度不够 |
...
- [nova_runtime.c:536-538] **nova_map_put 中的类型双关导致内存泄漏和未定义行为** → 将 void* 类型的 value 强制转换为 NovaValue* 并调用 nova_value_release。当 map 中存储的不是 NovaValue* 时，读取错误的 type 和 ref_count 字段，可能导致内存泄漏或堆破坏 → Map 应该使用 NovaValue* 作为 value 的唯一类型，或增加 value_free_fn 函数指针回调
- 追问：如果 GHC 的运行时有这个类型双关 bug，能被接受吗？→ **绝对不能。** 类型双关 + 任意内存解释是 C 运行时最危险的错误类别之一。

- [nova_runtime.c:479-486, 651-668, 749-756, 791-798] **容器释放不递归释放子对象——系统性内存泄漏** → nova_list_release 只释放 items 数组不释放子元素；nova_map_release 释放 key 但不释放 value；nova_adt_release 只释放 fields 数组不释放子对象；nova_closure_release 只释放 captured 数组不释放捕获对象 → 为每个容器类型增加元素释放回调函数，或改用 NovaValue* 作为唯一的元素类型
- 追问：如果 CPython list 释放时不 DECREF 元素，能被接受吗？→ **绝对不能。** 这是运行时内存管理的基础，系统性内存泄漏。

- [nova_runtime.c:79-87] **nova_realloc 不更新分配计数——GC 诊断数据完全错误** → realloc 成功时旧内存被释放、新内存被分配，但 g_alloc_count 和 g_free_count 都不更新。nova_gc_collect() 返回的净分配数不准确 → 在 realloc 成功后递增 g_alloc_count
- 追问：如果 GC 诊断数据完全错误，能被接受吗？→ **不能。** 诊断功能要么正确要么不要。

- [nova_runtime.c:959] **nova_abs_int(INT64_MIN) 是未定义行为** → 在二进制补码系统中，-INT64_MIN 溢出，这是 C 标准中的有符号整数溢出未定义行为 → 对 INT64_MIN 特殊处理，返回 INT64_MAX 或 panic

- [tree-sitter-nova/grammar.js:612-624] **Tree-sitter 管道操作符优先级错误——与 parser.py 完全相反** → Tree-sitter 中 PIPE(2) < OR(3) < AND(4)，而 parser 中 || < && < |>。管道操作符优先级在 tree-sitter 中比逻辑运算符还低 → 将 PIPE 优先级调整为 4.5（在 AND 和 EQUALITY 之间）
- 追问：如果编辑器语法高亮与实际编译器解析结果不一致，能被接受吗？→ **不能。** 语法工具链必须与编译器语义一致。

#### 中等问题（影响特定场景）

- [nova_runtime.c:1165-1188] JSON 解析器的 json_parse_true/false/null 不验证字面量，直接跳过字符
- [nova_runtime.c:597-614] nova_map_remove 不释放 value，与 put 的更新路径不一致
- [nova_runtime.c:1701-1703, 1770-1772] HTTP 函数忽略实际 HTTP 状态码，硬编码为 200
- [nova_runtime.c:217-223] nova_string_split 按字节拆分而非按字符，UTF-8 多字节字符会产生无效片段
- [nova_runtime.c:193-196] nova_string_char_at 返回字节而非 Unicode 码点
- [tree-sitter-nova/grammar.js:全文] Tree-sitter 缺少 Try 表达式（? 操作符）
- [tree-sitter-nova/grammar.js:88-97] Tree-sitter 缺少泛型类型参数（type Foo[T] { ... }）
- [tree-sitter-nova/grammar.js:398-403] Tree-sitter match arm 中 guard 的位置与 parser 不一致（body 后 vs pattern 后）
- [nova_runtime.c:135-148] nova_string_new_len(NULL, len) 数据未初始化，可能有未初始化内存读取

#### 轻微问题（代码质量）

- [nova_runtime.c:827-843] nova_read_line 固定 4096 字节缓冲区，长行会被截断
- [nova_runtime.c:1629-1631] nova_time_format 固定 256 字节缓冲区
- [nova_runtime.c:363-368] nova_list_set 负索引语义与 Python 不完全一致
- [tests/] 无 Evaluator vs VM 一致性测试
- [tests/] 无 Tree-sitter vs Parser 一致性测试
- [tests/] C 运行时测试未集成到 Python 测试套件
- [tests/] 无模糊测试/属性测试
- [tests/] 端到端 C 编译测试不足（很少实际编译并运行）
- [tree-sitter-nova/test/corpus/] Tree-sitter 语料测试严重不足（仅 15 个用例）

#### 测试覆盖统计表
| 测试文件 | 测试函数数 | 主要覆盖领域 |
|---------|-----------|-------------|
| test_nova.py | 396 | 核心语言（词法/语法/类型/求值器/VM/ADT/管道/内置/循环/IO/JSON/数学/列表推导） |
| test_type_system.py | 103 | 泛型 ADT、类型推断、模式匹配类型检查 |
| test_native_backend.py | 118 | x86_64 代码生成、寄存器分配、ELF、ADT 布局 |
| test_ir.py | 94 | HIR/MIR/LIR 降级、优化 pass |
| test_c_codegen.py | 52 | C 代码生成、ADT、表达式 |
| test_backends.py | 43 | Cranelift/WasmGC/编译管线 |
| test_errors.py | 36 | 错误格式化、错误收集、ANSI 颜色 |
...
**关键空白区域**：无 Evaluator vs VM 一致性测试、无 Tree-sitter vs Parser 一致性测试、无 GC/内存管理测试、无模糊测试、C 运行时无自动化测试、无性能基准测试

#### 原创性分析
- **Nova 特色**：五层全栈自研架构在同类项目中非常少见；双执行路径设计（Evaluator+VM）便于调试对比；表达式导向设计
- **参考已有**：引用计数内存管理（常见入门级 GC 方案）；FNV-1a 哈希函数（广泛使用）；递归下降解析器（标准做法）；栈式字节码 VM（标准实现）；Tree-sitter 语法定义（现代语言标准做法）
...
| 错误/模块/环境 | 8 | 13 | 8 | 29 |
| 所有后端 | 7 | 9 | 8 | 24 |
| IR 系统 + Pass | 6 | 7 | 10 | 23 |
| 运行时 + 测试 + Tree-sitter | 5 | 9 | 10 | 24 |
| **合计** | **51** | **84** | **75** | **210** |

### 最关键的 P0 问题（本轮新确认/深化）

1. **类型检查器无真正的合一算法** — _types_compatible 对 TypeVar 完全放行，类型检查形同虚设。这是整个类型系统的根基性缺陷。
2. **IR lowering 核心语义错误** — Phi 节点只取第一个源、Match 表达式不生成条件判断、Branch 丢失目标标签、Block 内 let 不更新环境。IR 系统的核心特性全部崩溃。
3. **Native 后端栈分配 ADT/List 返回悬垂指针** — 函数式语言最基本的语义违反，加上参数传递错误和除法寄存器冲突，Native 后端整体完全不可用。
4. **C 运行时子对象不递归释放引用 + 类型双关** — 系统性内存泄漏，list/map/adt/closure 释放时都不释放子对象引用；Map 的 void* 类型双关是潜在的崩溃源。
5. **解析器无错误恢复 + 词法错误递归栈溢出** — 遇错即停 + 递归错误恢复的 DoS 风险，离生产级编译器前端有显著差距。
6. **控制流表达式不能参与管道运算** — 号称"一切皆表达式"的语言，控制流表达式却不能参与管道，废掉了表达式导向的核心价值。
7. **闭包全帧捕获而非自由变量捕获 + 语义不一致** — 不仅是性能问题，还导致 Evaluator 与 VM 的闭包语义深层不一致（引用 vs 快照、全链 vs 当前帧）。
8. **路径遍历漏洞** — 模块系统允许通过路径遍历跳出搜索目录，读取任意系统文件，是严重的安全漏洞。
9. **POP_JUMP_IF_FALSE 滥用污染 while 循环栈** — && 运算符和列表推导式 filter 使用了带 while 循环副作用的指令，导致控制流状态污染。
10. **BACKEND_NATIVE 名不副实** — 自研原生后端从未接入编译管道，用户请求 native 实际得到 Cranelift。


---

## [2026-07-16] 第二十九轮审查报告

> **审查范围**：全模块深度审查（核心执行引擎 + 类型系统前端 + 后端IR运行时测试）
> **审查方法**：三轮 9 个 Explore Agent 并行审查，生产级编译器标准

---

## [2026-07-16] VM 虚拟机 (vm.py) 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配栈基指针机制、TRY_UNWRAP 双路径返回、for 循环迭代状态外置有特色 |
| 可行性 | ⭐⭐⭐ | 核心路径可用，73 个操作码全部实现，但 LOOP 是死代码 |
| 正确性 | ⭐⭐ | 闭包全量捕获语义错误、循环状态管理混乱、模式匹配直读栈无保护 |
| 安全性 | ⭐⭐ | 模式匹配指令绕过 _pop() 下溢检查、BREAK 无边界检查、内置函数缺类型检查 |
| 一致性 | ⭐⭐ | 闭包捕获语义与 Evaluator 根本不同 |
| 完整性 | ⭐⭐⭐⭐⭐ | 73 个操作码全部有处理路径 |
| 工程质量 | ⭐⭐ | hasattr 反模式、_execute_function 与 _run_code 重复、STORE_VAR 逻辑冗余 |
| 性能 | ⭐⭐ | 闭包捕获整个帧 dict 浅拷贝，高频创建闭包场景性能差 |
...
- **[vm.py:1077-1088] CLOSURE 捕获整个栈帧所有变量而非自由变量** → 每次创建闭包都 dict 浅拷贝所有局部变量，时间 O(n)，内存泄漏风险，且与 Evaluator 语义不一致（Evaluator 不可变变量走环境链） → 编译器端实现自由变量分析，CLOSURE 指令携带自由变量名列表，VM 仅捕获指定变量
  - 追问：如果 OCaml 的闭包捕获了整个作用域的 dict 拷贝，性能影响能被接受吗？→ **绝对不能。** 内存使用量可能增加 10-100 倍，完全抵消函数式语言性能优势。

- **[vm.py:1216-1217,1263-1264] `_range_index`/`_list_index` 未在 `__init__` 中初始化，用 `hasattr` 反模式** → 违背构造函数初始化所有状态原则；异常退出时字典条目可能泄漏；清理逻辑依赖 hasattr 掩盖状态不一致 → 在 `__init__` 中初始化为空 dict；循环状态注册与索引字典同步 push/pop
  - 追问：如果 Python 的 itertools 用 hasattr 惰性创建状态且有资源泄漏，能被接受吗？→ **不能。** 这是潜在的内存安全和正确性问题。

- **[vm.py:1349,1363,1377,1390,1402,1434,1453,1469] 模式匹配指令普遍使用 `self.stack[-1]` 直接访问，绕过 `_pop()` 的下溢检查** → 8 条 MATCH_* 指令手工检查栈非空，与 `_pop()` 重复造轮子且不一致；只看栈是否非空不校验深度是否足够 → 统一使用 `_pop()` 或 `_peek()` 辅助方法，集中管理栈访问
  - 追问：如果 Haskell GHC 模式匹配失败时栈错乱，能被接受吗？→ **绝对不能。** 栈管理是 VM 最基本的正确性要求。

- **[vm.py:239-280] 内置函数普遍缺乏参数类型检查** → str_len/list_length 对非序列参数崩溃；head/tail 不检查是否为 list；数学函数 _to_float 只处理 int/bool；json_parse/json_stringify 不检查参数类型 → 每个内置函数入口处统一校验参数数量和类型，抛出一致的 RuntimeError_
  - 追问：如果 OCaml 的 Pervasives 模块不做参数类型检查，能被接受吗？→ **不能。** 生产级语言的标准库必须有完整的类型和边界检查。

- **[vm.py:1577-1596,596-598] TRY_UNWRAP 提前返回时 `return_flag` 状态不一致** → TRY_UNWRAP 通过返回 True 信号触发提前返回，但不设置 return_flag；RETURN 指令设置 return_flag。两条路径语义等价但实现分散，易在新增检查点时遗漏 → 统一用 return_flag 机制，TRY_UNWRAP 也设置 return_flag = True
  - 追问：如果任何生产级 VM 的函数返回有两条独立且不一致的路径，能被接受吗？→ **不能。** 架构上的技术债务，极易引入回归 bug。

- **[vm.py:1045] BREAK 在 for 循环中直接索引 `self.stack[base_sp + 1]` 无边界检查** → 若栈被破坏会抛 Python IndexError 而非受控的 RuntimeError_；恶意构造的字节码可使 VM 以原生异常崩溃 → 添加边界检查，抛出 RuntimeError_
  - 追问：如果 JVM 的字节码验证器不检查栈深度边界，能被接受吗？→ **不能。** VM 应有防御性编程，防止恶意字节码导致未定义行为。

#### 中等问题（影响特定场景）

- [vm.py:751-801] STORE_VAR 逻辑过度复杂且重复 → 50 行代码处理 4 种情况，顶层和函数内逻辑几乎一样但分开写 → 提取 `_store_var(name, value, mutable, is_assignment)` 辅助方法
- [vm.py:1133-1153] BUILD_MAP 错误处理冗余低效 → try/except 捕获 TypeError 后又遍历一遍找不可哈希键，两次遍历 → 构建前检查每个 key 的可哈希性，一次遍历完成
- [vm.py:1171-1199] FIELD_ACCESS 字段索引用 `int(field)` 混用数字索引和命名字段 → 字段名如果是数字字符串会被当作索引访问，永远无法访问命名字段 "0" → 编译器应区分索引访问和命名字段访问用不同操作码
- [vm.py:1220,1267] FOR_ITER 中 `is_first` 检测依赖 IP 位置匹配 → 用 IP 位置匹配判断是否首次迭代，脆弱且依赖字节码布局；两个紧邻 for 循环可能混淆 → 编译器生成唯一循环 ID 作为操作数传入
- [vm.py:532-540] `_call_closure` 中 `frame.ip` 字段无用 → Frame 保存了 ip 但从未被使用，是冗余字段 → 移除 Frame.ip 或正确使用
- [vm.py:1312,1338-1342,1494-1499] 顶层 match 用 globals 存绑定变量，作用域污染 → 顶层 match 绑定变量直接写入 globals，MATCH_END 时通过快照恢复；若 match 内调用函数有副作用修改 globals，恢复时会撤销这些修改 → 顶层 match 用独立的局部作用域 dict
- [vm.py:307-325] `_builtin_filter` 和 `_builtin_map` 不检查返回类型一致性 → filter 只检查 Bool 类型返回，但对 Nova Bool ADT 和 Python bool 都接受，与其他内置函数不一致 → 统一布尔值判断逻辑
- [vm.py:584-604,626-663] `_execute_function` 和 `_run_code` 代码高度重复 → 两个执行循环几乎一样，维护成本翻倍 → 统一为一个执行引擎，通过退出条件区分

#### 轻微问题（代码质量）

- [vm.py:1598-1602] LOOP 操作码是死代码，编译器从不生成
- [vm.py:144-153,457-467] `NovaPartialBuiltin` 从未被 CALL_BUILTIN 产生，设计不一致
- [vm.py:42-43] `UNIT_TYPE.__bool__` 返回 False 有歧义，Unit 在布尔上下文中为假可能造成意外
- [vm.py:282-285] `_to_float` 不处理 NovaChar 等类型
- [vm.py:421-422] `_format_value` 中 `val is None` 返回 "null"，None 与 Option::None ADT 语义混淆
- [vm.py:202] `MAX_CALL_DEPTH = 1000` 硬编码，无法配置
- [vm.py:117-128] `NovaClosure` 缺少 `__eq__` 和 `__hash__`
- 错误消息中英文混用，不一致

#### 原创性分析

**Nova 特色**：
1. 模式匹配栈基指针机制（match_stack_bases + _pattern_fail_cleanup）：统一栈截断恢复处理所有失败路径，减少编译器生成的清理指令数
2. TRY_UNWRAP 双路径返回机制：用布尔返回值 + return_flag 双轨制实现 ? 操作符，避免异常栈展开开销
3. for 循环迭代状态外置：_for_iters 列表 + _range_index/_list_index 字典将迭代状态从栈中分离
4. while 循环通过 POP_JUMP_IF_FALSE 副作用记录循环信息，无需专门的 LOOP_BEGIN 指令

**借鉴部分**：栈式 VM 整体架构、字节码编译两段扫描、闭包值表示等是经典设计。

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获方式 | 环境链+mut快照 | 全变量快照 | ❌ |
| 不可变变量查找 | 环境链向上查找 | captured_vars 快照 | ❌ |
| mut 变量语义 | 值语义（快照） | 值语义（快照） | ✅ |
| 模式匹配作用域 | child_env 隔离 | 快照+删除方式 | ✅ |
| 顶层模式匹配 | env 链自然隔离 | 直接操作 globals | ⚠️ |
| TRY_UNWRAP (? ) | ReturnSignal 异常 | 返回 True + return_flag | ✅ |
| 模式匹配失败异常 | RuntimeError_ | MatchFailure | ❌ |
| 内置函数参数检查 | 同样缺乏 | 同样缺乏 | ✅ |
| 递归深度限制 | _call_depth 计数器 | call_stack 长度 | ✅ |
| 表达式深度检查 | _eval_depth 计数器 | 无 | ❌ |

**核心差异**：闭包捕获语义是最大的不一致——Evaluator 用环境链查找不可变变量，VM 用全变量快照。对于可变变量和闭包创建后外部修改不可变变量的场景，行为不同。

---

## [2026-07-16] 编译器 (compiler.py) 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 模式匹配字节码 + VM 级栈清理、for 循环抽象有独到设计 |
| 可行性 | ⭐⭐⭐ | 功能完整，核心逻辑正确，但闭包设计和模块系统有缺陷 |
| 正确性 | ⭐⭐⭐ | 主要 AST 节点编译正确，但死代码多、while break 语义模糊 |
| 安全性 | ⭐⭐⭐ | 无明显安全漏洞，但 mutable 参数未使用、ADT 构造器不一致 |
| 一致性 | ⭐⭐ | 闭包全量捕获与 Evaluator 环境链语义不一致 |
| 完整性 | ⭐⭐⭐⭐⭐ | 所有 AST 节点均有编译处理 |
| 工程质量 | ⭐⭐⭐ | 死代码多（旧 pattern 编译方法、patch_match_fail 3操作数分支）、命名不一致 |
| 性能 | ⭐⭐⭐ | 基本合理，但常量去重用 list.index O(n) |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[compiler.py:83 + vm.py:1077-1088] 闭包全量捕获所有局部变量而非自由变量** → 内存浪费、语义隐患、可变变量共享状态 bug → 实现自由变量分析，CLOSURE 指令携带自由变量名列表
  - 追问：如果 OCaml 的闭包转换（closure conversion）没有做自由变量分析，能被接受吗？→ **绝对不能。** 这是函数式语言编译器的核心优化，直接影响性能和语义正确性。

- **[compiler.py:336-407] 模块内联无循环导入防护，可能导致无限递归** → `_compile_import` 递归内联导入，若 A import B 且 B import A 将导致无限递归栈溢出；ModuleManager.modules 缓存了 AST 但未防止编译期循环内联 → 维护「正在编译中」的模块集合，编译导入前检查，遇到循环则报错；采用符号表先行（two-pass）策略
  - 追问：如果 Python 的 import 系统没有循环导入检测，能被接受吗？→ **不能。** 生产级模块系统必须正确处理循环依赖，至少给出清晰的错误信息而非栈溢出。

- **[vm.py:1023-1034,991-1010] while 循环 break 退出值语义不一致** → break 时结果槽保留的是进入循环体时的值，第一次迭代 break 返回初始 UNIT，第 N 次迭代 break 返回第 N-1 次的 body 值，语义不明确 → 明确 break 语义：要么 break 推入当前 body 值作为结果，要么 break 产生 Unit
  - 追问：如果 Rust 的 while break 值语义取决于发生在第几轮，能被接受吗？→ **不能。** 在 while 作为表达式返回值的语言中，break 的值必须有明确、可预测的规定。

#### 中等问题（影响特定场景）

- [compiler.py:947-1012] 死代码：`_compile_pattern_test` 和 `_compile_pattern_bindings` 从未被调用 → 旧版本残留，增加维护成本，且其中 PatternTuple/PatternList 直接生成 MATCH_WILDCARD 与正确实现不符 → 直接删除
- [compiler.py:902-945] `_compile_pattern_extract_and_bind` 是事实上的空操作 → 所有叶子模式在 `_compile_pattern_test_with_fail` 中已完成弹栈和绑定，该方法对所有叶子模式都是 `pass` → 删除该方法调用，或重构为真正的两阶段分离
- [compiler.py:200-211] `patch_match_fail` 3 操作数分支为死代码 → 注释提到 MATCH_CONSTRUCTOR 旧格式，但当前所有指令都是 2 或 4 操作数 → 删除 len==3 分支
- [compiler.py:511] Assignment 的 STORE_VAR 中 `mutable` 参数无意义 → is_assignment=True 时 mutable 操作数完全不被使用，多余且误导 → 去掉 mutable 参数，明确语义
- [compiler.py:468-471,665-676] 内置 ADT 构造器不能作为一等函数值 → `let f = Some` 会走 LOAD_VAR 路径查找 "Some"，导致运行时错误；用户自定义构造器通过 REGISTER_CTOR 注册可作为一等值 → 内置构造器也通过 REGISTER_CTOR 注册，统一路径
- [compiler.py:321-324] `_compile_decl` 的 `else` 分支静默处理未知声明类型 → 新增声明类型忘记添加分支会导致静默错误编译，而非明确报错 → 改为明确的表达式类型检查，或在 else 中 raise 明确错误

#### 轻微问题（代码质量）

- [compiler.py:83] CLOSURE 指令注释与实际操作数不符（注释有 code_key，实际只有 2 个操作数）
- [compiler.py:711] lambda 名称使用 `id(fn_code)` 作为唯一标识，id() 是 Python 对象地址可被复用 → 用单调递增计数器
- [compiler.py:172-181] `Bytecode.add_const` 对不可哈希值的去重用 list.index，时间复杂度 O(n) → 用 dict 或 set 维护可哈希值的索引映射
- [compiler.py:634-639] `_compile_pipe` 中内置函数分支两个分支执行完全相同的 LOAD_VAR → 删除 if/else，直接 LOAD_VAR
- [compiler.py:1021] `_compile_block` 中对 BreakExpr/ContinueExpr 的 POP 豁免列表需手动维护 → 为每个 AST 节点添加 leaves_value 属性
- [ast_nodes.py:441] `VariantDef.fields` 类型为 `List[tuple]`，缺乏结构 → 定义 FieldDef dataclass

#### 原创性分析

**独特设计**：
1. **模式匹配作为一等字节码指令 + VM 级栈统一清理**：MATCH_TEST_* 专用指令 + _pattern_fail_cleanup 统一栈截断，免除编译器为每个失败路径生成 POP 代码的负担
2. **FOR_ITER + LOOP_END 配对的 for 循环抽象**：将迭代器状态管理下沉到 VM 层，LOOP_END 负责追加结果到列表
3. **TRY_UNWRAP 提前返回机制**：? 操作符通过专用指令实现，VM 级直接支持错误传播原语
4. **MATCH_START/MATCH_ARM_START/MATCH_END 作用域管理**：VM 层面管理模式匹配变量作用域，arm 间不交叉污染

**常见设计**：标准栈式 VM 指令集、CLOSURE + CALL 函数调用模型、管道操作等是经典设计。

---

## [2026-07-16] 求值器 (evaluator.py) 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 两遍扫描、异常驱动控制流是标准做法，mut 变量快照混合语义有特色 |
| 可行性 | ⭐⭐⭐⭐ | 主要特性均可用，模式匹配支持完整 |
| 正确性 | ⭐⭐⭐ | 闭包语义混合、Block 中不支持嵌套函数定义 |
| 安全性 | ⭐⭐⭐⭐ | 算术/逻辑运算类型检查较全面，但内置函数缺类型校验 |
| 一致性 | ⭐⭐ | 闭包捕获语义与 VM 存在根本差异 |
| 完整性 | ⭐⭐⭐⭐ | 29 个表达式节点全部支持，10/10 Pattern 类型全部支持 |
| 工程质量 | ⭐⭐⭐ | 代码重复（_eval_decl 和 _eval_decl_body）、异常重新包装 |
| 性能 | ⭐⭐⭐ | 解释器正常水平，无特殊性能问题 |
...
- **[evaluator.py:480-494] 闭包捕获语义：不可变变量通过环境链动态查找，mut 变量快照** → 混合语义不统一：不可变变量走环境链（词法作用域正确），mut 变量是创建时快照值语义；与 VM 行为不一致（VM 全变量快照） → 统一闭包语义：要么全部引用语义（Scheme/OCaml），要么全部值语义
  - 追问：如果 OCaml 的闭包对不可变变量和可变变量有不同的捕获语义，能被接受吗？→ **不能。** 同一语言中闭包语义必须统一，否则用户难以理解和推理。

- **[evaluator.py:811-1026] Block 中不支持嵌套函数定义（FnDef）** → 在 Block 内的 FnDef 会落入 else 分支抛出 "未知的表达式类型"；函数式语言通常支持嵌套函数定义 → 在 `_eval_expr_inner` 中添加 FnDef、TypeDef 等的处理逻辑，复用 `_collect_decl` + `_eval_decl_body` 类似逻辑
  - 追问：如果 OCaml 不支持 let 表达式内的嵌套函数定义，能被接受吗？→ **不能。** OCaml 的 let ... in 就是表达式级别的绑定，嵌套函数是函数式语言的基本特性。

- **[evaluator.py:511-532] 闭包部分应用时 mut 变量语义不一致** → 部分应用时 captured_mut 直接复制快照，但新绑定参数的环境与原闭包的 captured_mut_vars 不同步 → 部分应用时重新捕获当前环境中的所有 mut 变量
  - 追问：如果 Haskell 的部分应用会导致闭包捕获的变量状态不一致，能被接受吗？→ **不能。** 部分应用是函数式语言的核心特性，语义必须正确。

- **[evaluator.py:663-756] _eval_decl 和 _eval_decl_body 代码高度重复** → 两个方法几乎完全重复，都处理 LetBinding、MutBinding、FnDef、TypeDef 等；维护困难，容易一边修改另一边忘记修改 → 消除重复，统一调用路径
  - 追问：如果生产级编译器的核心求值循环有两份重复实现，能被接受吗？→ **不能。** 重复代码是 bug 的温床，维护成本翻倍。

#### 中等问题（影响特定场景）

- [evaluator.py:1169-1171,1237] for 循环和列表推导中 iterable 元组格式是遗留代码 → `isinstance(expr.iterable, tuple)` 检查永远为 False，因为 AST 定义中 iterable 是 Expression 节点 → 清理遗留代码，仅使用 expr.step 判断范围循环
- [evaluator.py:1008-1023] 列表/元组索引访问缺少类型检查 → 对非序列类型索引会抛 Python 原生 TypeError 而非 RuntimeError_；索引值类型检查不完整 → 在索引前显式检查 target 类型和 index 类型
- [evaluator.py:284-297] 内置函数参数类型检查不完整 → _builtin_sum 等直接调用 sum()，未检查参数是否为列表、元素类型是否为数字 → 为所有内置函数添加参数类型检查
- [evaluator.py:1303] 模式匹配失败使用 RuntimeError_ 而非 MatchFailure → VM 端有专门的 MatchFailure 异常类型，evaluator 未使用 → 统一使用 MatchFailure 异常
- [evaluator.py:932-935] 赋值操作错误重新包装 RuntimeError_ → 无意义的异常重新包装，丢失原始异常的 span 等信息 → 直接让异常传播，或添加 span 信息后重新抛出
- [evaluator.py:970-975] 嵌套循环中 break/continue 没有带值 → BreakSignal 支持 value 参数但 evaluator 中 break 不携带值 → 要么支持带值 break，要么移除 value 参数
- [evaluator.py:151-156] _UnitValue 不是单例模式 → 类本身不阻止创建新实例，与 VM 端的 UNIT_TYPE 实现不一致 → 统一实现真正单例模式

#### 轻微问题（代码质量）

- [evaluator.py:22] 导入语句 Callable 仅在类型提示中使用，但类型注解不完整
- [evaluator.py:460-461] _format_value 中 None 分支语义不清，None 应等同于 Unit 还是独立值
- [evaluator.py:83-87] NovaADTValue 的 __eq__ 不比较 field_names → 两个 field_names 不同但其他相同的 ADT 值会判定相等
- [evaluator.py:500-503] _call_fn 中 BuiltinFn 部分应用返回 BuiltinFn，与 VM 端 NovaPartialBuiltin 类型不一致
- [evaluator.py:170-173] _eval_depth 和 _call_depth 双重计数 → 函数调用也算表达式求值，可能重复计数
- [evaluator.py:631-634] _collect_decl 中 TypeDef 构造器闭包在循环内定义（虽正确但不够优雅）

#### 原创性分析

**亮点**：
1. 两遍扫描（先注册所有函数/类型，再求值绑定）支持前向引用和相互递归
2. Environment 作用域链实现清晰，经典词法作用域
3. 异常驱动控制流（break/continue/return）是解释器常见模式
4. 模式匹配递归实现简洁正确，支持嵌套和守卫
5. 闭包混合语义（mut 快照 + 不可变引用）是非典型的原创设计

**与常见解释器的差异**：大多数教科书式解释器全部使用环境链+闭包，此实现对 mut 变量做特殊快照处理，避免闭包修改外部变量的副作用。
...
| 模式匹配失败异常 | RuntimeError_ | MatchFailure | ❌ |
| 表达式深度检查 | _eval_depth 计数器 | 无 | ❌ |
| 调用深度检查 | _call_depth 计数器 | call_stack 长度 | ✅ |
| ADT 构造器类型 | BuiltinFn 包装 | NovaConstructor 专门类 | ⚠️ |
| 部分应用内置函数 | BuiltinFn 类型 | NovaPartialBuiltin 类型 | ⚠️ |
| 顶层模式匹配 | env 链自然隔离 | 直接操作 globals | ⚠️ |
| 数学内置函数集 | 基本一致 | 基本一致 | ✅ |

---

## [2026-07-16] 类型检查器 (type_checker.py) 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 两阶段声明收集、identity 语义 TypeVar、ADT 字段访问有特色 |
| 可行性 | ⭐⭐⭐ | 基础类型检查可用，但推断能力严重受限 |
| 正确性 | ⭐⭐ | 无类型统一（unification）、无 occurs check、let 多态不完整 |
| 安全性 | ⭐⭐⭐ | 有类型检查但因无统一而有漏洞，TypeVar 永不报错 |
| 一致性 | ⭐⭐⭐ | 与 Evaluator/VM 的行为基本一致但类型系统本身不完备 |
| 完整性 | ⭐⭐⭐⭐ | 所有类型语法均支持，Pattern 类型检查完整 |
| 工程质量 | ⭐⭐⭐ | 代码结构清晰，命名规范，但核心算法缺失 |
| 性能 | ⭐⭐⭐⭐ | 因无统一所以速度快，但代价是推断能力不足 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[type_checker.py:1582-1583] 无类型统一（Unification）—— TypeVar 永不报错** → `_types_compatible` 中只要任意一方是 TypeVar 就返回 True，从不记录约束、从不求解类型变量；类型推断本质上只在函数调用时通过 `_collect_type_bindings` 部分工作，其他场景的类型变量永远"兼容"任何类型 → 实现完整的统一算法（unification），用 union-find 结构管理类型变量等价类
  - 追问：如果 OCaml 的类型推断器对某些表达式推断失败且不报错，能被接受吗？→ **绝对不能。** 类型统一是 Hindley-Milner 类型系统的核心支柱，没有它整个类型推断就是形同虚设。

- **[type_checker.py:全文缺失] 无 Occurs Check——递归类型无保护** → 完全没有 occurs check（出现检查）；如果未来添加了统一算法，或当前通过函数调用传递绑定，可能构造出无限类型（如 `fun x -> x(x)`） → 在统一函数中实现 occurs check：将类型变量 tvar 统一到类型 ty 前，检查 tvar 是否出现在 ty 内部
  - 追问：如果 Haskell 的类型推断器允许 `fun x -> x x` 通过而不报错，能被接受吗？→ **绝对不能。** Occurs check 是类型系统防止无限类型的基本保护机制。

- **[type_checker.py:563-569] 函数体检查时参数类型用新建 TypeVar，与第一遍注册的类型脱节** → `_check_decl_body` 检查 FnDef 时为每个参数创建新的 TypeVar，而第一遍 `_infer_fn_type` 注册的是另一组 TypeVar 对象，两组之间无关联；函数体内对参数的使用不会约束环境中注册的函数类型 → 函数体检查时应复用第一遍注册的 FnType 中的参数 TypeVar 对象，确保体内约束能反映到函数签名上
  - 追问：如果任何生产级编译器的函数参数类型检查与函数签名推断完全脱节，能被接受吗？→ **不能。** 这意味着参数类型永远无法被正确推断，类型检查形同虚设。

- **[type_checker.py:538-548] let 绑定值的类型推断不求解变量、不做泛化** → LetBinding 直接用 `check_expr(decl.value)` 的结果作为绑定类型，不做泛化（generalization），也不求解其中的类型变量；残留未约束的 TypeVar 意味着类型可能比实际更"泛" → 实现 HM 的 generalize 步骤：在将 let 绑定类型存入环境前，将所有自由类型变量泛化为全称量化变量
  - 追问：如果 OCaml 的 let 多态没有正确实现，能被接受吗？→ **不能。** Let 多态是 Hindley-Milner 类型系统的核心特性，没有泛化就没有真正的多态。

#### 中等问题（影响特定场景）

- [type_checker.py:1507-1509] 循环别名检测不可靠 → `_alias_stack` 只在单次 `_from_ast_type` 调用中有效；互相引用的别名（alias A = B + alias B = A）会报"未知类型名"而非循环错误 → 两遍处理别名：第一遍注册所有别名名（占位符），第二遍展开时检测循环
- [type_checker.py:1553-1576] `_expand_alias` 函数名不副实 → 递归遍历类型结构但不做任何别名展开，本质上是 deepcopy 式重建；别名在 `_from_ast_type` 阶段已被 eagerly 解析 → 删除该函数或重新设计为惰性展开系统
- [type_checker.py:718-730] 无匹配穷尽性检查（Exhaustiveness）→ MatchExpr 只检查各分支返回类型一致，不检查模式是否穷尽所有可能；缺少分支的代码只能在运行时失败 → 实现模式穷尽性检查算法，至少对 ADT 和元组/列表模式做基本覆盖检查
- [type_checker.py:1437-1466] `_collect_type_bindings` 不检查冲突绑定 → 当同一 TypeVar 已绑定时，只做传递收集不验证一致性；同一函数不同参数位置对同一类型变量产生冲突约束不会被检测到 → 当 TypeVar 已绑定时，调用统一检查实际类型与已绑定类型是否兼容
- [type_checker.py:169-174] 类型变量是全局计数器，多 TypeChecker 实例会冲突 → `TypeVar._counter` 是类级别的全局计数器，非线程安全，多实例时调试混乱 → 将计数器移入 TypeChecker 实例级别
- [type_checker.py:1281-1290] 二元操作符的类型检查方向单一 → TypeVar 在操作符语义中"自由漂浮"，因无统一而不会被约束为具体类型 → 统一缺失的连锁反应，修复统一后此问题自解

#### 轻微问题（代码质量）

- [type_checker.py:178-179] TypeVar.__eq__ 基于 identity，但部分注释提到基于 name 的比较，易造成误解
- [type_checker.py:1395-1418] `_substitute_type_vars` 同时支持 str 和 TypeVar identity 两种 key 格式，隐式分支脆弱 → 拆分为两个独立函数或统一使用一种 key 格式
- [type_checker.py:366] 内置函数 json_parse 的返回类型是 TypeVar("json_value")，本质上是 Any 类型的后门 → 引入专门的 JsonValue 类型或用 ADT 表示 JSON 值
- [type_checker.py:1176-1273] `_check_pattern` 接收 `match_expr` 参数但从未使用 → 移除或用于更好的错误定位
- [type_checker.py:654] ListExpr 空列表的元素类型命名为 "unknown_list_elem"，与其他地方命名不一致
- [type_checker.py:全文] warnings 收集功能基本未被使用，ErrorCollector 中 warnings 列表可能永远为空

#### 原创性分析

**特色设计**：
1. 两阶段声明收集（先收集所有函数/ADT/别名签名，再检查函数体），正确支持前向引用和相互递归
2. 实例化机制用 `id(ty)` 作为 mapping 的 key，确保同一 TypeVar 对象始终映射到同一个新变量——Algorithm W 实例化的正确实现
3. ADT 字段访问支持"所有变体共有的同名字段"访问模式，比传统模式匹配更灵活
4. TryExpr 错误传播检查（? 操作符）是 Rust 风格设计，实现较完整

**局限性**：整体架构借鉴了 HM 系统，但缺少统一算法这一核心支柱，使得推断能力大打折扣。当前的 `_collect_type_bindings` + `_substitute_type_vars` 模式只能在函数调用方向上做单遍约束收集，无法处理需要双向推断的场景。

---

## [2026-07-16] 词法/语法分析器 (lexer.py + parser.py) 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 融合 ML 家族和 Rust 特征，有自己的设计取舍；map 字面量消歧策略有特色 |
| 可行性 | ⭐⭐⭐⭐ | 主要语法元素均支持，递归下降结构基本正确 |
| 正确性 | ⭐⭐⭐ | 管道优先级错误、链式比较左结合错误、转义字符不完整 |
| 安全性 | ⭐⭐⭐ | 错误位置基本准确，但 end_col 计算有错误 |
| 一致性 | ⭐⭐⭐ | 与 tree-sitter 语法主要结构一致，但存在若干差异 |
| 完整性 | ⭐⭐⭐ | 缺少科学计数法、原始字符串、多行字符串、块注释等 |
| 工程质量 | ⭐⭐⭐ | 死代码（UNIT token、_make_error）、回溯消歧不够优雅 |
| 性能 | ⭐⭐⭐⭐ | 递归下降正常水平，但 map 消歧前瞻扫描可能 O(n²) |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[lexer.py:203-222] 数字字面量不支持科学计数法和下划线分隔符** → 无法解析 `1.5e10`、`1_000_000` 等常见数字字面量格式；现代语言基本功能缺失 → 在 `_read_number` 中增加对 `e/E` 科学计数法的识别，支持 `_` 分隔符
  - 追问：如果 GCC 不支持科学计数法和下划线分隔的数字字面量，能被接受吗？→ **绝对不能。** 这是现代编程语言的基本功能。

- **[lexer.py:237-258,291-311] 字符串转义字符处理不完整，未知转义静默吞掉反斜杠** → 未知转义序列（`\a`、`\b`、`\f`、`\v`、`\0`、`\xHH`、`\uXXXX`）被静默处理为仅保留转义字符本身（丢掉反斜杠），例如 `"\q"` 变成 `"q"`；静默篡改用户输入是严重的正确性问题 → 对未知转义序列发出警告或错误；补充标准转义序列支持
  - 追问：如果 Python 的字符串转义遇到未知序列静默丢弃反斜杠，能被接受吗？→ **不能。** 所有主流语言要么报错要么保留反斜杠，静默篡改输入是不可接受的。

- **[parser.py:438-445] 管道操作符 `|>` 优先级设计错误** → 注释称管道操作符"低于相等性，高于逻辑与"，但 Elixir/OCaml/F#/Elm 等所有主流函数式语言中管道优先级都很低（低于逻辑运算，接近赋值）；当前设计导致 `a == b |> f` 被解析为 `(a == b) |> f` 而非 `a == (b |> f)` → 将管道操作符优先级降低到逻辑或之下、赋值之上
  - 追问：如果 Elm 的管道操作符优先级高于相等性比较，能被接受吗？→ **不能。** 管道是连接表达式的高级组合子，应具有最低优先级之一，这是函数式语言的共识。

- **[parser.py:677-683] 比较运算符链式比较产生错误的左结合解析** → `a < b < c` 被解析为 `(a < b) < c`，即先用布尔值和 c 比较，产生无意义结果；Python 中是链式比较语义，Rust 中直接报错 → 要么实现链式比较（收集连续比较运算符，生成逻辑与连接的表达式），要么在遇到连续比较时抛出语法错误
  - 追问：如果 Python 的 `a < b < c` 被解析为 `(a < b) < c`，能被接受吗？→ **不能。** 要么正确支持链式比较，要么明确报错，静默产生错误结果是最糟糕的。

- **[lexer.py:全文] 完全没有块注释 `/* */` 支持** → 只有 `//` 单行注释；无法注释掉大段代码，调试和开发体验差；生产级语言标准功能缺失 → 添加 `/* */` 块注释支持，包括嵌套块注释检查
  - 追问：如果 Rust 没有块注释，能被接受吗？→ **不能。** 块注释是几乎所有生产级语言的标配。

- **[lexer.py:92,381-385] UNIT token 类型定义但从未由 lexer 生成** → `TokenType.UNIT` 在枚举中定义了，但 lexer 中 `(` 始终生成 `LPAREN`；UNIT token 完全是死代码 → 删除 UNIT token 类型，保持当前 parser 层面识别 Unit 的方式

- **[lexer.py:195-199] `//` 注释的 `\r\n` 处理有缺陷** → 注释跳过逻辑中遇到 `\n` 停止，但 `\r` 不会停止；在 Windows 风格换行源码中行为不正确 → 修正 `\r` 处理，遇到 `\r` 且下一个是 `\n` 时正确处理

- **[parser.py:全文] 解析器遇到第一个错误就抛出，无错误恢复** → ErrorCollector 虽然定义了，但 parser 完全没有使用；遇到任何语法错误直接 raise ParseError，用户一次只能看到一个错误 → 在 Parser 中集成 ErrorCollector + synchronize 机制，遇到错误后跳过 tokens 直到下一个语句边界继续解析
  - 追问：如果 Clang 遇到第一个语法错误就停止，能被接受吗？→ **不能。** 生产级编译器都有错误恢复机制，一次报告多个错误。

#### 中等问题（影响特定场景）

- [lexer.py:全文] 缺少原始字符串（raw string）支持 → 无法方便编写正则表达式、Windows 路径 → 添加 `r"..."` 原始字符串语法
- [lexer.py:259-265] 缺少多行字符串支持 → 字符串遇到换行直接报"未闭合"错误；对于长文本字符串不便 → 允许普通字符串包含换行，或添加三引号多行字符串
- [lexer.py:69,89] PIPE 和 PIPE_VARIANT 是同一 token 类型的两种语义 → PIPE_VARIANT 是死代码 → 删除 PIPE_VARIANT，明确 PIPE 用于所有 `|` 字符
- [parser.py:392-397] `_parse_block` 中赋值语句的识别方式脆弱 → 通过前瞻一个 token 判断 `ident =` 是否为赋值；无法处理字段赋值、索引赋值 → 将赋值作为表达式级别的语法，或使用更通用的语句识别机制
- [parser.py:467-479] for 循环的 iterable 字段类型不一致 → 有时是表达式，有时是元组 `("range", start, end, step)` → 为 range 形式创建专门的 AST 节点，或统一为表达式
- [parser.py:849-889] map 字面量的 `_is_map_literal` 前瞻扫描在大文件中效率低 → 每次遇到 `{` 都扫描到匹配的 `}`，可能导致 O(n²) 的解析时间 → 考虑其他消歧策略（如要求 map 字面量有特殊前缀）
- [parser.py:252-273] `_parse_variant_def` 中用回溯区分命名字段和匿名字段 → 虽然是常见做法但不够优雅 → 低优先级，当前实现可接受

#### 轻微问题（代码质量）

- [lexer.py:213-214] 浮点数字面量缺少对前导点 `.5` 和尾端点 `5.` 的处理
- [lexer.py:176-185] `_advance` 方法在 EOF 时行为未定义，会抛出 IndexError
- [parser.py:57-62] `_advance` 在最后一个 token 时不推进，不断返回 EOF
- [parser.py:543] `_parse_match_arm` 中 body 使用完整表达式解析，与函数定义、if 表达式的处理方式不一致
- [lexer.py:156-161] `_make_error` 方法从未被调用，span 计算也有错误
- [parser.py:502-504] if 条件表达式使用全优先级解析，赋值出现在条件中是否合理值得商榷

#### 原创性分析

**原创部分**：
1. 语言设计选择：`if-then-else` 关键字语法、管道操作符 `|>`、ADT 变体定义、`type` 关键字定义代数数据类型
2. map 字面量消歧策略：使用前瞻扫描 `=>` 的方式区分 `{}` 是代码块还是 map 字面量
3. for 循环双语法：同时支持 `for x in expr` 和 `for i <- start..end step n` 两种形式
4. 错误报告系统：Rust 风格错误格式化有自己的实现细节

**借鉴部分**：
1. 递归下降解析器优先级分层结构是教科书标准做法
2. 词法分析器逐字符扫描、peek/advance 模式是经典实现
3. Token 类型枚举、AST 节点 dataclass 是标准做法

---

## [2026-07-16] 错误处理 + 模块系统 + 环境 (errors.py + modules.py + environment.py) 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 错误报告框架借鉴 Rust 设计方向正确，模块系统三层架构清晰 |
| 可行性 | ⭐⭐⭐ | 基础功能可用，但错误恢复、循环导入检测、导出校验有缺陷 |
| 正确性 | ⭐⭐ | 环境 define 允许重复定义、assign 穿透作用域、循环导入检测顺序错误 |
| 安全性 | ⭐⭐⭐ | 路径安全检查基本可用，但相对路径 CWD 依赖有风险 |
| 一致性 | ⭐⭐⭐ | ErrorCollector 框架完整但集成不足，各模块错误类型不统一 |
| 完整性 | ⭐⭐⭐ | 缺少错误码系统、解析器错误恢复、模块递归签名等高级特性 |
| 工程质量 | ⭐⭐⭐ | 结构合理但有死代码、重复代码、命名不一致 |
| 性能 | ⭐⭐⭐⭐ | 无明显性能问题 |
...
- **[environment.py:30-32] `define()` 允许重复定义同作用域变量，无遮蔽检测** → 同一作用域内两次 define 会静默覆盖前一个绑定，不报错也不警告；拼写错误无法发现 → 在 `define()` 中检测 `name in self.bindings`，根据语言语义抛出错误或明确记录为遮蔽
  - 追问：如果 Rust 允许同一作用域重复定义同名变量且静默覆盖，能被接受吗？→ **不能。** 大多数静态语言同一作用域不可重复声明，这是基本的变量安全性。

- **[environment.py:50-61] `assign()` 沿作用域链向上赋值，可能意外修改外层变量** → 当内层存在与外层同名的不可变变量时，assign 会跳过内层不可变绑定继续向上查找，最终可能修改外层的可变绑定；违反最近遮蔽原则 → `assign()` 一旦在某个作用域找到同名绑定，无论是否可变都应停止向上搜索；不可变则报错，可变则修改
  - 追问：如果 JavaScript 的 `=` 赋值会穿透内层 const 绑定去修改外层 let 绑定，能被接受吗？→ **不能。** 这是作用域实现的根本性语义缺陷，会导致极其难以调试的 bug。

- **[errors.py:全文] 错误格式缺少错误码（error code）系统** → 所有错误只有文本消息，没有结构化错误码；无法按错误类型筛选/搜索、无法提供扩展文档、无法做 lint 级别配置 → 引入 ErrorCode 枚举，每个具体错误类型关联一个错误码
  - 追问：如果 Rust 编译器的错误没有错误码（E0308 等），能被接受吗？→ **不能。** 错误码是生产级编译器的标配，是错误管理和文档化的基础设施。

- **[modules.py:307-322] `_collect_exports()` 不验证导出名称是否实际存在** → `export foo` 即使 foo 从未定义也会被加入 exported_names；get_exported_bindings 中通过 try/except 静默跳过，用户得不到任何提示 → 收集导出名称后，验证每个名称在类型环境和求值环境中都存在，不存在则抛出 ImportError 或 ExportError
  - 追问：如果 OCaml 的模块签名与实现不匹配时静默通过，能被接受吗？→ **不能。** 生产级模块系统必须验证导出与定义的一致性。

- **[modules.py:246-259] 循环导入检测顺序错误——先查缓存后入栈** → 先检查缓存（243 行），再检查循环（247 行），然后才入栈（259 行）；A→B→A 场景下 B 加载 A 时 A 还没入栈，会走到缓存检查发现不在缓存里，然后重新开始加载 A，导致无限递归 → 将 `loading_stack.append(file_path)` 移到缓存检查之前，用"加载中"状态标记模块（三态模型：未加载、加载中、已加载）
  - 追问：如果 Python 的 import 系统在循环导入时会无限递归栈溢出，能被接受吗？→ **不能。** 循环导入检测是模块系统的基本功能，实现错误可能导致崩溃。

- **[modules.py:236-237] 每次 `load_module` 都创建新的 `ModuleResolver`** → 每次加载模块时创建新的解析器实例，search_paths 可能因 current_file 的不同而产生不一致的解析结果 → ModuleManager 持有一个基础 ModuleResolver，每次解析时传入当前文件计算相对路径
  - 追问：如果 Node.js 的 require 每次调用都创建新的模块解析器，能被接受吗？→ **不能。** 模块解析应该是确定性的，每次创建新实例增加了不一致的风险。

- **[parser.py:全文 + errors.py:全文] 解析器无错误恢复，遇到第一个错误就停止** → ErrorCollector 虽然定义了，但 parser 完全没有使用；用户一次只能看到一个错误 → 在 Parser 中集成 ErrorCollector + synchronize 机制
  - 追问：如果 GCC 遇到第一个语法错误就停止编译，能被接受吗？→ **不能。** 生产级编译器都有错误恢复机制，一次报告多个错误。

#### 中等问题（影响特定场景）

- [errors.py:456-458] `get_all()` 丢失时序信息 → 所有错误排在所有警告前面，与源码出现顺序不一致 → 使用单一列表存储所有诊断，每条记录带序号
- [errors.py:386-387] `PassError.__str__` 绕过格式化系统 → 不显示源码上下文、行号列号、颜色等 → PassError 也应使用标准格式化流程
- [errors.py:94] `highlight_span` 旧格式兼容字段造成数据重复 → 同时存在 span 和 highlight_span 两套位置表示 → 统一使用 Span，删除 highlight_span
- [modules.py:98-105] 默认搜索路径包含相对路径 `""`, `"./modules"`, `"../stdlib"` → 相对路径相对于 CWD 而非 nova 包目录，从不同目录运行结果不同 → 默认搜索路径应基于 nova 包的安装路径（使用 __file__）
- [modules.py:150] 路径安全检查 `startswith` 不可靠 → 符号链接可以绕过 → 使用 `os.path.realpath()` 解析符号链接后再比较
- [modules.py:359-361] 导入的绑定总是不可变 → 即使原模块中是 mut 变量，导入后也变成不可变 → 明确文档化，或考虑 `import mut` 语法
- [environment.py:34-40] `lookup()` 与 `lookup_binding()` 重复代码 → 两个方法作用域链遍历逻辑完全相同 → lookup() 调用 lookup_binding(name).value
- [modules.py:276] `_collect_exported_types()` 的返回值未被使用 → 冗余代码 → 删除未使用的调用和冗余方法
- [errors.py:465-471] `raise_all()` 将后续错误作为 note 添加到第一个错误 → 严重程度信息丢失 → 使用 ExceptionGroup 或返回错误列表

#### 轻微问题（代码质量）

- [errors.py:46-48] `ANSI.enabled()` 未检查 `TERM` 环境变量，dumb terminal 会输出乱码
- [errors.py:191-196] 位置信息格式用中文"第X行"，与 Rust 风格不一致，编辑器无法解析为可点击链接 → 使用标准 `file:line:column` 格式
- [errors.py:73-74] `RelatedNote` 中 `line` 和 `column` 默认值为 -1，C 风格做法 → 用 `Optional[int] = None`
- [modules.py:36-48] `ModuleInfo.is_loaded` 字段始终为 True，死代码
- [environment.py:67-73] `all_bindings()` 递归可能栈溢出 → 迭代实现更健壮
- [modules.py:186] 使用 `removesuffix()` 需要 Python 3.9+ → 应在文档或 requires-python 中声明

#### 原创性分析

**优点**：
1. 错误格式化设计思路正确：源码上下文 + 行号列号 + caret 下划线 + ANSI 颜色 + RelatedNote
2. ErrorCollector 概念完整：区分 errors/warnings、支持批量格式化、两种抛出策略
3. 模块系统三层架构清晰：ModuleResolver → ModuleManager → ModuleInfo
4. 环境设计简洁：Environment + BindingInfo 组合，parent 指针实现作用域链

**不足**：
1. 错误恢复完全缺失——几乎所有手写递归下降解析器的通病
2. 循环导入检测是教科书级栈检测，未处理更复杂场景
3. 作用域实现是最基础的链表式环境，没有闭包捕获分析、let-polymorphism

---

## [2026-07-16] 所有后端审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 三层 IR 架构、自研 x86_64 编码器、线性扫描分配器有技术深度 |
| 可行性 | ⭐⭐ | 仅 C 后端相对可用；native/Wasm/Cranelift 均为 demo 级别 |
| 正确性 | ⭐⭐ | 多个后端有根本性错误（Phi 节点、分支标签、控制流模型） |
| 安全性 | ⭐⭐ | native 后端栈上分配复合类型导致悬垂指针，基址寄存器被破坏 |
| 一致性 | ⭐⭐ | 各后端与 Nova 语义的对应程度参差不齐，类型信息大量丢失 |
| 完整性 | ⭐⭐ | 指令覆盖度低，大量 LIR 指令未实现或只是占位 |
| 工程质量 | ⭐⭐ | 命名误导（native 实际是 cranelift）、死代码、设计缺陷多 |
| 性能 | ⭐⭐ | 寄存器分配不完整、无溢出机制、callee-saved 全保存浪费 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[compiler_pipeline.py:34] `BACKEND_NATIVE` 实际使用 CraneliftBackend，名称严重误导** → 用户指定 `target="native"` 时实际使用 Cranelift 后端而非自研 native_backend；NativeCodeGen 类完全未被编译管道使用 → 要么将 BACKEND_NATIVE 改为实际使用 NativeCodeGen，要么重命名常量为 BACKEND_CRANELIFT
  - 追问：如果 GCC 的 `-march=native` 实际上调用的是 Clang，能被接受吗？→ **绝对不能。** 这是架构级别的命名欺诈，严重误导用户和开发者。

- **[native_backend.py:1098-1108] LIRIndex 编译直接破坏基址寄存器（base_reg += rcx）** → `e.add_reg_reg(base_reg, RCX)` 直接修改基址寄存器值；如果该基址寄存器后续仍需使用（常态），其值将被永久破坏，导致后续所有访问都指向错误地址 → 使用临时寄存器（如 RAX）计算地址，不修改 base_reg
  - 追问：如果任何生产级编译器的索引寻址指令会破坏基址寄存器，能被接受吗？→ **绝对不能。** 这是会导致内存安全违规的严重 bug。

- **[native_backend.py:1136-1148] 列表/元组/ADT 构建在栈上分配，函数返回后立即失效** → `_compile_build_list`、`_compile_build_tuple`、`_compile_build_adt` 都在当前栈帧上分配内存（`sub rsp, total_size`）；当函数返回或栈帧被回收时，这些数据结构的指针成为悬垂指针 → 通过堆分配（调用 nova_alloc）或值传递（复制到调用者栈帧）
  - 追问：如果 OCaml 的 native 编译器把 cons cell 分配在调用栈上，能被接受吗？→ **绝对不能。** 函数式语言的不可变数据结构必须分配在堆上，否则闭包和返回值都会成为悬垂指针。

- **[lir_lowering.py:221-228] MIR Phi 节点降级严重错误，仅取第一个 source** → SSA Phi 节点的核心语义是"根据前驱基本块选择对应的值"，但 LIR 降级中只取 `sources[0]` 生成 LIRLoadReg；所有涉及多前驱块的变量（循环变量、if-else 合并变量）都将得到错误的值 → LIR 层要么保留 Phi 节点让后端处理，要么在每个前驱块末尾插入 copy 指令
  - 追问：如果 LLVM 的 Phi 节点降级时只取第一个前驱的值，能被接受吗？→ **绝对不能。** Phi 节点是 SSA 的核心，降级错误意味着整个 SSA 优化管线的结果都是错的。

- **[cranelift_backend.py:162-168] LIRBranch 编译使用硬编码标签名，完全错误** → 条件分支编译为 `brz cond_loc, block_false` 和 `jump block_true`，但 `block_false` 和 `block_true` 是硬编码字符串，而非 LIR 指令中的 true_label 和 false_label；所有条件分支都跳转到不存在的标签 → 使用 `instr.true_label` 和 `instr.false_label` 动态生成分支目标
  - 追问：如果 Rustc 的 LLVM 后端生成分支指令时目标标签是硬编码的，能被接受吗？→ **绝对不能。** 这是根本性的正确性错误，生成的代码完全无法运行。

- **[wasm_backend.py:230-232] LIRLabel 编译为 block 嵌套结构，控制流完全错误** → Wasm 后端将每个 LIRLabel 编译为嵌套 block，但 Wasm 的 block 是"向前跳出"的结构化控制流，而 LIR 的标签是可以任意跳转的；循环、goto 等控制流将完全无法工作 → 使用 relooper 算法将 CFG 重新结构化，或用 br_table 模拟任意跳转
  - 追问：如果任何生产级 Wasm 编译器把每个标签都变成嵌套 block，能被接受吗？→ **绝对不能。** Wasm 的结构化控制流与 CFG 的转换是 Wasm 编译器的核心技术问题，简单嵌套 block 方案是完全错误的。

- **[native_backend.py:509-541] 函数调用参数传递不保存 caller-saved 寄存器** → 传参时直接将源寄存器 mov 到参数寄存器；如果源寄存器本身就是 caller-saved 寄存器（RAX、RCX、RDX 等），在函数调用后会被破坏；虚拟寄存器如果分配到这些寄存器，其值将丢失 → 在调用前保存所有活跃的 caller-saved 寄存器（溢出到栈），调用后恢复
  - 追问：如果 GCC 编译函数调用时不保存 caller-saved 寄存器，能被接受吗？→ **绝对不能。** 调用约定是 ABI 的核心，违反调用约定会导致随机、难以调试的 bug。

- **[native_backend.py:412-447] 线性扫描分配器有溢出就整体失败，fallback 到按需分配** → 只要有一个寄存器溢出就返回 None，然后 fallback 到简单的按需分配；函数稍微复杂一点（虚拟寄存器超过 12 个）就完全退化为无寄存器分配状态 → 实现真正的溢出（spill）机制，将溢出的值存储到栈帧中
  - 追问：如果 LLVM 的寄存器分配器遇到溢出就放弃并使用无分配模式，能被接受吗？→ **不能。** 溢出处理是寄存器分配器的基本功能。

- **[x86_64.py:83-93] `mov_reg_imm64` 对负数小立即数处理错误** → 条件 `if 0 <= imm <= 0x7FFFFFFF` 仅考虑非负小立即数，负数小立即数（如 -1）走不必要的 10 字节路径而非 7 字节符号扩展路径 → 判断条件改为有符号 32 位范围：`-0x80000000 <= imm <= 0x7FFFFFFF`
  - 追问：如果 NASM 的 `mov rax, -1` 生成 10 字节指令而非 7 字节，能被接受吗？→ 虽然不影响正确性，但作为"自研指令编码器"这是低级错误，影响代码质量。

#### 中等问题（影响特定场景）

- [cranelift_backend.py:203-214] 常量加载不关联 dst_loc，生成的 SSA 值无法被后续指令使用
- [cranelift_backend.py:216-238] BinOp 不区分整数/浮点操作，也不查类型
- [wasm_backend.py:260-263] LIRBranch 硬编码 `$block_false`，与 Cranelift 后端同样的问题
- [wasm_backend.py:161] 字符串扫描中使用字面量 `\\x00` 而非真正的 null 字节 → 字符串不是 null-terminated 的
- [native_backend.py:243-256] 常量加载的虚拟寄存器命名与 LIR dst_loc 不一致
- [native_backend.py:616-621] 函数序言保存所有 callee-saved 寄存器，浪费栈空间
- [native_backend.py:770-786] 浮点比较使用 setb/seta 等无符号比较指令（实际正确但需验证）
- [compiler_pipeline.py:55-67] 错误处理使用正则表达式从错误消息解析行号，脆弱反模式
- [c_codegen.py:590-600] TryExpr 编译假设返回指针类型，与实际类型系统不一致
- [lir_lowering.py:248-258] MIRSwitch 和 MIRMatchJump 降级为普通 LIRJump，多分支语义丢弃

#### 轻微问题（代码质量）

- [x86_64.py:451-473] `je_rel32` 函数定义了两次
- [native_backend.py:921-924] LIRPanic 直接 exit(1)，不输出 panic 消息
- [cranelift_backend.py:212-213] 闭包常量直接返回 iconst 0，无实际闭包支持
- [wasm_backend.py:309-310] 同上，闭包常量返回 i32.const 0
- [native_backend.py:1225-1245] _start 函数中调用 nova_init/nova_cleanup，但 native 后端不链接 runtime
- [c_codegen.py:1156-1159] 字段访问通过字段名是否为 int 判断是 tuple 还是 struct
- [c_codegen.py:1302] 标识符默认类型推断为 int64_t，大多数情况错误

#### 原创性分析

**亮点（值得肯定的设计）**：
1. 三层 IR 架构（HIR/MIR/LIR）借鉴 MLIR Dialect 分层思想，设计方向正确
2. 自研 x86_64 指令编码器从零实现 REX 前缀、ModR/M、SIB 编码，有技术深度
3. 线性扫描寄存器分配器实现了经典高效算法的框架
4. ELF 生成器从零构建 ELF64 可执行文件，展示了对可执行文件格式的深入理解
5. C 后端的闭包实现通过环境指针 + 捕获变量数组，设计相对完整
6. 多后端设计架构上有前瞻性

**整体评价**：项目在架构设计和 native 后端底层编码部分展示了不错的技术深度，但各后端的完成度参差不齐，距离生产可用有较大差距。

---

## [2026-07-16] IR 系统与 Pass 管理器审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 三层 IR 设计、统一类型系统横跨三层、Pass 错误包装有特色 |
| 可行性 | ⭐⭐ | 大量 lowering 为 stub，优化 pass 多为空壳，核心机制缺失 |
| 正确性 | ⭐⭐ | SSA 实现根本性错误、Match 降级错误、Phi 降级错误、常量折叠修改 dataclass 类型 |
| 安全性 | ⭐⭐⭐ | 无明显安全漏洞，但因验证缺失可能静默生成错误 IR |
| 一致性 | ⭐⭐ | 层间抽象边界模糊，LIR 过于简单，类型信息大量丢失 |
| 完整性 | ⭐⭐ | 大量 AST 节点 lowering 不完整，多个优化 pass 为空壳 |
| 工程质量 | ⭐⭐ | 用 `__class__` 修改 dataclass 类型、hasattr 反模式、死参数多 |
| 性能 | ⭐⭐⭐ | 优化 pass 少且实现简单，性能影响有限 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[pass_manager.py:106-109,116-119] HIR 常量折叠使用 `__class__` 赋值修改 dataclass 类型** → 直接修改 `__class__` 不会改变 dataclass 的字段结构，会导致 `__repr__`、`__eq__`、`__hash__` 等自动生成方法行为异常；`del expr.op` 直接操作 `__dict__` 与 dataclass 语义冲突 → 使用替换策略而非原地修改类型；用访问者模式重新构建表达式树
  - 追问：如果 LLVM 的常量折叠 pass 直接修改 Instruction 的 C++ 虚函数表指针，能被接受吗？→ **绝对不能。** 这是极其脆弱且不符合最佳实践的做法，一旦涉及 isinstance 链式判断或序列化必然崩溃。

- **[mir_lowering.py:275-283] MIR SSA 实现根本性错误——赋值不产生新版本** → 真正的 SSA 要求每次赋值都生成新的 SSA 名（版本号递增），并在控制流汇合处插入 phi 节点；当前实现直接覆盖 `self.env` 中的名字，完全违反 SSA 基本原则 → 实现完整的 SSA 构造算法：为每个变量的每次赋值生成新版本号，通过 dominance frontier 计算插入 phi 节点，最后重命名
  - 追问：如果 LLVM 的 MIR 不是真正的 SSA 形式，所有优化 pass 都基于错误前提，能被接受吗？→ **绝对不能。** SSA 是现代编译器优化的基石，SSA 实现错误意味着所有基于 SSA 的优化都是无效的。

- **[mir_lowering.py:351-384] MIR Match 降级完全错误——所有分支顺序跳转而非条件匹配** → Match 表达式的每个 arm 之间用 MIRJump（无条件跳转）连接，意味着第一个 arm 永远被执行，其余 arm 全是死代码；完全没有模式匹配的条件判断逻辑 → 为每个 arm 生成模式匹配代码（比较值、检查变体标签等），使用条件分支决定是否进入 arm 体
  - 追问：如果 Haskell 编译器把 case 表达式的所有分支用无条件跳转串联，只执行第一个分支，能被接受吗？→ **绝对不能。** 模式匹配是函数式语言的核心特性，降级错误意味着整个 match 表达式完全不可用。

- **[lir_lowering.py:221-228] LIR Phi 节点降级丢弃所有前驱信息——仅取第一个源** → Phi 节点的核心语义是"根据哪个前驱基本块进入，选择对应的值"；当前实现直接取 sources[0] 生成一条 LIRLoadReg，完全忽略其他前驱；所有控制流汇合处的值选择逻辑都被破坏了 → LIR 阶段将 phi 节点的选择逻辑下放到每个前驱块的末尾（SSA-out 算法）
  - 追问：如果 LLVM 的指令选择器把 phi 节点降级为"取第一个操作数的 mov"，能被接受吗？→ **绝对不能。** Phi 节点是 SSA 的核心，降级错误意味着 if 表达式的 else 分支结果永远被丢弃。

- **[ir/ 目录全文] 完全缺少 IR 验证机制** → 没有任何验证 pass 检查 SSA 正确性、CFG 完整性、类型一致性、基本块结构；任何优化 pass 的 bug 都可能静默生成错误 IR，调试极其困难 → 实现 HIRVerifier、MIRVerifier、LIRVerifier 三个验证 pass，在 pass manager 中可配置为在每个优化 pass 后自动运行
  - 追问：如果 LLVM 没有 VerifierPass，每个 pass 之后都不验证 IR 正确性，能被接受吗？→ **绝对不能。** VerifierPass 是编译器基础设施中最重要的调试工具，没有验证的优化管线是不可维护的。

- **[hir_lowering.py:292-299] HIR 块表达式中的 Let 绑定类型错误——Decl 混入 Expr 列表** → `HIRBlockExpr.exprs` 的类型声明是 `List[HIRExpr]`，但塞入了 `HIRLetDecl`（继承自 `HIRDecl`，不是 `HIRExpr`）；MIR lowering 处理 HIRBlockExpr 时遇到 HIRLetDecl 会返回 None，变量绑定完全丢失 → 在 HIR 层引入 HIRLetExpr（表达式级别的 let 绑定），或者将 block 设计为声明+表达式的混合序列
  - 追问：如果 Rustc 的 HIR 中 Block 的 stmt 列表混入了声明节点导致类型不匹配，能被接受吗？→ **不能。** 类型不一致是严重的设计缺陷，会导致下游 lowering 静默失败。

- **[pass_manager.py:617-694] MIR LICM 实现严重残缺** → 回边检测逻辑用 pass 跳过、循环体定义错误（只在 header 块收集）、外提目标错误（可能插入到循环内部）、只处理 header 块的指令 → 实现完整的 LICM：正确的回边检测、完整的循环体分析、正确的外提目标（循环前导块）
  - 追问：如果 GCC 的 LICM 优化只在循环头块中找不变量且回边检测是空实现，能被接受吗？→ **不能。** 这是"有这个 pass 的名字但几乎没实现"的典型空壳。

#### 中等问题（影响特定场景）

- [pass_manager.py:全文] 多个 Pass 是空壳（return False）→ Inlining、HIR DCE、HIR CSE 等均为空实现或只有框架
- [mir_lowering.py:285-289] MIR ListComprehension 降级为 stub → 直接返回空列表常量，完全忽略推导逻辑
- [mir_lowering.py:247-250] MIR Lambda/闭包降级为 stub → 只生成名字字符串，没有实际函数体 lowering，没有捕获变量分析
- [lir_lowering.py:174-200] LIR 降级丢失 List/Tuple/Map/ADT 的元素信息 → 只保留 count，元素/字段的寄存器位置完全丢失；MIRMapBuild 甚至被降级为 LIRBuildList
- [lir_lowering.py:248-258] LIR Switch/MatchJump 降级为无条件跳转 → 所有分支逻辑被丢弃，跳到默认分支
- [pass_manager.py:697-770] Pass 管理器无依赖图和管线调度 → 只是简单按添加顺序运行 pass，没有依赖声明、失效分析、智能调度
- [lir_lowering.py:236-240] LIR Branch 的 cond_reg 未设置 → DCE 和其他 pass 依赖 cond_reg 判断条件寄存器使用，导致 DCE 无法识别分支指令的条件寄存器使用
- [mir_lowering.py:299-305] HIRUnwrapExpr 降级为简单字段访问 → ? 操作符完全没有错误传播的控制流逻辑

#### 轻微问题（代码质量）

- [ir_nodes.py:全文] 整个 IR 无 dump/print 调试能力，仅 NovaType 有 __repr__
- [pass_manager.py:704] Pass Manager 的 _verbose 标志完全未使用
- [lir_lowering.py:88] LIR stack_size 计算不正确，简单地将虚拟寄存器数乘以 8
- [hir_lowering.py:97-98] HIR AliasDecl 不降级目标类型，永远是 TYPE_VAR
- [pass_manager.py:446-449] LIR CSE 不处理可交换操作的对称性
- [pass_manager.py:92-122] HIR 常量折叠不递归遍历所有表达式类型，只能在顶层二元操作中工作
- [mir_lowering.py:62-65] MIR 全局变量初始化值未被 lowering，init_value 总是 None

#### 原创性分析

**亮点**：
1. 统一类型系统横跨三层 IR：NovaType 在三层 IR 中共享，避免了类型系统在层间重复定义
2. LIR 用线性指令序列 + 虚拟寄存器：适合教学演示寄存器分配和指令选择
3. Pass 错误包装机制：PassError 包装原始异常并附带上下文，比许多同级别学习项目更完善
4. 迭代收敛框架：PassManager 的 max_iterations + 不动点检测是标准优化管线设计

**不足**：
1. 三层 IR 架构是编译器教材标准方案，核心思想无特别原创
2. SSA + CFG 的 MIR 设计直接借鉴 LLVM/Rustc
3. 常量折叠、DCE、CSE、LICM 四个经典优化 pass 是每个编译器项目的标配

---

## [2026-07-16] C 运行时 + 测试套件 + Tree-sitter 审查报告（第二十九轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐⭐ | 双后端一致性测试、三层 IR + 多后端架构有特色 |
| 可行性 | ⭐⭐⭐ | 引用计数基本可用，但有系统性内存泄漏；测试数量充足 |
| 正确性 | ⭐⭐ | 容器释放不释放元素、循环引用无法处理、Map 释放类型混淆 |
| 安全性 | ⭐⭐ | Map value 释放类型混淆、JSON unicode 代理对不支持、realloc 计数错误 |
| 一致性 | ⭐⭐⭐⭐ | 有专门的 57 个一致性测试覆盖核心特性 |
| 完整性 | ⭐⭐⭐ | 测试覆盖较广但边界和负例不足；运行时缺少完整 GC |
| 工程质量 | ⭐⭐⭐ | 测试组织良好，但有空断言测试、绕过类型检查的测试 |
| 性能 | ⭐⭐⭐ | 引用计数开销合理，但 FNV-1a 哈希分布可优化 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- **[nova_runtime.c:536-538] `nova_map_put` 中 `nova_value_release` 类型混淆 — 潜在内存损坏** → 当 Map 的 value 不是 NovaValue* 类型时（如 NovaString*、int64_t），`nova_value_release((NovaValue*)entry->value)` 会读取错误的内存偏移来递减 ref_count；如果是 tagged pointer 小整数会导致野指针解引用 → Map 的 value 类型应该有明确的类型标签，或提供释放回调函数指针
  - 追问：如果 Python 的 dict 释放值时不区分类型直接调用 Py_DECREF，能被接受吗？→ **绝对不能。** 类型混淆是内存安全的大忌，可能导致内存损坏或安全漏洞。

- **[nova_runtime.c:99-103] 引用计数 GC 无法处理循环引用 — 设计层面内存泄漏** → `nova_gc_collect()` 只是返回净分配数，完全没有 GC 功能；闭包捕获自身、Map 中存放包含 Map 的 ADT 等循环引用场景会造成永久性内存泄漏 → 至少实现简单的标记-清除 GC 作为备份，或在文档中明确说明循环引用是未定义行为
  - 追问：如果 Haskell 的 GHC 没有 GC 只有引用计数，能被接受吗？→ **绝对不能。** 函数式语言+闭包场景下循环引用非常普遍，纯引用计数方案是不可行的。

- **[nova_runtime.c:479-486,651-668] `nova_list_release` 和 `nova_map_release` 不释放元素 — 大规模内存泄漏** → List release 只释放 items 数组和 list 结构本身，不释放数组中每个元素的引用计数；Map release 只释放 key 和 entry，不释放 value 的引用 → List 和 Map 的 release 函数应遍历所有元素并递减其引用计数；需要运行时类型信息
  - 追问：如果 OCaml 的 GC 不释放列表元素，能被接受吗？→ **绝对不能。** 这是系统性的内存泄漏设计缺陷，影响所有容器类型。

- **[nova_runtime.c:749-756] `nova_adt_release` 不释放字段引用 — ADT 内存泄漏** → ADT release 只释放 fields 数组指针，不释放每个字段指向的对象；嵌套 ADT、String、List、Map 等字段的引用计数永远不会递减 → 遍历字段并释放；需要运行时类型信息
  - 追问：同问题 #3，系统性内存泄漏。

- **[nova_runtime.c:791-798] `nova_closure_release` 不释放捕获变量 — 闭包内存泄漏** → 闭包的 captured 数组中的变量如果是引用计数对象，在闭包释放时不会被释放；对于函数式语言是核心问题 → 闭包释放时遍历 captured 数组并释放每个捕获的变量
  - 追问：如果 Scheme 解释器的闭包释放时不释放捕获的变量，能被接受吗？→ **不能。** 闭包是一等公民，释放时必须正确清理捕获的环境。

- **[nova_runtime.c:1240-1256] JSON 解析器字符串转义 `\uXXXX` 不处理代理对 — Unicode 损坏** → 只处理单个 `\uXXXX`，遇到 UTF-16 代理对时会生成两个独立的 UTF-8 序列而不是一个正确的代码点；如果 `\u` 后面的字符不足 4 个十六进制数字，代码会越界读取 → 实现 UTF-16 代理对的正确处理，增加对十六进制数字的有效性检查
  - 追问：如果任何生产级 JSON 解析器不正确处理 Unicode 代理对，能被接受吗？→ **不能。** JSON 标准明确要求 UTF-16 代理对支持。

- **[nova_runtime.c:79-87] `nova_realloc` 不更新 `g_alloc_count` / `g_free_count` — 内存统计错误** → realloc 既不增加也不减少分配计数；频繁 realloc 会导致 `nova_gc_collect()` 返回的净分配数严重失真，可能为负或远小于实际 → realloc 应该正确更新计数（free 旧的，alloc 新的）
  - 追问：如果 jemalloc 的统计功能在 realloc 时不更新计数，能被接受吗？→ **不能。** 内存统计是调试和监控的基础，不准确的统计比没有统计更危险。

- **[nova_runtime.c:1700-1703,1770-1772] `nova_http_get` 和 `nova_http_post` 状态码解析错误** → 使用 `curl -w "%{http_code}"` 时 HTTP 状态码被输出到 stdout（与 body 一起写入 tmpfile），但代码没有从 tmpfile 中提取状态码，而是硬编码 `resp->status_code = 200` → 使用 `-o` 将 body 写入文件，用 `-w` 将状态码写入单独的文件或 stdout，然后正确解析
  - 追问：如果 curl 的 HTTP 状态码永远返回 200，能被接受吗？→ **不能。** 这是功能性错误，会导致调用方无法正确判断请求是否成功。

#### 中等问题（影响特定场景）

- [nova_runtime.h:76-89] NovaValue 的 ref_count 冗余 — 设计不一致 → NovaValue 有自己的 ref_count，但内部持有的 NovaString* 等也有各自的 ref_count，双重引用计数增加复杂性
- [nova_runtime.c:459-473] nova_list_contains 和 nova_list_index_of 使用指针相等比较 → 对字符串等对象使用指针相等是不正确的，两个内容相同但不同实例的 NovaString 会被认为不相等
- [nova_runtime.c:597-613] nova_map_remove 不释放 value 引用 → 与 nova_map_put 中更新 value 时的处理不一致
- [nova_runtime.c:519] FNV-1a 哈希使用 64 位但 bucket 索引用 % bucket_count → 当 bucket_count 较小时哈希值高位不参与索引计算，可能分布不均
- [nova_runtime.c:193-196] nova_string_char_at 返回字节而非字符 → 函数名暗示按字符索引但实际按字节索引，多字节 UTF-8 字符会返回不完整字节
- [nova_runtime.c:827-843] nova_read_line 固定 4096 字节缓冲区 — 长行被截断 → 没有动态增长缓冲区或返回错误的机制
- [nova_runtime.c:979-1287] JSON 解析器对 malformed 输入容错性差 → 不验证后续字符、数字解析不检查至少一个数字、无效字符静默返回 NULL
- [tree-sitter-nova/grammar.js:全文] Tree-sitter 缺少 `?` (try) 操作符语法 → Nova 语言有 `?` 操作符但 tree-sitter 语法中完全没有 try_expr 规则
- [tests/test_nova.py:全文] 大量 `check_types=False` 绕过类型检查 → 类型检查器的正确性没有被这些测试验证
- [tests/test_c_codegen.py:146-171] `test_generate_valid_c` 测试不验证编译结果 → 如果 gcc 不存在就静默跳过，即使编译失败测试也不会失败（"总是通过"的无效测试）
- [tests/test_type_system.py:254] `test_circular_alias_detected` 只有 `assert True` 空断言 → 无意义的测试

#### 轻微问题（代码质量）

- [nova_runtime.c:137-138] nova_string_new_len 中 capacity 最小为 16，小字符串多分配内存
- [nova_runtime.c:959] nova_abs_int 对 INT64_MIN 是未定义行为
- [tree-sitter-nova/grammar.js:293-296] escape_sequence 规则有冗余
- [nova_runtime.c:1650-1778] NovaHttpResponse 的 headers 字段从未被填充
- [nova_runtime.c:1500-1516] nova_system 的安全提示放在注释中而不是运行时检查
- 测试总数约 952 个，覆盖较广但 Char 类型运算、Map 操作、元组索引/解构、类型推断复杂场景等覆盖不足

#### 原创性分析

**正面亮点**：
1. 双后端架构设计（Evaluator + Bytecode VM + 一致性测试）：同时实现树遍历求值器和字节码虚拟机，并建立完整的一致性测试套件，在学习项目中非常少见
2. 三层 IR 架构 + Pass 管理器：完整的三层中间表示降级管道和多个优化 Pass
3. x86_64 原生后端 + 线性扫描寄存器分配：手动实现指令编码和寄存器分配器
4. 多后端编译管道：C、Cranelift、WasmGC、原生 x86_64 统一接口
5. 增强错误报告系统：SourceSpan 多行高亮、ErrorCollector 批量收集、ANSI 彩色输出
6. ? 操作符的完整实现：从语法解析到类型检查到求值器到 VM 的全链路错误传播

**借鉴/常见模式**：
1. 引用计数 GC 是语言运行时最常见的入门级 GC 实现
2. FNV-1a 哈希是标准哈希函数
3. 递归下降解析器、ADT + 模式匹配、管道操作符是函数式语言标配
...
| 所有后端 | 9 | 10 | 7 |
| IR/Pass 管理器 | 7 | 8 | 7 |
| 运行时/测试/Tree-sitter | 8 | 11 | 6 |
| **合计** | **56** | **72** | **61** |

### 最关键的 5 个问题（优先级排序）

1. **类型检查器无统一算法（type_checker.py:1582-1583）** — 类型系统的核心支柱缺失，整个类型推断形同虚设
2. **MIR SSA 实现根本性错误（mir_lowering.py:275-283）** — SSA 是现代编译器优化的基石，实现错误导致所有优化无效
3. **C 运行时容器/ADT/闭包不释放元素（nova_runtime.c:479-798）** — 系统性内存泄漏，影响所有复合类型
4. **闭包全量捕获而非自由变量捕获（vm.py:1077-1088 + compiler.py:83）** — 语义级错误，影响语言正确性和性能
5. **native 后端栈上分配复合类型（native_backend.py:1136-1148）** — 悬垂指针，内存安全违规
...
## 第三十轮审查（2026-07-16）— 全模块深度复评

> **审查方式**：三轮 9 个 Explore Agent 并行，逐行深度审查
> **审查范围**：全部 9 大模块（核心引擎、类型系统+前端、后端+IR+运行时）
> **审查标准**：生产级编译器标准（OCaml/Haskell/GCC/LLVM）

---

## [2026-07-16] VM 虚拟机 (vm.py) 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | MATCH_* 专用指令、PIPE_CALL、TRY_UNWRAP 有 Nova 特色 |
| 可行性 | ⭐⭐⭐ | 核心路径可用，但循环控制、闭包实现有严重缺陷 |
| 正确性 | ⭐⭐ | while 循环启发式检测、CLOSURE 全帧捕获、RETURN 双路径处理 |
| 安全性 | ⭐⭐⭐ | 大部分指令走 _pop() 检查，但 RETURN/TRY_UNWRAP 绕过 |
| 一致性 | ⭐⭐⭐ | 与 Evaluator 存在闭包语义、零字段构造器等多处差异 |
| 完整性 | ⭐⭐⭐⭐⭐ | 全部操作码均有实现路径 |
| 工程质量 | ⭐⭐ | _execute_instruction 过长、重复逻辑多、状态管理分散 |
| 性能 | ⭐⭐ | 闭包全帧拷贝性能差，循环检测依赖启发式 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [vm.py:1085-1096] **CLOSURE 捕获整个帧 locals 而非仅自由变量** → 每次创建闭包都 dict 浅拷贝所有局部变量，时间 O(n) 内存 O(n)，阻止 GC 回收不需要的变量；可变共享对象违反不可变性原则 → 编译器分析自由变量，CLOSURE 指令携带自由变量名列表，VM 只拷贝指定变量
  - 追问：如果 OCaml 的闭包捕获了整个作用域的 dict 拷贝，性能影响能被接受吗？→ **绝对不能。** 这是闭包实现的基本原则——只捕获自由变量。

- [vm.py:967-1014] **while 循环检测依赖启发式（POP_JUMP_IF_FALSE + JUMP 回跳）** → VM 通过 end_ip 是否匹配和 target < ip 来推断 while 循环，极其脆弱；嵌套 if 可能误判为 while；状态 push/pop 与实际循环不同步 → 编译器生成明确的 LOOP_START/LOOP_END 标记指令，VM 基于显式指令管理循环状态
  - 追问：如果任何生产级语言的 VM 用启发式推断循环结构，能被接受吗？→ **绝对不能。** 虚拟机的控制流必须基于明确的指令语义。

- [vm.py:594-598 + 1107-1112] **RETURN 指令有两条不同的执行路径** → `_execute_function` 前置检查弹出值后直接返回，`_execute_instruction` 中弹出再压入+设 return_flag；两种路径的栈效果和执行流不同，逻辑混乱 → 统一在 `_execute_instruction` 中处理，设置 return_flag 并保留栈顶值
  - 追问：如果 OCaml 的字节码 VM 同一指令有两条不同执行路径，能被接受吗？→ **不能。** 指令语义必须唯一且一致。

- [vm.py:597+602+606+1110] **RETURN 和 TRY_UNWRAP 直接使用 stack.pop() 绕过栈下溢检查** → 4 处使用原生 pop 而非 _pop()，绕过了统一的栈安全检查机制，错误消息不统一 → 统一使用 _pop() 或创建专用 _pop_return_value() 方法
  - 追问：如果 Haskell GHC 的 STG 机器栈管理绕过统一检查，能被接受吗？→ **不能。** 运行时系统必须有统一的栈操作原语。

#### 中等问题（影响特定场景）

- [vm.py:243-286] **内置函数几乎全部缺少类型检查和参数检查** → str_len/list_length 等对非序列参数崩溃；sqrt/log 不验证值域；filter/map 不检查第二个参数 → 每个内置函数入口添加参数数量和类型检查
- [vm.py:288-291] **_to_float 对 bool 的处理与 ADD/SUB 等不一致** → 算术运算拒绝 bool，但数学内置函数接受 bool（True→1.0），类型系统一致性被破坏 → _to_float 中添加 bool 类型检查并抛出错误
- [vm.py:1225-1227] **FOR_ITER 循环检测依赖 loop_start == self.ip - 1 启发式** → 通过比较指令位置判断是否为同一循环，依赖编译模式，脆弱易断 → 使用显式的循环 ID 作为 FOR_ITER 操作数
- [vm.py:78-80] **NovaChar.__init__ 使用 assert 而非运行时检查** → Python -O 模式下 assert 被移除，构造函数失去不变式验证 → 改用 if not ...: raise ValueError(...)
- [vm.py:1141-1161] **BUILD_MAP 键可哈希性检查使用异常驱动编程** → 先尝试构建 dict，失败后遍历所有键找错，效率低下且不优雅 → 构建前逐一检查键的可哈希性
- [vm.py:1184-1189] **FIELD_ACCESS 对元组的 ValueError 和 IndexError 混为一谈** → 错误消息都说是"越界"，但字段名无法转整数不是越界 → 分别处理 ValueError 和 IndexError，给出准确错误消息

#### 轻微问题（代码质量）

- [vm.py:1600-1604] **LOOP 指令与 JUMP 语义完全重复** → LOOP 只是无条件跳转，没有任何特殊循环管理逻辑 → 要么移除 LOOP，要么赋予实际语义
- [vm.py:427-428] **FORMAT_VALUE 中 Python None 输出为 "null"** → 内部状态泄漏，Nova 不应有 null 概念 → 移除该分支或转为断言
- [vm.py:669-674] **_pop 方法 n=0 边界处理多余** → 先检查 len < 0（永假），然后返回空列表，无意义 → 移除 n=0 特殊处理
- [vm.py:639+665] **_run_code 中 return_flag 在 finally 中无条件重置** → 可能掩盖调用前已有的状态，状态管理分散 → 集中管理 return_flag，使用更清晰的状态机模式
- [vm.py:705-713] **CONST_* 直接携带值与 LOAD_CONST 常量池设计冗余** → 小整数直接编码合理，但字符串也有两种方式可能浪费内存 → 明确区分小常量和大常量策略

#### 原创性分析
- **Nova 特色**：PIPE_CALL 专用管道调用指令、MATCH_* 系列专用模式匹配指令、TRY_UNWRAP 早期返回机制、MATCH_START/MATCH_END 显式作用域标记
- **借鉴方案**：栈式 VM 经典设计（参考 Python/Lua）、ADT 构造器注册模式（参考函数式语言）、内置函数表驱动

#### Evaluator vs VM 对比
| 行为 | Evaluator | VM | 是否一致 |
|------|-----------|-----|---------|
| 闭包捕获不可变变量 | 环境链引用语义 | 全帧值快照 | ❌ |
| 闭包捕获 mut 变量 | 值语义快照 | 值语义快照（所有变量） | ⚠ 部分一致 |
| 零字段 ADT 构造器 | 直接是值 | 是构造函数需调用 | ❌ |
| for 循环返回值 | body 结果列表 | result_list | ✅ |
| while 循环返回值 | 最后一次 body 值/UNIT | 结果槽中的值 | ✅ |
| 模式匹配失败异常 | RuntimeError_ | MatchFailure | ⚠ 最终效果一致 |
| TRY_UNWRAP 顶层行为 | ReturnSignal 传播 | 明确报错 | ⚠ VM 更严格 |

---

## [2026-07-16] 编译器 (compiler.py) 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 模式匹配字节码和 PIPE_CALL 有特色 |
| 可行性 | ⭐⭐⭐⭐ | 主要路径栈布局正确，跳转回填完整 |
| 正确性 | ⭐⭐⭐ | 内置构造器不一致、闭包全量捕获、导入检测有漏洞 |
| 安全性 | ⭐⭐⭐⭐ | 栈操作有编译器侧保证，类型安全由类型检查器负责 |
| 一致性 | ⭐⭐⭐ | 与 VM 基本配合，但与 Evaluator 闭包语义不同 |
| 完整性 | ⭐⭐⭐⭐ | 30 种表达式 + 10 种 Pattern + 所有声明均覆盖 |
| 工程质量 | ⭐⭐⭐ | 死代码多、两阶段模式名存实亡、冗余操作数 |
| 性能 | ⭐⭐⭐⭐ | 单遍编译，效率尚可 |
...
- [compiler.py:439 + vm.py:1085-1096] **CLOSURE 捕获全部局部变量而非自由变量** → 编译器无自由变量分析，VM 端全帧浅拷贝；内存浪费、语义风险、无法实现闭包优化 → 实现 FV 分析，CLOSURE 携带自由变量名列表
  - 追问：如果 OCaml 的编译器不做自由变量分析，能被接受吗？→ **绝对不能。** 这是闭包转换的基本要求。

- [compiler.py:665-676 + 468-471] **内置 ADT 构造器不能作为一等函数值** → Some/Ok/Err 仅在 FnCall 中硬编码为 MAKE_ADT，作为 Identifier 出现时 LOAD_VAR 找不到 → 初始化时生成 REGISTER_CTOR + STORE_VAR 指令，移除硬编码
  - 追问：如果 Haskell 的构造器不是一等公民，能被接受吗？→ **不能。** 构造器应该是一等函数，这是函数式语言的基本特性。

#### 中等问题（影响特定场景）

- [compiler.py:379-405] **导入冲突检测未覆盖内置 ADT 构造器** → None/Some/Ok/Err 仅在 _adt_constructors 中，导入同名变体不会触发冲突 → 冲突检测中加入 _adt_constructors 检查
- [compiler.py:1043+1140+1160] **ForExpr.iterable 使用原始 Python tuple 而非 AST 节点** → range 循环用 ("range", start, end, step) 元组，破坏 AST 类型安全 → 创建 RangeExpr AST 节点替代魔法 tuple
- [compiler.py:822-945] **模式匹配两阶段设计名存实亡** → _compile_pattern_test_with_fail 已完成所有绑定，_compile_pattern_extract_and_bind 全是 pass → 要么将绑定移到 extract 阶段，要么删除第二阶段
- [compiler.py:947-1012] **存在大量死代码** → _compile_pattern_test、_compile_pattern_bindings 从未被调用；LOAD_CONST、Bytecode.add_const 从未使用；LOOP opcode 从不发射 → 删除所有未使用的代码
- [compiler.py:294-297] **REGISTER_CTOR 的 name 操作数冗余且未使用** → 第 4 操作数 name 在 VM 端被读入但从未使用，与 variant_name 总是相同 → 移除冗余操作数

#### 轻微问题（代码质量）

- [compiler.py:1016-1022] **块中 break/continue 后生成死指令** → 跳转后仍编译后续语句并生成 POP，永远不会执行 → 检测到 break/continue 后终止块编译
- [compiler.py:511] **STORE_VAR 的 mutable 操作数在赋值路径上冗余** → is_assignment=True 时 VM 不使用第二个操作数，检查已有的 local_mutable → 移除或统一语义
- [compiler.py:83] **CLOSURE 指令注释与实际参数不符** → 注释写 3 个操作数，实际只有 2 个 → 修正注释
- [compiler.py:741-757] **无 else 的 if 表达式跳转逻辑可简化** → 两次跳转可简化为一次，多了一次无条件跳转 → 简化为单跳转结构
- [compiler.py:77] **LOOP opcode 定义但从未发射** → 编译器只用 LOOP_END 不用 LOOP → 移除或使用

#### 原创性分析
- **Nova 特色**：模式匹配作为一等字节码原语（MATCH_TEST_* 系列）、PIPE_CALL 专用管道调用、TRY_UNWRAP VM 级早期返回、MATCH_START/END 作用域标记
- **借鉴方案**：经典栈式字节码设计（Python/Java 家族）、递归下降编译、模式匹配编译为测试+跳转序列

---

## [2026-07-16] 求值器 (evaluator.py) 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 异常驱动的控制流、双遍声明收集有一定特色 |
| 可行性 | ⭐⭐⭐⭐ | 主要功能可用，表达式覆盖完整 |
| 正确性 | ⭐⭐ | 同作用域重定义、闭包语义混合、列表推导缺 break 处理 |
| 安全性 | ⭐⭐⭐ | Python 运行时保护，但 bool/int 子类型有穿透风险 |
| 一致性 | ⭐⭐ | 与 VM 闭包语义、零字段构造器、Unit 单例等多处不一致 |
| 完整性 | ⭐⭐⭐⭐ | 29 种表达式 + 10 种 Pattern 全覆盖 |
| 工程质量 | ⭐⭐ | ADT 注册重复 3 次、声明处理路径重复、代码冗余 |
| 性能 | ⭐⭐⭐ | 解释器正常水平 |
...
- [environment.py:30-32] **同作用域内 define 允许变量重定义（静默覆盖）** → let x = 1; let x = 2 在同一作用域内静默覆盖，没有 shadowing 的嵌套作用域语义 → define 前检查 name 是否已存在，存在则报错
  - 追问：如果 OCaml 的 let 在同一作用域允许重定义，能被接受吗？→ **不能。** let 应引入新绑定（通过嵌套作用域 shadow），同作用域重定义是错误。

- [evaluator.py:480-494 + vm.py:1085-1096] **闭包语义两端不一致** → Evaluator：不可变变量用环境链（引用语义），mut 变量用值快照；VM：所有变量全帧值快照 → 变量被重定义时行为不同 → 统一语义，建议采用引用语义（函数式语言标准行为）
  - 追问：如果语言的两个执行后端闭包语义不同，能被接受吗？→ **绝对不能。** 语义一致性是语言规范的基本要求。

- [evaluator.py:221 + vm.py:156-167] **零字段 ADT 构造器语义两端完全不同** → Evaluator 中 None 是 NovaADTValue（值），VM 中是 NovaConstructor（构造函数）→ VM 端零字段构造器直接存为 NovaADTValue
  - 追问：如果 Haskell 的 Nothing 在不同执行路径上一个是值一个是函数，能被接受吗？→ **绝对不能。** nullary constructor 应该是值，这是 ADT 的基本语义。

- [evaluator.py:1255-1289] **列表推导式未捕获 BreakSignal/ContinueSignal** → break/continue 在列表推导的 body 中会错误地跳出外层循环或报误导性错误 → 在迭代循环中捕获 Break/ContinueSignal，按语义决定报错或支持跳转
  - 追问：如果 Python 的列表推导中 break 会跳出外层 for 循环，能被接受吗？→ **不能。** 控制流的作用域边界必须清晰。

#### 中等问题（影响特定场景）

- [evaluator.py:480-494] **_capture_mut_vars 捕获所有 mut 变量而非仅自由变量** → 遍历整个作用域链捕获所有 mut 变量，无论是否实际引用 → 实现自由变量分析，只捕获实际引用的外部变量
- [evaluator.py:1190-1192] **ForExpr range 用元组混用 AST/运行时表示** → expr.iterable 有时是 Expression 有时是 ("range", ...) tuple，破坏 AST 纯结构性质 → 新增 RangeExpr AST 节点
- [evaluator.py:多处] **Python bool/int 子类型穿透风险** → 索引操作、内置函数等多处未严格排除 bool → 所有数值入口添加 bool 排除检查
- [evaluator.py:219-754] **ADT 构造器注册逻辑重复 3 次** → _setup_builtins、_collect_decl、_eval_decl_inner 三处几乎相同 → 提取为统一的 _register_adt_constructor 方法
- [evaluator.py:675-768] **_eval_decl_inner 与 _eval_decl_body 功能重复** → 两套独立的声明求值路径，维护成本高 → 统一路径，_eval_decl_inner 调用 _eval_decl_body

#### 轻微问题（代码质量）

- [evaluator.py:1324] **模式匹配失败抛出普通 RuntimeError_ 而非 MatchFailure** → 无法从异常类型区分匹配失败和其他运行时错误 → 改用 MatchFailure 异常，与 VM 一致
- [errors.py:394-398] **BreakSignal.value 字段存在但从未使用** → 要么实现带值的 break，要么删除该字段 → 删除或实现
- [evaluator.py:170-173] **_eval_depth 与 _call_depth 职责重叠** → 两个计数器都是 1000，但计数维度不同，大型字面量可能触发深度限制 → 明确语义边界或只保留调用深度限制
- [evaluator.py:1298-1321] **守卫和分支体使用独立环境，代码冗余** → 各自创建 child_env 并定义相同 bindings → 共享同一子环境，减少一次环境创建
- [evaluator.py:291] **_builtin_tail 的 None 变体 field_names 设为 ["value"]** → 零字段变体不应有字段名，VM 中正确使用空列表 → 修正为空列表

#### 原创性分析
- **Nova 特色**：表达式导向的求值（一切皆表达式）、异常驱动的 break/continue 控制流、双遍声明收集（先收集类型再求值）
- **借鉴方案**：环境链作用域（经典 Lisp/Scheme）、闭包捕获模式（参考 Lua）、模式匹配递归展开（函数式语言标准做法）

---

## [2026-07-16] 类型检查器 (type_checker.py) 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 声称 HM 但实际是简化版，有自己的设计思路 |
| 可行性 | ⭐⭐⭐ | 完全标注的代码可正确检查，无标注时大量放行 |
| 正确性 | ⭐⭐ | 无真正 unification、TypeVar 过于宽松、无 let 多态 |
| 安全性 | ⭐⭐ | 类型变量兼容检查太松，等于没有检查 |
| 一致性 | ⭐⭐⭐ | ADTType.__eq__ 正确，但 _types_compatible 行为不同 |
| 完整性 | ⭐⭐⭐⭐ | 所有 AST 节点和 Pattern 均有类型检查路径 |
| 工程质量 | ⭐⭐⭐ | 结构清晰，但算法核心有缺陷，别名循环检测不完善 |
| 性能 | ⭐⭐⭐ | 单遍检查，效率尚可 |
...
- [type_checker.py:622-1160 + 1437-1445] **不是真正的 Hindley-Milner — 缺少统一化（Unification）** → 只有单向的类型变量绑定收集，没有双向 unification；不支持从参数类型推断返回类型，不支持多方向约束传播 → 实现真正的 unify 函数，使用 union-find 维护类型变量等价类
  - 追问：如果 OCaml 的类型检查器没有 unification，能被接受吗？→ **完全不能接受。** 没有 unification 就不能称为 HM 类型推断，只能算带类型变量注解的简单类型检查器。

- [type_checker.py:1582-1583] **_types_compatible 中 TypeVar 过于宽松 — 等于没有类型检查** → 只要一方是类型变量就返回 True，未解析的类型变量与任何类型都"兼容" → 实现 unification 后，基于 substitution 环境正确判断兼容性
  - 追问：如果 Haskell 的类型检查器对类型变量总是放行，能被接受吗？→ **绝对不能接受。** 这是类型安全的核心漏洞。

- [type_checker.py:538-548 + 834-844] **缺少 Let-Polymorphism（let 多态）** → let 绑定的值推断出类型后直接存入环境，没有泛化步骤；instantiate 只是复制未解析的类型变量 → 实现 generalize，将自由类型变量提升为泛型变量；顶层和块级 let 都需要泛化
  - 追问：如果 OCaml 的 let 多态没有正确实现，能被接受吗？→ **不能接受。** Let-polymorphism 是 HM 类型系统的标志性特性。

#### 中等问题（影响特定场景）

- [type_checker.py:全局] **无 Occurs Check — 递归类型可能导致无限循环** → 类型变量出现在自身的类型中时没有检测和阻止，_substitute_type_vars 可能无限递归 → 添加 visited set 防止无限递归，实现 unification 后必须加 occurs check
- [type_checker.py:718-730] **Pattern 匹配缺少穷尽性检查和冗余分支检查** → 缺少 None 分支不会报错，通配符后的冗余分支无警告 → 实现穷尽性检查算法和冗余分支检测
- [type_checker.py:1506-1510] **类型别名循环检测不完善** → 只在 TypeIdentifier 分支检测，_expand_alias 本身不检测；别名展开后的子结构中引用原别名不会被检测 → _expand_alias 中全面传递 _alias_stack，每一步都检查循环
- [type_checker.py:多处] **错误恢复不完整** → 第 1508 行循环别名直接 raise 不走 _report_error；部分错误路径可能崩溃 → 所有错误走 _report_error，确保收集模式下不崩溃
- [type_checker.py:152-156 + 1605-1610] **ADTType.__eq__ 与 _types_compatible 行为不一致** → __eq__ 正确比较 type_params，但 _types_compatible 因 TypeVar 宽松规则可能给出不同结果 → 统一类型比较逻辑

#### 轻微问题（代码质量）

- [type_checker.py:178-179 + 1406-1417] **TypeVar.__eq__ 基于 identity，但 substitution 支持字符串 key** → 双轨设计容易引入 bug → 统一使用 TypeVar 对象作为 key，移除字符串 key 模式
- [type_checker.py:295-309] **内置 ADT 构造函数的类型变量命名混乱** → 同一概念用 "T"、"opt_t" 等不同名字，增加理解成本 → 统一命名规范
- [type_checker.py:828-829] **Block 中语句的返回类型被丢弃** → 不验证语句是否真的应该返回 Unit → 非 Unit 类型的语句至少给警告
- [type_checker.py:1314-1318] **比较操作符只支持 Int 和 Float，不支持 String 和 Char** → 字符串和字符也是可比较的 → 添加 String 和 Char 的比较支持
- [type_checker.py:1073+1121] **ForExpr 和 ListComprehension 中 iterable 是 tuple 的特殊处理** → 依赖内部约定而非正式 AST 节点类型 → 用 RangeExpr 替代

#### 原创性分析
- **Nova 特色**：声称简化版 HM，两阶段（收集+替换）设计有独特性；ErrorCollector 批量错误收集
- **借鉴方案**：ADT 类型系统（ML 家族）、泛型参数化（Haskell/ML）、类型别名展开

---

## [2026-07-16] 词法/语法分析器 (lexer.py + parser.py) 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 递归下降 + 手写 lexer，标准设计 |
| 可行性 | ⭐⭐⭐ | 主要语法可用，边界情况有问题 |
| 正确性 | ⭐⭐⭐ | 管道优先级注释矛盾、比较左结合错误、空块歧义 |
| 安全性 | ⭐⭐⭐⭐ | 位置跟踪基本准确 |
| 一致性 | ⭐⭐⭐ | AST 全覆盖，但 lexer/parser 错误处理模式不一致 |
| 完整性 | ⭐⭐⭐ | 缺少十六进制字面量、Unicode 转义、块注释 |
| 工程质量 | ⭐⭐⭐ | 结构清晰，但死代码、魔法 tuple、歧义处理脆弱 |
| 性能 | ⭐⭐⭐ | 递归下降正常水平，但 map 消歧有 O(n) 扫描 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [parser.py:457 vs 456-463] **管道操作符优先级注释与代码矛盾** → 注释说"低于逻辑或，高于逻辑与"，实际 OR < PIPE < AND，与注释相反 → 修正注释或调整优先级（建议让管道低于 OR，符合函数式语言惯例）
  - 追问：如果 GCC 的运算符优先级文档与实现相反，能被接受吗？→ **不能接受。** 文档和实现必须一致。

- [parser.py:695-701] **比较运算符左结合 — 语义错误** → `a < b < c` 被解析为 `(a < b) < c`，即布尔值与 c 比较，几乎肯定不是用户意图 → 改为只允许单个比较（遇第二个则报错），或实现链式比较
  - 追问：如果任何生产级语言的比较运算符是左结合且不报错，能被接受吗？→ **不能接受。** GCC 至少会给 -Wparentheses 警告。

- [parser.py:884-886] **{ } 空代码块被判定为空 map — 歧义错误** → 空代码块永远无法正确解析，总是被当作空 map → 根据上下文区分，或改变 map 字面量语法（如 map{...}）
  - 追问：如果 C 语言的 {} 有时是块有时是对象，能被接受吗？→ **不能接受。** 这是明确的语法歧义。

- [parser.py:440-446] **赋值仅支持 ident = expr，不支持索引/字段赋值** → Assignment 只有 name: str 字段，无法修改列表元素或对象字段 → 将 name 改为 target: Expression，支持左值表达式
  - 追问：如果 C 语言只能给变量赋值不能给数组元素赋值，能被接受吗？→ **不能接受。** 赋值左值必须支持所有可修改的表达式。

- [lexer.py:156-161] **_make_error 方法定义但从未调用 — 死代码 + 架构不一致** → 所有错误都是手动字符串 append 到 errors 列表并 print，error 对象未标准化 → 统一使用 _make_error 创建 LexerError 对象
  - 追问：如果 GCC 的 lexer 有一套错误 API 但从来不用，能被接受吗？→ **不能接受。** 诊断系统必须统一。

#### 中等问题（影响特定场景）

- [lexer.py:203-249] **缺少十六进制/八进制/二进制整数字面量支持** → 仅支持十进制，系统级语言必备特性缺失 → 添加 0x/0o/0b 前缀解析
- [lexer.py:274-359] **缺少 Unicode 转义序列和十六进制转义** → 只有 11 种转义，无法表示任意 Unicode 字符 → 添加 \u、\U、\x 转义
- [lexer.py:187-201] **缺少块注释（/* */）支持** → 只有单行注释，无法方便注释大段代码 → 添加块注释支持
- [lexer.py:211+386] **数字和标识符接受 Unicode 字符** → isdigit()/isalnum() 匹配所有 Unicode 字符，可能导致同形异义字攻击 → 限制为 ASCII 或明确规范
- [parser.py:497+996] **ForExpr.iterable 使用字符串 tag tuple 而非 AST 节点** → 类型安全丧失，下游消费者需用字符串判断 → 创建 RangeExpr AST 节点
- [parser.py:867-907] **_is_map_literal 线性扫描 — O(n) 前瞻开销** → 每次遇到 { 都可能扫描到匹配的 }，大文件解析性能差 → 改用语法层面消歧（1-2 token 前瞻）
- [parser.py:545] **match 分支续接条件遗漏 CHAR token** → 字符模式 'a' -> expr 无逗号分隔时无法续接 → 添加 TokenType.CHAR 到列表，提取 _is_pattern_start() 辅助函数
- [parser.py:426-435] **块语句隐式分隔 — 无分号也连接语句** → { 1 + 2 3 + 4 } 合法，可能掩盖用户输入错误 → 明确分隔规则（基于换行或要求分号）

#### 轻微问题（代码质量）

- [lexer.py:89] **PIPE_VARIANT Token 定义但永不生成** → 死代码，误导维护者 → 删除
- [lexer.py:92] **UNIT Token 定义但永不生成** → parser 中对应分支是死代码 → 删除
- [parser.py:全文件] **Parser 完全没有错误恢复 — 遇错即崩** → 用户一次只能看到一个错误 → 实现 panic mode 错误恢复
- [parser.py:704] **_parse_cons_expr 注释过时** → 注释说"预留"，但 ++ 已经完全实现 → 更新注释
- [ast_nodes.py:220-225] **MatchArm 没有 span 字段** → match 分支错误无法精确定位 → 添加 span 字段

#### 原创性分析
- **Nova 特色**：管道操作符语法、列表推导式集成、ADT + 模式匹配的语法设计
- **借鉴方案**：递归下降解析器（经典教材级设计）、手写 lexer（标准做法）、运算符优先级分层（标准方法）

---

## [2026-07-16] 错误处理 + 模块 + 环境 (errors.py + modules.py + environment.py) 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | ErrorCollector 批量收集、SourceSpan 多行高亮有特色 |
| 可行性 | ⭐⭐⭐ | 基本可用，但有明显缺陷 |
| 正确性 | ⭐⭐ | 循环导入检测不可靠、命名空间隔离缺失、闭包语义混合 |
| 安全性 | ⭐⭐⭐ | 路径安全有基本检查但有绕过可能 |
| 一致性 | ⭐⭐⭐ | 错误系统各部分模式不统一 |
| 完整性 | ⭐⭐⭐ | 错误类型覆盖基本场景，模块系统功能基本完整 |
| 工程质量 | ⭐⭐⭐ | 结构清晰，但冗余字段、死代码、设计不一致较多 |
| 性能 | ⭐⭐⭐⭐ | 正常水平 |
...
- [modules.py:247-249] **循环导入检测仅检测直接循环，无法检测间接/延迟循环** → 模块 A 加载完成后模块 B 导入 A，A 又导入 B 时 A 已在缓存中不报错，但 A 的状态可能不完整 → 采用三染色法（白/灰/黑）DFS 检测，在类型检查阶段检测类型层面循环依赖
  - 追问：如果 Rust 的模块系统检测不到间接循环导入，能被接受吗？→ **不能接受。** 循环导入是模块系统的核心问题，必须可靠检测。

- [modules.py:359-368] **模块导入时命名空间污染：直接 define 到目标环境** → 不同模块的同名导出静默覆盖，后导入的覆盖先导入的，无模块前缀访问方式 → 默认将模块作为整体对象导入，选择性导入才直接注入名称
  - 追问：如果 Python 的 import 会把所有导出名称直接注入当前作用域且同名覆盖不报错，能被接受吗？→ **不能接受。** 命名空间隔离是模块系统的基本职责。

- [environment.py:30-32] **define 不检查重定义，同作用域内静默覆盖** → 同一作用域内 let x = 1; let x = 2 是静默覆盖而非 shadowing → define 前检查 name 是否已存在，存在则报错
  - 追问：如果 Scheme 的 define 在同一作用域允许重定义且不报错，能被接受吗？→ **不能接受。** 即使是 Lisp 也有 set! 和 define 的明确区分。

- [errors.py:465-471] **raise_all 错误合并方式错误** → 将后续错误作为 note 添加到第一个错误上，语义完全错误——note 是补充说明而非独立错误 → 抛出聚合异常（NovaErrorBundle），或打印所有错误后抛出信号异常
  - 追问：如果 Rust 编译器把多个独立错误降级为一个错误的 note，能被接受吗？→ **不能接受。** 错误的严重级别和分类是诊断系统的核心。

- [evaluator.py:46-61 + environment.py 整体] **闭包环境是引用语义 + mut 值快照的混合设计** → 不可变变量引用语义（随外部变化），可变变量值语义（快照），两者不一致极易导致 bug → 统一为全引用或全值语义
  - 追问：如果 JavaScript 的闭包对 let 变量是引用语义对 var 变量是值语义，能被接受吗？→ **不能接受。** 闭包语义必须统一且可预测。

- [modules.py:307-322] **_collect_exports 不验证导出名称是否实际存在** → export 一个不存在的名称不会报错，静默 pass → 收集导出时验证名称存在，不存在则报错
  - 追问：如果 Rust 中 pub use 一个不存在的名称不报错，能被接受吗？→ **不能接受。** 导出不存在的名称是明确的编译错误。

#### 中等问题（影响特定场景）

- [errors.py:300-303] **_compute_underline 多行高亮首行越界时误导** → start_col 超出行长度时 caret_count 可能为负，max(1, ...) 保底但显示在第 1 列，误导用户 → clamp 到行尾，越界时附加说明
- [errors.py:68-76] **RelatedNote 的 line/column 与 span 字段冗余** → 可能存储不同的值，需要复杂回退逻辑 → 只保留 span，line/column 通过属性读取
- [errors.py:367-387] **PassError 不继承位置信息且绕过格式化系统** → __str__ 直接返回 message，没有源码位置和颜色 → 使用标准格式化，存储触发错误的源码 span
- [errors.py:425-430] **error_collector.add 对 NOTE 和 HELP 分类错误** → 非 WARNING 都算 errors，导致 has_errors() 误判 → 明确判断 severity == ERROR 才算错误
- [modules.py:236] **每次 load_module 都创建新的 ModuleResolver** → 搜索路径重复计算，嵌套导入时顺序可能不一致 → ModuleManager 持有一个 resolver 实例
- [modules.py:99+390] **默认搜索路径包含 ""（当前目录），含义模糊** → 导入行为依赖当前工作目录，可移植性差 → 明确区分包导入和文件导入
- [environment.py:67-73] **all_bindings 方法丢失可变性信息** → 返回 Dict[str, Any]，调试时看不到 mutable 状态 → 返回 Dict[str, BindingInfo]

#### 轻微问题（代码质量）

- [errors.py:47-48] **NO_COLOR 检测不检查 FORCE_COLOR** → CI 环境无法强制彩色输出 → 添加 FORCE_COLOR 支持
- [errors.py:139+191] **错误位置格式不统一** → 无上下文用 [行 N, 列 M]，有上下文用"第N行，第M列" → 统一为 file:line:col 格式
- [errors.py:全文件] **缺少错误码（error code）系统** → 用户无法通过错误码搜索文档，无法抑制特定警告 → 为每个错误类型分配唯一错误码
- [modules.py:47] **ModuleInfo.is_loaded 字段未被使用** → 死代码 → 删除或实现"加载中"状态
- [modules.py:397] **全局模块管理器是单例，测试隔离困难** → 测试之间可能互相干扰 → 提供测试专用上下文管理器
- [environment.py:17-20] **BindingInfo 的 name 字段冗余** → 字典的 key 也是 name → 移除 name 字段

#### 原创性分析
- **Nova 特色**：ErrorCollector 批量错误收集、ANSI 彩色多行高亮、SourceSpan 完整位置信息
- **借鉴方案**：Rust 风格错误报告（灵感）、环境链作用域（经典 Lisp）、模块缓存+加载栈（Python 模块系统）

---

## [2026-07-16] 所有后端审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐ | 自研 x86_64 后端有探索性，但整体架构较常规 |
| 可行性 | ⭐⭐ | 所有后端均为 demo 级别，距生产可用差距大 |
| 正确性 | ⭐ | 多个 SEVERE 级正确性 bug，无法运行非 trivial 程序 |
| 安全性 | ⭐ | 栈泄漏、越界读、悬垂指针等严重内存安全问题 |
| 一致性 | ⭐⭐ | C 后端绕过 IR，与其他后端架构不一致 |
| 完整性 | ⭐⭐ | 指令覆盖率表面高，但内部操作大量缺失 |
| 工程质量 | ⭐⭐ | 命名误导、设计错误、编码错误、类型混淆 |
| 性能 | ⭐⭐ | 概念验证级别，不做性能评估 |
...
- [native_backend.py:1125-1189] **List/Tuple/ADT 栈分配后永不释放，导致栈溢出** → sub rsp 分配但从不 add rsp 恢复，每构造一个复合类型栈就永久缩小 → 改用堆分配（malloc）或正确管理栈帧
  - 追问：如果 OCaml 的 native 编译器每次构造列表都泄漏栈空间，能被接受吗？→ **绝对不能。** 栈管理是运行时最基本的正确性要求。

- [lir_lowering.py:221-228] **LIR Phi 节点降级完全错误 — 只取第一个 source** → MIRPhi 被降级为从第一个源寄存器复制，完全忽略 phi 节点"根据前驱块选值"的核心语义 → 正确实现 phi 消除（前驱块末尾插入 move）或保留基本块结构
  - 追问：如果 LLVM 的 phi 节点降级为总是取第一个值，能被接受吗？→ **绝对不能。** Phi 是 SSA 的基石，失效等同于整个 SSA 基础设施崩溃。

- [lir_lowering.py:248-258] **Switch 和 MatchJump 降级为无条件跳转** → 所有 case/variant 分支完全丢失，永远走 default 分支 → 实现正确的 lowering（比较 + 条件跳转链或跳转表）
  - 追问：如果 GCC 的 switch 语句总是走 default 分支，能被接受吗？→ **绝对不能。** 控制流是编译器最核心的部分。

- [compiler_pipeline.py:33-35] **"native" 后端实际加载的是 Cranelift** → BACKEND_NATIVE 映射到 CraneliftBackend，自研 x86_64 后端从未在管道中使用 → 重命名为 BACKEND_CRANELIFT 或真正接入 NativeCodeGen
  - 追问：如果一个编译器声称有 native 后端实际是另一个东西，能被接受吗？→ **绝对不能。** 命名必须准确，这是最基本的工程诚信。

- [x86_64.py:266-273] **MOVSD 寄存器-寄存器操作数方向反转** → opcode F2 0F 10 的方向是 reg=dst, r/m=src，但代码中 src 放 reg 字段、dst 放 r/m 字段，方向完全相反 → 改用 opcode F2 0F 11，或交换 src/dst 位置
  - 追问：如果 GCC 的 movsd 指令编码方向是反的，能被接受吗？→ **绝对不能。** 指令编码错误是后端的致命缺陷。

- [lir_lowering.py:204 + native_backend.py:1113-1119] **ADT 字段访问偏移错误 — 读到 tag 而非字段** → field_index 0 的字节偏移是 0，但实际布局是 [tag:8字节][field0]，错位 8 字节 → LIR lowering 中对 ADT 字段访问加 tag 偏移
  - 追问：如果 OCaml 的记录字段访问总是偏移一个字，能被接受吗？→ **绝对不能。** 数据结构布局错误会导致整个类型系统失效。

- [native_backend.py:52-82] **寄存器分配器不区分寄存器和溢出槽** → 注释说负数表示 spill，但 spill_slot 从 0 开始（非负），寄存器号也是非负，完全无法区分 → 使用负数表示 spill slot 或加标记位
  - 追问：如果 LLVM 的寄存器分配器分不清寄存器和栈槽，能被接受吗？→ **绝对不能。** 这是寄存器分配的基本正确性要求。

- [native_backend.py:45-82 + 509-541] **寄存器分配不处理调用约定 — caller-saved 跨调用被破坏** → 分配器不知道哪些寄存器会被函数调用破坏，值存在 caller-saved 寄存器中跨过 call 就失效 → 将 call 指令视为对所有 caller-saved 寄存器的隐式 clobber

- [cranelift_backend.py:162-168] **Cranelift 后端条件分支使用硬编码标签名** → 总是 brz ..., block_false，不使用 instr.true_label/false_label → 使用指令中的标签名
- [wasm_backend.py:230-232] **WasmGC 后端 LIRLabel 被错误实现为 block** → Wasm block 是可跳出的结构化块，不是可跳转的标签，循环需要 loop 结构 → 重新设计控制流降级，识别循环并用 loop/block 正确嵌套

#### 中等问题（影响特定场景）

- [x86_64.py:375-386] **mov_mem_imm64 名不副实，只写 32 位立即数** → 函数名暗示 64 位，实际 imm32 符号扩展 → 改用寄存器中转或重命名并加范围检查
- [x86_64.py:275-287] **movsd_reg_imm REX 前缀使用错误的位** → 设置 REX.B 位但 SSE 寄存器扩展在 REX.R → 改为设置 REX.R
- [x86_64.py:429-434] **ucomisd 缺少 REX 前缀处理** → XMM8-XMM15 的浮点比较编码错误 → 添加 REX 前缀处理
- [lir_lowering.py:242-246] **LIRReturn 返回值类型硬编码为 UNIT_TYPE** → 后端无法区分整数返回和浮点返回 → 从函数 return_type 或 SSA 值类型获取
- [c_codegen.py:590-600] **C 后端 ? 操作符实现完全错误** → 字段名 variant_tag 应为 tag，常量名不匹配，返回类型可能不兼容 → 对齐字段名和枚举名，确保返回类型兼容
- [c_codegen.py:1035] **C 后端闭包调用参数不匹配** → 只传 2 个参数，runtime 需要 3 个 → 构造参数数组并传入正确数量
- [c_codegen.py:1257-1270] **C 后端 ADT 值类型与指针类型混用** → 同一 ADT 有时是值有时是指针，.tag 和 ->tag 混用 → 统一内存模型
- [native_backend.py:1064-1111] **List 索引操作无边界检查** → 直接计算地址并读取，越界读漏洞 → 添加边界检查

#### 轻微问题（代码质量）

- [x86_64.py:451-473] **je_rel32 函数定义重复** → 第二次覆盖第一次 → 删除重复定义
- [wasm_backend.py:319] **WasmGC 后端浮点取模生成空操作** → 浮点取模的 Wasm 操作符为空字符串，生成无效 WAT → 实现或明确报错不支持
- [c_codegen.py:188-195] **C 后端顶层全局变量未初始化** → main 之前被访问则是未初始化的 → 确保声明时有初始化
- [mir_lowering.py:285-289] **列表推导式被降级为空列表常量** → 迭代逻辑完全丢失 → 正确实现列表推导式 lowering
- [mir_lowering.py:247-250] **Lambda 函数体在 MIR 降级中完全丢失** → 只生成 ClosureCreate，函数体没有被降级为 MIR 函数 → 将 Lambda 体降级为独立 MIR 函数

#### 原创性分析
- **Nova 特色**：自研 x86_64 指令编码器和寄存器分配器（学习项目中少见）、多后端架构（C/native/Cranelift/Wasm）
- **借鉴方案**：三层 IR 设计（LLVM 灵感）、线性扫描寄存器分配（标准算法）、C 代码生成（常见方案）

---

## [2026-07-16] IR 系统 + Pass 管理器审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 三层 IR 设计有野心，模式匹配指令有特色 |
| 可行性 | ⭐⭐ | 框架搭建了，但 lowering 有多处语义丢失 |
| 正确性 | ⭐ | Phi 失效、分支丢失、列表推导变空列表 — 多个 P0 级 bug |
| 安全性 | ⭐⭐ | 类型信息大量丢失，常量折叠用 __class__ 篡改有安全隐患 |
| 一致性 | ⭐⭐ | 层次耦合严重，MIR 依赖 HIR 类型 |
| 完整性 | ⭐⭐ | HIR 覆盖较全，MIR/LIR 缺关键节点 |
| 工程质量 | ⭐⭐ | 死代码、空壳 Pass、设计不一致 |
| 性能 | ⭐⭐ | Pass 框架正常，但优化效果有限 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [lir_lowering.py:221-228] **LIR Phi 节点语义完全丢失 — 只取第一个源** → MIRPhi 降级为从第一个 source 复制，完全忽略控制流依赖 → 正确实现 SSA-out 或保留基本块结构
  - 追问：如果 LLVM 的 opt 把 phi 节点变成了 mov 第一个操作数，能被接受吗？→ **绝对不能。** Phi 是 SSA 的基石。

- [lir_lowering.py:248-258] **MIRSwitch/MIRMatchJump 降级为无条件跳转** → 所有分支逻辑完全丢失，总是走 default → 实现比较+条件跳转序列或添加 LIR 级 switch 指令
  - 追问：如果 LLVM 的 switch 降级为总是跳 default，能被接受吗？→ **绝对不能。** 控制流是编译器核心。

- [mir_lowering.py:285-289] **列表推导式被降级为空列表常量** → HIRListComprehension → MIRConst([])，迭代/过滤/结果表达式完全丢失 → 正确实现为循环 + 追加元素
  - 追问：如果 GCC 的 for 循环被优化成了空语句，能被接受吗？→ **绝对不能。** 这是直接产生错误代码的前端 bug。

- [pass_manager.py:106-109] **HIR 常量折叠使用 __class__ 篡改对象类型** → 通过修改 __class__ 将 BinaryOp 原地变为 IntLiteral，手动 del 旧字段，破坏 Python 对象模型不变式 → 返回新的节点对象，使用 visitor 模式替换子节点引用
  - 追问：如果 LLVM 的常量折叠通过篡改 vtable 指针改变指令类型，能被接受吗？→ **绝对不能。** LLVM 用 replaceAllUsesWith() 等严谨的 IR 突变机制。

#### 中等问题（影响特定场景）

- [ir_nodes.py:524] **MIR 层直接引用 HIR 类型定义 — 层次耦合** → MIRModule.type_defs 类型是 Dict[str, HIRTypeDef]，MIR 依赖 HIR 数据结构 → 定义 MIR 自己的类型表示，lowering 时转换
- [lir_lowering.py:107-119] **LIR 层 MIRStore/MIRLoad 全部按全局变量处理** → 局部变量、闭包捕获变量也被当作全局变量 → 区分全局和局部存储操作
- [lir_lowering.py:124-127] **LIR BinOp 操作数类型复用结果类型** → 比较运算的操作数类型应该是 Int 结果类型是 Bool，完全错误 → 在 MIR 指令中保留操作数类型
- [lir_lowering.py:147-163] **LIR Call 参数类型全部使用结果类型** → 每个参数应该有自己独立的类型 → MIRCall 携带参数类型列表
- [lir_lowering.py:188-193] **MIRMapBuild 降级为 LIRBuildList，类型丢失** → Map 变成了普通列表，键值对结构丢失 → 添加 LIRBuildMap 指令
- [lir_lowering.py:236-240] **LIRBranch 丢失目标标签信息** → true_target/false_target 没有设置到 LIRBranch 的 true_label/false_label → 正确传递标签
- [mir_lowering.py:247-250] **Lambda 函数体在 MIR 降级中完全丢失** → 只生成 ClosureCreate，函数体没有被降级 → 将 Lambda 体降级为独立 MIR 函数
- [mir_lowering.py:299-305] **Unwrap 操作降级为简单字段访问** → ? 操作符的错误传播控制流完全丢失，变成了普通 .value 访问 → 生成条件判断 + 提前返回的控制流
- [mir_lowering.py:351-384] **Match 表达式降级无实际匹配逻辑** → 所有 arm 用 JUMP 顺序连接，没有判别标签选择分支 → 根据判别标签生成 switch 或条件跳转序列
- [mir_lowering.py:396-417] **For 循环变量未绑定到环境** → 循环体内引用循环变量会返回 None → 在 body_block 中添加循环变量的 phi 或 load
- [pass_manager.py:606-609] **LICM LIR 实现外提位置可能改变语义** → 插入到 header 之后条件判断之前，循环不执行时也会执行外提指令 → 插入到 pre-header 块中
- [pass_manager.py:653-657] **LICM MIR 实现只检查 header 块** → 注释明确说"简化：只看 header 块"，绝大多数循环不变量无法识别 → 遍历所有循环块收集定义
- [pass_manager.py:789-792] **Pass 调度顺序：DCE 在 CSE/LICM 之前** → 标准顺序应该是 CF→CSE→LICM→DCE，DCE 在前面导致 CSE/LICM 产生的死代码不被清理 → 调整顺序

#### 轻微问题（代码质量）

- [pass_manager.py:258-263] **Inlining Pass 完全是空壳** → 只有类定义和 docstring，run 直接 return False → 要么实现，要么从默认管道移除
- [pass_manager.py:282-285] **DeadCodeElimination 的 _SIDE_EFFECT_TYPES 定义但未使用** → 实际用的是 side_effect_free_types 白名单 → 删除未使用定义
- [hir_lowering.py:97-98] **HIR 层类型别名目标信息丢失** → AliasDef 的 target 完全没有传递，被设为 TYPE_VAR → 降级别名目标类型并传递
- [ir_nodes.py:542] **MIR 基本块 terminator 允许为 None** → 基本块必须且只能有一个终结指令，Optional 破坏不变式 → 移除 Optional，要求构造时必须提供
- [ir_nodes.py:778-787] **LIRLoadReg 和 LIRStoreReg 语义冗余** → 都是寄存器间传送，功能相同 → 合并为 LIRMove
- [pass_manager.py:全文件] **缺少 IR 验证器（Verifier）** → 每个 pass 运行后不验证 IR 正确性，pass 引入的 bug 无法及时发现 → 添加 verify 函数，调试模式下每个 pass 前后调用

#### 原创性分析
- **Nova 特色**：三层 IR 架构（HIR→MIR→LIR）、模式匹配专用 IR 指令、PIPE_CALL 贯穿各层
- **借鉴方案**：SSA 形式（经典编译器设计）、线性扫描寄存器分配、Pass 管理器模式（LLVM 灵感）

---

## [2026-07-16] 运行时 + 测试 + Tree-sitter 审查报告（第三十轮）

### 总体评分
| 维度 | 评分 | 说明 |
|------|------|------|
| 原创性 | ⭐⭐⭐ | 引用计数 + 手动管理，C 运行时常见设计 |
| 可行性 | ⭐⭐ | C 运行时基本可用，但内存泄漏多、安全问题多 |
| 正确性 | ⭐⭐ | 类型混淆释放、char_at 返回字节、JSON 解析脆弱 |
| 安全性 | ⭐⭐ | Map value 类型混淆、越界读、OOM 直接 abort |
| 一致性 | ⭐⭐⭐ | 基本类型对应，但 List/Map/ADT 的内存模型与 Python 端不同 |
| 完整性 | ⭐⭐⭐ | 约 960 个测试，但分布极不均衡 |
| 工程质量 | ⭐⭐ | 测试大量 happy path、后端无端到端测试、Tree-sitter 语料不足 |
| 性能 | ⭐⭐⭐ | 引用计数正常水平，但无分代/压缩优化 |

### 发现的问题

#### 严重问题（阻碍正常使用）

- [nova_runtime.c:536-538] **nova_map_put 中 value 释放存在类型混淆（type-punned）** → 强制将任意 void* value 当作 NovaValue* 调用 nova_value_release，通过读取 ref_count 偏移处的字段判断是否释放 → 这是 undefined behavior → Map 存储带类型标签的值，或使用释放函数指针回调
  - 追问：如果 OCaml 的 Map 释放值时用强转读取 refcount，能被接受吗？→ **绝对不能。** 类型混淆是严重的内存安全漏洞。

- [nova_runtime.c:99-103] **无循环引用回收，nova_gc_collect 名不副实** → 只返回 alloc_count - free_count，不执行任何实际 GC；引用计数无法处理循环引用 → 实现真正的 tracing GC，或重命名函数并明确文档
  - 追问：如果 Java 的 GC 实际什么都不做只是返回计数，能被接受吗？→ **不能。** 函数名必须反映实际行为。

- [nova_runtime.c:193-196] **nova_string_char_at 返回字节而非 Unicode 码点** → 声称 UTF-8 字符串但按字节索引，多字节字符返回不完整字节 → 重命名为 byte_at 或实现正确的 UTF-8 码点索引
  - 追问：如果 Python 的字符串索引返回的是字节而非字符，能被接受吗？→ **不能。** UTF-8 字符串的索引语义必须明确。

- [nova_runtime.c:64-66 + 82-85] **nova_alloc/nova_realloc 内存不足时直接 abort()** → OOM 时整个进程崩溃，无法优雅处理或资源清理 → 返回 NULL 让上层处理，或设置 OOM 回调
  - 追问：如果 JVM 的内存分配失败直接 abort 而不是抛 OutOfMemoryError，能被接受吗？→ **不能。** 生产级运行时必须能处理 OOM。

- [测试套件] **递归类型完全没有测试** → 函数式语言核心特性（递归 ADT）没有类型检查和求值测试 → 添加递归 ADT 的完整测试
  - 追问：如果 GHC 没有递归数据类型的测试，能被接受吗？→ **绝对不能。** 递归类型是函数式语言的核心。

- [测试套件] **三个后端（C/native/wasm）均无端到端执行测试** → 只测生成的代码字符串包含什么，不测编译→链接→执行→输出的完整流程 → 添加端到端测试，验证实际运行结果
  - 追问：如果 GCC 只测试生成的汇编文本不测试实际执行，能被接受吗？→ **不能接受。** 后端测试必须验证执行结果。

- [grammar.js] **缺少 ?（try/error propagation）操作符语法** → parser.py 支持但 tree-sitter 完全没有 → 添加 try_expr 规则
- [grammar.js] **缺少泛型类型定义的类型参数语法** → type Option[T] { ... } 在 tree-sitter 中解析错误 → 在 type_def 中添加可选类型参数列表

#### 中等问题（影响特定场景）

- [nova_runtime.c:479-486] **nova_list_release 不释放列表元素** → 元素如果是引用计数对象会内存泄漏 → 列表需要知道元素类型或存储释放回调
- [nova_runtime.c:749-756] **nova_adt_release 不释放字段指向的对象** → 嵌套 ADT/字符串/列表会泄漏 → ADT 需要字段类型信息以正确释放
- [nova_runtime.c:791-798] **nova_closure_release 不释放捕获变量** → 捕获的引用计数对象泄漏 → 同上
- [nova_runtime.c:135-148] **nova_string_new_len 在 str 为 NULL 时未初始化 data** → 其余字节是未初始化垃圾 → memset 清零或要求调用方保证填充
- [nova_runtime.c:252-268] **nova_string_upper/lower 只处理 ASCII** → 非 ASCII UTF-8 字符不处理 → 明确文档说明或集成 Unicode 库
- [nova_runtime.c:979-1296] **JSON 解析器几乎没有错误处理** → 数字格式不验证、true/false/null 不验证后续字符、\u 不验证十六进制、错误不报位置和原因 → 添加严格语法验证和错误报告
- [nova_runtime.h:18] **引用计数不是原子的，线程不安全** → 普通 ++/--，多线程下 data race → 使用 _Atomic int64_t
- [test_consistency.py] **一致性测试大量使用 check_types=False** → 约 30/57 个跳过类型检查，类型检查通过后的代码路径一致性未验证 → 改为默认 check_types=True
- [测试套件] **大量测试只测 happy path** → 约 94% 是正常路径，错误路径仅 6% → 增加错误路径测试比例到 30%+
- [grammar.js] **泛型函数语法缺失** → fn map[T](...) 没有类型参数列表 → 添加泛型函数语法支持
- [grammar.js] **match_arm 分隔符可能与 parser 不一致** → tree-sitter 只支持逗号，parser 可能支持换行 → 支持换行分隔或统一为逗号

#### 轻微问题（代码质量）

- [nova_runtime.c:299] **nova_string_replace 中 while (*src) 依赖 NUL 终止** → 二进制字符串中间包含 NUL 会提前终止 → 使用长度比较
- [nova_runtime.c:1316-1321] **json_buf_grow 扩容逻辑有溢出风险** → cap * 2 溢出 int64 变成负数，realloc 分配 1 字节然后溢出 → 扩容前检查溢出
- [测试套件] **没有 property-based / fuzz 测试** → 所有测试都是手写给定输入，难以发现边界情况 → 添加属性测试/模糊测试
- [测试套件] **测试框架不统一** → 部分用 unittest，部分用 pytest → 统一测试框架
- [tree-sitter 测试] **测试语料严重不足（仅 15 个用例）** → 生产级语法通常有数百个测试 → 增加测试语料覆盖所有语言特性
- [nova_runtime.c:1650-1778] **nova_http_get/post 依赖系统 curl 命令** → 临时文件名 PID 基有竞争，不支持超时/证书配置 → 使用 libcurl 库替代

#### 原创性分析
- **Nova 特色**：C 运行时手动实现所有数据结构（String/List/Map/ADT/Closure）、JSON 解析器手写实现
- **借鉴方案**：引用计数 GC（最常见的入门级 GC）、FNV-1a 哈希（标准算法）、NovaValue 基类布局（参考 GObject/CPython）
...
1. **LIR Phi 节点降级完全错误（lir_lowering.py:221-228）** — SSA 基础崩塌，所有含控制流的代码在 LIR 层语义错误
2. **类型检查器无真正 Unification（type_checker.py:1582-1583）** — 类型系统的核心支柱缺失，TypeVar 过于宽松等于没有检查
3. **闭包全量捕获而非自由变量捕获（vm.py:1085-1096 + compiler.py:439）** — 语义级错误，影响语言正确性和内存效率
4. **C 运行时 Map value 类型混淆释放（nova_runtime.c:536-538）** — 类型混淆导致 undefined behavior，内存安全漏洞
5. **native 后端栈上分配复合类型不释放（native_backend.py:1125-1189）** — 系统性栈泄漏，任何非 trivial 程序必崩溃

### 与上一轮（第二十九轮）对比

- 本轮通过 9 个独立 Agent 并行深度复评，验证了上一轮发现的核心问题仍然存在且未被修复
- 新增发现：x86_64 MOVSD 编码方向反转、ADT 字段偏移错位、寄存器分配器无法区分寄存器和溢出槽等后端深层 bug
- 新增发现：HIR 常量折叠 __class__ 篡改、列表推导式降级为空列表等 IR 层严重 bug
- 新增发现：Map value 类型混淆释放、char_at 返回字节等 C 运行时安全问题

---

---

## 2026-07-16 [AST 节点] 审查报告（第三十一轮）
...
#### 严重问题
无。AST 节点定义作为纯数据结构，逻辑正确性良好，59 个类定义与 `__all__` 导出列表完全一致，无遗漏或冗余。

#### 中等问题
1. **[ast_nodes.py:220-224] `MatchArm` 缺少 `span` 字段**
   影响：所有其他 AST 节点都有 `span` 字段用于错误定位，唯独 `MatchArm` 没有。当模式匹配分支出错时，无法精确定位到具体的 arm 位置，降低错误报告质量。
   修复建议：为 `MatchArm` 添加 `span: Optional[Span] = None` 字段，parser 在构造时传入对应位置信息。

2. **[ast_nodes.py:通篇] 表达式/模式/类型字段全部使用 `Any` 类型注解**
   影响：`left: Any`、`body: Any`、`params: List[Any]` 等遍布全文件，完全失去类型检查价值。mypy 等工具无法对 AST 操作代码进行类型验证，容易引入类型相关 bug。
   修复建议：使用 `TYPE_CHECKING` 块 + 字符串前向引用，定义 `Expression`、`Pattern`、`TypeExpr` 等 Union 类型别名，替换所有 `Any`。

3. **[ast_nodes.py:382,441] `MapExpr.pairs` 和 `VariantDef.fields` 类型为 `List[tuple]` 过于模糊**
   影响：tuple 内部元素类型未指定，使用者无法从类型签名得知是 (key, value) 还是 (name, type) 的二元组，容易用错顺序。
   修复建议：改为 `List[Tuple[Any, Any]]` 并附注释，或使用命名 tuple/dataclass 封装字段对。

#### 轻微问题
1. **[ast_nodes.py:通篇] AST 节点未设置 `frozen=True`**
   修复建议：AST 作为不可变数据结构，应在 dataclass 装饰器中设置 `frozen=True`，防止运行时意外修改节点导致难以调试的问题。

2. **[ast_nodes.py:通篇] 缺少访问者模式（Visitor Pattern）支持**
   修复建议：定义 `AstVisitor` 基类和各节点的 `accept` 方法，替代 evaluator/compiler/type_checker 中大量的 `isinstance` 链，提升可扩展性。

3. **[ast_nodes.py:Pattern 类组] 缺少 `PatternOr`（或模式）**
   修复建议：添加 `PatternOr` 节点，支持 `pat1 | pat2` 语法，这是函数式语言模式匹配的标准特性。

4. **[ast_nodes.py:Pattern 类组] 缺少 `PatternAs`（as 模式）**
   修复建议：添加 `PatternAs` 节点，支持 `pat as name` 语法，在匹配的同时将值绑定到变量。

5. **[ast_nodes.py:类型节点组] 缺少记录/结构体相关 AST 节点**
   修复建议：补充 `RecordExpr`、`PatternRecord`、`TypeRecord` 节点，支持具名字段的产品类型（product type），与 ADT 的和类型互补。

6. **[ast_nodes.py:85-87] `UnitLiteral` 无 value 字段，与其他字面量风格不一致**
   修复建议：保持现状（Unit 单值语义正确），但可在注释中明确说明设计理由，减少读者困惑。

7. **[ast_nodes.py:通篇] 缺少 `__post_init__` 字段验证**
   修复建议：为关键节点添加 `__post_init__` 方法，在构造时验证字段有效性（如 `IntLiteral.value` 必须为 int、`FnDef.params` 不能为空列表等），尽早发现错误。
